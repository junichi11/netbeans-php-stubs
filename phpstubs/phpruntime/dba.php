 ...
 * @link http://php.net/manual/ja/function.dba-close.php
 ...
 * @link http://php.net/manual/ja/function.dba-delete.php
 ...
 * @link http://php.net/manual/ja/function.dba-exists.php
 ...
 * @link http://php.net/manual/ja/function.dba-fetch.php
 ...
 * @link http://php.net/manual/ja/function.dba-firstkey.php
 ...
 * @link http://php.net/manual/ja/function.dba-handlers.php
 ...
 * @param resource $handle <p><code>dba_open()</code> あるいは <code>dba_popen()</code> によって返されたデータベースハンドル。</p>
 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
 * @link http://php.net/manual/ja/function.dba-insert.php
 ...
 * @link http://php.net/manual/ja/function.dba-key-split.php
 ...
 * @link http://php.net/manual/ja/function.dba-list.php
 * @since PHP 4 >= 4.3.0, PHP 5, PHP 7
 */
 ...
 * @param resource $handle <p><code>dba_open()</code> あるいは <code>dba_popen()</code> によって返されたデータベースハンドル。</p>
 * @return string <p>成功した場合にキー、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
 * @link http://php.net/manual/ja/function.dba-nextkey.php
 ...
 * @link http://php.net/manual/ja/function.dba-open.php
 ...
 * @param resource $handle <p><code>dba_open()</code> あるいは <code>dba_popen()</code> によって返されたデータベースハンドル。</p>
 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
 * @link http://php.net/manual/ja/function.dba-optimize.php
 * @see dba_sync()
 * @since PHP 4, PHP 5, PHP 7
 */
 ...
 * @param mixed $_
 * @return resource <p>成功した場合に正のハンドル、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
 * @link http://php.net/manual/ja/function.dba-popen.php
 ...
 * @param resource $handle <p><code>dba_open()</code> あるいは <code>dba_popen()</code> によって返されたデータベースハンドル。</p>
 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
 * @link http://php.net/manual/ja/function.dba-replace.php
 ...
 * @param resource $handle <p><code>dba_open()</code> あるいは <code>dba_popen()</code> によって返されたデータベースハンドル。</p>
 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
 * @link http://php.net/manual/ja/function.dba-sync.php
 * @see dba_optimize()
 * @since PHP 4, PHP 5, PHP 7
 */
