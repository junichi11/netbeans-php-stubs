...
class Memcached {
	...
	/**
	 * @var integer <p>ペイロードの圧縮を有効あるいは無効にします。有効にすると、 有効にすると、一定の閾値 (現在は 100 バイト) を超える長さのアイテムは 格納時に圧縮され、取得時に伸長されます。この操作は透過的に行われます。</p> <p>型: <i>boolean</i>、デフォルト: <b><code>TRUE</code></b></p>
	 ...
	 * @link http://php.net/manual/ja/memcached.setsaslauthdata.php
	 * @since PECL memcached >= 2.0.0
	 */
