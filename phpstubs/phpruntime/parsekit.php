 ...
 * @link http://php.net/manual/ja/function.parsekit-compile-file.php
 ...
 * @param int $options <p><b><code>PARSEKIT_QUIET</code></b> あるいは <b><code>PARSEKIT_SIMPLE</code></b> のいずれかです。 返される出力の冗長性を設定します。</p>
 * @return array <p>複雑な形式の配列を返します。詳細は以下に示します。</p>
 * @link http://php.net/manual/ja/function.parsekit-compile-string.php
 ...
 * @link http://php.net/manual/ja/function.parsekit-func-arginfo.php
