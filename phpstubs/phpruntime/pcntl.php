 ...
 * @link http://php.net/manual/ja/function.pcntl-async-signals.php
 * @since PHP 7 >= 7.1.0
 */
 ...
 * @return bool <p>エラー時に <b><code>FALSE</code></b> を返し、成功時には何も返しません。</p>
 ...
 * @link http://php.net/manual/ja/function.pcntl-signal-get-handler.php
 * @see pcntl_signal()
 * @since PHP 7 >= 7.1.0
 */
