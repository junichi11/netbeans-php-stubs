 ...
 * @link http://php.net/manual/ja/function.id3-get-frame-long-name.php
 ...
 * @link http://php.net/manual/ja/function.id3-get-frame-short-name.php
 ...
 * @link http://php.net/manual/ja/function.id3-get-genre-id.php
 ...
 * @link http://php.net/manual/ja/function.id3-get-genre-list.php
 ...
 * @link http://php.net/manual/ja/function.id3-get-genre-name.php
 ...
 * @link http://php.net/manual/ja/function.id3-get-tag.php
 ...
 * @link http://php.net/manual/ja/function.id3-get-version.php
 ...
 * @link http://php.net/manual/ja/function.id3-remove-tag.php
 ...
 * @param int $version <p>MP3 ファイルにはバージョン 1.x および 2.x のタグを両方含められるので、 ここでタグのバージョンを指定します。</p>
 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
 * @link http://php.net/manual/ja/function.id3-set-tag.php
