 ...
 * @link http://php.net/manual/ja/class.v8js.php
...
class V8Js {
	 ...
	 * @link http://php.net/manual/ja/v8js.construct.php
	 * @since PECL v8js >= 0.1.0
	 */
	 ...
	 * @link http://php.net/manual/ja/v8js.executestring.php
	 * @since PECL v8js >= 0.1.0
	 */
	 ...
	 * @link http://php.net/manual/ja/v8js.getextensions.php
	 * @since PECL v8js >= 0.1.0
	 */
	 ...
	 * @link http://php.net/manual/ja/v8js.getpendingexception.php
	 * @since PECL v8js >= 0.1.0
	 */
	 ...
	 * @link http://php.net/manual/ja/v8js.registerextension.php
	 * @since PECL v8js >= 0.1.0
	 */
...
/**
 * @link http://php.net/manual/ja/class.v8jsexception.php
 * @since PECL v8js >= 0.1.0
 */
class V8JsException extends \Exception {
	...
	/**
	 * @var mixed
	 * @link http://php.net/manual/ja/class.v8jsexception.php#v8jsexception.props.jsfilename
	 */
	protected $JsFileName;

	/**
	 * @var mixed
	 * @link http://php.net/manual/ja/class.v8jsexception.php#v8jsexception.props.jslinenumber
	 */
	protected $JsLineNumber;

	/**
	 * @var mixed
	 * @link http://php.net/manual/ja/class.v8jsexception.php#v8jsexception.props.jssourceline
	 */
	protected $JsSourceLine;

	/**
	 * @var mixed
	 * @link http://php.net/manual/ja/class.v8jsexception.php#v8jsexception.props.jstrace
	 */
	protected $JsTrace;
	 ...
	 * @return string
	 * @link http://php.net/manual/ja/v8jsexception.getjsfilename.php
	 * @since PECL v8js >= 0.1.0
	 */
	 ...
	 * <p></p><p>この関数は、 現在のところ詳細な情報はありません。引数のリストのみが 記述されています。</p>
	 * @return int
	 * @link http://php.net/manual/ja/v8jsexception.getjslinenumber.php
	 * @since PECL v8js >= 0.1.0
	 */
	 ...
	 * <p></p><p>この関数は、 現在のところ詳細な情報はありません。引数のリストのみが 記述されています。</p>
	 * @return string
	 * @link http://php.net/manual/ja/v8jsexception.getjssourceline.php
	 * @since PECL v8js >= 0.1.0
	 */
	 ...
	 * <p></p><p>この関数は、 現在のところ詳細な情報はありません。引数のリストのみが 記述されています。</p>
	 * @return string
	 * @link http://php.net/manual/ja/v8jsexception.getjstrace.php
	 * @since PECL v8js >= 0.1.0
	 */
