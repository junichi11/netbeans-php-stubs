...
namespace {
	 ...
	 * @link https://php.net/manual/ja/function.boolval.php
	 ...
	 * @link https://php.net/manual/ja/function.debug-zval-dump.php
	 ...
	 * @return float
	 * @link https://php.net/manual/ja/function.doubleval.php
	 ...
	 * @link https://php.net/manual/ja/function.floatval.php
	 ...
	 * @link https://php.net/manual/ja/function.get-defined-vars.php
	 ...
	 * @link https://php.net/manual/ja/function.get-resource-type.php
	 ...
	 * @link https://php.net/manual/ja/function.gettype.php
	 ...
	 * @link https://php.net/manual/ja/function.import-request-variables.php
	 * @see extract()
	 ...
	 * @link https://php.net/manual/ja/function.intval.php
	 ...
	 * @link https://php.net/manual/ja/function.is-array.php
	 ...
	 * @link https://php.net/manual/ja/function.is-bool.php
	 ...
	 * @param bool $syntax_only <p><b><code>TRUE</code></b> の場合、この関数は単に <code>var</code> が関数またはメソッドであるかどうかだけを調べます。 文字列以外の型の変数や不正な形式の配列は、 引数として受け付けられません。有効な配列の形式は、 最初のエントリがオブジェクトあるいは文字列で、2 番目のエントリが文字列である 2 つのエントリからなるものです。</p>
	 ...
	 * @link https://php.net/manual/ja/function.is-callable.php
	 ...
	 * @link https://php.net/manual/ja/function.is-countable.php
	 ...
	 * @param mixed $var <p>評価する変数</p>
	 * @return bool
	 * @link https://php.net/manual/ja/function.is-double.php
	 * @since PHP 4, PHP 5, PHP 7
	 */
	 ...
	 * @link https://php.net/manual/ja/function.is-float.php
	 ...
	 * @link https://php.net/manual/ja/function.is-int.php
	 ...
	 * @param mixed $var <p>評価する変数</p>
	 * @return bool
	 * @link https://php.net/manual/ja/function.is-integer.php
	 * @since PHP 4, PHP 5, PHP 7
	 */
	 ...
	 * <p>変数の内容が <code>iterable</code> 疑似型で許容されること、すなわち <code>array</code>、あるいは Traversable のどちらかを実装したオブジェクトであることを確認する。</p>
	 * @param mixed $var <p>チェックする値</p>
	 * @return bool <p><code>var</code> が反復可能であれば <b><code>TRUE</code></b> を、そうでなければ <b><code>FALSE</code></b> を返す。</p>
	 * @link https://php.net/manual/ja/function.is-iterable.php
	 * @see is_array()
	 * @since PHP 7 >= 7.1.0
	 */
	 ...
	 * @param mixed $var <p>評価する変数</p>
	 * @return bool
	 * @link https://php.net/manual/ja/function.is-long.php
	 * @since PHP 4, PHP 5, PHP 7
	 */
	 ...
	 * @link https://php.net/manual/ja/function.is-null.php
	 ...
	 * @link https://php.net/manual/ja/function.is-numeric.php
	 ...
	 * @link https://php.net/manual/ja/function.is-object.php
	 ...
	 * @param mixed $var <p>評価する変数</p>
	 * @return bool
	 * @link https://php.net/manual/ja/function.is-real.php
	 * @since PHP 4, PHP 5, PHP 7
	 */
	 ...
	 * @link https://php.net/manual/ja/function.is-resource.php
	 ...
	 * @link https://php.net/manual/ja/function.is-scalar.php
	 ...
	 * @link https://php.net/manual/ja/function.is-string.php
	 ...
	 * @link https://php.net/manual/ja/function.print-r.php
	 ...
	 * @link https://php.net/manual/ja/function.serialize.php
	 ...
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.settype.php
	 * @see gettype()
	 * @since PHP 4, PHP 5, PHP 7
	 */
	 ...
	 * @link https://php.net/manual/ja/function.strval.php
	 ...
	 * @link https://php.net/manual/ja/function.unserialize.php
	 ...
	 * @param mixed $_
	 * @return void <p>値を返しません。</p>
	 * @link https://php.net/manual/ja/function.var-dump.php
	 ...
	 * @link https://php.net/manual/ja/function.var-export.php
