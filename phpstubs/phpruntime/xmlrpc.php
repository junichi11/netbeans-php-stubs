...
namespace {
	 ...
	 * @link https://php.net/manual/ja/function.xmlrpc-decode.php
	 ...
	 * @return mixed
	 * @link https://php.net/manual/ja/function.xmlrpc-decode-request.php
	 * @since PHP 4 >= 4.1.0, PHP 5, PHP 7
	 */
	 ...
	 * @param mixed $value
	 * @return string
	 * @link https://php.net/manual/ja/function.xmlrpc-encode.php
	 * @since PHP 4 >= 4.1.0, PHP 5, PHP 7
	 */
	 ...
	 * @link https://php.net/manual/ja/function.xmlrpc-encode-request.php
	 ...
	 * @link https://php.net/manual/ja/function.xmlrpc-get-type.php
	 * @see xmlrpc_set_type()
	 * @since PHP 4 >= 4.1.0, PHP 5, PHP 7
	 */
	 ...
	 * @link https://php.net/manual/ja/function.xmlrpc-is-fault.php
	 * @see xmlrpc_decode()
	 ...
	 * @param string $xml
	 * @return array
	 * @link https://php.net/manual/ja/function.xmlrpc-parse-method-descriptions.php
	 * @since PHP 4 >= 4.1.0, PHP 5, PHP 7
	 */
	 ...
	 * @param array $desc
	 * @return int
	 * @link https://php.net/manual/ja/function.xmlrpc-server-add-introspection-data.php
	 * @since PHP 4 >= 4.1.0, PHP 5, PHP 7
	 */
	 ...
	 * @return string
	 * @link https://php.net/manual/ja/function.xmlrpc-server-call-method.php
	 * @since PHP 4 >= 4.1.0, PHP 5, PHP 7
	 */
	 ...
	 * <p>この関数は、 <i>実験的</i> なものです。この関数の動作・ 名前・その他ドキュメントに書かれている事項は、予告なく、将来的な PHP のリリースにおいて変更される可能性があります。 この関数は自己責任で使用してください。</p><p>この関数は、 現在のところ詳細な情報はありません。引数のリストのみが 記述されています。</p>
	 * @return resource
	 * @link https://php.net/manual/ja/function.xmlrpc-server-create.php
	 * @since PHP 4 >= 4.1.0, PHP 5, PHP 7
	 */
	 ...
	 * @param resource $server
	 * @return int
	 * @link https://php.net/manual/ja/function.xmlrpc-server-destroy.php
	 * @since PHP 4 >= 4.1.0, PHP 5, PHP 7
	 */
	 ...
	 * @return bool
	 * @link https://php.net/manual/ja/function.xmlrpc-server-register-introspection-callback.php
	 * @since PHP 4 >= 4.1.0, PHP 5, PHP 7
	 */
	 ...
	 * @param string $function
	 * @return bool
	 * @link https://php.net/manual/ja/function.xmlrpc-server-register-method.php
	 * @since PHP 4 >= 4.1.0, PHP 5, PHP 7
	 */
	 ...
	 * @link https://php.net/manual/ja/function.xmlrpc-set-type.php
	 * @since PHP 4 >= 4.1.0, PHP 5, PHP 7
	 */
