...
namespace {
	 ...
	 * @link https://php.net/manual/ja/function.bcadd.php
	 * @see bcsub()
	 ...
	 * @link https://php.net/manual/ja/function.bccomp.php
	 * @since PHP 4, PHP 5, PHP 7
	 */
	 ...
	 * @link https://php.net/manual/ja/function.bcdiv.php
	 * @see bcmul()
	 * @since PHP 4, PHP 5, PHP 7
	 */
	 ...
	 * @link https://php.net/manual/ja/function.bcmod.php
	 * @see bcdiv()
	 * @since PHP 4, PHP 5, PHP 7
	 */
	 ...
	 * @link https://php.net/manual/ja/function.bcmul.php
	 * @see bcdiv()
	 * @since PHP 4, PHP 5, PHP 7
	 */
	 ...
	 * @param int $scale <p>このオプションパラメータを使用して、 結果の小数点以下の桁数を指定します。省略した場合は、<code>bcscale()</code> 関数でグローバルに設定した桁数をデフォルトとして使用します。それも設定されていない場合は <i>0</i> を使用します。</p>
	 * @return string <p>結果を文字列で返します。</p>
	 * @link https://php.net/manual/ja/function.bcpow.php
	 * @see bcpowmod(), bcsqrt()
	 * @since PHP 4, PHP 5, PHP 7
	 */
	 ...
	 * @link https://php.net/manual/ja/function.bcpowmod.php
	 * @see bcpow(), bcmod()
	 * @since PHP 5, PHP 7
	 */
	 ...
	 * @link https://php.net/manual/ja/function.bcscale.php
	 * @since PHP 4, PHP 5, PHP 7
	 */
	 ...
	 * @link https://php.net/manual/ja/function.bcsqrt.php
	 * @see bcpow()
	 * @since PHP 4, PHP 5, PHP 7
	 */
	 ...
	 * @link https://php.net/manual/ja/function.bcsub.php
	 * @see bcadd()
	 * @since PHP 4, PHP 5, PHP 7
	 */
