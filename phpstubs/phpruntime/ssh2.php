 ...
 * @link http://php.net/manual/ja/function.ssh2-auth-agent.php
 ...
 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
 * @link http://php.net/manual/ja/function.ssh2-auth-hostbased-file.php
 ...
 * @link http://php.net/manual/ja/function.ssh2-auth-none.php
 * @since PECL ssh2 >= 0.9.0
 */
 ...
 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
 * @link http://php.net/manual/ja/function.ssh2-auth-password.php
 * @since PECL ssh2 >= 0.9.0
 */
 ...
 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
 * @link http://php.net/manual/ja/function.ssh2-auth-pubkey-file.php
 * @since PECL ssh2 >= 0.9.0
 */
 ...
 * @link http://php.net/manual/ja/function.ssh2-connect.php
 ...
 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
 * @link http://php.net/manual/ja/function.ssh2-disconnect.php
 * @see ssh2_connect()
 * @since PECL ssh2 >= 1.0
 */
 ...
 * @link http://php.net/manual/ja/function.ssh2-exec.php
 ...
 * @link http://php.net/manual/ja/function.ssh2-fetch-stream.php
 ...
 * @link http://php.net/manual/ja/function.ssh2-fingerprint.php
 * @since PECL ssh2 >= 0.9.0
 */
 ...
 * @param resource $session <p><code>ssh2_connect()</code> のコールによって取得した SSH 接続リンク ID。</p>
 * @return array
 * @link http://php.net/manual/ja/function.ssh2-methods-negotiated.php
 * @see ssh2_connect()
 * @since PECL ssh2 >= 0.9.0
 */
 ...
 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
 * @link http://php.net/manual/ja/function.ssh2-publickey-add.php
 ...
 * @link http://php.net/manual/ja/function.ssh2-publickey-init.php
 ...
 * @link http://php.net/manual/ja/function.ssh2-publickey-list.php
 ...
 * @param string $blob <p>生のバイナリデータとしての blob 形式の公開鍵。</p>
 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
 * @link http://php.net/manual/ja/function.ssh2-publickey-remove.php
 ...
 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
 * @link http://php.net/manual/ja/function.ssh2-scp-recv.php
 ...
 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
 * @link http://php.net/manual/ja/function.ssh2-scp-send.php
 ...
 * @param resource $session <p><code>ssh2_connect()</code> のコールによって取得した SSH 接続リンク ID。</p>
 * @return resource <p>このメソッドは全ての他の ssh2_sftp_&#42;() や ssh2.sftp:// fopen ラッパーで使用する <i>SSH2 SFTP</i> リソースを返します。</p>
 * @link http://php.net/manual/ja/function.ssh2-sftp.php
 ...
 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
 * @link http://php.net/manual/ja/function.ssh2-sftp-chmod.php
 ...
 * @link http://php.net/manual/ja/function.ssh2-sftp-lstat.php
 ...
 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
 * @link http://php.net/manual/ja/function.ssh2-sftp-mkdir.php
 ...
 * @link http://php.net/manual/ja/function.ssh2-sftp-readlink.php
 ...
 * @link http://php.net/manual/ja/function.ssh2-sftp-realpath.php
 ...
 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
 * @link http://php.net/manual/ja/function.ssh2-sftp-rename.php
 * @see rename()
 * @since PECL ssh2 >= 0.9.0
 */
 ...
 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
 * @link http://php.net/manual/ja/function.ssh2-sftp-rmdir.php
 ...
 * @link http://php.net/manual/ja/function.ssh2-sftp-stat.php
 ...
 * @param string $link
 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
 * @link http://php.net/manual/ja/function.ssh2-sftp-symlink.php
 ...
 * @param string $filename
 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
 * @link http://php.net/manual/ja/function.ssh2-sftp-unlink.php
 * @see unlink()
 * @since PECL ssh2 >= 0.9.0
 */
 ...
 * @param int $width_height_type <p><code>width_height_type</code> は <b><code>SSH2_TERM_UNIT_CHARS</code></b> あるいは <b><code>SSH2_TERM_UNIT_PIXELS</code></b> のいずれかです。</p>
 * @return resource
 * @link http://php.net/manual/ja/function.ssh2-shell.php
 ...
 * @param int $port
 * @return resource
 * @link http://php.net/manual/ja/function.ssh2-tunnel.php
