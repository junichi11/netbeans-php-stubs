 ...
 * @link http://php.net/manual/ja/function.socket-addrinfo-bind.php
 ...
 * @param resource $addr <p>Resource created from <b>socket_addrinfo_lookup()()</b></p>
 * @return resource <p>Returns a Socket resource on success or <b><code>NULL</code></b> on failure.</p>
 * @link http://php.net/manual/ja/function.socket-addrinfo-connect.php
 ...
 * @link http://php.net/manual/ja/function.socket-addrinfo-explain.php
 ...
 * @link http://php.net/manual/ja/function.socket-addrinfo-lookup.php
 ...
 * @link http://php.net/manual/ja/function.socket-export-stream.php
 * @since PHP 7 >= 7.0.7
 */
...
/**
 * この定数は、PHP 5.4.10 以降でかつソケットオプション <b><code>SO_REUSEPORT</code></b> に対応したプラットフォーム上でだけ使えます。 Mac OS X や FreeBSD などはこのソケットオプションに対応していますが、 Linux や Windows は対応していません。
 */
