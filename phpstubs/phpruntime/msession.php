...
namespace {
	 ...
	 * @param string $port
	 * @return bool
	 * @link https://php.net/manual/ja/function.msession-connect.php
	 ...
	 * <p>この関数は、 現在のところ詳細な情報はありません。引数のリストのみが 記述されています。</p>
	 * @return int
	 * @link https://php.net/manual/ja/function.msession-count.php
	 * @since PHP 4 >= 4.2.0, PHP 5 < 5.1.3
	 */
	 ...
	 * @param string $data
	 * @return bool
	 * @link https://php.net/manual/ja/function.msession-create.php
	 * @since PHP 4 >= 4.2.0, PHP 5 < 5.1.3
	 */
	 ...
	 * @param string $name
	 * @return bool
	 * @link https://php.net/manual/ja/function.msession-destroy.php
	 * @since PHP 4 >= 4.2.0, PHP 5 < 5.1.3
	 */
	 ...
	 * <p>この関数は、 現在のところ詳細な情報はありません。引数のリストのみが 記述されています。</p>
	 * @return void
	 * @link https://php.net/manual/ja/function.msession-disconnect.php
	 * @since PHP 4 >= 4.2.0, PHP 5 < 5.1.3
	 */
	 ...
	 * @param string $value
	 * @return array
	 * @link https://php.net/manual/ja/function.msession-find.php
	 * @since PHP 4 >= 4.2.0, PHP 5 < 5.1.3
	 */
	 ...
	 * @param string $value
	 * @return string
	 * @link https://php.net/manual/ja/function.msession-get.php
	 * @since PHP 4 >= 4.2.0, PHP 5 < 5.1.3
	 */
	 ...
	 * @param string $session
	 * @return array
	 * @link https://php.net/manual/ja/function.msession-get-array.php
	 * @since PHP 4 >= 4.2.0, PHP 5 < 5.1.3
	 */
	 ...
	 * @param string $session
	 * @return string
	 * @link https://php.net/manual/ja/function.msession-get-data.php
	 * @since PHP 4 >= 4.2.0, PHP 5 < 5.1.3
	 */
	 ...
	 * @param string $name
	 * @return string
	 * @link https://php.net/manual/ja/function.msession-inc.php
	 * @since PHP 4 >= 4.2.0, PHP 5 < 5.1.3
	 */
	 ...
	 * <p>この関数は、 現在のところ詳細な情報はありません。引数のリストのみが 記述されています。</p>
	 * @return array
	 * @link https://php.net/manual/ja/function.msession-list.php
	 * @since PHP 4 >= 4.2.0, PHP 5 < 5.1.3
	 */
	 ...
	 * @link https://php.net/manual/ja/function.msession-listvar.php
	 * @since PHP 4 >= 4.2.0, PHP 5 < 5.1.3
	 */
	 ...
	 * @param string $name
	 * @return int
	 * @link https://php.net/manual/ja/function.msession-lock.php
	 * @since PHP 4 >= 4.2.0, PHP 5 < 5.1.3
	 */
	 ...
	 * @param string $param
	 * @return string
	 * @link https://php.net/manual/ja/function.msession-plugin.php
	 * @since PHP 4 >= 4.2.0, PHP 5 < 5.1.3
	 */
	 ...
	 * @param int $param
	 * @return string
	 * @link https://php.net/manual/ja/function.msession-randstr.php
	 * @since PHP 4 >= 4.2.0, PHP 5 < 5.1.3
	 */
	 ...
	 * @param string $value
	 * @return bool
	 * @link https://php.net/manual/ja/function.msession-set.php
	 * @since PHP 4 >= 4.2.0, PHP 5 < 5.1.3
	 */
	 ...
	 * @param array $tuples
	 * @return void
	 * @link https://php.net/manual/ja/function.msession-set-array.php
	 * @since PHP 4 >= 4.2.0, PHP 5 < 5.1.3
	 */
	 ...
	 * @param string $value
	 * @return bool
	 * @link https://php.net/manual/ja/function.msession-set-data.php
	 * @since PHP 4 >= 4.2.0, PHP 5 < 5.1.3
	 */
	 ...
	 * @param int $param
	 * @return int
	 * @link https://php.net/manual/ja/function.msession-timeout.php
	 * @since PHP 4 >= 4.2.0, PHP 5 < 5.1.3
	 */
	 ...
	 * @param string $data
	 * @return string
	 * @link https://php.net/manual/ja/function.msession-uniq.php
	 * @since PHP 4 >= 4.2.0, PHP 5 < 5.1.3
	 */
	 ...
	 * @param int $key
	 * @return int
	 * @link https://php.net/manual/ja/function.msession-unlock.php
	 * @since PHP 4 >= 4.2.0, PHP 5 < 5.1.3
	 */
