...
namespace Gender {
	...
	/**
	 * @link https://php.net/manual/ja/class.gender.php
	...
	class Gender {
		 ...
		 * @return self
		 * @link https://php.net/manual/ja/gender-gender.construct.php
		 * @since PECL gender >= 0.6.0
		 */
		 ...
		 * @link https://php.net/manual/ja/gender-gender.connect.php
		 * @since PECL gender >= 0.6.0
		 */
		 ...
		 * @link https://php.net/manual/ja/gender-gender.country.php
		 ...
		 * @link https://php.net/manual/ja/gender-gender.get.php
		 * @since PECL gender >= 0.6.0
		 */
		 ...
		 * @link https://php.net/manual/ja/gender-gender.isnick.php
		 ...
		 * @link https://php.net/manual/ja/gender-gender.similarnames.php
		 * @since PECL gender >= 0.9.0
		 */
