...
namespace {
	 ...
	 * @link https://php.net/manual/ja/function.array-change-key-case.php
	 ...
	 * @link https://php.net/manual/ja/function.array-chunk.php
	 * @see array_slice()
	 * @since PHP 4 >= 4.2.0, PHP 5, PHP 7
	 */
	 ...
	 * @link https://php.net/manual/ja/function.array-column.php
	 ...
	 * @link https://php.net/manual/ja/function.array-combine.php
	 ...
	 * @link https://php.net/manual/ja/function.array-count-values.php
	 ...
	 * @link https://php.net/manual/ja/function.array-diff.php
	 ...
	 * @link https://php.net/manual/ja/function.array-diff-assoc.php
	 ...
	 * @link https://php.net/manual/ja/function.array-diff-key.php
	 ...
	 * @param array $array2 <p>比較する対象となる配列。</p>
	 * @param array $_ <p>さらに比較する対象となる配列。</p>
	 * @param callable $key_compare_func <p>比較関数は、最初の引数と二番目の引数の比較結果を返します。最初の引数のほうが二番目の引数より大きい場合は正の数を、二番目の引数と等しい場合はゼロを、そして二番目の引数より小さい場合は負の数を返す必要があります。PHP 7.0.0 より前のバージョンでは、この整数が -2147483648 から 2147483647 までの範囲におさまる必要がありました。</p>  callback ( <code>mixed</code> <code>$a</code>, <code>mixed</code> <code>$b</code> ) : int
	 * @return array <p><code>array1</code> の要素のうち、 その他の配列のいずれにも含まれないものだけを残した配列を返します。</p>
	 * @link https://php.net/manual/ja/function.array-diff-uassoc.php
	 ...
	 * @param callable $key_compare_func <p>比較関数は、最初の引数と二番目の引数の比較結果を返します。最初の引数のほうが二番目の引数より大きい場合は正の数を、二番目の引数と等しい場合はゼロを、そして二番目の引数より小さい場合は負の数を返す必要があります。PHP 7.0.0 より前のバージョンでは、この整数が -2147483648 から 2147483647 までの範囲におさまる必要がありました。</p>  callback ( <code>mixed</code> <code>$a</code>, <code>mixed</code> <code>$b</code> ) : int
	 * @return array <p><code>array1</code> の要素のうち、 その他の配列のいずれにも含まれないものだけを残した配列を返します。</p>
	 * @link https://php.net/manual/ja/function.array-diff-ukey.php
	 ...
	 * @link https://php.net/manual/ja/function.array-fill.php
	 ...
	 * @return array <p>値を埋めた配列を返します。</p>
	 * @link https://php.net/manual/ja/function.array-fill-keys.php
	 ...
	 * @link https://php.net/manual/ja/function.array-filter.php
	 ...
	 * @link https://php.net/manual/ja/function.array-flip.php
	 ...
	 * @link https://php.net/manual/ja/function.array-intersect.php
	 ...
	 * @link https://php.net/manual/ja/function.array-intersect-assoc.php
	 ...
	 * @link https://php.net/manual/ja/function.array-intersect-key.php
	 ...
	 * @link https://php.net/manual/ja/function.array-intersect-uassoc.php
	 ...
	 * @link https://php.net/manual/ja/function.array-intersect-ukey.php
	 ...
	 * @link https://php.net/manual/ja/function.array-key-exists.php
	 ...
	 * @link https://php.net/manual/ja/function.array-key-first.php
	 ...
	 * @link https://php.net/manual/ja/function.array-key-last.php
	 ...
	 * @link https://php.net/manual/ja/function.array-keys.php
	 ...
	 * @link https://php.net/manual/ja/function.array-map.php
	 ...
	 * @link https://php.net/manual/ja/function.array-merge.php
	 ...
	 * @link https://php.net/manual/ja/function.array-merge-recursive.php
	 ...
	 * @link https://php.net/manual/ja/function.array-multisort.php
	 * @see usort()
	 * @since PHP 4, PHP 5, PHP 7
	 */
	 ...
	 * @link https://php.net/manual/ja/function.array-pad.php
	 ...
	 * @link https://php.net/manual/ja/function.array-pop.php
	 ...
	 * @link https://php.net/manual/ja/function.array-product.php
	 * @since PHP 5 >= 5.1.0, PHP 7
	 */
	 ...
	 * @link https://php.net/manual/ja/function.array-push.php
	 ...
	 * @link https://php.net/manual/ja/function.array-rand.php
	 * @see shuffle()
	 * @since PHP 4, PHP 5, PHP 7
	 */
	 ...
	 * @param array $array <p>入力の配列。</p>
	 * @param callable $callback callback ( <code>mixed</code> <code>$carry</code> , <code>mixed</code> <code>$item</code> ) : <code>mixed</code>    <code>carry</code>   <p>前回の反復処理の結果を保持します。最初の反復処理のときには、 <code>initial</code> の値を保持しています。</p>   <code>item</code>   <p>現在の反復処理の値を保持します。</p>
	 ...
	 * @link https://php.net/manual/ja/function.array-reduce.php
	 ...
	 * @param array $_ <p>置き換えたい要素を含む配列。 後から渡した配列の値のほうが優先されます。</p>
	 * @return array <p>配列を返します。エラーが発生した場合は <b><code>NULL</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.array-replace.php
	 * @see array_replace_recursive(), array_merge()
	 * @since PHP 5 >= 5.3.0, PHP 7
	 */
	function array_replace(array $array1, array $_ = NULL): array {}
	 ...
	 * @return array <p>配列を返します。エラーが発生した場合は <b><code>NULL</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.array-replace-recursive.php
	 ...
	 * @link https://php.net/manual/ja/function.array-reverse.php
	 * @see array_flip()
	 * @since PHP 4, PHP 5, PHP 7
	 */
	 ...
	 * <p><code>haystack</code> 内の <code>needle</code> を検索します。</p>
	 ...
	 * @link https://php.net/manual/ja/function.array-search.php
	...
	/**
	 * 配列の先頭から要素を一つ取り出す
	 * <p><b>array_shift()</b> は、<code>array</code> の最初の値を取り出して返します。配列 <code>array</code> は、要素一つ分だけ短くなり、全ての要素は前にずれます。 数値添字の配列のキーはゼロから順に新たに振りなおされますが、 リテラルのキーには影響しません。</p><p><b>注意</b>: この関数は、 入力配列のポインタを、使用した後にリセット (<code>reset()</code>) します。</p>
	 * @param array $array <p>入力の配列。</p>
	 * @return mixed <p>取り出した値を返します。<code>array</code> が空の場合や配列でない場合は <b><code>NULL</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.array-shift.php
	 ...
	 * @link https://php.net/manual/ja/function.array-slice.php
	 ...
	 * @link https://php.net/manual/ja/function.array-splice.php
	 ...
	 * @link https://php.net/manual/ja/function.array-sum.php
	 ...
	 * @param array $_
	 * @param callable $value_compare_func <p>比較用のコールバック関数。</p> <p>比較関数は、最初の引数と二番目の引数の比較結果を返します。最初の引数のほうが二番目の引数より大きい場合は正の数を、二番目の引数と等しい場合はゼロを、そして二番目の引数より小さい場合は負の数を返す必要があります。PHP 7.0.0 より前のバージョンでは、この整数が -2147483648 から 2147483647 までの範囲におさまる必要がありました。</p>  callback ( <code>mixed</code> <code>$a</code>, <code>mixed</code> <code>$b</code> ) : int
	 * @return array <p>他の引数のいずれにも存在しない <code>array1</code> の値の全てを有する配列を返します。</p>
	 * @link https://php.net/manual/ja/function.array-udiff.php
	 ...
	 * @param array $array2 <p>2 番目の配列。</p>
	 * @param array $_
	 * @param callable $value_compare_func <p>比較関数は、最初の引数と二番目の引数の比較結果を返します。最初の引数のほうが二番目の引数より大きい場合は正の数を、二番目の引数と等しい場合はゼロを、そして二番目の引数より小さい場合は負の数を返す必要があります。PHP 7.0.0 より前のバージョンでは、この整数が -2147483648 から 2147483647 までの範囲におさまる必要がありました。</p>  callback ( <code>mixed</code> <code>$a</code>, <code>mixed</code> <code>$b</code> ) : int
	 ...
	 * @link https://php.net/manual/ja/function.array-udiff-assoc.php
	 ...
	 * @link https://php.net/manual/ja/function.array-udiff-uassoc.php
	 ...
	 * @link https://php.net/manual/ja/function.array-uintersect.php
	 ...
	 * @link https://php.net/manual/ja/function.array-uintersect-assoc.php
	 ...
	 * @return array <p>全ての引数に現れる <code>array1</code> の全ての値を含む配列を返します。</p>
	 * @link https://php.net/manual/ja/function.array-uintersect-uassoc.php
	 ...
	 * @link https://php.net/manual/ja/function.array-unique.php
	 ...
	 * @link https://php.net/manual/ja/function.array-unshift.php
	 ...
	 * @link https://php.net/manual/ja/function.array-values.php
	 ...
	 * @link https://php.net/manual/ja/function.array-walk.php
	 ...
	 * @param mixed $userdata <p>オプションの <code>userdata</code> パラメータが指定された場合、 コールバック関数 <code>callback</code> への三番目の引数として渡されます。</p>
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.array-walk-recursive.php
	 * @see array_walk()
	 * @since PHP 5, PHP 7
	 */
	 ...
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.arsort.php
	 * @see asort()
	 * @since PHP 4, PHP 5, PHP 7
	 */
	 ...
	 * @param int $sort_flags <p>オプションのパラメータ <code>sort_flags</code> によりソートの動作を修正可能です。 詳細については、<code>sort()</code> を参照ください。</p>
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.asort.php
	 * @see arsort()
	 * @since PHP 4, PHP 5, PHP 7
	 */
	...
	/**
	 * 変数名とその値から配列を作成する
	 * <p>変数名とその値から配列を作成します。</p><p>各引数について、<b>compact()</b> は現在のシンボルテーブルにおいてその名前を有する変数を探し、 変数名がキー、変数の値がそのキーに関する値となるように追加します。 端的に言うと、<code>extract()</code> の逆の動作をします。</p><p><b>注意</b>:</p><p>PHP 7.3 より前のバージョンでは、設定されていない全ての文字列は、単にスキップされます。</p>
	 ...
	 * @link https://php.net/manual/ja/function.compact.php
	 * @see extract()
	 * @since PHP 4, PHP 5, PHP 7
	 */
	 ...
	 * @return int <p><code>array_or_countable</code> に含まれる要素の数を返します。 もしパラメータが配列でもなく Countable インターフェイスを 実装したオブジェクトでもない場合、<i>1</i> が返されます。 ひとつ例外があり、<code>array_or_countable</code> が <b><code>NULL</code></b> の場合、 <i>0</i> が返されます。</p>
	 * @link https://php.net/manual/ja/function.count.php
	 ...
	 * @link https://php.net/manual/ja/function.current.php
	 ...
	 * @link https://php.net/manual/ja/function.each.php
	 ...
	 * @link https://php.net/manual/ja/function.end.php
	 ...
	 * @link https://php.net/manual/ja/function.extract.php
	 * @see compact(), list()
	 * @since PHP 4, PHP 5, PHP 7
	 */
	...
	/**
	 * 配列に値があるかチェックする
	 * <p><code>haystack</code> 内の <code>needle</code> を検索します。 <code>strict</code> が設定されていない限りは型の比較は行いません。</p>
	 ...
	 * @link https://php.net/manual/ja/function.in-array.php
	 ...
	 * @link https://php.net/manual/ja/function.key.php
	 * @see current(), next()
	 * @since PHP 4, PHP 5, PHP 7
	 */
	 ...
	 * @param array $array <p>キーが存在するかどうかを調べたい配列。</p>
	 * @return bool
	 * @link https://php.net/manual/ja/function.key-exists.php
	 * @since PHP 4 >= 4.0.6, PHP 5, PHP 7
	 */
	 ...
	 * @param int $sort_flags <p>オプションのパラメータ <code>sort_flags</code> によりソートの動作を修正可能です。詳細については、 <code>sort()</code> を参照ください。</p>
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.krsort.php
	 * @see arsort(), ksort()
	 * @since PHP 4, PHP 5, PHP 7
	 */
	 ...
	 * @param int $sort_flags <p>オプションのパラメータ <code>sort_flags</code> によりソートの動作を修正可能です。詳細については、 <code>sort()</code> を参照ください。</p>
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.ksort.php
	 * @see asort()
	 * @since PHP 4, PHP 5, PHP 7
	 */
	 ...
	 * @param array $array <p>入力の配列。</p>
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.natcasesort.php
	 ...
	 * @param array $array <p>入力の配列。</p>
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.natsort.php
	 ...
	 * @link https://php.net/manual/ja/function.next.php
	 ...
	 * @param array $array <p>配列。</p>
	 * @return mixed
	 * @link https://php.net/manual/ja/function.pos.php
	 * @since PHP 4, PHP 5, PHP 7
	 */
	 ...
	 * @link https://php.net/manual/ja/function.prev.php
	 ...
	 * @link https://php.net/manual/ja/function.range.php
	 ...
	 * @link https://php.net/manual/ja/function.reset.php
	 ...
	 * @param int $sort_flags <p>オプションのパラメータ <code>sort_flags</code> によりソートの動作を修正可能です。詳細については、 <code>sort()</code> を参照ください。</p>
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.rsort.php
	 * @see arsort(), krsort()
	 * @since PHP 4, PHP 5, PHP 7
	 */
	...
	/**
	 * 配列をシャッフルする
	 * <p>この関数は、配列をシャッフル (要素の順番をランダムに) します。 この関数が使う疑似乱数生成器は、暗号学的な使い方には適していません。</p>
	 * @param array $array <p>配列。</p>
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.shuffle.php
	 * @see array_rand()
	 * @since PHP 4, PHP 5, PHP 7
	 */
	 ...
	 * @param int $mode <p>オプションの<code>mode</code> 引数が <b><code>COUNT_RECURSIVE</code></b> (または 1) にセットされた場合、<b>count()</b> は再帰的に配列をカウントします。 これは多次元配列の全ての要素をカウントするといった場合に特に有効です。</p>  <b>警告</b> <p><b>count()</b> は、再帰を検出して無限ループを回避するようになっています。 しかしその場合 (配列の中に自分自身が複数回登場する場合) は毎回 <b><code>E_WARNING</code></b> を発行し、期待する結果より大きい数を返します。</p>
	 * @return int
	 * @link https://php.net/manual/ja/function.sizeof.php
	 * @since PHP 4, PHP 5, PHP 7
	 */
	 ...
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.sort.php
	 * @see asort(), rsort()
	 * @since PHP 4, PHP 5, PHP 7
	 */
	 ...
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.uasort.php
	 * @see usort()
	 * @since PHP 4, PHP 5, PHP 7
	 */
	 ...
	 * @param callable $key_compare_func <p>比較関数は、最初の引数と二番目の引数の比較結果を返します。最初の引数のほうが二番目の引数より大きい場合は正の数を、二番目の引数と等しい場合はゼロを、そして二番目の引数より小さい場合は負の数を返す必要があります。PHP 7.0.0 より前のバージョンでは、この整数が -2147483648 から 2147483647 までの範囲におさまる必要がありました。</p>  callback ( <code>mixed</code> <code>$a</code>, <code>mixed</code> <code>$b</code> ) : int
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.uksort.php
	 * @see usort()
	 * @since PHP 4, PHP 5, PHP 7
	 */
