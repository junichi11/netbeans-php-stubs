...
namespace {
	 ...
	 * @link https://php.net/manual/ja/class.ev.php
	 * @since PECL ev >= 0.2.0
	 */
	final class Ev {
		 ...
		 * @link https://php.net/manual/ja/evsignal.construct.php
		 * @since PECL ev >= 0.2.0
		 */
		 ...
		 * @link https://php.net/manual/ja/ev.backend.php
		 * @since PECL ev >= 0.2.0
		 */
		 ...
		 * @link https://php.net/manual/ja/evloop.defaultloop.php
		 * @since PECL ev >= 0.2.0
		 */
		 ...
		 * @link https://php.net/manual/ja/ev.depth.php
		 * @since PECL ev >= 0.2.0
		 */
		 ...
		 * @link https://php.net/manual/ja/ev.embeddablebackends.php
		 * @since PECL ev >= 0.2.0
		 */
		 ...
		 * @link https://php.net/manual/ja/evwatcher.feed.php
		 * @since PECL ev >= 0.2.0
		 */
		 ...
		 * @return void <p>値を返しません。</p>
		 * @link https://php.net/manual/ja/ev.feedsignal.php
		 * @since PECL ev >= 0.2.0
		 */
		 ...
		 * @param int $signum <p>シグナル番号。詳細は <i>signal(7)</i> の man ページを参照ください。 <i>pcntl</i> 拡張モジュールが公開する定数も使えます。</p>
		 * @return void <p>値を返しません。</p>
		 * @link https://php.net/manual/ja/ev.feedsignalevent.php
		 ...
		 * @link https://php.net/manual/ja/evloop.fork.php
		 * @since PECL ev >= 0.2.0
		 */
		 ...
		 * @link https://php.net/manual/ja/ev.iteration.php
		 * @since PECL ev >= 0.2.0
		 */
		 ...
		 * @link https://php.net/manual/ja/ev.now.php
		 * @since PECL ev >= 0.2.0
		 */
		 ...
		 * @return void <p>値を返しません。</p>
		 * @link https://php.net/manual/ja/ev.nowupdate.php
		 * @since PECL ev >= 0.2.0
		 */
		 ...
		 * @return void <p>ビットマスクを返します。 バックエンドのフラグ を、ビット <i>OR</i> 演算子で組み合わせたものになります。</p>
		 * @link https://php.net/manual/ja/ev.recommendedbackends.php
		 * @since PECL ev >= 0.2.0
		 */
		 ...
		 * @return void <p>値を返しません。</p>
		 * @link https://php.net/manual/ja/ev.resume.php
		 * @since PECL ev >= 0.2.0
		 */
		 ...
		 * @return void <p>値を返しません。</p>
		 * @link https://php.net/manual/ja/ev.run.php
		 * @since PECL ev >= 0.2.0
		 */
		 ...
		 * @return void <p>値を返しません。</p>
		 * @link https://php.net/manual/ja/ev.sleep.php
		 * @since PECL ev >= 0.2.0
		 */
		 ...
		 * @return void <p>値を返しません。</p>
		 * @link https://php.net/manual/ja/ev.stop.php
		 * @since PECL ev >= 0.2.0
		 */
		 ...
		 * @return void <p>ビットマスクを返します。 バックエンドのフラグ を、ビット <i>OR</i> 演算子で組み合わせたものになります。</p>
		 * @link https://php.net/manual/ja/ev.supportedbackends.php
		 * @since PECL ev >= 0.2.0
		 */
		 ...
		 * @return void <p>値を返しません。</p>
		 * @link https://php.net/manual/ja/ev.suspend.php
		 * @since PECL ev >= 0.2.0
		 */
		 ...
		 * @link https://php.net/manual/ja/ev.time.php
		 * @since PECL ev >= 0.2.0
		 */
		 ...
		 * @return void <p>値を返しません。</p>
		 * @link https://php.net/manual/ja/ev.verify.php
		 * @since PECL ev >= 0.2.0
		 */
	 ...
	 * @link https://php.net/manual/ja/class.evcheck.php
	 * @since PECL ev >= 0.2.0
	 */
	class EvCheck extends \EvWatcher {
		 ...
		 * @link https://php.net/manual/ja/class.evwatcher.php#evwatcher.props.is-active
		 */
		public $is_active;

		/**
		 * @var mixed <p>User custom data associated with the watcher</p>
		 * @link https://php.net/manual/ja/class.evwatcher.php#evwatcher.props.data
		 */
		public $data;
		 ...
		 * @link https://php.net/manual/ja/class.evwatcher.php#evwatcher.props.is-pending
		 */
		public $is_pending;
		 ...
		 * @link https://php.net/manual/ja/class.evwatcher.php#evwatcher.props.priority
		 */
		public $priority;
		 ...
		 * @link https://php.net/manual/ja/evcheck.construct.php
		 * @since PECL ev >= 0.2.0
		 */
		 ...
		 * @link https://php.net/manual/ja/evwatcher.clear.php
		 * @since PECL ev >= 0.2.0
		 */
		 ...
		 * @link https://php.net/manual/ja/evcheck.createstopped.php
		 * @since PECL ev >= 0.2.0
		 */
		 ...
		 * @link https://php.net/manual/ja/evwatcher.getloop.php
		 * @since PECL ev >= 0.2.0
		 */
		 ...
		 * @param int $revents <p>Bit mask of watcher received events .</p>
		 * @return void <p>値を返しません。</p>
		 * @link https://php.net/manual/ja/evwatcher.invoke.php
		 * @since PECL ev >= 0.2.0
		 */
		 ...
		 * @link https://php.net/manual/ja/evwatcher.keepalive.php
		 * @since PECL ev >= 0.2.0
		 */
		 ...
		 * @return void <p>値を返しません。</p>
		 * @link https://php.net/manual/ja/evloop.run.php
		 * @since PECL ev >= 0.2.0
		 */
		 ...
		 * @param callable $callback <p>See Watcher callbacks .</p>
		 * @return void <p>値を返しません。</p>
		 * @link https://php.net/manual/ja/evwatcher.setcallback.php
		 * @since PECL ev >= 0.2.0
		 */
		 ...
		 * @return void <p>値を返しません。</p>
		 * @link https://php.net/manual/ja/evwatcher.start.php
		 * @since PECL ev >= 0.2.0
		 */
		 ...
		 * @return void <p>値を返しません。</p>
		 * @link https://php.net/manual/ja/evwatcher.stop.php
		 * @since PECL ev >= 0.2.0
		 */
	 ...
	 * @link https://php.net/manual/ja/class.evchild.php
	 * @since PECL ev >= 0.2.0
	 */
	class EvChild extends \EvWatcher {
		 ...
		 * @link https://php.net/manual/ja/class.evchild.php#evchild.props.pid
		 */
		public $pid;

		/**
		 * @var mixed <p><i>読み込み専用</i>。 状態の変更を検出するプロセスの ID。</p>
		 * @link https://php.net/manual/ja/class.evchild.php#evchild.props.rpid
		 */
		public $rpid;

		/**
		 * @var mixed <p><i>読み込み専用</i>。 rpid のプロセス終了ステータス。</p>
		 * @link https://php.net/manual/ja/class.evchild.php#evchild.props.rstatus
		 */
		public $rstatus;
		 ...
		 * @link https://php.net/manual/ja/evchild.construct.php
		 * @since PECL ev >= 0.2.0
		 */
		 ...
		 * @param int $priority <p>ウォッチャーの優先度。</p>
		 * @return object
		 * @link https://php.net/manual/ja/evchild.createstopped.php
		 * @since PECL ev >= 0.2.0
		 */
		 ...
		 * @param bool $trace <p><code>EvChild::__construct()</code> と同じ。</p>
		 * @return void <p>値を返しません。</p>
		 * @link https://php.net/manual/ja/evchild.set.php
		 * @since PECL ev >= 0.2.0
		 */
	 ...
	 * @link https://php.net/manual/ja/class.evembed.php
	 * @since PECL ev >= 0.2.0
	 */
	class EvEmbed extends \EvWatcher {
		...
		/**
		 * @var mixed
		 * @link https://php.net/manual/ja/class.evembed.php#evembed.props.embed
		 */
		public $embed;
		 ...
		 * @link https://php.net/manual/ja/evembed.construct.php
		 * @since PECL ev >= 0.2.0
		 */
		 ...
		 * @link https://php.net/manual/ja/evembed.createstopped.php
		 * @since PECL ev >= 0.2.0
		 */
		 ...
		 * @param object $other <p><code>EvEmbed::__construct()</code> と同じ。</p>
		 * @return void <p>値を返しません。</p>
		 * @link https://php.net/manual/ja/evembed.set.php
		 * @since PECL ev >= 0.2.0
		 */
		 ...
		 * @return void <p>値を返しません。</p>
		 * @link https://php.net/manual/ja/evembed.sweep.php
		 * @since PECL ev >= 0.2.0
		 */
	 ...
	 * @link https://php.net/manual/ja/class.evfork.php
	 * @since PECL ev >= 0.2.0
	 */
	class EvFork extends \EvWatcher {
		 ...
		 * @link https://php.net/manual/ja/evfork.construct.php
		 * @since PECL ev >= 0.2.0
		 */
		 ...
		 * @link https://php.net/manual/ja/evfork.createstopped.php
		 * @since PECL ev >= 0.2.0
		 */
		final public static function createStopped(string $callback, string $data = NULL, string $priority = NULL): object {}
	 ...
	 * @link https://php.net/manual/ja/class.evidle.php
	 * @since PECL ev >= 0.2.0
	 */
	class EvIdle extends \EvWatcher {
		 ...
		 * @link https://php.net/manual/ja/evidle.construct.php
		 * @since PECL ev >= 0.2.0
		 */
		public function __construct(callable $callback, $data = NULL, int $priority = NULL) {}
		 ...
		 * @link https://php.net/manual/ja/evidle.createstopped.php
		 * @since PECL ev >= 0.2.0
		 */
	 ...
	 * @link https://php.net/manual/ja/class.evio.php
	 * @since PECL ev >= 0.2.0
	 */
	class EvIo extends \EvWatcher {
		...
		/**
		 * @var mixed
		 * @link https://php.net/manual/ja/class.evio.php#evio.props.fd
		 */
		public $fd;

		/**
		 * @var mixed
		 * @link https://php.net/manual/ja/class.evio.php#evio.props.events
		 */
		public $events;
		 ...
		 * @link https://php.net/manual/ja/evio.construct.php
		 * @since PECL ev >= 0.2.0
		 */
		 ...
		 * @link https://php.net/manual/ja/evio.createstopped.php
		 * @since PECL ev >= 0.2.0
		 */
		 ...
		 * @param int $events <p>The same as for <code>EvIo::__construct()</code></p>
		 * @return void <p>値を返しません。</p>
		 * @link https://php.net/manual/ja/evio.set.php
		 * @since PECL ev >= 0.2.0
		 */
	 ...
	 * @link https://php.net/manual/ja/class.evloop.php
	 * @since PECL ev >= 0.2.0
	 */
	final class EvLoop {
		 ...
		 * @link https://php.net/manual/ja/class.evloop.php#evloop.props.io-interval
		 */
		public $io_interval;
		 ...
		 * @link https://php.net/manual/ja/class.evloop.php#evloop.props.timeout-interval
		 */
		public $timeout_interval;

		/**
		 * @var mixed <p>The recursion depth. See <code>Ev::depth()</code> .</p>
		 * @link https://php.net/manual/ja/class.evloop.php#evloop.props.depth
		 */
		public $depth;
		 ...
		 * @link https://php.net/manual/ja/evloop.construct.php
		 * @since PECL ev >= 0.2.0
		 */
		 ...
		 * @link https://php.net/manual/ja/evloop.backend.php
		 * @since PECL ev >= 0.2.0
		 */
		 ...
		 * @link https://php.net/manual/ja/evloop.check.php
		 * @since PECL ev >= 0.2.0
		 */
		 ...
		 * @link https://php.net/manual/ja/evloop.child.php
		 * @since PECL ev >= 0.2.0
		 */
		 ...
		 * @link https://php.net/manual/ja/evloop.embed.php
		 * @since PECL ev >= 0.2.0
		 */
		 ...
		 * @link https://php.net/manual/ja/evloop.idle.php
		 * @since PECL ev >= 0.2.0
		 */
		 ...
		 * @return void <p>値を返しません。</p>
		 * @link https://php.net/manual/ja/evloop.invokepending.php
		 * @since PECL ev >= 0.2.0
		 */
		 ...
		 * @param int $priority
		 * @return EvIo <p>Returns EvIo object on success.</p>
		 * @link https://php.net/manual/ja/evloop.io.php
		 * @since PECL ev >= 0.2.0
		 */
		 ...
		 * @return void <p>値を返しません。</p>
		 * @link https://php.net/manual/ja/evloop.loopfork.php
		 * @since PECL ev >= 0.2.0
		 */
		 ...
		 * @link https://php.net/manual/ja/evloop.now.php
		 * @since PECL ev >= 0.2.0
		 */
		 ...
		 * @return void <p>値を返しません。</p>
		 * @link https://php.net/manual/ja/evloop.nowupdate.php
		 * @since PECL ev >= 0.2.0
		 */
		 ...
		 * @link https://php.net/manual/ja/evloop.periodic.php
		 * @since PECL ev >= 0.2.0
		 */
		 ...
		 * @link https://php.net/manual/ja/evloop.prepare.php
		 * @since PECL ev >= 0.2.0
		 */
		 ...
		 * @return void <p>値を返しません。</p>
		 * @link https://php.net/manual/ja/evloop.resume.php
		 * @since PECL ev >= 0.2.0
		 */
		 ...
		 * @link https://php.net/manual/ja/evloop.signal.php
		 * @since PECL ev >= 0.2.0
		 */
		 ...
		 * @link https://php.net/manual/ja/evloop.stat.php
		 * @since PECL ev >= 0.2.0
		 */
		 ...
		 * @return void <p>値を返しません。</p>
		 * @link https://php.net/manual/ja/evloop.stop.php
		 * @since PECL ev >= 0.2.0
		 */
		 ...
		 * @return void <p>値を返しません。</p>
		 * @link https://php.net/manual/ja/evloop.suspend.php
		 * @since PECL ev >= 0.2.0
		 */
		 ...
		 * @link https://php.net/manual/ja/evloop.timer.php
		 * @since PECL ev >= 0.2.0
		 */
		 ...
		 * @return void <p>値を返しません。</p>
		 * @link https://php.net/manual/ja/evloop.verify.php
		 * @since PECL ev >= 0.2.0
		 */
	 ...
	 * @link https://php.net/manual/ja/class.evperiodic.php
	 * @since PECL ev >= 0.2.0
	 */
	class EvPeriodic extends \EvWatcher {
		 ...
		 * @link https://php.net/manual/ja/class.evperiodic.php#evperiodic.props.offset
		 */
		public $offset;
		 ...
		 * @link https://php.net/manual/ja/class.evperiodic.php#evperiodic.props.interval
		 */
		public $interval;
		 ...
		 * @link https://php.net/manual/ja/evperiodic.construct.php
		 * @since PECL ev >= 0.2.0
		 */
		 ...
		 * @return void <p>値を返しません。</p>
		 * @link https://php.net/manual/ja/evperiodic.again.php
		 * @since PECL ev >= 0.2.0
		 */
		 ...
		 * @link https://php.net/manual/ja/evperiodic.at.php
		 * @since PECL ev >= 0.2.0
		 */
		 ...
		 * @link https://php.net/manual/ja/evperiodic.createstopped.php
		 * @since PECL ev >= 0.2.0
		 */
		 ...
		 * @return void <p>値を返しません。</p>
		 * @link https://php.net/manual/ja/evperiodic.set.php
		 * @since PECL ev >= 0.2.0
		 */
	 ...
	 * @link https://php.net/manual/ja/class.evprepare.php
	 * @since PECL ev >= 0.2.0
	 */
	class EvPrepare extends \EvWatcher {
		 ...
		 * @link https://php.net/manual/ja/evprepare.construct.php
		 * @since PECL ev >= 0.2.0
		 */
		 ...
		 * @link https://php.net/manual/ja/evprepare.createstopped.php
		 * @since PECL ev >= 0.2.0
		 */
	 ...
	 * @link https://php.net/manual/ja/class.evsignal.php
	 * @since PECL ev >= 0.2.0
	 */
	class EvSignal extends \EvWatcher {
		 ...
		 * @link https://php.net/manual/ja/class.evsignal.php#evsignal.props.signum
		 */
		public $signum;
		 ...
		 * @param int $priority <p>Watcher priority</p>
		 * @return EvSignal <p>Returns EvSignal object on success.</p>
		 * @link https://php.net/manual/ja/evsignal.createstopped.php
		 * @since PECL ev >= 0.2.0
		 */
		 ...
		 * @return void <p>値を返しません。</p>
		 * @link https://php.net/manual/ja/evsignal.set.php
		 * @since PECL ev >= 0.2.0
		 */
	 ...
	 * @link https://php.net/manual/ja/class.evstat.php
	 * @since PECL ev >= 0.2.0
	 */
	class EvStat extends \EvWatcher {
		 ...
		 * @link https://php.net/manual/ja/class.evstat.php#evstat.props.path
		 */
		public $path;
		 ...
		 * @link https://php.net/manual/ja/class.evstat.php#evstat.props.interval
		 */
		public $interval;
		 ...
		 * @link https://php.net/manual/ja/evstat.construct.php
		 * @since PECL ev >= 0.2.0
		 */
		 ...
		 * @link https://php.net/manual/ja/evstat.attr.php
		 * @since PECL ev >= 0.2.0
		 */
		 ...
		 * @link https://php.net/manual/ja/evstat.createstopped.php
		 * @since PECL ev >= 0.2.0
		 */
		 ...
		 * @link https://php.net/manual/ja/evstat.prev.php
		 * @since PECL ev >= 0.2.0
		 */
		 ...
		 * @param float $interval <p>Hint on how quickly a change is expected to be detected and should normally be specified as <b><code>0.0</code></b> to let <i>libev</i> choose a suitable value.</p>
		 * @return void <p>値を返しません。</p>
		 * @link https://php.net/manual/ja/evstat.set.php
		 * @since PECL ev >= 0.2.0
		 */
		 ...
		 * @link https://php.net/manual/ja/evstat.stat.php
		 * @since PECL ev >= 0.2.0
		 */
	 ...
	 * @link https://php.net/manual/ja/class.evtimer.php
	 * @since PECL ev >= 0.2.0
	 */
	class EvTimer extends \EvWatcher {
		 ...
		 * @link https://php.net/manual/ja/class.evtimer.php#evtimer.props.repeat
		 */
		public $repeat;
		 ...
		 * @link https://php.net/manual/ja/class.evtimer.php#evtimer.props.remaining
		 */
		public $remaining;
		 ...
		 * @link https://php.net/manual/ja/evtimer.construct.php
		 * @since PECL ev >= 0.2.0
		 */
		 ...
		 * @return void <p>値を返しません。</p>
		 * @link https://php.net/manual/ja/evtimer.again.php
		 * @since PECL ev >= 0.2.0
		 */
		public function again(): void {}
		 ...
		 * @link https://php.net/manual/ja/evtimer.createstopped.php
		 * @since PECL ev >= 0.2.0
		 */
		 ...
		 * @param float $repeat <p>If repeat is <b><code>0.0</code></b> , then it will automatically be stopped once the timeout is reached. If it is positive, then the timer will automatically be configured to trigger again every repeat seconds later, until stopped manually.</p>
		 * @return void <p>値を返しません。</p>
		 * @link https://php.net/manual/ja/evtimer.set.php
		 * @since PECL ev >= 0.2.0
		 */
	 ...
	 * @link https://php.net/manual/ja/class.evwatcher.php
	 * @since PECL ev >= 0.2.0
	 */
	abstract class EvWatcher {
		 ...
		 * @return self
		 * @link https://php.net/manual/ja/evwatcher.construct.php
		 * @since PECL ev >= 0.2.0
		 */
