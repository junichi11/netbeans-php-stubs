...
namespace {
	...
	/**
	 * @link https://php.net/manual/ja/class.xsltprocessor.php
	 * @since PHP 5, PHP 7
	 */
	class XSLTProcessor {
		 ...
		 * @link https://php.net/manual/ja/xsltprocessor.getparameter.php
		 ...
		 * @link https://php.net/manual/ja/xsltprocessor.getsecurityprefs.php
		 * @since PHP >= 5.4.0
		 */
		 ...
		 * @link https://php.net/manual/ja/xsltprocessor.hasexsltsupport.php
		 ...
		 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
		 * @link https://php.net/manual/ja/xsltprocessor.importstylesheet.php
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * @link https://php.net/manual/ja/xsltprocessor.registerphpfunctions.php
		 * @since PHP 5 >= 5.0.4, PHP 7
		 */
		 ...
		 * @param string $localName <p>XSLT パラメータのローカル名を指定します。</p>
		 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
		 * @link https://php.net/manual/ja/xsltprocessor.removeparameter.php
		 ...
		 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
		 * @link https://php.net/manual/ja/xsltprocessor.setparameter.php
		 ...
		 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
		 * @link https://php.net/manual/ja/xsltprocessor.setprofiling.php
		 * @since PHP >= 5.3.0
		 */
		 ...
		 * @link https://php.net/manual/ja/xsltprocessor.setsecurityprefs.php
		 * @since PHP >= 5.4.0
		 */
		 ...
		 * @link https://php.net/manual/ja/xsltprocessor.transformtodoc.php
		 ...
		 * @link https://php.net/manual/ja/xsltprocessor.transformtouri.php
		 ...
		 * @link https://php.net/manual/ja/xsltprocessor.transformtoxml.php
