...
namespace {
	...
	/**
	 * <p>RRD データベースファイルの生成クラス</p>
	 * @link https://php.net/manual/ja/class.rrdcreator.php
	...
	class RRDCreator {
		 ...
		 * @link https://php.net/manual/ja/rrdcreator.construct.php
		 * @since PECL rrd >= 0.9.0
		 */
		 ...
		 * @link https://php.net/manual/ja/rrdcreator.addarchive.php
		 * @since PECL rrd >= 0.9.0
		 */
		 ...
		 * @return void <p>値を返しません。</p>
		 * @link https://php.net/manual/ja/rrdcreator.adddatasource.php
		 * @since PECL rrd >= 0.9.0
		 */
		 ...
		 * @link https://php.net/manual/ja/rrdcreator.save.php
		 * @since PECL rrd >= 0.9.0
		 */
	...
	/**
	 * <p>RRD データベースから画像ファイルにデータをエクスポートするクラス</p>
	 * @link https://php.net/manual/ja/class.rrdgraph.php
	 * @since PECL rrd >= 0.9.0
	 */
	class RRDGraph {
		 ...
		 * @return self <p>値を返しません。</p>
		 * @link https://php.net/manual/ja/rrdgraph.construct.php
		 * @since PECL rrd >= 0.9.0
		 */
		 ...
		 * @link https://php.net/manual/ja/rrdgraph.save.php
		 * @since PECL rrd >= 0.9.0
		 */
		 ...
		 * @link https://php.net/manual/ja/rrdgraph.saveverbose.php
		 * @since PECL rrd >= 0.9.0
		 */
		 ...
		 * @return void <p>値を返しません。</p>
		 * @link https://php.net/manual/ja/rrdgraph.setoptions.php
		 * @since PECL rrd >= 0.9.0
		 */
	...
	/**
	 * <p>RDD データベースファイルを更新するクラス</p>
	 * @link https://php.net/manual/ja/class.rrdupdater.php
	 * @since PECL rrd >= 0.9.0
	 */
	class RRDUpdater {
		 ...
		 * @return self <p>値を返しません。</p>
		 * @link https://php.net/manual/ja/rrdupdater.construct.php
		 * @since PECL rrd >= 0.9.0
		 */
		public function __construct(string $path) {}
		 ...
		 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
		 * @link https://php.net/manual/ja/rrdupdater.update.php
		 * @since PECL rrd >= 0.9.0
		 */
	 ...
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.rrd-create.php
	 * @since PECL rrd >= 0.9.0
	 */
	 ...
	 * @link https://php.net/manual/ja/function.rrd-error.php
	 * @since PECL rrd >= 0.9.0
	 */
	 ...
	 * @link https://php.net/manual/ja/function.rrd-fetch.php
	 * @since PECL rrd >= 0.9.0
	 */
	 ...
	 * @link https://php.net/manual/ja/function.rrd-first.php
	 * @since PECL rrd >= 0.9.0
	 */
	 ...
	 * @link https://php.net/manual/ja/function.rrd-graph.php
	 * @since PECL rrd >= 0.9.0
	 */
	 ...
	 * @link https://php.net/manual/ja/function.rrd-info.php
	 * @since PECL rrd >= 0.9.0
	 */
	 ...
	 * @link https://php.net/manual/ja/function.rrd-last.php
	 * @since PECL rrd >= 0.9.0
	 */
	 ...
	 * @link https://php.net/manual/ja/function.rrd-lastupdate.php
	 * @since PECL rrd >= 0.9.0
	 */
	 ...
	 * @link https://php.net/manual/ja/function.rrd-restore.php
	 * @since PECL rrd >= 0.9.0
	 */
	 ...
	 * @return bool <p>Returns <b><code>TRUE</code></b> on success, <b><code>FALSE</code></b> otherwise.</p>
	 * @link https://php.net/manual/ja/function.rrd-tune.php
	 * @since PECL rrd >= 0.9.0
	 */
	 ...
	 * @link https://php.net/manual/ja/function.rrd-update.php
	 * @since PECL rrd >= 0.9.0
	 */
	 ...
	 * @link https://php.net/manual/ja/function.rrd-version.php
	 ...
	 * @link https://php.net/manual/ja/function.rrd-xport.php
	 * @since PECL rrd >= 0.9.0
	 */
	 ...
	 * @return void <p>値を返しません。</p>
	 * @link https://php.net/manual/ja/function.rrdc-disconnect.php
