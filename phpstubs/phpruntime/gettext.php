...
namespace {
	 ...
	 * @link https://php.net/manual/ja/function.bind-textdomain-codeset.php
	 ...
	 * @link https://php.net/manual/ja/function.bindtextdomain.php
	 ...
	 * @return string <p>成功した場合に文字列を返します。</p>
	 * @link https://php.net/manual/ja/function.dcgettext.php
	 * @see gettext()
	 * @since PHP 4, PHP 5, PHP 7
	 */
	 ...
	 * @param int $category
	 * @return string <p>成功した場合に文字列を返します。</p>
	 * @link https://php.net/manual/ja/function.dcngettext.php
	 * @see ngettext()
	 * @since PHP 4 >= 4.2.0, PHP 5, PHP 7
	 */
	 ...
	 * @param string $message <p>メッセージ。</p>
	 * @return string <p>成功した場合に文字列を返します。</p>
	 * @link https://php.net/manual/ja/function.dgettext.php
	 * @see gettext()
	 * @since PHP 4, PHP 5, PHP 7
	 */
	 ...
	 * @param int $n
	 * @return string <p>成功した場合に文字列を返します。</p>
	 * @link https://php.net/manual/ja/function.dngettext.php
	 * @see ngettext()
	 * @since PHP 4 >= 4.2.0, PHP 5, PHP 7
	 */
	 ...
	 * @link https://php.net/manual/ja/function.gettext.php
	 * @see setlocale()
	 * @since PHP 4, PHP 5, PHP 7
	 */
	 ...
	 * @link https://php.net/manual/ja/function.ngettext.php
	 * @since PHP 4 >= 4.2.0, PHP 5, PHP 7
	 */
	 ...
	 * @link https://php.net/manual/ja/function.textdomain.php
	 * @since PHP 4, PHP 5, PHP 7
	 */
