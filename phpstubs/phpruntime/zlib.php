 ...
 * @link http://php.net/manual/ja/function.inflate-get-read-len.php
 * @since PHP 7 >= 7.2.0
 */
 ...
 * @link http://php.net/manual/ja/function.inflate-get-status.php
 * @since PHP 7 >= 7.2.0
 */
 ...
 * @return int <p>ファイルから読み込んだ (解凍された) データのバイト数を返します。 エラーが発生した場合、<b><code>FALSE</code></b> が返され、<i>@readgzfile</i> としてコールされている場合を除き、エラーメッセージが出力されます。</p>
 ...
 * @param string $data <p>圧縮するデータ。</p>
 * @param string $encoding <p>圧縮アルゴリズム。 <b><code>ZLIB_ENCODING_RAW</code></b>、 <b><code>ZLIB_ENCODING_DEFLATE</code></b> または <b><code>ZLIB_ENCODING_GZIP</code></b> 。</p>
 * @param string $level
 * @return string
