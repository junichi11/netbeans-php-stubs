 ...
 * @link http://php.net/manual/ja/class.zookeeper.php
...
class Zookeeper {
	...
	/**
	 * @var integer <p>No quorum of new config is connected and up-to-date with the leader of last commmitted config - try invoking reconfiguration after new servers are connected and synced.</p> <p>Available as of ZooKeeper 3.5.0</p>
	 * @link http://php.net/manual/ja/class.zookeeper.php
	 */
	 ...
	 * @return self
	 * @link http://php.net/manual/ja/zookeeper.construct.php
	 * @since PECL zookeeper >= 0.1.0
	 */
	 ...
	 * @link http://php.net/manual/ja/zookeeper.addauth.php
	 * @since PECL zookeeper >= 0.1.0
	 */
	 ...
	 * @return void
	 * @link http://php.net/manual/ja/zookeeper.close.php
	 ...
	 * @param int $recv_timeout <p>The timeout for this session, only valid if the connections is currently connected (ie. last watcher state is ZOO_CONNECTED_STATE).</p>
	 * @return void
	 * @link http://php.net/manual/ja/zookeeper.connect.php
	 ...
	 * @link http://php.net/manual/ja/zookeeper.create.php
	 * @since PECL zookeeper >= 0.1.0
	 */
	 ...
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link http://php.net/manual/ja/zookeeper.delete.php
	 * @since PECL zookeeper >= 0.2.0
	 */
	 ...
	 * @link http://php.net/manual/ja/zookeeper.exists.php
	 * @since PECL zookeeper >= 0.1.0
	 */
	 ...
	 * @link http://php.net/manual/ja/zookeeper.get.php
	 * @since PECL zookeeper >= 0.1.0
	 */
	 ...
	 * @link http://php.net/manual/ja/zookeeper.getacl.php
	 * @since PECL zookeeper >= 0.1.0
	 */
	 ...
	 * @link http://php.net/manual/ja/zookeeper.getchildren.php
	 * @since PECL zookeeper >= 0.1.0
	 */
	 ...
	 * @link http://php.net/manual/ja/zookeeper.getclientid.php
	 * @since PECL zookeeper >= 0.1.0
	 */
	 ...
	 * @link http://php.net/manual/ja/zookeeper.getconfig.php
	 ...
	 * @link http://php.net/manual/ja/zookeeper.getrecvtimeout.php
	 * @since PECL zookeeper >= 0.1.0
	 */
	 ...
	 * @link http://php.net/manual/ja/zookeeper.getstate.php
	 * @since PECL zookeeper >= 0.1.0
	 */
	 ...
	 * @return bool <p>Returns true/false on success, and false on failure.</p>
	 * @link http://php.net/manual/ja/zookeeper.isrecoverable.php
	 * @since PECL zookeeper >= 0.1.0
	 */
	 ...
	 * @param array $stat <p>If not NULL, will hold the value of stat for the path on return.</p>
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link http://php.net/manual/ja/zookeeper.set.php
	 * @since PECL zookeeper >= 0.1.0
	 */
	 ...
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link http://php.net/manual/ja/zookeeper.setacl.php
	 * @since PECL zookeeper >= 0.1.0
	 */
	 ...
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link http://php.net/manual/ja/zookeeper.setdebuglevel.php
	 * @since PECL zookeeper >= 0.1.0
	 */
	 ...
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link http://php.net/manual/ja/zookeeper.setdeterministicconnorder.php
	 * @since PECL zookeeper >= 0.1.0
	 */
	 ...
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link http://php.net/manual/ja/zookeeper.setlogstream.php
	 * @since PECL zookeeper >= 0.1.0
	 */
	 ...
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link http://php.net/manual/ja/zookeeper.setwatcher.php
	 * @since PECL zookeeper >= 0.1.0
	 */
 ...
 * @link http://php.net/manual/ja/class.zookeeperauthenticationexception.php
 ...
 * @link http://php.net/manual/ja/class.zookeeperconfig.php
 * @since PECL zookeeper >= 0.6.0, ZooKeeper >= 3.5.0
 */
class ZookeeperConfig {
	 ...
	 * @param array $stat <p>If not NULL, will hold the value of stat for the path on return.</p>
	 * @return void
	 * @link http://php.net/manual/ja/zookeeperconfig.add.php
	 * @since PECL zookeeper >= 0.6.0, ZooKeeper >= 3.5.0
	 */
	 ...
	 * @link http://php.net/manual/ja/zookeeperconfig.get.php
	 * @since PECL zookeeper >= 0.6.0, ZooKeeper >= 3.5.0
	 */
	 ...
	 * @param array $stat <p>If not NULL, will hold the value of stat for the path on return.</p>
	 * @return void
	 * @link http://php.net/manual/ja/zookeeperconfig.remove.php
	 * @since PECL zookeeper >= 0.6.0, ZooKeeper >= 3.5.0
	 */
	 ...
	 * @param array $stat <p>If not NULL, will hold the value of stat for the path on return.</p>
	 * @return void
	 * @link http://php.net/manual/ja/zookeeperconfig.set.php
	 * @since PECL zookeeper >= 0.6.0, ZooKeeper >= 3.5.0
	 */
 ...
 * @link http://php.net/manual/ja/class.zookeeperconnectionexception.php
 * @since PECL zookeeper >= 0.3.0
 */
 ...
 * @link http://php.net/manual/ja/class.zookeeperexception.php
 * @since PECL zookeeper >= 0.3.0
 */
 ...
 * @link http://php.net/manual/ja/class.zookeepermarshallingexception.php
 * @since PECL zookeeper >= 0.3.0
 */
 ...
 * @link http://php.net/manual/ja/class.zookeepernonodeexception.php
 * @since PECL zookeeper >= 0.3.0
 */
 ...
 * @link http://php.net/manual/ja/class.zookeeperoperationtimeoutexception.php
 * @since PECL zookeeper >= 0.3.0
 */
 ...
 * @link http://php.net/manual/ja/class.zookeepersessionexception.php
 * @since PECL zookeeper >= 0.3.0
 */
 ...
 * @return void
 * @link http://php.net/manual/ja/function.zookeeper-dispatch.php
