...
namespace {
	 ...
	 * @link https://php.net/manual/ja/function.inotify-add-watch.php
	 * @see inotify_init()
	 ...
	 * @link https://php.net/manual/ja/function.inotify-init.php
	 ...
	 * @link https://php.net/manual/ja/function.inotify-queue-len.php
	 ...
	 * @link https://php.net/manual/ja/function.inotify-read.php
	 ...
	 * @link https://php.net/manual/ja/function.inotify-rm-watch.php
	 * @see inotify_init()
	 * @since PECL inotify >= 0.1.2
	 */
