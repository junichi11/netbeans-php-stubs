...
namespace {
	...
	/**
	 * <p><b>Exception</b> は、PHP 5 ではすべての例外の基底クラスです。 PHP 7 では、すべてのユーザー例外の基底クラスとなります。</p>
	 * <p>PHP 7 より前は、<b>Exception</b> は Throwable インターフェイスを実装しませんでした。</p>
	 * @link https://php.net/manual/ja/class.exception.php
	 * @since PHP 5, PHP 7
	 */
	class Exception extends \Throwable {
		 ...
		 * @param \Throwable $previous <p>以前に使われた例外。例外の連結に使用します。</p>
		 * @return self
		 * @link https://php.net/manual/ja/exception.construct.php
		 * @since PHP 5, PHP 7
		 */
