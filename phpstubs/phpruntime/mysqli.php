...
namespace {
	 ...
	 * @link https://php.net/manual/ja/class.mysqli.php
	 * @since PHP 5, PHP 7
	 */
	class mysqli {
		 ...
		 * @link https://php.net/manual/ja/mysqli.affected-rows.php
		 ...
		 * @link https://php.net/manual/ja/mysqli.connect-errno.php
		 ...
		 * @link https://php.net/manual/ja/mysqli.connect-error.php
		 ...
		 * @link https://php.net/manual/ja/mysqli.errno.php
		 ...
		 * @link https://php.net/manual/ja/mysqli.error-list.php
		 * @see mysqli_connect_errno(), mysqli_connect_error(), mysqli_error(), mysqli_sqlstate()
		 ...
		 * @link https://php.net/manual/ja/mysqli.error.php
		 ...
		 * @link https://php.net/manual/ja/mysqli.field-count.php
		 * @since PHP 5, PHP 7
		 */
		public $field_count;
		 ...
		 * @link https://php.net/manual/ja/mysqli.get-client-info.php
		 ...
		 * @link https://php.net/manual/ja/mysqli.get-client-version.php
		 ...
		 * @link https://php.net/manual/ja/mysqli.get-host-info.php
		 ...
		 * @link https://php.net/manual/ja/mysqli.get-proto-info.php
		 ...
		 * @link https://php.net/manual/ja/mysqli.get-server-info.php
		 ...
		 * @link https://php.net/manual/ja/mysqli.get-server-version.php
		 ...
		 * @link https://php.net/manual/ja/mysqli.info.php
		 ...
		 * @link https://php.net/manual/ja/mysqli.insert-id.php
		 * @since PHP 5, PHP 7
		 */
		public $insert_id;
		 ...
		 * @link https://php.net/manual/ja/mysqli.sqlstate.php
		 ...
		 * @link https://php.net/manual/ja/mysqli.thread-id.php
		 * @see mysqli_kill()
		 * @since PHP 5, PHP 7
		 */
		public $thread_id;
		 ...
		 * @link https://php.net/manual/ja/mysqli.warning-count.php
		 ...
		 * @link https://php.net/manual/ja/mysqli.construct.php
		 ...
		 * @link https://php.net/manual/ja/mysqli.autocommit.php
		 ...
		 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
		 * @link https://php.net/manual/ja/mysqli.begin-transaction.php
		 ...
		 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
		 * @link https://php.net/manual/ja/mysqli.change-user.php
		 ...
		 * @link https://php.net/manual/ja/mysqli.character-set-name.php
		 ...
		 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
		 * @link https://php.net/manual/ja/mysqli.close.php
		 ...
		 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
		 * @link https://php.net/manual/ja/mysqli.commit.php
		 ...
		 * @link https://php.net/manual/ja/mysqli.debug.php
		 ...
		 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
		 * @link https://php.net/manual/ja/mysqli.dump-debug-info.php
		 * @see mysqli_debug()
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * @link https://php.net/manual/ja/mysqli.real-escape-string.php
		 ...
		 * @link https://php.net/manual/ja/mysqli.get-charset.php
		 ...
		 * @link https://php.net/manual/ja/mysqli.get-connection-stats.php
		 ...
		 * @link https://php.net/manual/ja/mysqli.get-warnings.php
		 * @since PHP 5 >= 5.1.0, PHP 7
		 */
		 ...
		 * @link https://php.net/manual/ja/mysqli.init.php
		 ...
		 * @param int $processid
		 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
		 * @link https://php.net/manual/ja/mysqli.kill.php
		 ...
		 * @link https://php.net/manual/ja/mysqli.more-results.php
		 ...
		 * @link https://php.net/manual/ja/mysqli.multi-query.php
		 ...
		 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
		 * @link https://php.net/manual/ja/mysqli.next-result.php
		 ...
		 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
		 * @link https://php.net/manual/ja/mysqli.options.php
		 ...
		 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
		 * @link https://php.net/manual/ja/mysqli.ping.php
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * @link https://php.net/manual/ja/mysqli.poll.php
		 ...
		 * @link https://php.net/manual/ja/mysqli.prepare.php
		 ...
		 * @link https://php.net/manual/ja/mysqli.query.php
		 ...
		 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
		 * @link https://php.net/manual/ja/mysqli.real-connect.php
		 ...
		 * @param string $query <p>クエリを表す文字列。</p> <p>クエリ内のデータは 適切にエスケープ. する必要があります。</p>
		 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
		 * @link https://php.net/manual/ja/mysqli.real-query.php
		 ...
		 * @link https://php.net/manual/ja/mysqli.reap-async-query.php
		 * @see mysqli_poll()
		 * @since PHP 5 >= 5.3.0, PHP 7
		 */
		 ...
		 * @link https://php.net/manual/ja/mysqli.refresh.php
		 * @see mysqli_poll()
		 * @since PHP 5 >= 5.3.0, PHP 7
		 */
		 ...
		 * @param string $name
		 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
		 * @link https://php.net/manual/ja/mysqli.release-savepoint.php
		 * @see mysqli_rollback()
		 * @since PHP 5 >= 5.5.0, PHP 7
		 */
		 ...
		 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
		 * @link https://php.net/manual/ja/mysqli.rollback.php
		 ...
		 * @param string $query
		 * @return int
		 * @link https://php.net/manual/ja/mysqli.rpl-query-type.php
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * @param string $name
		 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
		 * @link https://php.net/manual/ja/mysqli.savepoint.php
		 * @see mysqli_commit()
		 * @since PHP 5 >= 5.5.0, PHP 7
		 */
		 ...
		 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
		 * @link https://php.net/manual/ja/mysqli.select-db.php
		 ...
		 * @param string $query
		 * @return bool
		 * @link https://php.net/manual/ja/mysqli.send-query.php
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
		 * @link https://php.net/manual/ja/mysqli.set-charset.php
		 ...
		 * @link https://php.net/manual/ja/mysqli.set-local-infile-default.php
		 ...
		 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
		 * @link https://php.net/manual/ja/mysqli.set-local-infile-handler.php
		 ...
		 * @link https://php.net/manual/ja/mysqli.ssl-set.php
		 ...
		 * @link https://php.net/manual/ja/mysqli.stat.php
		 ...
		 * @link https://php.net/manual/ja/mysqli.stmt-init.php
		 ...
		 * @link https://php.net/manual/ja/mysqli.store-result.php
		 ...
		 * @link https://php.net/manual/ja/mysqli.thread-safe.php
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * @link https://php.net/manual/ja/mysqli.use-result.php
	...
	/**
	 * <p>MySQLi ドライバです。</p>
	 * @link https://php.net/manual/ja/class.mysqli-driver.php
	 * @since PHP 5, PHP 7
	 */
	class mysqli_driver {
		 ...
		 * @link https://php.net/manual/ja/class.mysqli-driver.php#mysqli-driver.props.client-info
		 */
		public $client_info;

		/**
		 * @var string <p>クライアントのバージョン</p>
		 * @link https://php.net/manual/ja/class.mysqli-driver.php#mysqli-driver.props.client-version
		 */
		public $client_version;

		/**
		 * @var string <p>MySQLi ドライバのバージョン</p>
		 * @link https://php.net/manual/ja/class.mysqli-driver.php#mysqli-driver.props.driver-version
		 */
		public $driver_version;

		/**
		 * @var string <p>MySQLi Embedded のサポートが有効かどうか</p>
		 * @link https://php.net/manual/ja/class.mysqli-driver.php#mysqli-driver.props.embedded
		 */
		public $embedded;

		/**
		 * @var bool <p>再接続を許可するかどうか (INI 設定 mysqli.reconnect を参照ください)</p>
		 * @link https://php.net/manual/ja/class.mysqli-driver.php#mysqli-driver.props.reconnect
		 */
		public $reconnect;
		 ...
		 * @link https://php.net/manual/ja/class.mysqli-driver.php#mysqli-driver.props.report-mode
		 */
		public $report_mode;
		 ...
		 * <p>オブジェクト指向型</p><p>手続き型</p><p>この関数は、 現在のところ詳細な情報はありません。引数のリストのみが 記述されています。</p>
		 * @return void
		 * @link https://php.net/manual/ja/mysqli-driver.embedded-server-end.php
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * @param array $groups
		 * @return bool
		 * @link https://php.net/manual/ja/mysqli-driver.embedded-server-start.php
		 * @since PHP 5, PHP 7
		 */
	 ...
	 * <p><i>変更履歴</i></p>
	 * @link https://php.net/manual/ja/class.mysqli-result.php
	 * @since PHP 5, PHP 7
	 */
	class mysqli_result {
		 ...
		 * @link https://php.net/manual/ja/mysqli-result.current-field.php
		 ...
		 * @link https://php.net/manual/ja/mysqli-result.field-count.php
		 ...
		 * @link https://php.net/manual/ja/mysqli-result.lengths.php
		 * @since PHP 5, PHP 7
		 */
		public $lengths;
		 ...
		 * @link https://php.net/manual/ja/mysqli-result.num-rows.php
		 ...
		 * @return void <p>値を返しません。</p>
		 * @link https://php.net/manual/ja/mysqli-result.free.php
		 ...
		 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
		 * @link https://php.net/manual/ja/mysqli-result.data-seek.php
		 ...
		 * @link https://php.net/manual/ja/mysqli-result.fetch-all.php
		 ...
		 * @link https://php.net/manual/ja/mysqli-result.fetch-array.php
		 ...
		 * @link https://php.net/manual/ja/mysqli-result.fetch-assoc.php
		 ...
		 * @link https://php.net/manual/ja/mysqli-result.fetch-field.php
		 ...
		 * @link https://php.net/manual/ja/mysqli-result.fetch-field-direct.php
		 ...
		 * @link https://php.net/manual/ja/mysqli-result.fetch-fields.php
		 ...
		 * @link https://php.net/manual/ja/mysqli-result.fetch-object.php
		 ...
		 * @link https://php.net/manual/ja/mysqli-result.fetch-row.php
		 ...
		 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
		 * @link https://php.net/manual/ja/mysqli-result.field-seek.php
		 * @see mysqli_fetch_field()
		 * @since PHP 5, PHP 7
		 */
	 ...
	 * @link https://php.net/manual/ja/class.mysqli-sql-exception.php
	 * @since PHP 5, PHP 7
	 */
	class mysqli_sql_exception extends \RuntimeException {
		 ...
		 * @link https://php.net/manual/ja/class.mysqli-sql-exception.php#mysqli-sql-exception.props.sqlstate
		 */
		protected $sqlstate;
	 ...
	 * @link https://php.net/manual/ja/class.mysqli-stmt.php
	 * @since PHP 5, PHP 7
	 */
	class mysqli_stmt {
		 ...
		 * @link https://php.net/manual/ja/mysqli-stmt.affected-rows.php
		 ...
		 * @link https://php.net/manual/ja/mysqli-stmt.errno.php
		 ...
		 * @var array <p>エラーの一覧を返します。個々のエラーは連想配列形式で、 errno、error および sqlstate のキーを含みます。</p>
		 * @link https://php.net/manual/ja/mysqli-stmt.error-list.php
		 ...
		 * @link https://php.net/manual/ja/mysqli-stmt.error.php
		 ...
		 * <p>オブジェクト指向型</p><p>手続き型</p><p>この関数は、 現在のところ詳細な情報はありません。引数のリストのみが 記述されています。</p>
		 * @var int
		 * @link https://php.net/manual/ja/mysqli-stmt.field-count.php
		 * @since PHP 5, PHP 7
		 */
		public $field_count;
		 ...
		 * <p>オブジェクト指向型</p><p>手続き型</p><p>この関数は、 現在のところ詳細な情報はありません。引数のリストのみが 記述されています。</p>
		 * @var int
		 * @link https://php.net/manual/ja/mysqli-stmt.insert-id.php
		 * @since PHP 5, PHP 7
		 */
		public $insert_id;
		 ...
		 * @link https://php.net/manual/ja/mysqli-stmt.num-rows.php
		 ...
		 * @link https://php.net/manual/ja/mysqli-stmt.param-count.php
		 * @see mysqli_prepare()
		 * @since PHP 5, PHP 7
		 */
		public $param_count;
		 ...
		 * @var string <p>直前のエラーに関する SQLSTATE エラーコードを含む文字列を返します。 エラーコードは 5 文字で構成され、<i>'00000'</i> はエラーが発生しなかったことを意味します。</p>
		 * @link https://php.net/manual/ja/mysqli-stmt.sqlstate.php
		 ...
		 * @return self
		 * @link https://php.net/manual/ja/mysqli-stmt.construct.php
		 ...
		 * @link https://php.net/manual/ja/mysqli-stmt.attr-get.php
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * @return bool
		 * @link https://php.net/manual/ja/mysqli-stmt.attr-set.php
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * @param mixed $_
		 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
		 * @link https://php.net/manual/ja/mysqli-stmt.bind-param.php
		 ...
		 * @param mixed $_
		 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
		 * @link https://php.net/manual/ja/mysqli-stmt.bind-result.php
		 ...
		 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
		 * @link https://php.net/manual/ja/mysqli-stmt.close.php
		 * @see mysqli_prepare()
		 * @since PHP 5, PHP 7
		 */
		public function close(): bool {}
		 ...
		 * @return void <p>値を返しません。</p>
		 * @link https://php.net/manual/ja/mysqli-stmt.data-seek.php
		 * @see mysqli_prepare()
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
		 * @link https://php.net/manual/ja/mysqli-stmt.execute.php
		 ...
		 * @link https://php.net/manual/ja/mysqli-stmt.fetch.php
		 ...
		 * @return void <p>値を返しません。</p>
		 * @link https://php.net/manual/ja/mysqli-stmt.free-result.php
		 ...
		 * @link https://php.net/manual/ja/mysqli-stmt.get-result.php
		 ...
		 * @return object
		 * @link https://php.net/manual/ja/mysqli-stmt.get-warnings.php
		 * @since PHP 5 >= 5.1.0, PHP 7
		 */
		 ...
		 * @link https://php.net/manual/ja/mysqli-stmt.prepare.php
		 ...
		 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
		 * @link https://php.net/manual/ja/mysqli-stmt.reset.php
		 * @see mysqli_prepare()
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * @link https://php.net/manual/ja/mysqli-stmt.result-metadata.php
		 ...
		 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
		 * @link https://php.net/manual/ja/mysqli-stmt.send-long-data.php
		 ...
		 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
		 * @link https://php.net/manual/ja/mysqli-stmt.store-result.php
	...
	/**
	 * <p>MySQL の警告を表します。</p>
	 * @link https://php.net/manual/ja/class.mysqli-warning.php
	 * @since PHP 5, PHP 7
	 */
	class mysqli_warning {
		 ...
		 * @link https://php.net/manual/ja/class.mysqli-warning.php#mysqli-warning.props.message
		 */
		public $message;

		/**
		 * @var mixed <p>SQL state</p>
		 * @link https://php.net/manual/ja/class.mysqli-warning.php#mysqli-warning.props.sqlstate
		 */
		public $sqlstate;

		/**
		 * @var mixed <p>エラー番号</p>
		 * @link https://php.net/manual/ja/class.mysqli-warning.php#mysqli-warning.props.errno
		 */
		public $errno;
		 ...
		 * @return self
		 * @link https://php.net/manual/ja/mysqli-warning.construct.php
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * <p></p><p>この関数は、 現在のところ詳細な情報はありません。引数のリストのみが 記述されています。</p>
		 * @return void
		 * @link https://php.net/manual/ja/mysqli-warning.next.php
		 * @since PHP 5, PHP 7
		 */
	 ...
	 * @link https://php.net/manual/ja/function.mysqli-bind-param.php
	 * @since PHP 5 < 5.4.0
	 */
	 ...
	 * @link https://php.net/manual/ja/function.mysqli-bind-result.php
	 * @since PHP 5 < 5.4.0
	 */
	 ...
	 * @link https://php.net/manual/ja/function.mysqli-client-encoding.php
	 * @since PHP 5 < 5.4.0
	 */
	 ...
	 * @param \mysqli $link
	 * @return bool
	 * @link https://php.net/manual/ja/function.mysqli-disable-reads-from-master.php
	 * @since PHP 5 < 5.3.0
	 */
	 ...
	 * @param \mysqli $link
	 * @return bool
	 * @link https://php.net/manual/ja/function.mysqli-disable-rpl-parse.php
	 * @since PHP 5 < 5.3.0
	 */
	 ...
	 * @param \mysqli $link
	 * @return bool
	 * @link https://php.net/manual/ja/function.mysqli-enable-reads-from-master.php
	 * @since PHP 5 < 5.3.0
	 */
	 ...
	 * @param \mysqli $link
	 * @return bool
	 * @link https://php.net/manual/ja/function.mysqli-enable-rpl-parse.php
	 * @since PHP 5 < 5.3.0
	 */
	 ...
	 * @param string $escapestr <p>エスケープする文字列。</p> <p>エンコードされる文字は <i>NUL (ASCII 0), \n, \r, \, ', ", および Control-Z</i> です。</p>
	 * @return string
	 * @link https://php.net/manual/ja/function.mysqli-escape-string.php
	 * @since PHP 5, PHP 7
	 */
	 ...
	 * @link https://php.net/manual/ja/function.mysqli-execute.php
	 * @since PHP 5, PHP 7
	 */
	 ...
	 * @link https://php.net/manual/ja/function.mysqli-fetch.php
	 * @since PHP 5 < 5.4.0
	 */
	 ...
	 * @link https://php.net/manual/ja/function.mysqli-get-cache-stats.php
	 ...
	 * @link https://php.net/manual/ja/function.mysqli-get-client-stats.php
	 * @since PHP 5 >= 5.3.0, PHP 7
	 */
	 ...
	 * @link https://php.net/manual/ja/function.mysqli-get-links-stats.php
	 ...
	 * @link https://php.net/manual/ja/function.mysqli-get-metadata.php
	 * @since PHP 5 < 5.4.0
	 */
	 ...
	 * @param string $query
	 * @return bool
	 * @link https://php.net/manual/ja/function.mysqli-master-query.php
	 * @since PHP 5 < 5.3.0
	 */
	 ...
	 * @link https://php.net/manual/ja/function.mysqli-param-count.php
	 * @since PHP 5 < 5.4.0
	 */
	 ...
	 * @link https://php.net/manual/ja/function.mysqli-report.php
	 * @since PHP 5, PHP 7
	 */
	 ...
	 * @param \mysqli $link
	 * @return int
	 * @link https://php.net/manual/ja/function.mysqli-rpl-parse-enabled.php
	 * @since PHP 5 < 5.3.0
	 */
	 ...
	 * @param \mysqli $link
	 * @return bool
	 * @link https://php.net/manual/ja/function.mysqli-rpl-probe.php
	 * @since PHP 5 < 5.3.0
	 */
	 ...
	 * @link https://php.net/manual/ja/function.mysqli-send-long-data.php
	 * @since PHP 5 < 5.4.0
	 */
	 ...
	 * @link https://php.net/manual/ja/function.mysqli-set-opt.php
	 * @since PHP 5, PHP 7
	 */
	 ...
	 * @param string $query
	 * @return bool
	 * @link https://php.net/manual/ja/function.mysqli-slave-query.php
	 * @since PHP 5 < 5.3.0
	 */
