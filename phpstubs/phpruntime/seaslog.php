...
/**
 * @link http://php.net/manual/ja/class.seaslog.php
...
class SeasLog {
	 ...
	 * @return void
	 * @link http://php.net/manual/ja/seaslog.destruct.php
	 * @since PECL seaslog >=1.0.0
	 */
	 ...
	 * @link http://php.net/manual/ja/seaslog.alert.php
	 * @since PECL seaslog >=1.0.0
	 */
	 ...
	 * @link http://php.net/manual/ja/seaslog.analyzercount.php
	 ...
	 * @link http://php.net/manual/ja/seaslog.analyzerdetail.php
	 * @since PECL seaslog >=1.1.6
	 */
	 ...
	 * @param string $logger <p>The `logger` cased by the third param would be used right this right now, like a temp logger, when the function SeasLog::setLogger() called in pre content. If `logger` NULL or "", SeasLog will use lastest logger setted by <code>SeasLog::setLogger()</code>.</p>
	 * @return bool <p>Return TRUE on record log information success, FALSE on failure.</p>
	 * @link http://php.net/manual/ja/seaslog.critical.php
	 * @since PECL seaslog >=1.0.0
	 */
	 ...
	 * @param string $logger <p>The `logger` cased by the third param would be used right this right now, like a temp logger, when the function SeasLog::setLogger() called in pre content. If `logger` NULL or "", SeasLog will use lastest logger setted by <code>SeasLog::setLogger()</code>.</p>
	 * @return bool <p>Return TRUE on record log information success, FALSE on failure.</p>
	 * @link http://php.net/manual/ja/seaslog.debug.php
	 * @since PECL seaslog >=1.0.0
	 */
	 ...
	 * @param string $logger <p>The `logger` cased by the third param would be used right this right now, like a temp logger, when the function SeasLog::setLogger() called in pre content. If `logger` NULL or "", SeasLog will use lastest logger setted by <code>SeasLog::setLogger()</code>.</p>
	 * @return bool <p>Return TRUE on record log information success, FALSE on failure.</p>
	 * @link http://php.net/manual/ja/seaslog.emergency.php
	 * @since PECL seaslog >=1.0.0
	 */
	 ...
	 * @param string $logger <p>The `logger` cased by the third param would be used right this right now, like a temp logger, when the function SeasLog::setLogger() called in pre content. If `logger` NULL or "", SeasLog will use lastest logger setted by <code>SeasLog::setLogger()</code>.</p>
	 * @return bool <p>Return TRUE on record log information success, FALSE on failure.</p>
	 * @link http://php.net/manual/ja/seaslog.error.php
	 * @since PECL seaslog >=1.0.0
	 */
	 ...
	 * @link http://php.net/manual/ja/seaslog.flushbuffer.php
	 * @since PECL seaslog >=1.0.0
	 */
	 ...
	 * @link http://php.net/manual/ja/seaslog.getbasepath.php
	 * @since PECL seaslog >=1.0.0
	 */
	 ...
	 * @link http://php.net/manual/ja/seaslog.getbuffer.php
	 * @since PECL seaslog >=1.0.0
	 */
	 ...
	 * @link http://php.net/manual/ja/seaslog.getbufferenabled.php
	 * @since PECL seaslog >=1.0.0
	 */
	 ...
	 * @link http://php.net/manual/ja/seaslog.getdatetimeformat.php
	 * @since PECL seaslog >=1.0.0
	 */
	 ...
	 * @link http://php.net/manual/ja/seaslog.getlastlogger.php
	 * @since PECL seaslog >=1.0.0
	 */
	 ...
	 * @link http://php.net/manual/ja/seaslog.getrequestid.php
	 * @since PECL seaslog >=1.0.0
	 */
	 ...
	 * @param string $logger <p>The `logger` cased by the third param would be used right this right now, like a temp logger, when the function SeasLog::setLogger() called in pre content. If `logger` NULL or "", SeasLog will use lastest logger setted by <code>SeasLog::setLogger()</code>.</p>
	 * @return bool <p>Return TRUE on record log information success, FALSE on failure.</p>
	 * @link http://php.net/manual/ja/seaslog.info.php
	 * @since PECL seaslog >=1.0.0
	 */
	 ...
	 * @param string $logger <p>The `logger` cased by the third param would be used right this right now, like a temp logger, when the function SeasLog::setLogger() called in pre content. If `logger` NULL or "", SeasLog will use lastest logger setted by <code>SeasLog::setLogger()</code>.</p>
	 * @return bool <p>Return TRUE on record log information success, FALSE on failure.</p>
	 * @link http://php.net/manual/ja/seaslog.log.php
	 * @since PECL seaslog >=1.0.0
	 */
	 ...
	 * @param string $logger <p>The `logger` cased by the third param would be used right this right now, like a temp logger, when the function SeasLog::setLogger() called in pre content. If `logger` NULL or "", SeasLog will use lastest logger setted by <code>SeasLog::setLogger()</code>.</p>
	 * @return bool <p>Return TRUE on record log information success, FALSE on failure.</p>
	 * @link http://php.net/manual/ja/seaslog.notice.php
	 * @since PECL seaslog >=1.0.0
	 */
	 ...
	 * @link http://php.net/manual/ja/seaslog.setbasepath.php
	 * @since PECL seaslog >=1.0.0
	 */
	 ...
	 * @link http://php.net/manual/ja/seaslog.setdatetimeformat.php
	 * @since PECL seaslog >=1.0.0
	 */
	 ...
	 * @link http://php.net/manual/ja/seaslog.setlogger.php
	 * @since PECL seaslog >=1.0.0
	 */
	 ...
	 * @link http://php.net/manual/ja/seaslog.setrequestid.php
	 * @since PECL seaslog >=1.0.0
	 */
	 ...
	 * @param string $logger <p>The `logger` cased by the third param would be used right this right now, like a temp logger, when the function SeasLog::setLogger() called in pre content. If `logger` NULL or "", SeasLog will use lastest logger setted by <code>SeasLog::setLogger()</code>.</p>
	 * @return bool <p>Return TRUE on record log information success, FALSE on failure.</p>
	 * @link http://php.net/manual/ja/seaslog.warning.php
	 * @since PECL seaslog >=1.0.0
	 */
 ...
 * @link http://php.net/manual/ja/function.seaslog-get-author.php
 * @since PECL seaslog >=1.0.0
 */
 ...
 * @link http://php.net/manual/ja/function.seaslog-get-version.php
 * @since PECL seaslog >=1.0.0
 */
