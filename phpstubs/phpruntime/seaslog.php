...
namespace {
	...
	/**
	 * @link https://php.net/manual/ja/class.seaslog.php
	...
	class SeasLog {
		 ...
		 * @return void
		 * @link https://php.net/manual/ja/seaslog.destruct.php
		 * @since PECL seaslog >=1.0.0
		 */
		 ...
		 * <p>Record alert log information.</p><p><b>注意</b>:</p><p>"ALERT" - Action must be taken immediately. Immediate attention should be given to relevant personnel for emergency repairs.</p>
		 ...
		 * @link https://php.net/manual/ja/seaslog.alert.php
		 * @since PECL seaslog >=1.0.0
		 */
		 ...
		 * @link https://php.net/manual/ja/seaslog.analyzercount.php
		 ...
		 * @return mixed <p>Return results as array.</p> <p><b>注意</b>:</p> <p>When `start`,`limit` is not NULL and in Windows, SeasLog will threw exception with message 'Param start and limit don't support Windows'.</p>
		 * @link https://php.net/manual/ja/seaslog.analyzerdetail.php
		 * @since PECL seaslog >=1.1.6
		 */
		 ...
		 * @link https://php.net/manual/ja/seaslog.closeloggerstream.php
		 ...
		 * <p>Record critical log information.</p><p><b>注意</b>:</p><p>"CRITICAL" - Critical conditions.Need to be repaired immediately, and the program component is unavailable.</p>
		 * @param string $message <p>The log message.</p>
		 * @param array $content <p>The `message` contain placeholders which implementors replace with values from content array. Sush as `message` is `log info from {NAME}` and `content` is `array('NAME' =&gt; neeke)`, the log information will `log info from neeke`.</p>
		 * @param string $logger <p>The `logger` cased by the third param would be used right this right now, like a temp logger, when the function SeasLog::setLogger() called in pre content. If `logger` NULL or "", SeasLog will use lastest logger setted by <code>SeasLog::setLogger()</code>.</p>
		 * @return bool <p>Return TRUE on record log information success, FALSE on failure.</p>
		 * @link https://php.net/manual/ja/seaslog.critical.php
		 * @since PECL seaslog >=1.0.0
		 */
		 ...
		 * <p>Record debug log information.</p><p><b>注意</b>:</p><p>"DEBUG" - Detailed debug information.Fine-grained information events.</p>
		 * @param string $message <p>The log message.</p>
		 * @param array $content <p>The `message` contain placeholders which implementors replace with values from content array. Sush as `message` is `log info from {NAME}` and `content` is `array('NAME' =&gt; neeke)`, the log information will `log info from neeke`.</p>
		 * @param string $logger <p>The `logger` cased by the third param would be used right this right now, like a temp logger, when the function SeasLog::setLogger() called in pre content. If `logger` NULL or "", SeasLog will use lastest logger setted by <code>SeasLog::setLogger()</code>.</p>
		 * @return bool <p>Return TRUE on record log information success, FALSE on failure.</p>
		 * @link https://php.net/manual/ja/seaslog.debug.php
		 * @since PECL seaslog >=1.0.0
		 */
		 ...
		 * <p>Record emergency log information.</p><p><b>注意</b>:</p><p>"EMERGENCY" - System is unusable.</p>
		 * @param string $message <p>The log message.</p>
		 * @param array $content <p>The `message` contain placeholders which implementors replace with values from content array. Sush as `message` is `log info from {NAME}` and `content` is `array('NAME' =&gt; neeke)`, the log information will `log info from neeke`.</p>
		 * @param string $logger <p>The `logger` cased by the third param would be used right this right now, like a temp logger, when the function SeasLog::setLogger() called in pre content. If `logger` NULL or "", SeasLog will use lastest logger setted by <code>SeasLog::setLogger()</code>.</p>
		 * @return bool <p>Return TRUE on record log information success, FALSE on failure.</p>
		 * @link https://php.net/manual/ja/seaslog.emergency.php
		 * @since PECL seaslog >=1.0.0
		 */
		 ...
		 * <p>Record error log information.</p><p><b>注意</b>:</p><p>"ERROR" - Runtime errors that do not require immediate action but should typically.</p>
		 * @param string $message <p>The log message.</p>
		 * @param array $content <p>The `message` contain placeholders which implementors replace with values from content array. Sush as `message` is `log info from {NAME}` and `content` is `array('NAME' =&gt; neeke)`, the log information will `log info from neeke`.</p>
		 * @param string $logger <p>The `logger` cased by the third param would be used right this right now, like a temp logger, when the function SeasLog::setLogger() called in pre content. If `logger` NULL or "", SeasLog will use lastest logger setted by <code>SeasLog::setLogger()</code>.</p>
		 * @return bool <p>Return TRUE on record log information success, FALSE on failure.</p>
		 * @link https://php.net/manual/ja/seaslog.error.php
		 * @since PECL seaslog >=1.0.0
		 */
		 ...
		 * <p>Flush logs buffer by seaslog.appender: dump to file, or send to remote api with tcp/udp.</p><p><b>注意</b>:</p><p>See also: seaslog.appender_retry seaslog.remote_host seaslog.remote_port</p>
		 * @return bool <p>Return TRUE on flush buffer success, FALSE on failure.</p>
		 * @link https://php.net/manual/ja/seaslog.flushbuffer.php
		 * @since PECL seaslog >=1.0.0
		 */
		 ...
		 * @link https://php.net/manual/ja/seaslog.getbasepath.php
		 * @since PECL seaslog >=1.0.0
		 */
		 ...
		 * @link https://php.net/manual/ja/seaslog.getbuffer.php
		 * @since PECL seaslog >=1.0.0
		 */
		 ...
		 * @link https://php.net/manual/ja/seaslog.getbufferenabled.php
		 * @since PECL seaslog >=1.0.0
		 */
		 ...
		 * @link https://php.net/manual/ja/seaslog.getdatetimeformat.php
		 * @since PECL seaslog >=1.0.0
		 */
		 ...
		 * @link https://php.net/manual/ja/seaslog.getlastlogger.php
		 * @since PECL seaslog >=1.0.0
		 */
		 ...
		 * @link https://php.net/manual/ja/seaslog.getrequestid.php
		 * @since PECL seaslog >=1.0.0
		 */
		 ...
		 * @link https://php.net/manual/ja/seaslog.getrequestvariable.php
		 ...
		 * <p>Record info log information.</p><p><b>注意</b>:</p><p>"INFO" - Interesting events.Emphasizes the running process of the application.</p>
		 * @param string $message <p>The log message.</p>
		 * @param array $content <p>The `message` contain placeholders which implementors replace with values from content array. Sush as `message` is `log info from {NAME}` and `content` is `array('NAME' =&gt; neeke)`, the log information will `log info from neeke`.</p>
		 * @param string $logger <p>The `logger` cased by the third param would be used right this right now, like a temp logger, when the function SeasLog::setLogger() called in pre content. If `logger` NULL or "", SeasLog will use lastest logger setted by <code>SeasLog::setLogger()</code>.</p>
		 * @return bool <p>Return TRUE on record log information success, FALSE on failure.</p>
		 * @link https://php.net/manual/ja/seaslog.info.php
		 * @since PECL seaslog >=1.0.0
		 */
		 ...
		 * @param string $logger <p>The `logger` cased by the third param would be used right this right now, like a temp logger, when the function SeasLog::setLogger() called in pre content. If `logger` NULL or "", SeasLog will use lastest logger setted by <code>SeasLog::setLogger()</code>.</p>
		 * @return bool <p>Return TRUE on record log information success, FALSE on failure.</p>
		 * @link https://php.net/manual/ja/seaslog.log.php
		 * @since PECL seaslog >=1.0.0
		 */
		 ...
		 * <p>Record notice log information.</p><p><b>注意</b>:</p><p>"NOTICE" - Normal but significant events.Information that is more important than the INFO level during execution.</p>
		 * @param string $message <p>The log message.</p>
		 * @param array $content <p>The `message` contain placeholders which implementors replace with values from content array. Sush as `message` is `log info from {NAME}` and `content` is `array('NAME' =&gt; neeke)`, the log information will `log info from neeke`.</p>
		 * @param string $logger <p>The `logger` cased by the third param would be used right this right now, like a temp logger, when the function SeasLog::setLogger() called in pre content. If `logger` NULL or "", SeasLog will use lastest logger setted by <code>SeasLog::setLogger()</code>.</p>
		 * @return bool <p>Return TRUE on record log information success, FALSE on failure.</p>
		 * @link https://php.net/manual/ja/seaslog.notice.php
		 * @since PECL seaslog >=1.0.0
		 */
		 ...
		 * @link https://php.net/manual/ja/seaslog.setbasepath.php
		 * @since PECL seaslog >=1.0.0
		 */
		 ...
		 * <p>Set SeasLog datetime format style.</p><p>この関数は、 現在のところ詳細な情報はありません。引数のリストのみが 記述されています。</p>
		 ...
		 * @link https://php.net/manual/ja/seaslog.setdatetimeformat.php
		 * @since PECL seaslog >=1.0.0
		 */
		 ...
		 * @link https://php.net/manual/ja/seaslog.setlogger.php
		 * @since PECL seaslog >=1.0.0
		 */
		 ...
		 * @link https://php.net/manual/ja/seaslog.setrequestid.php
		 * @since PECL seaslog >=1.0.0
		 */
		 ...
		 * @link https://php.net/manual/ja/seaslog.setrequestvariable.php
		 * @since PECL seaslog >=1.9.0
		 */
		 ...
		 * <p>Record warning log information.</p><p><b>注意</b>:</p><p>"WARNING" - Exceptional occurrences that are not errors. Potentially aberrant information that needs attention and needs to be repaired.</p>
		 * @param string $message <p>The log message.</p>
		 * @param array $content <p>The `message` contain placeholders which implementors replace with values from content array. Sush as `message` is `log info from {NAME}` and `content` is `array('NAME' =&gt; neeke)`, the log information will `log info from neeke`.</p>
		 * @param string $logger <p>The `logger` cased by the third param would be used right this right now, like a temp logger, when the function SeasLog::setLogger() called in pre content. If `logger` NULL or "", SeasLog will use lastest logger setted by <code>SeasLog::setLogger()</code>.</p>
		 * @return bool <p>Return TRUE on record log information success, FALSE on failure.</p>
		 * @link https://php.net/manual/ja/seaslog.warning.php
		 * @since PECL seaslog >=1.0.0
		 */
	 ...
	 * @link https://php.net/manual/ja/function.seaslog-get-author.php
	 * @since PECL seaslog >=1.0.0
	 */
	 ...
	 * @link https://php.net/manual/ja/function.seaslog-get-version.php
	 * @since PECL seaslog >=1.0.0
	 */
