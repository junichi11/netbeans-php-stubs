...
class DateInterval {
	...
	/**
	 * @var integer <p>年。</p>
	 * @link http://php.net/manual/ja/class.dateinterval.php#dateinterval.props.y
	 */
	public $y;

	/**
	 * @var integer <p>月。</p>
	 * @link http://php.net/manual/ja/class.dateinterval.php#dateinterval.props.m
	 */
	public $m;

	/**
	 * @var integer <p>日。</p>
	 * @link http://php.net/manual/ja/class.dateinterval.php#dateinterval.props.d
	 */
	public $d;

	/**
	 * @var integer <p>時間。</p>
	 * @link http://php.net/manual/ja/class.dateinterval.php#dateinterval.props.h
	 */
	public $h;

	/**
	 * @var integer <p>分。</p>
	 * @link http://php.net/manual/ja/class.dateinterval.php#dateinterval.props.i
	 */
	public $i;

	/**
	 * @var integer <p>秒。</p>
	 * @link http://php.net/manual/ja/class.dateinterval.php#dateinterval.props.s
	 */
	public $s;

	/**
	 * @var integer <p>間隔が負の数になっている場合は <i>1</i>、そうでない場合は <i>0</i>。 <code>DateInterval::format()</code> を参照ください。</p>
	 * @link http://php.net/manual/ja/class.dateinterval.php#dateinterval.props.invert
	 */
	public $invert;
	 ...
	 * @link http://php.net/manual/ja/class.dateinterval.php#dateinterval.props.days
	 */
	public $days;
