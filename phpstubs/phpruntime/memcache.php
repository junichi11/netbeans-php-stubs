...
namespace {
	 ...
	 * @link https://php.net/manual/ja/class.memcache.php
	...
	class Memcache {
		 ...
		 * @link https://php.net/manual/ja/memcache.add.php
		 ...
		 * @link https://php.net/manual/ja/memcache.addserver.php
		 ...
		 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
		 * @link https://php.net/manual/ja/memcache.close.php
		 ...
		 * @param int $timeout <p>デーモンへの接続の際に使用する値 (秒単位) です。 デフォルト値を 1 秒でも変更する前には十分注意してください。 接続が遅くなってしまうと、 キャッシュ処理のメリットが なくなってしまいます。</p>
		 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
		 * @link https://php.net/manual/ja/memcache.connect.php
		 ...
		 * @link https://php.net/manual/ja/memcache.decrement.php
		 ...
		 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
		 * @link https://php.net/manual/ja/memcache.delete.php
		 * @see Memcache::set(), Memcache::replace()
		 * @since PECL memcache >= 0.2.0
		 */
		 ...
		 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
		 * @link https://php.net/manual/ja/memcache.flush.php
		 ...
		 * @link https://php.net/manual/ja/memcache.get.php
		 * @since PECL memcache >= 0.2.0
		 */
		 ...
		 * @link https://php.net/manual/ja/memcache.getextendedstats.php
		 ...
		 * @link https://php.net/manual/ja/memcache.getserverstatus.php
		 ...
		 * @link https://php.net/manual/ja/memcache.getstats.php
		 ...
		 * @link https://php.net/manual/ja/memcache.getversion.php
		 ...
		 * @return int <p>項目の新しい値か、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
		 * @link https://php.net/manual/ja/memcache.increment.php
		 ...
		 * @link https://php.net/manual/ja/memcache.pconnect.php
		 ...
		 * @param int $expire <p>項目の有効期限。ゼロの場合は有効期限なし (いつまでも有効) となります。Unix タイムスタンプ形式、あるいは現在からの 秒数で指定することが可能ですが、後者の場合は秒数が 2592000 (30 日) を超えることはできません。</p>
		 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
		 * @link https://php.net/manual/ja/memcache.replace.php
		 ...
		 * @param int $expire <p>項目の有効期限。ゼロの場合は有効期限なし (いつまでも有効) となります。Unix タイムスタンプ形式、あるいは現在からの 秒数で指定することが可能ですが、後者の場合は秒数が 2592000 (30 日) を超えることはできません。</p>
		 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
		 * @link https://php.net/manual/ja/memcache.set.php
		 ...
		 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
		 * @link https://php.net/manual/ja/memcache.setcompressthreshold.php
		 * @since PECL memcache >= 2.0.0
		 */
		 ...
		 * @param callable $failure_callback <p>エラーが発生した際に実行されるコールバック関数を指定できるようにします。 コールバック関数は、フェイルオーバー処理の前に実行されます。 この関数は、ふたつの引数 (ホスト名、失敗したサーバーのポート) を受け取ります。</p>
		 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
		 * @link https://php.net/manual/ja/memcache.setserverparams.php
	 ...
	 * @link https://php.net/manual/ja/function.memcache-debug.php
	 * @since PECL memcache >= 0.2.0
	 */
