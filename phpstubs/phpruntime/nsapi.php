 ...
 * <p><b>nsapi_request_headers()</b> は、カレントの リクエストの HTTP ヘッダを連想配列で返します。 この関数は、PHP を NSAPI モジュールとして 実行している場合にのみサポートされます。</p><p><b>注意</b>:</p><p>PHP 4.3.3 未満では、<code>getallheaders()</code> は Apache サーバーでのみ使用可能でした。 PHP 4.3.3 以降では、NSAPI モジュールを使用している場合、 <code>getallheaders()</code> は <b>nsapi_request_headers()</b> へのエイリアスとなります。</p><p><b>注意</b>:</p><p>$_SERVER スーパーグローバル変数を使うことによって Common CGI 変数を取得することも可能です。この変数は PHP を NSAPI モジュールとして実行しているか どうかにかかわらず利用できます。</p>
 * @return array <p>HTTP ヘッダを連想配列で返します。</p>
 * @link http://php.net/manual/ja/function.nsapi-request-headers.php
 ...
 * @link http://php.net/manual/ja/function.nsapi-response-headers.php
 ...
 * @link http://php.net/manual/ja/function.nsapi-virtual.php
 * @since PHP 4 >= 4.3.3, PHP 5, PHP 7
 */
