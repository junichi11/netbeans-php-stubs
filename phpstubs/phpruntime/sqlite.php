 ...
 * @link http://php.net/manual/ja/function.sqlite-array-query.php
 ...
 * @link http://php.net/manual/ja/function.sqlite-busy-timeout.php
 * @see sqlite_open()
 * @since PHP 5 < 5.4.0, PECL sqlite >= 1.0.0
 */
 ...
 * @link http://php.net/manual/ja/function.sqlite-changes.php
 * @see sqlite_open()
 * @since PHP 5 < 5.4.0, PECL sqlite >= 1.0.0
 */
 ...
 * @return void <p>値を返しません。</p>
 * @link http://php.net/manual/ja/function.sqlite-close.php
 ...
 * @link http://php.net/manual/ja/function.sqlite-column.php
 ...
 * @return void <p>値を返しません。</p>
 * @link http://php.net/manual/ja/function.sqlite-create-aggregate.php
 ...
 * @return void <p>値を返しません。</p>
 * @link http://php.net/manual/ja/function.sqlite-create-function.php
 ...
 * @link http://php.net/manual/ja/function.sqlite-current.php
 ...
 * @link http://php.net/manual/ja/function.sqlite-error-string.php
 ...
 * @link http://php.net/manual/ja/function.sqlite-escape-string.php
 ...
 * @link http://php.net/manual/ja/function.sqlite-exec.php
 ...
 * @link http://php.net/manual/ja/function.sqlite-factory.php
 * @see sqlite_open(), sqlite_popen()
 * @since PHP 5 < 5.4.0
 */
 ...
 * @link http://php.net/manual/ja/function.sqlite-fetch-all.php
 ...
 * @link http://php.net/manual/ja/function.sqlite-fetch-array.php
 ...
 * @link http://php.net/manual/ja/function.sqlite-fetch-column-types.php
 * @since PHP 5 < 5.4.0
 */
 ...
 * @return object
 * @link http://php.net/manual/ja/function.sqlite-fetch-object.php
 * @since PHP 5 < 5.4.0
 */
 ...
 * @link http://php.net/manual/ja/function.sqlite-fetch-single.php
 * @see sqlite_fetch_array()
 ...
 * @param bool $decode_binary <p><code>decode_binary</code> パラメータが <b><code>TRUE</code></b> (デフォルト)に 設定された場合、PHP はバイナリエンコーディングをデコードします。 これは、<code>sqlite_escape_string()</code> によりエンコードされたデータに 適用されます。sqlite をサポートする他のアプリケーションにより 作成されたデータベースを処理する時以外は、この値をデフォルトのままにしておくべきです。</p>
 * @return string
 * @link http://php.net/manual/ja/function.sqlite-fetch-string.php
 * @since PHP 5 < 5.4.0, PECL sqlite >= 1.0.0
 */
 ...
 * @link http://php.net/manual/ja/function.sqlite-field-name.php
 * @since PHP 5 < 5.4.0, PECL sqlite >= 1.0.0
 */
 ...
 * @link http://php.net/manual/ja/function.sqlite-has-more.php
 ...
 * @link http://php.net/manual/ja/function.sqlite-has-prev.php
 ...
 * @link http://php.net/manual/ja/function.sqlite-key.php
 ...
 * @link http://php.net/manual/ja/function.sqlite-last-error.php
 ...
 * @link http://php.net/manual/ja/function.sqlite-last-insert-rowid.php
 * @since PHP 5 < 5.4.0, PECL sqlite >= 1.0.0
 */
 ...
 * @link http://php.net/manual/ja/function.sqlite-libencoding.php
 * @since PHP 5 < 5.4.0, PECL sqlite >= 1.0.0
 */
 ...
 * @link http://php.net/manual/ja/function.sqlite-libversion.php
 ...
 * @link http://php.net/manual/ja/function.sqlite-next.php
 ...
 * @link http://php.net/manual/ja/function.sqlite-num-fields.php
 ...
 * @link http://php.net/manual/ja/function.sqlite-num-rows.php
 ...
 * @link http://php.net/manual/ja/function.sqlite-open.php
 ...
 * @param string $error_message <p>参照として渡され、エラーが発生した場合に データベースがオープンできなかった原因を説明する 記述的なエラーメッセージを保持するために設定されます。</p>
 * @return resource <p>成功時にリソース (データベースハンドル)、失敗時に <b><code>FALSE</code></b> を返します。</p>
 * @link http://php.net/manual/ja/function.sqlite-popen.php
 ...
 * @param resource $result <p>SQLite 結果リソース。 このパラメータは、 オブジェクト指向言語型メソッドを使用する場合は不要です。</p>  <p><b>注意</b>:</p> <p>この関数は、 バッファなしの結果ハンドルで使用することはできません。</p>
 * @return bool <p>成功時は <b><code>TRUE</code></b>、もしレコードがない場合は <b><code>FALSE</code></b> を返します。</p>
 * @link http://php.net/manual/ja/function.sqlite-prev.php
 ...
 * @link http://php.net/manual/ja/function.sqlite-query.php
 ...
 * @link http://php.net/manual/ja/function.sqlite-rewind.php
 ...
 * @link http://php.net/manual/ja/function.sqlite-seek.php
 * @see sqlite_next(), sqlite_current(), sqlite_rewind()
 * @since PHP 5 < 5.4.0, PECL sqlite >= 1.0.0
 */
 ...
 * @param bool $decode_binary
 * @return array
 * @link http://php.net/manual/ja/function.sqlite-single-query.php
 * @since PHP 5 < 5.4.0, PECL sqlite >= 1.0.1
 */
 ...
 * @link http://php.net/manual/ja/function.sqlite-udf-decode-binary.php
 ...
 * @link http://php.net/manual/ja/function.sqlite-udf-encode-binary.php
 ...
 * @link http://php.net/manual/ja/function.sqlite-unbuffered-query.php
 * @see sqlite_query()
 * @since PHP 5 < 5.4.0, PECL sqlite >= 1.0.0
 */
 ...
 * @link http://php.net/manual/ja/function.sqlite-valid.php
 * @see sqlite_num_rows(), sqlite_changes()
 * @since PHP 5 < 5.4.0
 */
