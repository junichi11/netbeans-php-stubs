...
namespace {
	 ...
	 * @link https://php.net/manual/ja/function.mysql-affected-rows.php
	 ...
	 * @link https://php.net/manual/ja/function.mysql-client-encoding.php
	 ...
	 * @link https://php.net/manual/ja/function.mysql-close.php
	 ...
	 * @link https://php.net/manual/ja/function.mysql-connect.php
	 ...
	 * @param resource $link_identifier <p>MySQL 接続。 指定されない場合、<code>mysql_connect()</code> により直近にオープンされたリンクが 指定されたと仮定されます。そのようなリンクがない場合、引数を指定せずに <code>mysql_connect()</code> がコールした時と同様にリンクを確立します。 リンクが見付からない、または、確立できない場合、 <b><code>E_WARNING</code></b> レベルのエラーが生成されます。</p>
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.mysql-create-db.php
	 ...
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.mysql-data-seek.php
	 ...
	 * @link https://php.net/manual/ja/function.mysql-db-name.php
	 ...
	 * @link https://php.net/manual/ja/function.mysql-db-query.php
	 * @see mysql_query(), mysql_select_db()
	 * @since PHP 4, PHP 5
	 */
	 ...
	 * @param resource $link_identifier <p>MySQL 接続。 指定されない場合、<code>mysql_connect()</code> により直近にオープンされたリンクが 指定されたと仮定されます。そのようなリンクがない場合、引数を指定せずに <code>mysql_connect()</code> がコールした時と同様にリンクを確立します。 リンクが見付からない、または、確立できない場合、 <b><code>E_WARNING</code></b> レベルのエラーが生成されます。</p>
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.mysql-drop-db.php
	 * @see mysql_query()
	 * @since PHP 4, PHP 5
	 */
	 ...
	 * @link https://php.net/manual/ja/function.mysql-errno.php
	 * @see mysql_error()
	 * @since PHP 4, PHP 5
	 */
	 ...
	 * @link https://php.net/manual/ja/function.mysql-error.php
	 * @see mysql_errno()
	 * @since PHP 4, PHP 5
	 */
	 ...
	 * @link https://php.net/manual/ja/function.mysql-escape-string.php
	 ...
	 * @link https://php.net/manual/ja/function.mysql-fetch-array.php
	 ...
	 * @link https://php.net/manual/ja/function.mysql-fetch-assoc.php
	 ...
	 * @link https://php.net/manual/ja/function.mysql-fetch-field.php
	 ...
	 * @link https://php.net/manual/ja/function.mysql-fetch-lengths.php
	 ...
	 * @link https://php.net/manual/ja/function.mysql-fetch-object.php
	 ...
	 * @link https://php.net/manual/ja/function.mysql-fetch-row.php
	 ...
	 * @link https://php.net/manual/ja/function.mysql-field-flags.php
	 ...
	 * @link https://php.net/manual/ja/function.mysql-field-len.php
	 ...
	 * @link https://php.net/manual/ja/function.mysql-field-name.php
	 * @see mysql_field_type(), mysql_field_len()
	 * @since PHP 4, PHP 5
	 */
	 ...
	 * @param int $field_offset <p>数値フィールドオフセット。 <code>field_offset</code> は <i>0</i> から始まります。 <code>field_offset</code> が存在しない場合、 <b><code>E_WARNING</code></b> レベルのエラーが発行されます。</p>
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.mysql-field-seek.php
	 ...
	 * @link https://php.net/manual/ja/function.mysql-field-table.php
	 ...
	 * @link https://php.net/manual/ja/function.mysql-field-type.php
	 ...
	 * @link https://php.net/manual/ja/function.mysql-free-result.php
	 ...
	 * @link https://php.net/manual/ja/function.mysql-get-client-info.php
	 ...
	 * @link https://php.net/manual/ja/function.mysql-get-host-info.php
	 ...
	 * @link https://php.net/manual/ja/function.mysql-get-proto-info.php
	 ...
	 * @link https://php.net/manual/ja/function.mysql-get-server-info.php
	 ...
	 * @link https://php.net/manual/ja/function.mysql-info.php
	 ...
	 * @link https://php.net/manual/ja/function.mysql-insert-id.php
	 ...
	 * @link https://php.net/manual/ja/function.mysql-list-dbs.php
	 ...
	 * @link https://php.net/manual/ja/function.mysql-list-fields.php
	 ...
	 * @link https://php.net/manual/ja/function.mysql-list-processes.php
	 ...
	 * @link https://php.net/manual/ja/function.mysql-list-tables.php
	 * @see mysql_list_dbs(), mysql_tablename()
	 * @since PHP 4, PHP 5
	 */
	 ...
	 * @link https://php.net/manual/ja/function.mysql-num-fields.php
	 ...
	 * @link https://php.net/manual/ja/function.mysql-num-rows.php
	 ...
	 * @link https://php.net/manual/ja/function.mysql-pconnect.php
	 * @see mysql_connect()
	 * @since PHP 4, PHP 5
	 */
	 ...
	 * @link https://php.net/manual/ja/function.mysql-ping.php
	 ...
	 * @link https://php.net/manual/ja/function.mysql-query.php
	 ...
	 * @link https://php.net/manual/ja/function.mysql-real-escape-string.php
	 ...
	 * @link https://php.net/manual/ja/function.mysql-result.php
	 ...
	 * @param resource $link_identifier <p>MySQL 接続。 指定されない場合、<code>mysql_connect()</code> により直近にオープンされたリンクが 指定されたと仮定されます。そのようなリンクがない場合、引数を指定せずに <code>mysql_connect()</code> がコールした時と同様にリンクを確立します。 リンクが見付からない、または、確立できない場合、 <b><code>E_WARNING</code></b> レベルのエラーが生成されます。</p>
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.mysql-select-db.php
	 ...
	 * @param resource $link_identifier <p>MySQL 接続。 指定されない場合、<code>mysql_connect()</code> により直近にオープンされたリンクが 指定されたと仮定されます。そのようなリンクがない場合、引数を指定せずに <code>mysql_connect()</code> がコールした時と同様にリンクを確立します。 リンクが見付からない、または、確立できない場合、 <b><code>E_WARNING</code></b> レベルのエラーが生成されます。</p>
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.mysql-set-charset.php
	 ...
	 * @link https://php.net/manual/ja/function.mysql-stat.php
	 ...
	 * @link https://php.net/manual/ja/function.mysql-tablename.php
	 ...
	 * @link https://php.net/manual/ja/function.mysql-thread-id.php
	 ...
	 * @link https://php.net/manual/ja/function.mysql-unbuffered-query.php
	 * @see mysql_query()
