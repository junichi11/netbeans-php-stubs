...
class libXMLError {
	 ...
	 * @link http://php.net/manual/ja/class.libxmlerror.php#libxmlerror.props.level
	 */
	public $level;

	/**
	 * @var int <p>エラーコード。</p>
	 * @link http://php.net/manual/ja/class.libxmlerror.php#libxmlerror.props.code
	 */
	public $code;

	/**
	 * @var int <p>エラーが発生した列。</p>  <p><b>注意</b>:</p> <p>このプロパティは libxml で完全には実装されておらず、しばしば <i>0</i> が返されることがあります。</p>
	 * @link http://php.net/manual/ja/class.libxmlerror.php#libxmlerror.props.column
	 */
	public $column;

	/**
	 * @var string <p>エラーメッセージ (存在する場合)。</p>
	 * @link http://php.net/manual/ja/class.libxmlerror.php#libxmlerror.props.message
	 */
	public $message;

	/**
	 * @var string <p>ファイル名。XML を文字列から読み込んだ場合は空文字列。</p>
	 * @link http://php.net/manual/ja/class.libxmlerror.php#libxmlerror.props.file
	 */
	public $file;

	/**
	 * @var int <p>エラーが発生した行。</p>
	 * @link http://php.net/manual/ja/class.libxmlerror.php#libxmlerror.props.line
	 */
	public $line;
}
