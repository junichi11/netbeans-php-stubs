...
namespace {
	 ...
	 * @link https://php.net/manual/ja/class.weakreference.php
	 * @since PHP 7 >= 7.4.0
	 */
	class WeakReference {
		 ...
		 * @return self
		 * @link https://php.net/manual/ja/weakreference.construct.php
		 * @since PHP 7 >= 7.4.0
		 */
		 ...
		 * @link https://php.net/manual/ja/weakreference.create.php
		 * @since PHP 7 >= 7.4.0
		 */
		 ...
		 * @link https://php.net/manual/ja/weakreference.get.php
		 * @since PHP 7 >= 7.4.0
		 */
