...
namespace {
	 ...
	 * @link https://php.net/manual/ja/class.php-user-filter.php
	 * @since PHP 5, PHP 7
	 */
	class php_user_filter {
		 ...
		 * @link https://php.net/manual/ja/class.php-user-filter.php#php-user-filter.props.filtername
		 */
		public $filtername;

		/**
		 * @var mixed
		 * @link https://php.net/manual/ja/class.php-user-filter.php#php-user-filter.props.params
		 */
		public $params;
		 ...
		 * @link https://php.net/manual/ja/php-user-filter.filter.php
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * @link https://php.net/manual/ja/php-user-filter.onclose.php
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * @link https://php.net/manual/ja/php-user-filter.oncreate.php
		 * @since PHP 5, PHP 7
		 */
	 ...
	 * @link https://php.net/manual/ja/class.streamwrapper.php
	...
	class streamWrapper {
		 ...
		 * @link https://php.net/manual/ja/class.streamwrapper.php#streamwrapper.props.context
		 */
		public $context;
		 ...
		 * @return self
		 * @link https://php.net/manual/ja/streamwrapper.construct.php
		 * @since PHP 4 >= 4.3.2, PHP 5, PHP 7
		 */
		 ...
		 * @return void
		 * @link https://php.net/manual/ja/streamwrapper.destruct.php
		 * @since PHP 4 >= 4.3.2, PHP 5, PHP 7
		 */
		 ...
		 * @link https://php.net/manual/ja/streamwrapper.dir-closedir.php
		 * @see closedir()
		 * @since PHP 4 >= 4.3.2, PHP 5, PHP 7
		 */
		 ...
		 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
		 * @link https://php.net/manual/ja/streamwrapper.dir-opendir.php
		 ...
		 * @link https://php.net/manual/ja/streamwrapper.dir-readdir.php
		 * @see readdir()
		 * @since PHP 4 >= 4.3.2, PHP 5, PHP 7
		 */
		 ...
		 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
		 * @link https://php.net/manual/ja/streamwrapper.dir-rewinddir.php
		 * @see rewinddir()
		 * @since PHP 4 >= 4.3.2, PHP 5, PHP 7
		 */
		 ...
		 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
		 * @link https://php.net/manual/ja/streamwrapper.mkdir.php
		 * @see mkdir()
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
		 * @link https://php.net/manual/ja/streamwrapper.rename.php
		 * @see rename()
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * @param int $options <p><b><code>STREAM_MKDIR_RECURSIVE</code></b> などの値のビットマスク。</p>
		 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
		 * @link https://php.net/manual/ja/streamwrapper.rmdir.php
		 * @see rmdir()
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * @link https://php.net/manual/ja/streamwrapper.stream-cast.php
		 * @see stream_select()
		 ...
		 * @link https://php.net/manual/ja/streamwrapper.stream-close.php
		 * @see fclose()
		 * @since PHP 4 >= 4.3.2, PHP 5, PHP 7
		 */
		 ...
		 * @link https://php.net/manual/ja/streamwrapper.stream-eof.php
		 * @see feof()
		 * @since PHP 4 >= 4.3.2, PHP 5, PHP 7
		 */
		 ...
		 * @link https://php.net/manual/ja/streamwrapper.stream-flush.php
		 * @see fflush()
		 * @since PHP 4 >= 4.3.2, PHP 5, PHP 7
		 */
		 ...
		 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
		 * @link https://php.net/manual/ja/streamwrapper.stream-lock.php
		 ...
		 * @link https://php.net/manual/ja/streamwrapper.stream-metadata.php
		 ...
		 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
		 * @link https://php.net/manual/ja/streamwrapper.stream-open.php
		 * @see fopen(), parse_url()
		 * @since PHP 4 >= 4.3.2, PHP 5, PHP 7
		 */
		 ...
		 * @link https://php.net/manual/ja/streamwrapper.stream-read.php
		 * @see fread(), fgets()
		 * @since PHP 4 >= 4.3.2, PHP 5, PHP 7
		 */
		 ...
		 * @link https://php.net/manual/ja/streamwrapper.stream-seek.php
		 * @see fseek()
		 * @since PHP 4 >= 4.3.2, PHP 5, PHP 7
		 */
		 ...
		 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。 <code>option</code> が実装されていない場合は <b><code>FALSE</code></b> を返さなければなりません。</p>
		 * @link https://php.net/manual/ja/streamwrapper.stream-set-option.php
		 ...
		 * @link https://php.net/manual/ja/streamwrapper.stream-stat.php
		 * @see stat()
		 * @since PHP 4 >= 4.3.2, PHP 5, PHP 7
		 */
		 ...
		 * @link https://php.net/manual/ja/streamwrapper.stream-tell.php
		 * @since PHP 4 >= 4.3.2, PHP 5, PHP 7
		 */
		 ...
		 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
		 * @link https://php.net/manual/ja/streamwrapper.stream-truncate.php
		 * @see ftruncate()
		 * @since PHP 5 >= 5.4.0, PHP 7
		 */
		 ...
		 * @link https://php.net/manual/ja/streamwrapper.stream-write.php
		 * @see fwrite()
		 * @since PHP 4 >= 4.3.2, PHP 5, PHP 7
		 */
		 ...
		 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
		 * @link https://php.net/manual/ja/streamwrapper.unlink.php
		 * @see unlink()
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * @link https://php.net/manual/ja/streamwrapper.url-stat.php
		 * @see stat()
		 * @since PHP 4 >= 4.3.2, PHP 5, PHP 7
		 */
	 ...
	 * @return bool
	 * @link https://php.net/manual/ja/function.set-socket-blocking.php
	 * @since PHP 4, PHP 5
	 */
	 ...
	 * @param object $bucket
	 * @return void
	 * @link https://php.net/manual/ja/function.stream-bucket-append.php
	 * @since PHP 5, PHP 7
	 */
	 ...
	 * @param resource $brigade
	 * @return object
	 * @link https://php.net/manual/ja/function.stream-bucket-make-writeable.php
	 * @since PHP 5, PHP 7
	 */
	 ...
	 * @param string $buffer
	 * @return object
	 * @link https://php.net/manual/ja/function.stream-bucket-new.php
	 * @since PHP 5, PHP 7
	 */
	 ...
	 * @return void <p>値を返しません。</p>
	 * @link https://php.net/manual/ja/function.stream-bucket-prepend.php
	 * @since PHP 5, PHP 7
	 */
	 ...
	 * @param array $params <p><i>$arr['parameter'] = $value</i> 形式の連想配列でなくてはなりません。 標準のストリームパラメータについては コンテキストパラメータ を参照ください。</p>
	 * @return resource <p>ストリームコンテキストリソースを返します。</p>
	 * @link https://php.net/manual/ja/function.stream-context-create.php
	 ...
	 * @return resource <p>ストリームコンテキストリソースを返します。</p>
	 * @link https://php.net/manual/ja/function.stream-context-get-default.php
	 ...
	 * @link https://php.net/manual/ja/function.stream-context-get-options.php
	 * @since PHP 4 >= 4.3.0, PHP 5, PHP 7
	 */
	 ...
	 * @link https://php.net/manual/ja/function.stream-context-get-params.php
	 ...
	 * @link https://php.net/manual/ja/function.stream-context-set-default.php
	 ...
	 * @param mixed $value
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.stream-context-set-option.php
	 * @since PHP 4 >= 4.3.0, PHP 5, PHP 7
	 */
	 ...
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.stream-context-set-params.php
	 ...
	 * @link https://php.net/manual/ja/function.stream-copy-to-stream.php
	 * @see copy()
	 * @since PHP 5, PHP 7
	 */
	 ...
	 * @link https://php.net/manual/ja/function.stream-filter-append.php
	 ...
	 * @return resource <p>成功した場合にリソース、失敗した場合に <b><code>FALSE</code></b> を返します。 このリソースは、<code>stream_filter_remove()</code> をコールする際にこのフィルタインスタンスを参照するために使用可能です。</p><p><b><code>FALSE</code></b> が返されるのは、<code>stream</code> がリソースではない場合や <code>filtername</code> が見つからない場合です。</p>
	 * @link https://php.net/manual/ja/function.stream-filter-prepend.php
	 ...
	 * @link https://php.net/manual/ja/function.stream-filter-register.php
	 ...
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.stream-filter-remove.php
	 ...
	 * @link https://php.net/manual/ja/function.stream-get-contents.php
	 ...
	 * @link https://php.net/manual/ja/function.stream-get-filters.php
	 ...
	 * @link https://php.net/manual/ja/function.stream-get-line.php
	 ...
	 * @link https://php.net/manual/ja/function.stream-get-meta-data.php
	 * @see get_headers()
	 * @since PHP 4 >= 4.3.0, PHP 5, PHP 7
	 */
	 ...
	 * @link https://php.net/manual/ja/function.stream-get-transports.php
	 ...
	 * @link https://php.net/manual/ja/function.stream-get-wrappers.php
	 ...
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.stream-is-local.php
	 ...
	 * @param resource $stream
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.stream-isatty.php
	 * @since PHP 7 >= 7.2.0
	 */
	 ...
	 * @return void <p>値を返しません。</p>
	 * @link https://php.net/manual/ja/function.stream-notification-callback.php
	 ...
	 * @return bool
	 * @link https://php.net/manual/ja/function.stream-register-wrapper.php
	 * @since PHP 4 >= 4.3.0, PHP 5, PHP 7
	 */
	 ...
	 * @link https://php.net/manual/ja/function.stream-resolve-include-path.php
	 ...
	 * @link https://php.net/manual/ja/function.stream-select.php
	 ...
	 * @param bool $mode <p><code>mode</code> が <b><code>FALSE</code></b> の時、ストリームは 非ブロックモードに切り替えられ、<b><code>TRUE</code></b> の場合は、 ブロックモードに切り替えられます。このモードの違いは、 <code>fgets()</code> や <code>fread()</code> といった、ストリームからデータを読む関数に影響します。 非ブロックモードにおいては <code>fgets()</code> を呼び出すと どんな場合でもただちに呼び出し元に戻りますが、ブロックモードの場合では、 ストリームがデータを読み出せる状態になるまで待ちつづけます。</p>
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.stream-set-blocking.php
	 * @see stream_select()
	 * @since PHP 4 >= 4.3.0, PHP 5, PHP 7
	 */
	 ...
	 * @link https://php.net/manual/ja/function.stream-set-chunk-size.php
	 * @since PHP 5 >= 5.4.0, PHP 7
	 */
	 ...
	 * @link https://php.net/manual/ja/function.stream-set-read-buffer.php
	 ...
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.stream-set-timeout.php
	 * @see fsockopen(), fopen()
	 * @since PHP 4 >= 4.3.0, PHP 5, PHP 7
	 */
	 ...
	 * @return int <p>成功時に 0 を、要求通りに設定できなかった場合はそれ以外の値を返します。</p>
	 * @link https://php.net/manual/ja/function.stream-set-write-buffer.php
	 * @see fopen(), fwrite()
	 * @since PHP 4 >= 4.3.0, PHP 5, PHP 7
	 */
	 ...
	 * @link https://php.net/manual/ja/function.stream-socket-accept.php
	 ...
	 * @link https://php.net/manual/ja/function.stream-socket-client.php
	 ...
	 * @link https://php.net/manual/ja/function.stream-socket-enable-crypto.php
	 * @since PHP 5 >= 5.1.0, PHP 7
	 */
	 ...
	 * @link https://php.net/manual/ja/function.stream-socket-get-name.php
	 ...
	 * @link https://php.net/manual/ja/function.stream-socket-pair.php
	 * @since PHP 5 >= 5.1.0, PHP 7
	 */
	 ...
	 * @link https://php.net/manual/ja/function.stream-socket-recvfrom.php
	 ...
	 * @link https://php.net/manual/ja/function.stream-socket-sendto.php
	 ...
	 * @link https://php.net/manual/ja/function.stream-socket-server.php
	 ...
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.stream-socket-shutdown.php
	 * @see fclose()
	 ...
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.stream-supports-lock.php
	 * @see flock()
	 * @since PHP 5 >= 5.3.0, PHP 7
	 */
	 ...
	 * @link https://php.net/manual/ja/function.stream-wrapper-register.php
	 ...
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.stream-wrapper-restore.php
	 * @since PHP 5 >= 5.1.0, PHP 7
	 */
	 ...
	 * @param string $protocol
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.stream-wrapper-unregister.php
	 * @since PHP 5 >= 5.1.0, PHP 7
	 */
