...
namespace {
	 ...
	 * @link https://php.net/manual/ja/function.phpdbg-break-file.php
	 ...
	 * @return void <p>値を返しません。</p>
	 * @link https://php.net/manual/ja/function.phpdbg-break-function.php
	 ...
	 * @return void <p>値を返しません。</p>
	 * @link https://php.net/manual/ja/function.phpdbg-break-method.php
	 ...
	 * @return void <p>値を返しません。</p>
	 * @link https://php.net/manual/ja/function.phpdbg-break-next.php
	 ...
	 * <p>Clear all breakpoints that have been set, either via one of the <b>phpdbg_break_&#42;()</b> functions or interactively in the console.</p><p>この関数は、 現在のところ詳細な情報はありません。引数のリストのみが 記述されています。</p>
	 * @return void <p>値を返しません。</p>
	 * @link https://php.net/manual/ja/function.phpdbg-clear.php
	 ...
	 * @return void <p>値を返しません。</p>
	 * @link https://php.net/manual/ja/function.phpdbg-color.php
	 * @see phpdbg_prompt()
	 * @since PHP 5 >= 5.6.0, PHP 7
	 */
	 ...
	 * @param array $options
	 * @return array
	 * @link https://php.net/manual/ja/function.phpdbg-end-oplog.php
	 * @since PHP 7
	 */
	 ...
	 * @link https://php.net/manual/ja/function.phpdbg-exec.php
	 * @since PHP 5 >= 5.6.0, PHP 7
	 */
	 ...
	 * @param array $options
	 * @return array
	 * @link https://php.net/manual/ja/function.phpdbg-get-executable.php
	 * @since PHP 7
	 */
	 ...
	 * @return void <p>値を返しません。</p>
	 * @link https://php.net/manual/ja/function.phpdbg-prompt.php
	 * @see phpdbg_color()
	 * @since PHP 5 >= 5.6.0, PHP 7
	 */
	 ...
	 * <p></p><p>この関数は、 現在のところ詳細な情報はありません。引数のリストのみが 記述されています。</p>
	 * @return void <p>値を返しません。</p>
	 * @link https://php.net/manual/ja/function.phpdbg-start-oplog.php
	 * @since PHP 7
	 */
