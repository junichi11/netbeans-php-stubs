...
/**
 * @link http://php.net/manual/ja/class.yar-client.php
...
class Yar_Client {
	...
	/**
	 * @var mixed
	 * @link http://php.net/manual/ja/class.yar-client.php#yar-client.props.protocol
	 */
	protected $_protocol;

	/**
	 * @var mixed
	 * @link http://php.net/manual/ja/class.yar-client.php#yar-client.props.uri
	 */
	protected $_uri;

	/**
	 * @var mixed
	 * @link http://php.net/manual/ja/class.yar-client.php#yar-client.props.options
	 */
	protected $_options;

	/**
	 * @var mixed
	 * @link http://php.net/manual/ja/class.yar-client.php#yar-client.props.running
	 */
	protected $_running;
	 ...
	 * @return void
	 * @link http://php.net/manual/ja/yar-client.call.php
	 ...
	 * @link http://php.net/manual/ja/yar-client.construct.php
	 * @since PECL yar >= 1.0.0
	 */
	 ...
	 * @link http://php.net/manual/ja/yar-client.setopt.php
	 * @since PECL yar >= 1.0.0
	 */
...
/**
 * @link http://php.net/manual/ja/class.yar-client-exception.php
 * @since バージョン情報なし。おそらく SVN 版にしか存在しないでしょう
 */
class Yar_Client_Exception extends \Exception {
	 ...
	 * @link http://php.net/manual/ja/yar-client-exception.gettype.php
	 * @since PECL yar >= 1.0.0
	 */
...
/**
 * @link http://php.net/manual/ja/class.yar-concurrent-client.php
 * @since バージョン情報なし。おそらく SVN 版にしか存在しないでしょう
 */
class Yar_Concurrent_Client {
	...
	/**
	 * @var mixed
	 * @link http://php.net/manual/ja/class.yar-concurrent-client.php#yar-concurrent-client.props.callstack
	 */
	static $_callstack;

	/**
	 * @var mixed
	 * @link http://php.net/manual/ja/class.yar-concurrent-client.php#yar-concurrent-client.props.callback
	 */
	static $_callback;

	/**
	 * @var mixed
	 * @link http://php.net/manual/ja/class.yar-concurrent-client.php#yar-concurrent-client.props.error-callback
	 */
	 ...
	 * @link http://php.net/manual/ja/yar-concurrent-client.call.php
	 * @since PECL yar >= 1.0.0
	 */
	 ...
	 * @return bool
	 * @link http://php.net/manual/ja/yar-concurrent-client.loop.php
	 * @since PECL yar >= 1.0.0
	 */
	 ...
	 * @return bool
	 * @link http://php.net/manual/ja/yar-concurrent-client.reset.php
...
/**
 * @link http://php.net/manual/ja/class.yar-server.php
 * @since バージョン情報なし。おそらく SVN 版にしか存在しないでしょう
 */
class Yar_Server {
	...
	/**
	 * @var mixed
	 * @link http://php.net/manual/ja/class.yar-server.php#yar-server.props.executor
	 */
	protected $_executor;
	 ...
	 * @link http://php.net/manual/ja/yar-server.construct.php
	 * @since PECL yar >= 1.0.0
	 */
	 ...
	 * @link http://php.net/manual/ja/yar-server.handle.php
	 * @since PECL yar >= 1.0.0
	 */
 ...
 * @link http://php.net/manual/ja/class.yar-server-exception.php
 * @since バージョン情報なし。おそらく SVN 版にしか存在しないでしょう
 */
class Yar_Server_Exception extends \Exception {
	...
	/**
	 * @var mixed
	 * @link http://php.net/manual/ja/class.yar-server-exception.php#yar-server-exception.props.type
	 */
	protected $_type;
	 ...
	 * @link http://php.net/manual/ja/yar-server-exception.gettype.php
	 * @since PECL yar >= 1.0.0
	 */
	public function getType(): string {}
}
