...
/**
 * @link http://php.net/manual/ja/class.zmq.php
...
class ZMQ {
	 ...
	 * @return self
	 * @link http://php.net/manual/ja/zmq.construct.php
...
/**
 * @link http://php.net/manual/ja/class.zmqcontext.php
 * @since バージョン情報なし。おそらく SVN 版にしか存在しないでしょう
 */
class ZMQContext {
	 ...
	 * @link http://php.net/manual/ja/zmqcontext.construct.php
	 * @since PECL zmq >= 0.5.0
	 */
	 ...
	 * @link http://php.net/manual/ja/zmqcontext.getopt.php
	 ...
	 * @link http://php.net/manual/ja/zmqcontext.getsocket.php
	 * @since PECL zmq >= 0.5.0
	 */
	 ...
	 * @link http://php.net/manual/ja/zmqcontext.ispersistent.php
	 * @since PECL zmq >= 0.5.0
	 */
	 ...
	 * @link http://php.net/manual/ja/zmqcontext.setopt.php
	 * @since PECL zmq >= 1.0.4
	 */
...
/**
 * @link http://php.net/manual/ja/class.zmqdevice.php
 * @since バージョン情報なし。おそらく SVN 版にしか存在しないでしょう
 */
class ZMQDevice {
	 ...
	 * @link http://php.net/manual/ja/zmqdevice.construct.php
	 * @since PECL zmq >= 0.5.0
	 */
	 ...
	 * @link http://php.net/manual/ja/zmqdevice.getidletimeout.php
	 * @since バージョン情報なし。おそらく SVN 版にしか存在しないでしょう
	 */
	 ...
	 * @link http://php.net/manual/ja/zmqdevice.gettimertimeout.php
	 * @since バージョン情報なし。おそらく SVN 版にしか存在しないでしょう
	 */
	 ...
	 * @link http://php.net/manual/ja/zmqdevice.run.php
	 * @since バージョン情報なし。おそらく SVN 版にしか存在しないでしょう
	 */
	 ...
	 * @link http://php.net/manual/ja/zmqdevice.setidlecallback.php
	 * @since バージョン情報なし。おそらく SVN 版にしか存在しないでしょう
	 */
	 ...
	 * @return ZMQDevice <p>On success this method returns the current object.</p>
	 * @link http://php.net/manual/ja/zmqdevice.setidletimeout.php
	 * @since バージョン情報なし。おそらく SVN 版にしか存在しないでしょう
	 */
	 ...
	 * @param mixed $user_data <p>Additional data to pass to the callback function.</p>
	 * @return ZMQDevice <p>On success this method returns the current object.</p>
	 * @link http://php.net/manual/ja/zmqdevice.settimercallback.php
	 * @since バージョン情報なし。おそらく SVN 版にしか存在しないでしょう
	 */
	 ...
	 * @return ZMQDevice <p>On success this method returns the current object.</p>
	 * @link http://php.net/manual/ja/zmqdevice.settimertimeout.php
	 * @since バージョン情報なし。おそらく SVN 版にしか存在しないでしょう
	 */
...
/**
 * @link http://php.net/manual/ja/class.zmqpoll.php
 * @since バージョン情報なし。おそらく SVN 版にしか存在しないでしょう
 */
class ZMQPoll {
	 ...
	 * @link http://php.net/manual/ja/zmqpoll.add.php
	 * @since PECL zmq >= 0.5.0
	 */
	 ...
	 * @link http://php.net/manual/ja/zmqpoll.clear.php
	 * @since PECL zmq >= 0.5.0
	 */
	 ...
	 * @link http://php.net/manual/ja/zmqpoll.count.php
	 * @since PECL zmq >= 0.5.0
	 */
	 ...
	 * @link http://php.net/manual/ja/zmqpoll.getlasterrors.php
	 * @since PECL zmq >= 0.5.0
	 */
	 ...
	 * @link http://php.net/manual/ja/zmqpoll.poll.php
	 * @since PECL zmq >= 0.5.0
	 */
	 ...
	 * @link http://php.net/manual/ja/zmqpoll.remove.php
	 * @since PECL zmq >= 0.5.0
	 */
...
/**
 * @link http://php.net/manual/ja/class.zmqsocket.php
 * @since バージョン情報なし。おそらく SVN 版にしか存在しないでしょう
 */
class ZMQSocket {
	 ...
	 * @link http://php.net/manual/ja/zmqsocket.construct.php
	 * @since PECL zmq >= 0.5.0
	 */
	 ...
	 * @link http://php.net/manual/ja/zmqsocket.bind.php
	 * @since PECL zmq >= 0.5.0
	 */
	 ...
	 * @return ZMQSocket <p>Returns the current object. Throws ZMQSocketException on error.</p>
	 * @link http://php.net/manual/ja/zmqsocket.connect.php
	 * @since PECL zmq >= 0.5.0
	 */
	 ...
	 * @param string $dsn <p>The connect dsn, for example <i>transport://address</i>.</p>
	 * @return ZMQSocket <p>Returns the current object. Throws ZMQSocketException on error.</p>
	 * @link http://php.net/manual/ja/zmqsocket.disconnect.php
	 * @since PECL zmq >= 1.0.4
	 */
	 ...
	 * @link http://php.net/manual/ja/zmqsocket.getendpoints.php
	 * @since PECL zmq >= 0.5.0
	 */
	 ...
	 * @link http://php.net/manual/ja/zmqsocket.getpersistentid.php
	 * @since PECL zmq >= 0.5.0
	 */
	 ...
	 * @link http://php.net/manual/ja/zmqsocket.getsockopt.php
	 * @since PECL zmq >= 0.5.0
	 */
	 ...
	 * @link http://php.net/manual/ja/zmqsocket.getsockettype.php
	 * @since PECL zmq >= 0.5.0
	 */
	 ...
	 * @link http://php.net/manual/ja/zmqsocket.ispersistent.php
	 * @since PECL zmq >= 0.5.0
	 */
	public function isPersistent(): bool {}
	 ...
	 * @link http://php.net/manual/ja/zmqsocket.recv.php
	 * @since PECL zmq >= 0.5.0
	 */
	 ...
	 * @link http://php.net/manual/ja/zmqsocket.recvmulti.php
	 ...
	 * @link http://php.net/manual/ja/zmqsocket.send.php
	 * @since PECL zmq >= 0.5.0
	 */
	 ...
	 * @param mixed $value <p>The value of the parameter.</p>
	 * @return ZMQSocket <p>Returns the current object. Throws ZMQSocketException on error.</p>
	 * @link http://php.net/manual/ja/zmqsocket.setsockopt.php
	 * @since PECL zmq >= 0.5.0
	 */
	 ...
	 * @return ZMQSocket <p>Returns the current object. Throws ZMQSocketException on error.</p>
	 * @link http://php.net/manual/ja/zmqsocket.unbind.php
	 * @since PECL zmq >= 1.0.4
	 */
