...
namespace {
	...
	/**
	 * @link https://php.net/manual/ja/class.zmq.php
	...
	class ZMQ {
		...
		/**
		 * @var integer <p>Used to send and receive TCP data from a non-ØMQ peer. Available if compiled against ZeroMQ 4.x or higher (Value: <code>integer</code>).</p>
		 * @link https://php.net/manual/ja/class.zmq.php
		 */
		const SOCKET_STREAM = null;

		/**
		 * @var integer <p>The high water mark for inbound and outbound messages is a hard limit on the maximum number of outstanding messages ØMQ shall queue in memory for any single peer that the specified socket is communicating with. Setting this option on a socket will only affect connections made after the option has been set. On ZeroMQ 3.x this is a wrapper for setting both SNDHWM and RCVHWM. (Value: <code>integer</code>).</p>
		 * @link https://php.net/manual/ja/class.zmq.php
		 */
		 ...
		 * @return self
		 * @link https://php.net/manual/ja/zmq.construct.php
	...
	/**
	 * @link https://php.net/manual/ja/class.zmqcontext.php
	 * @since No version information available, might only be in Git
	 */
	class ZMQContext {
		 ...
		 * @link https://php.net/manual/ja/zmqcontext.construct.php
		 * @since PECL zmq >= 0.5.0
		 */
		 ...
		 * @link https://php.net/manual/ja/zmqcontext.getopt.php
		 ...
		 * @link https://php.net/manual/ja/zmqcontext.getsocket.php
		 * @since PECL zmq >= 0.5.0
		 */
		 ...
		 * @link https://php.net/manual/ja/zmqcontext.ispersistent.php
		 * @since PECL zmq >= 0.5.0
		 */
		 ...
		 * @link https://php.net/manual/ja/zmqcontext.setopt.php
		 * @since PECL zmq >= 1.0.4
		 */
	...
	/**
	 * @link https://php.net/manual/ja/class.zmqdevice.php
	 * @since No version information available, might only be in Git
	 */
	class ZMQDevice {
		 ...
		 * @link https://php.net/manual/ja/zmqdevice.construct.php
		 * @since PECL zmq >= 0.5.0
		 */
		 ...
		 * @link https://php.net/manual/ja/zmqdevice.getidletimeout.php
		 * @since No version information available, might only be in Git
		 */
		 ...
		 * @link https://php.net/manual/ja/zmqdevice.gettimertimeout.php
		 * @since No version information available, might only be in Git
		 */
		 ...
		 * @link https://php.net/manual/ja/zmqdevice.run.php
		 * @since No version information available, might only be in Git
		 */
		 ...
		 * @link https://php.net/manual/ja/zmqdevice.setidlecallback.php
		 * @since No version information available, might only be in Git
		 */
		 ...
		 * @return ZMQDevice <p>On success this method returns the current object.</p>
		 * @link https://php.net/manual/ja/zmqdevice.setidletimeout.php
		 * @since No version information available, might only be in Git
		 */
		 ...
		 * @param mixed $user_data <p>Additional data to pass to the callback function.</p>
		 * @return ZMQDevice <p>On success this method returns the current object.</p>
		 * @link https://php.net/manual/ja/zmqdevice.settimercallback.php
		 * @since No version information available, might only be in Git
		 */
		 ...
		 * @return ZMQDevice <p>On success this method returns the current object.</p>
		 * @link https://php.net/manual/ja/zmqdevice.settimertimeout.php
		 * @since No version information available, might only be in Git
		 */
	...
	/**
	 * @link https://php.net/manual/ja/class.zmqpoll.php
	 * @since No version information available, might only be in Git
	 */
	class ZMQPoll {
		 ...
		 * @link https://php.net/manual/ja/zmqpoll.add.php
		 * @since PECL zmq >= 0.5.0
		 */
		 ...
		 * @link https://php.net/manual/ja/zmqpoll.clear.php
		 * @since PECL zmq >= 0.5.0
		 */
		 ...
		 * @link https://php.net/manual/ja/zmqpoll.count.php
		 * @since PECL zmq >= 0.5.0
		 */
		 ...
		 * @link https://php.net/manual/ja/zmqpoll.getlasterrors.php
		 * @since PECL zmq >= 0.5.0
		 */
		 ...
		 * @link https://php.net/manual/ja/zmqpoll.poll.php
		 * @since PECL zmq >= 0.5.0
		 */
		 ...
		 * @link https://php.net/manual/ja/zmqpoll.remove.php
		 * @since PECL zmq >= 0.5.0
		 */
	...
	/**
	 * @link https://php.net/manual/ja/class.zmqsocket.php
	 * @since No version information available, might only be in Git
	 */
	class ZMQSocket {
		 ...
		 * @link https://php.net/manual/ja/zmqsocket.construct.php
		 * @since PECL zmq >= 0.5.0
		 */
		 ...
		 * @link https://php.net/manual/ja/zmqsocket.bind.php
		 * @since PECL zmq >= 0.5.0
		 */
		 ...
		 * @return ZMQSocket <p>Returns the current object. Throws ZMQSocketException on error.</p>
		 * @link https://php.net/manual/ja/zmqsocket.connect.php
		 * @since PECL zmq >= 0.5.0
		 */
		 ...
		 * @param string $dsn <p>The connect dsn, for example <i>transport://address</i>.</p>
		 * @return ZMQSocket <p>Returns the current object. Throws ZMQSocketException on error.</p>
		 * @link https://php.net/manual/ja/zmqsocket.disconnect.php
		 * @since PECL zmq >= 1.0.4
		 */
		 ...
		 * @link https://php.net/manual/ja/zmqsocket.getendpoints.php
		 * @since PECL zmq >= 0.5.0
		 */
		 ...
		 * @link https://php.net/manual/ja/zmqsocket.getpersistentid.php
		 * @since PECL zmq >= 0.5.0
		 */
		 ...
		 * @link https://php.net/manual/ja/zmqsocket.getsockopt.php
		 * @since PECL zmq >= 0.5.0
		 */
		 ...
		 * @link https://php.net/manual/ja/zmqsocket.getsockettype.php
		 * @since PECL zmq >= 0.5.0
		 */
		 ...
		 * @link https://php.net/manual/ja/zmqsocket.ispersistent.php
		 * @since PECL zmq >= 0.5.0
		 */
		public function isPersistent(): bool {}
		 ...
		 * @return string <p>Returns the message. Throws ZMQSocketException in error. If <b><code>ZMQ::MODE_DONTWAIT</code></b> is used and the operation would block <code>boolean</code> false shall be returned.</p>
		 * @link https://php.net/manual/ja/zmqsocket.recv.php
		 * @since PECL zmq >= 0.5.0
		 */
		 ...
		 * @param int $mode <p>Pass mode flags to receive multipart messages or non-blocking operation. See <b><code>ZMQ::MODE_&#42;</code></b> constants.</p>
		 * @return array <p>Returns the array of message parts. Throws ZMQSocketException in error. If <b><code>ZMQ::MODE_NOBLOCK</code></b> is used and the operation would block <code>boolean</code> false shall be returned.</p>
		 * @link https://php.net/manual/ja/zmqsocket.recvmulti.php
		 ...
		 * @link https://php.net/manual/ja/zmqsocket.send.php
		 * @since PECL zmq >= 0.5.0
		 */
		 ...
		 * @param mixed $value <p>The value of the parameter.</p>
		 * @return ZMQSocket <p>Returns the current object. Throws ZMQSocketException on error.</p>
		 * @link https://php.net/manual/ja/zmqsocket.setsockopt.php
		 * @since PECL zmq >= 0.5.0
		 */
		 ...
		 * @return ZMQSocket <p>Returns the current object. Throws ZMQSocketException on error.</p>
		 * @link https://php.net/manual/ja/zmqsocket.unbind.php
		 * @since PECL zmq >= 1.0.4
		 */
