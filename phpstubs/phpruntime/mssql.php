...
namespace {
	 ...
	 * @link https://php.net/manual/ja/function.mssql-bind.php
	 ...
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.mssql-close.php
	 ...
	 * @link https://php.net/manual/ja/function.mssql-connect.php
	 ...
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.mssql-data-seek.php
	 * @since PHP 4, PHP 5, PECL odbtp >= 1.1.1
	 */
	 ...
	 * @return mixed
	 * @link https://php.net/manual/ja/function.mssql-execute.php
	 ...
	 * @link https://php.net/manual/ja/function.mssql-fetch-array.php
	 * @see mssql_fetch_row()
	 * @since PHP 4, PHP 5, PECL odbtp >= 1.1.1
	 */
	 ...
	 * @link https://php.net/manual/ja/function.mssql-fetch-assoc.php
	 ...
	 * @link https://php.net/manual/ja/function.mssql-fetch-batch.php
	 ...
	 * @link https://php.net/manual/ja/function.mssql-fetch-field.php
	 ...
	 * @link https://php.net/manual/ja/function.mssql-fetch-object.php
	 ...
	 * @link https://php.net/manual/ja/function.mssql-fetch-row.php
	 ...
	 * @link https://php.net/manual/ja/function.mssql-field-length.php
	 ...
	 * @link https://php.net/manual/ja/function.mssql-field-name.php
	 ...
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.mssql-field-seek.php
	 ...
	 * @link https://php.net/manual/ja/function.mssql-field-type.php
	 ...
	 * @param resource $result <p>処理対象となる結果リソース。これは <code>mssql_query()</code> のコールによって取得します。</p>
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.mssql-free-result.php
	 ...
	 * @param resource $stmt <p><code>mssql_init()</code> で取得したステートメントリソース。</p>
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.mssql-free-statement.php
	 ...
	 * @link https://php.net/manual/ja/function.mssql-get-last-message.php
	 ...
	 * @link https://php.net/manual/ja/function.mssql-guid-string.php
	 * @since PHP 4 >= 4.0.7, PHP 5, PECL odbtp >= 1.1.1
	 */
	 ...
	 * @link https://php.net/manual/ja/function.mssql-init.php
	 ...
	 * @link https://php.net/manual/ja/function.mssql-min-error-severity.php
	 * @since PHP 4, PHP 5, PECL odbtp >= 1.1.1
	 */
	 ...
	 * @return void <p>値を返しません。</p>
	 * @link https://php.net/manual/ja/function.mssql-min-message-severity.php
	 * @since PHP 4, PHP 5, PECL odbtp >= 1.1.1
	 */
	 ...
	 * @link https://php.net/manual/ja/function.mssql-next-result.php
	 ...
	 * @link https://php.net/manual/ja/function.mssql-num-fields.php
	 ...
	 * @link https://php.net/manual/ja/function.mssql-num-rows.php
	 ...
	 * @link https://php.net/manual/ja/function.mssql-pconnect.php
	 * @since PHP 4, PHP 5, PECL odbtp >= 1.1.1
	 */
	 ...
	 * @link https://php.net/manual/ja/function.mssql-query.php
	 ...
	 * @link https://php.net/manual/ja/function.mssql-result.php
	 ...
	 * @link https://php.net/manual/ja/function.mssql-rows-affected.php
	 * @since PHP 4 >= 4.0.4, PHP 5, PECL odbtp >= 1.1.1
	 */
	 ...
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.mssql-select-db.php
