 ...
 * @link http://php.net/manual/ja/class.collectable.php
...
interface Collectable {
	 ...
	 * @return bool
	 * @link http://php.net/manual/ja/collectable.isgarbage.php
	 * @since PECL pthreads >= 2.0.8
	 */
	 ...
	 * @return void
	 * @link http://php.net/manual/ja/collectable.setgarbage.php
 ...
 * @link http://php.net/manual/ja/class.cond.php
 * @since PECL pthreads < 3.0.0
 */
class Cond {
	 ...
	 * @link http://php.net/manual/ja/cond.broadcast.php
	 * @since PECL pthreads < 3.0.0
	 */
	 ...
	 * @link http://php.net/manual/ja/cond.create.php
	 * @since PECL pthreads < 3.0.0
	 */
	 ...
	 * @param int $condition <p>A handle to a Condition Variable returned by a previous call to <code>Cond::create()</code></p>
	 * @return bool <p>A boolean indication of success.</p>
	 * @link http://php.net/manual/ja/cond.destroy.php
	 * @since PECL pthreads < 3.0.0
	 */
	 ...
	 * @return bool <p>A boolean indication of success.</p>
	 * @link http://php.net/manual/ja/cond.signal.php
	 * @since PECL pthreads < 3.0.0
	 */
	 ...
	 * @return bool <p>A boolean indication of success.</p>
	 * @link http://php.net/manual/ja/cond.wait.php
	 * @since PECL pthreads < 3.0.0
	 */
 ...
 * @link http://php.net/manual/ja/class.mutex.php
 * @since PECL pthreads < 3.0.0
 */
class Mutex {
	 ...
	 * @link http://php.net/manual/ja/mutex.create.php
	 * @since PECL pthreads < 3.0.0
	 */
	 ...
	 * @return bool <p>A boolean indication of success</p>
	 * @link http://php.net/manual/ja/mutex.destroy.php
	 * @since PECL pthreads < 3.0.0
	 */
	 ...
	 * @return bool <p>A boolean indication of success.</p>
	 * @link http://php.net/manual/ja/mutex.lock.php
	 * @since PECL pthreads < 3.0.0
	 */
	 ...
	 * @param int $mutex <p>A handle returned by a previous call to <code>Mutex::create()</code>.</p>
	 * @return bool <p>A boolean indication of success.</p>
	 * @link http://php.net/manual/ja/mutex.trylock.php
	 * @since PECL pthreads < 3.0.0
	 */
	 ...
	 * @return bool <p>A boolean indication of success.</p>
	 * @link http://php.net/manual/ja/mutex.unlock.php
	 * @since PECL pthreads < 3.0.0
	 */
 ...
 * @link http://php.net/manual/ja/class.pool.php
...
class Pool {
	 ...
	 * @link http://php.net/manual/ja/class.pool.php#pool.props.size
	 */
	protected $size;

	/**
	 * @var mixed <p>the class of the Worker</p>
	 * @link http://php.net/manual/ja/class.pool.php#pool.props.class
	 */
	protected $class;

	/**
	 * @var mixed <p>references to Workers</p>
	 * @link http://php.net/manual/ja/class.pool.php#pool.props.workers
	 */
	protected $workers;

	/**
	 * @var mixed <p>the arguments for constructor of new Workers</p>
	 * @link http://php.net/manual/ja/class.pool.php#pool.props.ctor
	 */
	protected $ctor;

	/**
	 * @var mixed <p>offset in workers of the last Worker used</p>
	 * @link http://php.net/manual/ja/class.pool.php#pool.props.last
	 */
	protected $last;
	 ...
	 * @link http://php.net/manual/ja/pool.construct.php
	 * @since PECL pthreads >= 2.0.0
	 */
	 ...
	 * @link http://php.net/manual/ja/pool.collect.php
	 * @since PECL pthreads >= 2.0.0
	 */
	 ...
	 * @link http://php.net/manual/ja/pool.resize.php
	 * @since PECL pthreads >= 2.0.0
	 */
	 ...
	 * @link http://php.net/manual/ja/pool.shutdown.php
	 * @since PECL pthreads >= 2.0.0
	 */
	 ...
	 * @link http://php.net/manual/ja/pool.submit.php
	 * @since PECL pthreads >= 2.0.0
	 */
	 ...
	 * @link http://php.net/manual/ja/pool.submitTo.php
	 * @since PECL pthreads >= 2.0.0
	 */
 ...
 * @link http://php.net/manual/ja/class.thread.php
 * @since PECL pthreads >= 2.0.0
 */
class Thread extends \Threaded implements \Countable, \Traversable, \ArrayAccess {
	 ...
	 * @link http://php.net/manual/ja/threaded.chunk.php
	 * @since PECL pthreads >= 2.0.0
	 */
	 ...
	 * @return int
	 * @link http://php.net/manual/ja/threaded.count.php
	 * @since PECL pthreads >= 2.0.0
	 */
	 ...
	 * @return void
	 * @link http://php.net/manual/ja/thread.detach.php
	 * @since PECL pthreads < 3.0.0
	 */
	 ...
	 * @return bool <p>A boolean indication of success</p>
	 * @link http://php.net/manual/ja/threaded.extend.php
	 * @since PECL pthreads >= 2.0.8
	 */
	 ...
	 * @link http://php.net/manual/ja/threaded.from.php
	 ...
	 * @link http://php.net/manual/ja/thread.getcreatorid.php
	 * @since PECL pthreads >= 2.0.0
	 */
	 ...
	 * @link http://php.net/manual/ja/thread.getcurrentthread.php
	 * @since PECL pthreads >= 2.0.0
	 */
	 ...
	 * @link http://php.net/manual/ja/thread.getcurrentthreadid.php
	 * @since PECL pthreads >= 2.0.0
	 */
	 ...
	 * @link http://php.net/manual/ja/threaded.getterminationinfo.php
	 * @since PECL pthreads < 3.0.0
	 */
	 ...
	 * @return integer <p>数値の ID を返します。</p>
	 * @link http://php.net/manual/ja/thread.getthreadid.php
	 * @since PECL pthreads >= 2.0.0
	 */
	 ...
	 * @link http://php.net/manual/ja/thread.globally.php
	 * @since PECL pthreads < 3.0.0
	 */
	 ...
	 * @link http://php.net/manual/ja/thread.isjoined.php
	 * @since PECL pthreads >= 2.0.0
	 */
	 ...
	 * @link http://php.net/manual/ja/thread.isrunning.php
	 * @since PECL pthreads >= 2.0.0
	 */
	 ...
	 * @return boolean <p>状態を表す boolean 値を返します。</p>
	 * @link http://php.net/manual/ja/thread.isstarted.php
	 * @since PECL pthreads >= 2.0.0
	 */
	 ...
	 * @link http://php.net/manual/ja/threaded.isterminated.php
	 * @since PECL pthreads >= 2.0.0
	 */
	 ...
	 * @return bool <p>A boolean indication of state</p>
	 * @link http://php.net/manual/ja/threaded.iswaiting.php
	 * @since PECL pthreads < 3.0.0
	 */
	 ...
	 * @link http://php.net/manual/ja/thread.join.php
	 * @since PECL pthreads >= 2.0.0
	 */
	 ...
	 * @link http://php.net/manual/ja/thread.kill.php
	 * @since PECL pthreads < 3.0.0
	 */
	 ...
	 * @return bool <p>A boolean indication of success</p>
	 * @link http://php.net/manual/ja/threaded.lock.php
	 * @since PECL pthreads < 3.0.0
	 */
	 ...
	 * @return bool <p>A boolean indication of success</p>
	 * @link http://php.net/manual/ja/threaded.merge.php
	 * @since PECL pthreads >= 2.0.0
	 */
	 ...
	 * @return bool <p>A boolean indication of success</p>
	 * @link http://php.net/manual/ja/threaded.notify.php
	 * @since PECL pthreads >= 2.0.0
	 */
	 ...
	 * @return bool <p>A boolean indication of success</p>
	 * @link http://php.net/manual/ja/threaded.notifyone.php
	 * @since PECL pthreads >= 3.0.0
	 */
	 ...
	 * @link http://php.net/manual/ja/threaded.pop.php
	 * @since PECL pthreads >= 2.0.0
	 */
	 ...
	 * @link http://php.net/manual/ja/threaded.run.php
	 * @since PECL pthreads >= 2.0.0
	 */
	 ...
	 * @link http://php.net/manual/ja/threaded.shift.php
	 * @since PECL pthreads >= 2.0.0
	 */
	 ...
	 * @return boolean <p>成功したかどうかを表す boolean 値を返します。</p>
	 * @link http://php.net/manual/ja/thread.start.php
	 * @since PECL pthreads >= 2.0.0
	 */
	 ...
	 * @link http://php.net/manual/ja/threaded.synchronized.php
	 * @since PECL pthreads >= 2.0.0
	 */
	 ...
	 * @return bool <p>A boolean indication of success</p>
	 * @link http://php.net/manual/ja/threaded.unlock.php
	 * @since PECL pthreads < 3.0.0
	 */
	 ...
	 * @return bool <p>A boolean indication of success</p>
	 * @link http://php.net/manual/ja/threaded.wait.php
	 * @since PECL pthreads >= 2.0.0
	 */
 ...
 * @link http://php.net/manual/ja/class.threaded.php
 * @since PECL pthreads >= 2.0.0
 */
 ...
 * @link http://php.net/manual/ja/class.worker.php
 * @since PECL pthreads >= 2.0.0
 */
class Worker extends \Thread implements \Traversable, \Countable, \ArrayAccess {
	 ...
	 * @link http://php.net/manual/ja/worker.collect.php
	 * @since PECL pthreads >= 3.0.0
	 */
	public function collect(Callable $collector = NULL): int {}
	 ...
	 * @link http://php.net/manual/ja/worker.getstacked.php
	 * @since PECL pthreads >= 2.0.0
	 */
	 ...
	 * @link http://php.net/manual/ja/worker.isshutdown.php
	 * @since PECL pthreads >= 2.0.0
	 */
	 ...
	 * @return boolean <p>状態を表す boolean 値を返します。</p>
	 * @link http://php.net/manual/ja/worker.isworking.php
	 * @since PECL pthreads >= 2.0.0
	 */
	 ...
	 * @link http://php.net/manual/ja/worker.shutdown.php
	 * @since PECL pthreads >= 2.0.0
	 */
	 ...
	 * @link http://php.net/manual/ja/worker.stack.php
	 * @since PECL pthreads >= 2.0.0
	 */
	 ...
	 * @return int <p>The new size of the stack.</p>
	 * @link http://php.net/manual/ja/worker.unstack.php
	 * @since PECL pthreads >= 2.0.0
	 */
