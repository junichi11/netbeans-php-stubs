...
namespace {
	...
	/**
	 * <p><b>ArithmeticError</b> は、数学的な操作でエラーが発生した場合にスローされます。 PHP 7.0 では、たとえばマイナスのビットシフトを行おうとした場合などに発生します。 また、結果が <code>integer</code> の範囲をこえてしまうような <code>intdiv()</code> の呼び出しの際にも発生します。</p>
	 * @link https://php.net/manual/ja/class.arithmeticerror.php
	 * @since PHP 7
	 */
