 ...
 * @return string <p>実行されたコマンドからの出力を返します。 エラーが発生した場合やコマンドが何も出力しなかった場合は <b><code>NULL</code></b> を返します。</p> <p><b>注意</b>:</p> <p>この関数は、エラーが発生した場合だけでなくプログラムが何も出力しなかった場合にも <b><code>NULL</code></b> を返します。 そのため、実行に失敗したノかどうかをこの関数では判断できません。 プログラムの終了コードを調べる必要があるときには <code>exec()</code> を使いましょう。</p>
