 ...
 * @link http://php.net/manual/ja/function.apd-breakpoint.php
 * @since PECL apd >= 0.2
 */
 ...
 * @link http://php.net/manual/ja/function.apd-callstack.php
 ...
 * @link http://php.net/manual/ja/function.apd-clunk.php
 * @see apd_croak()
 * @since PECL apd 0.2-0.4
 */
 ...
 * @param int $debug_level <p><i>XXX_TRACE</i> 定数の組み合わせによる整数値。</p> <p><b><code>MEMORY_TRACE</code></b> を用いることは推奨しません。 これは非常に低速で、またあまり正確ではないようだからです。 <b><code>ASSIGNMENT_TRACE</code></b> は、まだ実装されていません。</p> <p>すべての機能 (TIMING, FUNCTIONS, ARGS SUMMARY (strace -c のようなもの)) のトレースを有効にするには、値 99 を指定します。</p>
 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
 * @link http://php.net/manual/ja/function.apd-continue.php
 * @since PECL apd >= 0.2
 */
 ...
 * @param string $delimiter <p>区切り文字。デフォルトは <i>&lt;BR /&gt;</i>。</p>
 * @return void <p>値を返しません。</p>
 * @link http://php.net/manual/ja/function.apd-croak.php
 * @see apd_clunk()
 * @since PECL apd 0.2-0.4
 */
 ...
 * <p>現在の関数テーブルを出力します。</p>
 * @return void <p>値を返しません。</p>
 * @link http://php.net/manual/ja/function.apd-dump-function-table.php
 * @since Unknown
 */
 ...
 * @link http://php.net/manual/ja/function.apd-dump-persistent-resources.php
 ...
 * @link http://php.net/manual/ja/function.apd-dump-regular-resources.php
 ...
 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
 * @link http://php.net/manual/ja/function.apd-echo.php
 * @since PECL apd >= 0.2
 */
 ...
 * @link http://php.net/manual/ja/function.apd-get-active-symbols.php
 * @since PECL apd 0.2
 */
 ...
 * @link http://php.net/manual/ja/function.apd-set-pprof-trace.php
 ...
 * @param int $debug_level <p><i>XXX_TRACE</i> 定数の組み合わせによる整数値。</p> <p><b><code>MEMORY_TRACE</code></b> を用いることは推奨しません。 これは非常に低速で、またあまり正確ではないようだからです。 <b><code>ASSIGNMENT_TRACE</code></b> は、まだ実装されていません。</p> <p>すべての機能 (TIMING, FUNCTIONS, ARGS SUMMARY (strace -c のようなもの)) のトレースを有効にするには、値 99 を指定します。</p>
 * @return void <p>値を返しません。</p>
 * @link http://php.net/manual/ja/function.apd-set-session.php
 * @since PECL apd 0.2-0.4
 */
 ...
 * @return void <p>値を返しません。</p>
 * @link http://php.net/manual/ja/function.apd-set-session-trace.php
 * @since PECL apd 0.2-0.4
 */
 ...
 * @param int $debug_level <p><i>XXX_TRACE</i> 定数の組み合わせによる整数値。</p> <p><b><code>MEMORY_TRACE</code></b> を用いることは推奨しません。 これは非常に低速で、またあまり正確ではないようだからです。 <b><code>ASSIGNMENT_TRACE</code></b> は、まだ実装されていません。</p> <p>すべての機能 (TIMING, FUNCTIONS, ARGS SUMMARY (strace -c のようなもの)) のトレースを有効にするには、値 99 を指定します。</p>
 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
 * @link http://php.net/manual/ja/function.apd-set-session-trace-socket.php
 * @since PECL apd >= 0.2
 */
 ...
 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
 * @link http://php.net/manual/ja/function.override-function.php
 * @since PECL apd >= 0.2
 */
 ...
 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
 * @link http://php.net/manual/ja/function.rename-function.php
 * @since PECL apd >= 0.2
 */
