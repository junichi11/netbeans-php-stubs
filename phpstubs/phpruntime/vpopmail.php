...
namespace {
	 ...
	 * @return bool
	 * @link https://php.net/manual/ja/function.vpopmail-add-alias-domain.php
	 ...
	 * @return bool
	 * @link https://php.net/manual/ja/function.vpopmail-add-alias-domain-ex.php
	 * @since PHP 4 >= 4.0.5, PECL vpopmail >= 0.2
	 */
	 ...
	 * @param int $gid
	 * @return bool
	 * @link https://php.net/manual/ja/function.vpopmail-add-domain.php
	 * @since PHP 4 >= 4.0.5, PECL vpopmail >= 0.2
	 */
	 ...
	 * @param bool $apop
	 * @return bool
	 * @link https://php.net/manual/ja/function.vpopmail-add-domain-ex.php
	 * @since PHP 4 >= 4.0.5, PECL vpopmail >= 0.2
	 */
	 ...
	 * @param bool $apop
	 * @return bool
	 * @link https://php.net/manual/ja/function.vpopmail-add-user.php
	 * @since PHP 4 >= 4.0.5, PECL vpopmail >= 0.2
	 */
	 ...
	 * @param string $alias
	 * @return bool
	 * @link https://php.net/manual/ja/function.vpopmail-alias-add.php
	 ...
	 * @param string $domain
	 * @return bool
	 * @link https://php.net/manual/ja/function.vpopmail-alias-del.php
	 * @since PHP 4 >= 4.0.7, PECL vpopmail >= 0.2
	 */
	 ...
	 * @param string $domain
	 * @return bool
	 * @link https://php.net/manual/ja/function.vpopmail-alias-del-domain.php
	 * @since PHP 4 >= 4.0.7, PECL vpopmail >= 0.2
	 */
	 ...
	 * @param string $domain
	 * @return array
	 * @link https://php.net/manual/ja/function.vpopmail-alias-get.php
	 * @since PHP 4 >= 4.0.7, PECL vpopmail >= 0.2
	 */
	 ...
	 * @param string $domain
	 * @return array
	 * @link https://php.net/manual/ja/function.vpopmail-alias-get-all.php
	 * @since PHP 4 >= 4.0.7, PECL vpopmail >= 0.2
	 */
	 ...
	 * @param string $apop
	 * @return bool
	 * @link https://php.net/manual/ja/function.vpopmail-auth-user.php
	 * @since PHP 4 >= 4.0.5, PECL vpopmail >= 0.2
	 */
	 ...
	 * @param string $domain
	 * @return bool
	 * @link https://php.net/manual/ja/function.vpopmail-del-domain.php
	 * @since PHP 4 >= 4.0.5, PECL vpopmail >= 0.2
	 */
	 ...
	 * @param string $domain
	 * @return bool
	 * @link https://php.net/manual/ja/function.vpopmail-del-domain-ex.php
	 * @since PHP 4 >= 4.0.5, PECL vpopmail >= 0.2
	 */
	 ...
	 * @param string $domain
	 * @return bool
	 * @link https://php.net/manual/ja/function.vpopmail-del-user.php
	 * @since PHP 4 >= 4.0.5, PECL vpopmail >= 0.2
	 */
	 ...
	 * <p>この関数は、 <i>実験的</i> なものです。この関数の動作・ 名前・その他ドキュメントに書かれている事項は、予告なく、将来的な PHP のリリースにおいて変更される可能性があります。 この関数は自己責任で使用してください。</p><p>この関数は、 現在のところ詳細な情報はありません。引数のリストのみが 記述されています。</p>
	 * @return string
	 * @link https://php.net/manual/ja/function.vpopmail-error.php
	 * @since PHP 4 >= 4.0.5, PECL vpopmail >= 0.2
	 */
	 ...
	 * @param bool $apop
	 * @return bool
	 * @link https://php.net/manual/ja/function.vpopmail-passwd.php
	 * @since PHP 4 >= 4.0.5, PECL vpopmail >= 0.2
	 */
	 ...
	 * @param string $quota
	 * @return bool
	 * @link https://php.net/manual/ja/function.vpopmail-set-user-quota.php
	 * @since PHP 4 >= 4.0.5, PECL vpopmail >= 0.2
	 */
