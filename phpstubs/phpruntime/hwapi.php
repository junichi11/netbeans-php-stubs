...
namespace {
	 ...
	 * @link https://php.net/manual/ja/function.hwapi-attribute-new.php
	 * @since PHP 5 < 5.2.0
	 */
	 ...
	 * @link https://php.net/manual/ja/function.hwapi-content-new.php
	 * @since PHP 5 < 5.2.0
	 */
	 ...
	 * @link https://php.net/manual/ja/function.hwapi-hgcsp.php
	 ...
	 * @link https://php.net/manual/ja/function.hwapi-object-new.php
	 * @since PHP 5 < 5.2.0
	 */
