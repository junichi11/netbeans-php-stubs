...
namespace {
	 ...
	 * @link https://php.net/manual/ja/function.crack-check.php
	 ...
	 * @link https://php.net/manual/ja/function.crack-closedict.php
	 * @see crack_opendict()
	 * @since PECL crack >= 0.1
	 */
	 ...
	 * @link https://php.net/manual/ja/function.crack-getlastmessage.php
	 * @see crack_check()
	 * @since PECL crack >= 0.1
	 */
	 ...
	 * @link https://php.net/manual/ja/function.crack-opendict.php
