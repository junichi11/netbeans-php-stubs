...
namespace {
	 ...
	 * @link https://php.net/manual/ja/function.connection-aborted.php
	 ...
	 * @link https://php.net/manual/ja/function.connection-status.php
	 ...
	 * @link https://php.net/manual/ja/function.constant.php
	 * @see define(), defined()
	 ...
	 * @link https://php.net/manual/ja/function.define.php
	 ...
	 * @link https://php.net/manual/ja/function.defined.php
	 ...
	 * @link https://php.net/manual/ja/function.get-browser.php
	 * @since PHP 4, PHP 5, PHP 7
	 */
	 ...
	 * @link https://php.net/manual/ja/function.highlight-file.php
	 ...
	 * @param bool $return <p>このパラメータを <b><code>TRUE</code></b> にすると、この関数はハイライトされたコードを返します。</p>
	 * @return mixed <p><code>return</code> が <b><code>TRUE</code></b> の場合は、 ハイライトされたコードを文字列として返し、表示しません。 それ以外の場合は、成功した場合に <b><code>TRUE</code></b>、 失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.highlight-string.php
	 * @see highlight_file()
	 * @since PHP 4, PHP 5, PHP 7
	 */
	 ...
	 * @link https://php.net/manual/ja/function.hrtime.php
	 * @since PHP 7 >= 7.3.0
	 */
	 ...
	 * @link https://php.net/manual/ja/function.ignore-user-abort.php
	 ...
	 * @link https://php.net/manual/ja/function.pack.php
	 * @see unpack()
	 * @since PHP 4, PHP 5, PHP 7
	 */
	 ...
	 * @link https://php.net/manual/ja/function.php-check-syntax.php
	 ...
	 * @link https://php.net/manual/ja/function.php-strip-whitespace.php
	 * @since PHP 5, PHP 7
	 */
	 ...
	 * @link https://php.net/manual/ja/function.sapi-windows-cp-conv.php
	 ...
	 * @link https://php.net/manual/ja/function.sapi-windows-cp-get.php
	 ...
	 * @link https://php.net/manual/ja/function.sapi-windows-cp-is-utf8.php
	 ...
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.sapi-windows-cp-set.php
	 * @see sapi_windows_cp_get()
	 * @since PHP 7 >= 7.1.0
	 */
	 ...
	 * @link https://php.net/manual/ja/function.sapi-windows-vt100-support.php
	 * @since PHP 7 >= 7.2.0
	 */
	 ...
	 * @param bool $return <p>このパラメータを <b><code>TRUE</code></b> にすると、この関数はハイライトされたコードを返します。</p>
	 * @return mixed
	 * @link https://php.net/manual/ja/function.show-source.php
	 * @since PHP 4, PHP 5, PHP 7
	 */
	...
	/**
	 * 実行を遅延させる
	 * <p><code>seconds</code> で与えられた秒数分プログラムの実行を遅延させます。</p>
	 ...
	 * @link https://php.net/manual/ja/function.sleep.php
	 ...
	 * @link https://php.net/manual/ja/function.sys-getloadavg.php
	 ...
	 * @link https://php.net/manual/ja/function.time-nanosleep.php
	 ...
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.time-sleep-until.php
	...
	/**
	 * 一意な ID を生成する
	 * <p>マイクロ秒単位の現在時刻にもとづいた、接頭辞つきの一意な ID を取得します。</p><p>この関数が生成する値は、暗号学的に安全ではありません。そのため、これを暗号として使ってはいけません。暗号学的に安全な値が必要な場合は、<code>random_int()</code> か <code>random_bytes()</code> あるいは <code>openssl_random_pseudo_bytes()</code> を使いましょう。</p><p>この関数は、戻り値の一意性を保証するものではありません。 ほとんどのシステムは、NTP などでシステムクロックを調整するので、 システム時刻は絶えず変更されます。 したがって、この関数がプロセス/スレッドの一意の ID を返さない可能性があります。 一意性を高めるには、<code>more_entropy</code> を使用してください。</p>
	 ...
	 * @return string <p>タイムスタンプにもとづいた一意な識別子を文字列で返します。</p> <b>警告</b> <p>この関数は一意な識別子を作成しようとしますが、 戻り値の一意性を完全に保証するものではありません。</p>
	 * @link https://php.net/manual/ja/function.uniqid.php
	 * @since PHP 4, PHP 5, PHP 7
	 */
	 ...
	 * @param int $offset <p>データ切り出しを開始するオフセット。</p>
	 * @return array <p>バイナリ文字列を切り出した要素を含む連想配列を返します。</p>
	 * @link https://php.net/manual/ja/function.unpack.php
	 * @see pack()
	 * @since PHP 4, PHP 5, PHP 7
	 */
	 ...
	 * @link https://php.net/manual/ja/function.usleep.php
...
namespace HRTime {
	...
	/**
	 * @link https://php.net/manual/ja/class.hrtime-performancecounter.php
	...
	class PerformanceCounter {
		 ...
		 * @link https://php.net/manual/ja/hrtime-performancecounter.getfrequency.php
		 * @since PECL hrtime >= 0.4.3
		 */
		 ...
		 * @link https://php.net/manual/ja/hrtime-performancecounter.getticks.php
		 ...
		 * @return int <p>Returns <code>integer</code> indicating the ticks count.</p>
		 * @link https://php.net/manual/ja/hrtime-performancecounter.gettickssince.php
		 * @since PECL hrtime >= 0.6.0
		 */
	...
	/**
	 * @link https://php.net/manual/ja/class.hrtime-stopwatch.php
	 * @since PECL hrtime >= 0.4.3
	 */
	class StopWatch extends \HRTime\PerformanceCounter {
		 ...
		 * @link https://php.net/manual/ja/hrtime-stopwatch.getelapsedticks.php
		 * @since PECL hrtime >= 0.4.3
		 */
		 ...
		 * @link https://php.net/manual/ja/hrtime-stopwatch.getelapsedtime.php
		 * @since PECL hrtime >= 0.4.3
		 */
		 ...
		 * @return int <p>Returns <code>integer</code> indicating elapsed ticks.</p>
		 * @link https://php.net/manual/ja/hrtime-stopwatch.getlastelapsedticks.php
		 * @since PECL hrtime >= 0.4.3
		 */
		 ...
		 * @param int $unit <p>Time unit represented by a HRTime\Unit constant. Default is HRTime\Unit::SECOND.</p>
		 * @return float <p>Returns <code>float</code> indicating elapsed time.</p>
		 * @link https://php.net/manual/ja/hrtime-stopwatch.getlastelapsedtime.php
		 * @since PECL hrtime >= 0.4.3
		 */
		 ...
		 * @link https://php.net/manual/ja/hrtime-stopwatch.isrunning.php
		 * @since PECL hrtime >= 0.4.3
		 */
		 ...
		 * @link https://php.net/manual/ja/hrtime-stopwatch.start.php
		 * @since PECL hrtime >= 0.4.3
		 */
		 ...
		 * @return void <p>Returns void.</p>
		 * @link https://php.net/manual/ja/hrtime-stopwatch.stop.php
		 * @since PECL hrtime >= 0.4.3
		 */
	...
	/**
	 * @link https://php.net/manual/ja/class.hrtime-unit.php
	 * @since PECL hrtime >= 0.4.3
	 */
	class Unit {
