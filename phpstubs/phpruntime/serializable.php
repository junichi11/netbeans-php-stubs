 ...
 * <p>今はこのインターフェイスを実装しているけれどもシリアライズした際には まだこのインターフェイスを実装していなかったオブジェクトをアンシリアライズする際には、 unserialize メソッドではなく __wakeup() が呼ばれます。これは、マイグレーションの際に便利です。</p>
...
interface Serializable {
	...
	/**
	 * オブジェクトの文字列表現
	 * <p>オブジェクトを文字列であらわしたものを返します。</p><p><b>注意</b>:</p><p>このメソッドは、オブジェクトの デストラクタ として働きます。 このメソッドの後に __destruct() メソッドがコールされることは <i>ありません</i>。 method.</p>
