...
namespace {
	 ...
	 * @link https://php.net/manual/ja/class.domattr.php
	 * @since PHP 5, PHP 7
	 */
	class DOMAttr extends \DOMNode {
		 ...
		 * @link https://php.net/manual/ja/class.domattr.php#domattr.props.name
		 */
		public $name;

		/**
		 * @var DOMElement <p>属性を保持する要素</p>
		 * @link https://php.net/manual/ja/class.domattr.php#domattr.props.ownerelement
		 */
		public $ownerElement;

		/**
		 * @var bool <p>未実装です。常に <b><code>NULL</code></b> を返します。</p>
		 * @link https://php.net/manual/ja/class.domattr.php#domattr.props.schematypeinfo
		 */
		public $schemaTypeInfo;

		/**
		 * @var bool <p>未実装です。常に <b><code>NULL</code></b> を返します。</p>
		 * @link https://php.net/manual/ja/class.domattr.php#domattr.props.specified
		 */
		public $specified;

		/**
		 * @var string <p>属性の値</p>
		 * @link https://php.net/manual/ja/class.domattr.php#domattr.props.value
		 */
		public $value;
		 ...
		 * @link https://php.net/manual/ja/domnode.c14n.php
		 ...
		 * @link https://php.net/manual/ja/domnode.c14nfile.php
		 * @since PHP 5 >= 5.2.0, PHP 7
		 */
		 ...
		 * @return self
		 * @link https://php.net/manual/ja/domattr.construct.php
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * @link https://php.net/manual/ja/domnode.appendchild.php
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * @link https://php.net/manual/ja/domnode.clonenode.php
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * @link https://php.net/manual/ja/domnode.getlineno.php
		 ...
		 * @link https://php.net/manual/ja/domnode.getnodepath.php
		 * @since PHP 5 >= 5.2.0, PHP 7
		 */
		 ...
		 * @link https://php.net/manual/ja/domnode.hasattributes.php
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
		 * @link https://php.net/manual/ja/domnode.haschildnodes.php
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * @link https://php.net/manual/ja/domnode.insertbefore.php
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * @link https://php.net/manual/ja/domnode.isdefaultnamespace.php
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
		 * @link https://php.net/manual/ja/domattr.isid.php
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
		 * @link https://php.net/manual/ja/domnode.issamenode.php
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
		 * @link https://php.net/manual/ja/domnode.issupported.php
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * @link https://php.net/manual/ja/domnode.lookupnamespaceuri.php
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * @link https://php.net/manual/ja/domnode.lookupprefix.php
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * @link https://php.net/manual/ja/domnode.normalize.php
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * @link https://php.net/manual/ja/domnode.removechild.php
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * @link https://php.net/manual/ja/domnode.replacechild.php
		 * @since PHP 5, PHP 7
		 */
	 ...
	 * @link https://php.net/manual/ja/class.domcdatasection.php
	 * @since PHP 5, PHP 7
	 */
	class DOMCdataSection extends \DOMText {
		 ...
		 * @return self
		 * @link https://php.net/manual/ja/domcdatasection.construct.php
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
		 * @link https://php.net/manual/ja/domtext.iselementcontentwhitespace.php
		 ...
		 * @link https://php.net/manual/ja/domtext.iswhitespaceinelementcontent.php
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * @link https://php.net/manual/ja/domtext.splittext.php
		 * @since PHP 5, PHP 7
		 */
	 ...
	 * @link https://php.net/manual/ja/class.domcharacterdata.php
	 * @since PHP 5, PHP 7
	 */
	class DOMCharacterData extends \DOMNode {
		 ...
		 * @link https://php.net/manual/ja/class.domcharacterdata.php#domcharacterdata.props.data
		 */
		public $data;

		/**
		 * @var int <p>内容の長さ。</p>
		 * @link https://php.net/manual/ja/class.domcharacterdata.php#domcharacterdata.props.length
		 */
		public $length;
		 ...
		 * @return void <p>値を返しません。</p>
		 * @link https://php.net/manual/ja/domcharacterdata.appenddata.php
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * @return void <p>値を返しません。</p>
		 * @link https://php.net/manual/ja/domcharacterdata.deletedata.php
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * @return void <p>値を返しません。</p>
		 * @link https://php.net/manual/ja/domcharacterdata.insertdata.php
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * @return void <p>値を返しません。</p>
		 * @link https://php.net/manual/ja/domcharacterdata.replacedata.php
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * @link https://php.net/manual/ja/domcharacterdata.substringdata.php
		 * @since PHP 5, PHP 7
		 */
	 ...
	 * @link https://php.net/manual/ja/class.domcomment.php
	 * @since PHP 5, PHP 7
	 */
	class DOMComment extends \DOMCharacterData {
		 ...
		 * @return self
		 * @link https://php.net/manual/ja/domcomment.construct.php
		 * @since PHP 5, PHP 7
		 */
	 ...
	 * @link https://php.net/manual/ja/class.domdocument.php
	 * @since PHP 5, PHP 7
	 */
	class DOMDocument extends \DOMNode {
		 ...
		 * @link https://php.net/manual/ja/class.domdocument.php#domdocument.props.actualencoding
		 */
		public $actualEncoding;

		/**
		 * @var DOMConfiguration <p><i>非推奨</i>。 <code>DOMDocument::normalizeDocument()</code> を実行する際に使用する設定。</p>
		 * @link https://php.net/manual/ja/class.domdocument.php#domdocument.props.config
		 */
		public $config;

		/**
		 * @var DOMDocumentType <p>このドキュメントに関連付けられた文書型宣言</p>
		 * @link https://php.net/manual/ja/class.domdocument.php#domdocument.props.doctype
		 */
		public $doctype;

		/**
		 * @var DOMElement <p>ドキュメントの子ノードであるドキュメント要素に対し、 直接アクセスするために便利な属性</p>
		 * @link https://php.net/manual/ja/class.domdocument.php#domdocument.props.documentelement
		 */
		public $documentElement;

		/**
		 * @var string <p>ドキュメントの位置。未定義の場合は <b><code>NULL</code></b></p>
		 * @link https://php.net/manual/ja/class.domdocument.php#domdocument.props.documenturi
		 */
		public $documentURI;
		 ...
		 * @link https://php.net/manual/ja/class.domdocument.php#domdocument.props.encoding
		 */
		public $encoding;

		/**
		 * @var bool <p>字下げや空白を考慮してきれいに整形した出力を行う。</p>
		 * @link https://php.net/manual/ja/class.domdocument.php#domdocument.props.formatoutput
		 */
		public $formatOutput;

		/**
		 * @var DOMImplementation <p>このドキュメントを処理する DOMImplementation オブジェクト</p>
		 * @link https://php.net/manual/ja/class.domdocument.php#domdocument.props.implementation
		 */
		public $implementation;

		/**
		 * @var bool <p>余分な空白を取り除かない。デフォルトは <b><code>TRUE</code></b></p>
		 * @link https://php.net/manual/ja/class.domdocument.php#domdocument.props.preservewhitespace
		 */
		public $preserveWhiteSpace = true;

		/**
		 * @var bool <p><i>プロプライエタリ</i>。 リカバリーモードを有効にし、整形式でないドキュメントのパースを試みます。 この属性は DOM の仕様にはなく、libxml に固有のものです。</p>
		 * @link https://php.net/manual/ja/class.domdocument.php#domdocument.props.recover
		 */
		public $recover;

		/**
		 * @var bool <p>文書型宣言で外部エンティティを読み込む際に <b><code>TRUE</code></b> を設定する。 XML ドキュメントに文字エンティティを含める際に便利です。</p>
		 * @link https://php.net/manual/ja/class.domdocument.php#domdocument.props.resolveexternals
		 */
		public $resolveExternals;

		/**
		 * @var bool <p><i>非推奨</i>。 そのドキュメントがスタンドアローンかどうかを XML 宣言で指定したもの。 xmlStandalone に対応します。</p>
		 * @link https://php.net/manual/ja/class.domdocument.php#domdocument.props.standalone
		 */
		public $standalone;

		/**
		 * @var bool <p>エラー時に DOMException をスローする。デフォルトは <b><code>TRUE</code></b></p>
		 * @link https://php.net/manual/ja/class.domdocument.php#domdocument.props.stricterrorchecking
		 */
		public $strictErrorChecking = true;

		/**
		 * @var bool <p><i>プロプライエタリ</i>。 エンティティの置換を行うかどうか。 この属性は DOM の仕様にはなく、libxml に固有のものです。</p>
		 * @link https://php.net/manual/ja/class.domdocument.php#domdocument.props.substituteentities
		 */
		public $substituteEntities;

		/**
		 * @var bool <p>DTD を読み込んで検証する。デフォルトは <b><code>FALSE</code></b></p>
		 * @link https://php.net/manual/ja/class.domdocument.php#domdocument.props.validateonparse
		 */
		public $validateOnParse = false;

		/**
		 * @var string <p><i>非推奨</i>。 XML のバージョン。 xmlVersion に対応します。</p>
		 * @link https://php.net/manual/ja/class.domdocument.php#domdocument.props.version
		 */
		public $version;

		/**
		 * @var string <p>XML 宣言の一部として、このドキュメントのエンコーディングを 指定する属性。指定されていない場合や不明な場合 (たとえば ドキュメントがメモリ上に存在する場合など) は <b><code>NULL</code></b></p>
		 * @link https://php.net/manual/ja/class.domdocument.php#domdocument.props.xmlencoding
		 */
		public $xmlEncoding;

		/**
		 * @var bool <p>XML 宣言の一部として、このドキュメントがスタンドアローンか どうかを指定する。指定されていない場合は <b><code>FALSE</code></b></p>
		 * @link https://php.net/manual/ja/class.domdocument.php#domdocument.props.xmlstandalone
		 */
		public $xmlStandalone;

		/**
		 * @var string <p>XML 宣言の一部として、このドキュメントのバージョン番号を指定する。 バージョン番号が定義されておらず、ドキュメントが "XML" の機能を サポートしている場合は、値は "1.0"</p>
		 * @link https://php.net/manual/ja/class.domdocument.php#domdocument.props.xmlversion
		 */
		public $xmlVersion;
		 ...
		 * @return self
		 * @link https://php.net/manual/ja/domdocument.construct.php
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * @link https://php.net/manual/ja/domdocument.createattribute.php
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * @return DOMAttr <p>新しい DOMAttr、あるいはエラーが発生した場合は <b><code>FALSE</code></b> を返します。</p>
		 * @link https://php.net/manual/ja/domdocument.createattributens.php
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * @link https://php.net/manual/ja/domdocument.createcdatasection.php
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * @link https://php.net/manual/ja/domdocument.createcomment.php
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * @link https://php.net/manual/ja/domdocument.createdocumentfragment.php
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * @link https://php.net/manual/ja/domdocument.createelement.php
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * @link https://php.net/manual/ja/domdocument.createelementns.php
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * @link https://php.net/manual/ja/domdocument.createentityreference.php
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * @link https://php.net/manual/ja/domdocument.createprocessinginstruction.php
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * @link https://php.net/manual/ja/domdocument.createtextnode.php
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * @link https://php.net/manual/ja/domdocument.getelementbyid.php
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * @link https://php.net/manual/ja/domdocument.getelementsbytagname.php
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * @return DOMNodeList <p>一致するすべての要素を含む、新しい DOMNodeList オブジェクトを返します。</p>
		 * @link https://php.net/manual/ja/domdocument.getelementsbytagnamens.php
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * @link https://php.net/manual/ja/domdocument.importnode.php
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * @link https://php.net/manual/ja/domdocument.load.php
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * @link https://php.net/manual/ja/domdocument.loadhtml.php
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * @param int $options <p>PHP 5.4.0 と Libxml 2.6.0 以降では、 <code>options</code> パラメータで Libxml の追加パラメータ を指定できます。</p>
		 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。 静的にコールされた場合には DOMDocument を返します。 失敗した場合に <b><code>FALSE</code></b> を返します</p>
		 * @link https://php.net/manual/ja/domdocument.loadhtmlfile.php
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * @param int $options <p>libxml オプション定数 を ビット <i>OR</i> で連結したもの。</p>
		 * @return mixed <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。 静的にコールされた場合には DOMDocument を返します。 失敗した場合に <b><code>FALSE</code></b> を返します</p>
		 * @link https://php.net/manual/ja/domdocument.loadxml.php
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * @return void <p>値を返しません。</p>
		 * @link https://php.net/manual/ja/domdocument.normalizedocument.php
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
		 * @link https://php.net/manual/ja/domdocument.registernodeclass.php
		 * @since PHP 5 >= 5.2.0, PHP 7
		 */
		 ...
		 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
		 * @link https://php.net/manual/ja/domdocument.relaxngvalidate.php
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
		 * @link https://php.net/manual/ja/domdocument.relaxngvalidatesource.php
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * @link https://php.net/manual/ja/domdocument.save.php
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * @link https://php.net/manual/ja/domdocument.savehtml.php
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * @return int <p>書き込んだバイト数、あるいはエラーが発生した場合は <b><code>FALSE</code></b> を返します。</p>
		 * @link https://php.net/manual/ja/domdocument.savehtmlfile.php
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * @link https://php.net/manual/ja/domdocument.savexml.php
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
		 * @link https://php.net/manual/ja/domdocument.schemavalidate.php
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * @param int $flags <p>Libxml のスキーマ検証フラグのビットマスク。現在サポートしている値は LIBXML_SCHEMA_CREATE だけです。PHP 5.5.2 および Libxml 2.6.14 以降で使えます。</p>
		 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
		 * @link https://php.net/manual/ja/domdocument.schemavalidatesource.php
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * @link https://php.net/manual/ja/domdocument.validate.php
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * @link https://php.net/manual/ja/domdocument.xinclude.php
		 * @since PHP 5, PHP 7
		 */
	...
	/**
	 * @link https://php.net/manual/ja/class.domdocumentfragment.php
	 * @since PHP 5, PHP 7
	 */
	class DOMDocumentFragment extends \DOMNode {
		 ...
		 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
		 * @link https://php.net/manual/ja/domdocumentfragment.appendxml.php
	 ...
	 * @link https://php.net/manual/ja/class.domdocumenttype.php
	 * @since PHP 5, PHP 7
	 */
	class DOMDocumentType extends \DOMNode {
		 ...
		 * @link https://php.net/manual/ja/class.domdocumenttype.php#domdocumenttype.props.publicid
		 */
		public $publicId;

		/**
		 * @var string <p>外部サブセットのシステム ID。完全 URI である場合とそうでない場合がある。</p>
		 * @link https://php.net/manual/ja/class.domdocumenttype.php#domdocumenttype.props.systemid
		 */
		public $systemId;

		/**
		 * @var string <p>DTD の名前。すなわち、<i>DOCTYPE</i> キーワードに続く値。</p>
		 * @link https://php.net/manual/ja/class.domdocumenttype.php#domdocumenttype.props.name
		 */
		public $name;

		/**
		 * @var DOMNamedNodeMap <p>DTD で宣言されている一般エンティティ (外部・内部とも) を含む DOMNamedNodeMap。</p>
		 * @link https://php.net/manual/ja/class.domdocumenttype.php#domdocumenttype.props.entities
		 */
		public $entities;

		/**
		 * @var DOMNamedNodeMap <p>DTD で宣言されている記法を含む DOMNamedNodeMap。</p>
		 * @link https://php.net/manual/ja/class.domdocumenttype.php#domdocumenttype.props.notations
		 */
		public $notations;

		/**
		 * @var string <p>内部サブセットを文字列として取得する。存在しない場合は null となる。区切りの角括弧は含まない。</p>
		 * @link https://php.net/manual/ja/class.domdocumenttype.php#domdocumenttype.props.internalsubset
		 */
	...
	/**
	 * @link https://php.net/manual/ja/class.domelement.php
	 * @since PHP 5, PHP 7
	 */
	class DOMElement extends \DOMNode {
		 ...
		 * @link https://php.net/manual/ja/class.domelement.php#domelement.props.schematypeinfo
		 */
		public $schemaTypeInfo;

		/**
		 * @var string <p>要素名</p>
		 * @link https://php.net/manual/ja/class.domelement.php#domelement.props.tagname
		 */
		public $tagName;
		 ...
		 * @return self
		 * @link https://php.net/manual/ja/domelement.construct.php
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * @link https://php.net/manual/ja/domelement.getattribute.php
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * @link https://php.net/manual/ja/domelement.getattributens.php
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * @link https://php.net/manual/ja/domelement.getattributenode.php
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * @param string $localName <p>ローカル名。</p>
		 * @return DOMAttr <p>属性ノードを返します。 Note that for XML namespace declarations (<i>xmlns</i> and <i>xmlns:&#42;</i> attributes) an instance of <b>DOMNameSpaceNode</b> is returned instead of a DOMAttr.</p>
		 * @link https://php.net/manual/ja/domelement.getattributenodens.php
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * @link https://php.net/manual/ja/domelement.getelementsbytagname.php
		 * @since PHP 5, PHP 7
		 */
		public function getElementsByTagName(string $name): \DOMNodeList {}
		 ...
		 * @link https://php.net/manual/ja/domelement.getelementsbytagnamens.php
		 * @since PHP 5, PHP 7
		 */
		public function getElementsByTagNameNS(string $namespaceURI, string $localName): \DOMNodeList {}
		 ...
		 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
		 * @link https://php.net/manual/ja/domelement.hasattribute.php
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * @param string $localName <p>ローカル名。</p>
		 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
		 * @link https://php.net/manual/ja/domelement.hasattributens.php
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * @param string $name <p>属性の名前。</p>
		 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
		 * @link https://php.net/manual/ja/domelement.removeattribute.php
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * @param string $localName <p>ローカル名。</p>
		 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
		 * @link https://php.net/manual/ja/domelement.removeattributens.php
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
		 * @link https://php.net/manual/ja/domelement.removeattributenode.php
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * @param string $value <p>属性の値。</p>
		 * @return DOMAttr <p>新しい DOMAttr、 あるいはエラーが発生した場合は <b><code>FALSE</code></b> を返します。</p>
		 * @link https://php.net/manual/ja/domelement.setattribute.php
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * @param string $value <p>属性の値。</p>
		 * @return void <p>値を返しません。</p>
		 * @link https://php.net/manual/ja/domelement.setattributens.php
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * @link https://php.net/manual/ja/domelement.setattributenode.php
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * @link https://php.net/manual/ja/domelement.setattributenodens.php
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * @return void <p>値を返しません。</p>
		 * @link https://php.net/manual/ja/domelement.setidattribute.php
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * @param bool $isId <p><code>name</code> を ID 型にしたい場合に <b><code>TRUE</code></b>、 それ以外の場合に <b><code>FALSE</code></b> を設定します。</p>
		 * @return void <p>値を返しません。</p>
		 * @link https://php.net/manual/ja/domelement.setidattributens.php
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * @param bool $isId <p><code>name</code> を ID 型にしたい場合に <b><code>TRUE</code></b>、 それ以外の場合に <b><code>FALSE</code></b> を設定します。</p>
		 * @return void <p>値を返しません。</p>
		 * @link https://php.net/manual/ja/domelement.setidattributenode.php
		 * @since PHP 5, PHP 7
		 */
	 ...
	 * @link https://php.net/manual/ja/class.domentity.php
	 * @since PHP 5, PHP 7
	 */
	class DOMEntity extends \DOMNode {
		 ...
		 * @link https://php.net/manual/ja/class.domentity.php#domentity.props.publicid
		 */
		public $publicId;

		/**
		 * @var string <p>エンティティに関連付けられているシステム ID が存在すればその値、 それ以外の場合は <b><code>NULL</code></b>。これは完全な URI かもしれないし、 そうでないかもしれない。</p>
		 * @link https://php.net/manual/ja/class.domentity.php#domentity.props.systemid
		 */
		public $systemId;

		/**
		 * @var string <p>パースされていないエンティティの場合はそのエンティティの名前、 パース済みのエンティティの場合は <b><code>NULL</code></b></p>
		 * @link https://php.net/manual/ja/class.domentity.php#domentity.props.notationname
		 */
		public $notationName;
		 ...
		 * @link https://php.net/manual/ja/class.domentity.php#domentity.props.actualencoding
		 */
		public $actualEncoding;

		/**
		 * @var string <p>外部でパースされたエンティティの場合は、テキスト宣言の一部として このエンティティのエンコーディングを指定する属性。それ以外の場合は <b><code>NULL</code></b></p>
		 * @link https://php.net/manual/ja/class.domentity.php#domentity.props.encoding
		 */
		public $encoding;

		/**
		 * @var string <p>外部でパースされたエンティティの場合は、テキスト宣言の一部として このエンティティのバージョン番号を指定する属性。それ以外の場合は <b><code>NULL</code></b></p>
		 * @link https://php.net/manual/ja/class.domentity.php#domentity.props.version
		 */
		public $version;
	...
	/**
	 * @link https://php.net/manual/ja/class.domentityreference.php
	 * @since PHP 5, PHP 7
	 */
	class DOMEntityReference extends \DOMNode {
		 ...
		 * @return self
		 * @link https://php.net/manual/ja/domentityreference.construct.php
		 * @since PHP 5, PHP 7
		 */
	 ...
	 * @link https://php.net/manual/ja/class.domexception.php
	 * @since PHP 5, PHP 7
	 */
	class DOMException extends \Exception {
		 ...
		 * @link https://php.net/manual/ja/class.domexception.php#domexception.props.code
		 */
		public $code;
	 ...
	 * @link https://php.net/manual/ja/class.domimplementation.php
	 * @since PHP 5, PHP 7
	 */
	class DOMImplementation {
		 ...
		 * @return self
		 * @link https://php.net/manual/ja/domimplementation.construct.php
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * @link https://php.net/manual/ja/domimplementation.createdocument.php
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * @link https://php.net/manual/ja/domimplementation.createdocumenttype.php
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
		 * @link https://php.net/manual/ja/domimplementation.hasfeature.php
		 * @since PHP 5, PHP 7
		 */
	...
	/**
	 * @link https://php.net/manual/ja/class.domnamednodemap.php
	 * @since PHP 5, PHP 7
	 */
	class DOMNamedNodeMap implements \Traversable {
		 ...
		 * @link https://php.net/manual/ja/class.domnamednodemap.php#domnamednodemap.props.length
		 */
		public $length;
		 ...
		 * @link https://php.net/manual/ja/domnamednodemap.count.php
		 * @since PHP 7 >= 7.2.0
		 */
		 ...
		 * @link https://php.net/manual/ja/domnamednodemap.getnameditem.php
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * @link https://php.net/manual/ja/domnamednodemap.getnameditemns.php
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * @link https://php.net/manual/ja/domnamednodemap.item.php
		 * @since PHP 5, PHP 7
		 */
	...
	/**
	 * @link https://php.net/manual/ja/class.domnode.php
	 * @since PHP 5, PHP 7
	 */
	class DOMNode {
		 ...
		 * @link https://php.net/manual/ja/class.domnode.php#domnode.props.nodename
		 */
		public $nodeName;

		/**
		 * @var string <p>その型に応じてノードの値を返す。 W3C の仕様とは異なり、 DOMElement ノードの値は <b><code>NULL</code></b> ではなく DOMNode::textContent と等しくなる。</p>
		 * @link https://php.net/manual/ja/class.domnode.php#domnode.props.nodevalue
		 */
		public $nodeValue;

		/**
		 * @var int <p>ノードの型を、定義済みの定数 XML_xxx_NODE のいずれかで返す</p>
		 * @link https://php.net/manual/ja/class.domnode.php#domnode.props.nodetype
		 */
		public $nodeType;

		/**
		 * @var DOMNode <p>このノードの親 (存在しない場合は <b><code>NULL</code></b>) を返す</p>
		 * @link https://php.net/manual/ja/class.domnode.php#domnode.props.parentnode
		 */
		public $parentNode;

		/**
		 * @var DOMNodeList <p>このノードのすべての子を含む DOMNodeList。 子が存在しない場合は、空の DOMNodeList</p>
		 * @link https://php.net/manual/ja/class.domnode.php#domnode.props.childnodes
		 */
		public $childNodes;

		/**
		 * @var DOMNode <p>このノードの最初の子。存在しない場合は <b><code>NULL</code></b> を返す</p>
		 * @link https://php.net/manual/ja/class.domnode.php#domnode.props.firstchild
		 */
		public $firstChild;

		/**
		 * @var DOMNode <p>このノードの最後の子。存在しない場合は <b><code>NULL</code></b> を返す</p>
		 * @link https://php.net/manual/ja/class.domnode.php#domnode.props.lastchild
		 */
		public $lastChild;

		/**
		 * @var DOMNode <p>このノードの直前のノード。存在しない場合は <b><code>NULL</code></b> を返す</p>
		 * @link https://php.net/manual/ja/class.domnode.php#domnode.props.previoussibling
		 */
		public $previousSibling;

		/**
		 * @var DOMNode <p>このノードの直後のノード。存在しない場合は <b><code>NULL</code></b> を返す</p>
		 * @link https://php.net/manual/ja/class.domnode.php#domnode.props.nextsibling
		 */
		public $nextSibling;

		/**
		 * @var DOMNamedNodeMap <p>このノードが DOMElement の場合は ノードの属性を含む DOMNamedNodeMap、 それ以外の場合は <b><code>NULL</code></b></p>
		 * @link https://php.net/manual/ja/class.domnode.php#domnode.props.attributes
		 */
		public $attributes;

		/**
		 * @var DOMDocument <p>このノードに関連付けられている DOMDocument オブジェクト</p>
		 * @link https://php.net/manual/ja/class.domnode.php#domnode.props.ownerdocument
		 */
		public $ownerDocument;

		/**
		 * @var string <p>このノードの名前空間 URI。指定されていない場合は <b><code>NULL</code></b></p>
		 * @link https://php.net/manual/ja/class.domnode.php#domnode.props.namespaceuri
		 */
		public $namespaceURI;

		/**
		 * @var string <p>このノードの名前空間プレフィックス。指定されていない場合は <b><code>NULL</code></b></p>
		 * @link https://php.net/manual/ja/class.domnode.php#domnode.props.prefix
		 */
		public $prefix;

		/**
		 * @var string <p>このノードの名前のローカル部分を返す</p>
		 * @link https://php.net/manual/ja/class.domnode.php#domnode.props.localname
		 */
		public $localName;

		/**
		 * @var string <p>このノードの完全なベース URI。もし実装が完全な URL を できなかった場合は <b><code>NULL</code></b></p>
		 * @link https://php.net/manual/ja/class.domnode.php#domnode.props.baseuri
		 */
		public $baseURI;

		/**
		 * @var string <p>このノードとその子孫ノードのテキスト</p>
		 * @link https://php.net/manual/ja/class.domnode.php#domnode.props.textcontent
		 */
		public $textContent;
	...
	/**
	 * @link https://php.net/manual/ja/class.domnodelist.php
	 * @since PHP 5, PHP 7
	 */
	class DOMNodeList implements \Traversable {
		 ...
		 * @link https://php.net/manual/ja/class.domnodelist.php#domnodelist.props.length
		 */
		public $length;
		 ...
		 * @link https://php.net/manual/ja/domnodelist.count.php
		 * @since PHP 7 >= 7.2.0
		 */
		public function count(): int {}
		 ...
		 * @link https://php.net/manual/ja/domnodelist.item.php
		 * @since PHP 5, PHP 7
		 */
	...
	/**
	 * @link https://php.net/manual/ja/class.domnotation.php
	 * @since PHP 5, PHP 7
	 */
	class DOMNotation extends \DOMNode {
		...
		/**
		 * @var string
		 * @link https://php.net/manual/ja/class.domnotation.php#domnotation.props.publicid
		 */
		public $publicId;

		/**
		 * @var string
		 * @link https://php.net/manual/ja/class.domnotation.php#domnotation.props.systemid
		 */
		public $systemId;
	...
	/**
	 * @link https://php.net/manual/ja/class.domprocessinginstruction.php
	 * @since PHP 5, PHP 7
	 */
	class DOMProcessingInstruction extends \DOMNode {
		...
		/**
		 * @var string
		 * @link https://php.net/manual/ja/class.domprocessinginstruction.php#domprocessinginstruction.props.target
		 */
		public $target;

		/**
		 * @var string
		 * @link https://php.net/manual/ja/class.domprocessinginstruction.php#domprocessinginstruction.props.data
		 */
		public $data;
		 ...
		 * @return self
		 * @link https://php.net/manual/ja/domprocessinginstruction.construct.php
		 * @since PHP 5, PHP 7
		 */
		public function __construct(string $name, string $value = NULL) {}
	 ...
	 * @link https://php.net/manual/ja/class.domtext.php
	 * @since PHP 5, PHP 7
	 */
	class DOMText extends \DOMCharacterData {
		 ...
		 * @link https://php.net/manual/ja/class.domtext.php#domtext.props.wholetext
		 */
		public $wholeText;
		 ...
		 * @return self
		 * @link https://php.net/manual/ja/domtext.construct.php
		 * @since PHP 5, PHP 7
		 */
		public function __construct(string $value = NULL) {}
	 ...
	 * @link https://php.net/manual/ja/class.domxpath.php
	 * @since PHP 5, PHP 7
	 */
	class DOMXPath {
		...
		/**
		 * @var DOMDocument
		 * @link https://php.net/manual/ja/class.domxpath.php#domxpath.props.document
		 */
		public $document;
		 ...
		 * @return self
		 * @link https://php.net/manual/ja/domxpath.construct.php
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * @link https://php.net/manual/ja/domxpath.evaluate.php
		 * @since PHP 5 >= 5.1.0, PHP 7
		 */
		 ...
		 * @link https://php.net/manual/ja/domxpath.query.php
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * @param string $namespaceURI <p>名前空間の URI。</p>
		 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
		 * @link https://php.net/manual/ja/domxpath.registernamespace.php
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * @return void <p>値を返しません。</p>
		 * @link https://php.net/manual/ja/domxpath.registerphpfunctions.php
		 * @since PHP 5 >= 5.3.0, PHP 7
		 */
	 ...
	 * @link https://php.net/manual/ja/function.dom-import-simplexml.php
