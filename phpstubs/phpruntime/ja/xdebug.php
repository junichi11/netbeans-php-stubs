 ...
 */
function xdebug_print_function_stack($message, $options) {}
 ...
 */
function xdebug_call_class($depth) {}

/**
 * @param $depth [optional]
 */
function xdebug_call_function($depth) {}

/**
 * @param $depth [optional]
 */
function xdebug_call_file($depth) {}

/**
 * @param $depth [optional]
 */
function xdebug_call_line($depth) {}
 ...
 * @param $options [optional]
 */
function xdebug_start_trace($fname, $options) {}
 ...
 */
function xdebug_get_collected_errors($clear) {}
 ...
 * @param $clear [optional]
 */
function xdebug_get_monitored_functions($clear) {}

/**
 * @param $options [optional]
 */
function xdebug_start_code_coverage($options) {}
