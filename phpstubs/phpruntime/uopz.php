 ...
 * @link http://php.net/manual/ja/function.uopz-add-function.php
 ...
 * @link http://php.net/manual/ja/function.uopz-allow-exit.php
 ...
 * @return void
 * @link http://php.net/manual/ja/function.uopz-backup.php
 ...
 * @return void
 * @link http://php.net/manual/ja/function.uopz-compose.php
 ...
 * @link http://php.net/manual/ja/function.uopz-copy.php
 ...
 * @param string $function <p>The name of the function or method.</p>
 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
 * @link http://php.net/manual/ja/function.uopz-del-function.php
 ...
 * @return void
 * @link http://php.net/manual/ja/function.uopz-delete.php
 * @since PECL uopz 1, PECL uopz 2
 */
 ...
 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
 * @link http://php.net/manual/ja/function.uopz-extend.php
 ...
 * @link http://php.net/manual/ja/function.uopz-flags.php
 ...
 * @return void
 * @link http://php.net/manual/ja/function.uopz-function.php
 * @since PECL uopz 1, PECL uopz 2
 */
 ...
 * @link http://php.net/manual/ja/function.uopz-get-exit-status.php
 * @see uopz_allow_exit()
 * @since PECL uopz 5
 */
 ...
 * @link http://php.net/manual/ja/function.uopz-get-hook.php
 ...
 * @link http://php.net/manual/ja/function.uopz-get-mock.php
 ...
 * @link http://php.net/manual/ja/function.uopz-get-property.php
 ...
 * @link http://php.net/manual/ja/function.uopz-get-return.php
 * @since PECL uopz 5
 */
 ...
 * @link http://php.net/manual/ja/function.uopz-get-static.php
 * @see uopz_set_static()
 * @since PECL uopz 5
 */
 ...
 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
 * @link http://php.net/manual/ja/function.uopz-implement.php
 * @since PECL uopz 1, PECL uopz 2, PECL uopz 5
 */
 ...
 * @return void
 * @link http://php.net/manual/ja/function.uopz-overload.php
 * @since PECL uopz 1, PECL uopz 2
 */
 ...
 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
 * @link http://php.net/manual/ja/function.uopz-redefine.php
 * @since PECL uopz 1, PECL uopz 2, PECL uopz 5
 */
 ...
 * @return void
 * @link http://php.net/manual/ja/function.uopz-rename.php
 * @since PECL uopz 1, PECL uopz 2
 */
 ...
 * @param string $function <p>The name of the function</p>
 * @return void
 * @link http://php.net/manual/ja/function.uopz-restore.php
 * @since PECL uopz 1 >= 1.0.3, PECL uopz 2
 */
 ...
 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
 * @link http://php.net/manual/ja/function.uopz-set-hook.php
 ...
 * @return void
 * @link http://php.net/manual/ja/function.uopz-set-mock.php
 ...
 * @return void <p>値を返しません。</p>
 * @link http://php.net/manual/ja/function.uopz-set-property.php
 ...
 * <p>Sets the return value of the <code>function</code> to <code>value</code>. If <code>value</code> is a Closure and <code>execute</code> is set, the Closure will be executed in place of the original function.</p><p><b>注意</b>:</p><p>This function replaces <code>uopz_rename()</code>.</p>
 * @param string $function <p>The name of an existing function</p>
 ...
 * @link http://php.net/manual/ja/function.uopz-set-return.php
 * @since PECL uopz 5
 */
 ...
 * @return void <p>値を返しません。</p>
 * @link http://php.net/manual/ja/function.uopz-set-static.php
 * @see uopz_get_static()
 * @since PECL uopz 5
 */
 ...
 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
 * @link http://php.net/manual/ja/function.uopz-undefine.php
 * @since PECL uopz 1, PECL uopz 2, PECL uopz 5
 */
 ...
 * @param string $function <p>The name of the function or method.</p>
 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
 * @link http://php.net/manual/ja/function.uopz-unset-hook.php
 ...
 * @param string $class <p>The name of the mocked class.</p>
 * @return void
 * @link http://php.net/manual/ja/function.uopz-unset-mock.php
 ...
 * @link http://php.net/manual/ja/function.uopz-unset-return.php
 * @since PECL uopz 5
 */
