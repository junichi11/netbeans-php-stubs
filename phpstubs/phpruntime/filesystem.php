...
namespace {
	 ...
	 * @link https://php.net/manual/ja/function.basename.php
	 ...
	 * @link https://php.net/manual/ja/function.chgrp.php
	 * @see chown(), chmod()
	 * @since PHP 4, PHP 5, PHP 7
	 */
	 ...
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.chmod.php
	 ...
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.chown.php
	 * @see chmod(), chgrp()
	 * @since PHP 4, PHP 5, PHP 7
	 */
	 ...
	 * @link https://php.net/manual/ja/function.clearstatcache.php
	 * @since PHP 4, PHP 5, PHP 7
	 */
	 ...
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.copy.php
	 ...
	 * @link https://php.net/manual/ja/function.dirname.php
	 ...
	 * @link https://php.net/manual/ja/function.disk-free-space.php
	 ...
	 * @link https://php.net/manual/ja/function.disk-total-space.php
	 * @see disk_free_space()
	 * @since PHP 4 >= 4.1.0, PHP 5, PHP 7
	 */
	 ...
	 * @param string $directory <p>ファイルシステムのディレクトリあるいはディスクパーティション。</p>  <p><b>注意</b>:</p> <p>ディレクトリのかわりにファイル名を指定したときの挙動は未定義です。 OS や PHP のバージョンによって結果は異なります。</p>
	 * @return float
	 * @link https://php.net/manual/ja/function.diskfreespace.php
	 * @since PHP 4, PHP 5, PHP 7
	 */
	 ...
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.fclose.php
	 * @see fopen(), fsockopen()
	 * @since PHP 4, PHP 5, PHP 7
	 */
	 ...
	 * @link https://php.net/manual/ja/function.feof.php
	 * @since PHP 4, PHP 5, PHP 7
	 */
	 ...
	 * @param resource $handle <p>ファイルポインタは、有効なファイルポインタである必要があり、 <code>fopen()</code> または <code>fsockopen()</code> で正常にオープンされた （そしてまだ <code>fclose()</code> でクローズされていない） ファイルを指している必要があります。</p>
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.fflush.php
	 ...
	 * @link https://php.net/manual/ja/function.fgetc.php
	 ...
	 * @link https://php.net/manual/ja/function.fgetcsv.php
	 ...
	 * @link https://php.net/manual/ja/function.fgets.php
	 ...
	 * @param string $allowable_tags <p>オプションの 3 番目の引数を使用して、 取り除く必要がないタグを指定することができます。 <code>allowable_tags</code> について詳しくは <code>strip_tags()</code> を参照ください。</p>
	 ...
	 * @link https://php.net/manual/ja/function.fgetss.php
	 ...
	 * @param int $flags <p>オプションのパラメータ <code>flags</code> は、以下の定数のうちのひとつ、あるいは複数の組み合わせとなります。</p>  <b><code>FILE_USE_INCLUDE_PATH</code></b>    include_path のファイルを探します。    <b><code>FILE_IGNORE_NEW_LINES</code></b>    配列の各要素の最後の改行を省略します。    <b><code>FILE_SKIP_EMPTY_LINES</code></b>    空行を読み飛ばします。
	 ...
	 * @return array <p>ファイルを配列に入れて返します。 配列の各要素はファイルの各行に対応します。改行記号はついたままとなります。 失敗すると <b>file()</b> は <b><code>FALSE</code></b> を返します。</p> <p><b>注意</b>:</p> <p><b><code>FILE_IGNORE_NEW_LINES</code></b> を指定しない限り、 配列に取り込まれた各行は行末文字も含みます。</p> <p><b>注意</b>:  マッキントッシュコンピュータ上で作成されたファイルを読み込む際に、 <i>PHP</i> が行末を認識できないという問題が発生した場合、 実行時の設定オプションauto_detect_line_endings を有効にする必要が生じるかもしれません。</p>
	 * @link https://php.net/manual/ja/function.file.php
	 ...
	 * @link https://php.net/manual/ja/function.file-exists.php
	 ...
	 * @link https://php.net/manual/ja/function.file-get-contents.php
	 ...
	 * @link https://php.net/manual/ja/function.file-put-contents.php
	 ...
	 * @link https://php.net/manual/ja/function.fileatime.php
	 ...
	 * @link https://php.net/manual/ja/function.filectime.php
	 * @see filemtime()
	 * @since PHP 4, PHP 5, PHP 7
	 */
	 ...
	 * @link https://php.net/manual/ja/function.filegroup.php
	 ...
	 * @link https://php.net/manual/ja/function.fileinode.php
	 * @see getmyinode(), stat()
	 * @since PHP 4, PHP 5, PHP 7
	 */
	 ...
	 * @link https://php.net/manual/ja/function.filemtime.php
	 ...
	 * @link https://php.net/manual/ja/function.fileowner.php
	 ...
	 * @param string $filename <p>ファイルへのパス。</p>
	 * @return int <p>ファイルのパーミッションを数値モードで返します。このモードの下位ビットは <code>chmod()</code> に渡すのと同じ形式です。 しかし、大半のプラットフォームでは、それだけではなく <code>filename</code> のファイル形式に関する情報も含まれます。 以下の例で示すのは、ファイルのパーミッションやファイル形式を POSIX システム (Linux や macOS など) で調べる方法です。</p><p>ローカルファイルの場合、その返り値は C ライブラリ関数 <code>stat()</code> が返す構造体の <i>st_mode</i> メンバーの値となります。 どのビットがセットされるかはプラットフォームによって異なるので、 パーミッション部分以外のビットをパースしたい場合は各プラットフォームのドキュメントを参照することをおすすめします。</p>
	 * @link https://php.net/manual/ja/function.fileperms.php
	 ...
	 * @link https://php.net/manual/ja/function.filesize.php
	 * @see file_exists()
	 * @since PHP 4, PHP 5, PHP 7
	 */
	 ...
	 * @link https://php.net/manual/ja/function.filetype.php
	 ...
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.flock.php
	 * @since PHP 4, PHP 5, PHP 7
	 */
	 ...
	 * @link https://php.net/manual/ja/function.fnmatch.php
	 ...
	 * @link https://php.net/manual/ja/function.fopen.php
	 ...
	 * @link https://php.net/manual/ja/function.fpassthru.php
	 ...
	 * @link https://php.net/manual/ja/function.fputcsv.php
	 * @see fgetcsv()
	 ...
	 * @return int
	 * @link https://php.net/manual/ja/function.fputs.php
	 * @since PHP 4, PHP 5, PHP 7
	 */
	 ...
	 * @link https://php.net/manual/ja/function.fread.php
	 ...
	 * @link https://php.net/manual/ja/function.fscanf.php
	 ...
	 * @link https://php.net/manual/ja/function.fseek.php
	 * @see ftell(), rewind()
	 * @since PHP 4, PHP 5, PHP 7
	 */
	 ...
	 * @link https://php.net/manual/ja/function.fstat.php
	 * @since PHP 4, PHP 5, PHP 7
	 */
	 ...
	 * @link https://php.net/manual/ja/function.ftell.php
	 ...
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.ftruncate.php
	 * @see fopen(), fseek()
	 * @since PHP 4, PHP 5, PHP 7
	 */
	 ...
	 * @link https://php.net/manual/ja/function.fwrite.php
	 ...
	 * @link https://php.net/manual/ja/function.glob.php
	 ...
	 * @link https://php.net/manual/ja/function.is-dir.php
	 ...
	 * @link https://php.net/manual/ja/function.is-executable.php
	 * @see is_file(), is_link()
	 * @since PHP 4, PHP 5, PHP 7
	 */
	 ...
	 * @link https://php.net/manual/ja/function.is-file.php
	 * @see is_dir(), is_link()
	 * @since PHP 4, PHP 5, PHP 7
	 */
	 ...
	 * @link https://php.net/manual/ja/function.is-link.php
	 ...
	 * @link https://php.net/manual/ja/function.is-readable.php
	 ...
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.is-uploaded-file.php
	 ...
	 * @link https://php.net/manual/ja/function.is-writable.php
	 ...
	 * @param string $filename <p>調べたいファイル名。</p>
	 * @return bool
	 * @link https://php.net/manual/ja/function.is-writeable.php
	 * @since PHP 4, PHP 5, PHP 7
	 */
	 ...
	 * @param mixed $group <p>グループ名あるいはグループ番号。</p>
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.lchgrp.php
	 ...
	 * @param mixed $user <p>ユーザー名あるいはユーザー番号。</p>
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.lchown.php
	 ...
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.link.php
	 ...
	 * @link https://php.net/manual/ja/function.linkinfo.php
	 ...
	 * @link https://php.net/manual/ja/function.lstat.php
	 * @see stat()
	 * @since PHP 4, PHP 5, PHP 7
	 */
	 ...
	 * @param resource $context <p><b>注意</b>: コンテキストのサポートは、 PHP 5.0.0 で追加されました。<i>contexts</i> の説明に関しては、 ストリーム を参照してください。</p>
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.mkdir.php
	 * @see rmdir()
	 * @since PHP 4, PHP 5, PHP 7
	 */
	 ...
	 * @link https://php.net/manual/ja/function.move-uploaded-file.php
	 ...
	 * @link https://php.net/manual/ja/function.parse-ini-file.php
	 ...
	 * @param int $scanner_mode <p><b><code>INI_SCANNER_NORMAL</code></b> (デフォルト) あるいは <b><code>INI_SCANNER_RAW</code></b>。<b><code>INI_SCANNER_RAW</code></b> を指定すると、オプションの値はパースされません。</p> <p>PHP 5.6.1 以降では <b><code>INI_SCANNER_TYPED</code></b> も指定できるようになりました。 このモードでは、boolean や null そして integer の型を、可能な限り維持します。 文字列 <i>"true"</i>、<i>"on"</i> そして <i>"yes"</i> は <b><code>TRUE</code></b> に変換されます。<i>"false"</i>、<i>"off"</i>、<i>"no"</i> そして <i>"none"</i> は <b><code>FALSE</code></b> だとみなされます。このモードでは、<i>"null"</i> は <b><code>NULL</code></b> に変換されます。また数値形式の文字列も、可能な限り integer 型に変換されます。</p>
	 * @return array <p>成功した場合に設定を連想配列形式で返します。 失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.parse-ini-string.php
	 * @see parse_ini_file()
	 ...
	 * @link https://php.net/manual/ja/function.pathinfo.php
	 ...
	 * @link https://php.net/manual/ja/function.pclose.php
	 * @see popen()
	 * @since PHP 4, PHP 5, PHP 7
	 */
	 ...
	 * @link https://php.net/manual/ja/function.popen.php
	 ...
	 * @link https://php.net/manual/ja/function.readfile.php
	 ...
	 * @link https://php.net/manual/ja/function.readlink.php
	 ...
	 * @param string $path <p>調べたいパス。</p>  <p><b>注意</b>:</p> <p>path の指定は必須ですが、空の文字列を指定することもできます。 その場合はカレントディレクトリを指定したものとみなします。</p>
	 * @return string <p>成功した場合は、正規化された絶対パス名を返します。 返されるパスはシンボリックリンク、<i>/./</i> および <i>/../</i> 要素を含みません。 パスの末尾の区切り文字 (<i>\</i> や <i>/</i> など) は削除されます。</p><p><b>realpath()</b> は、 たとえばファイルが存在しないなどの失敗時に <b><code>FALSE</code></b> を返します。</p> <p><b>注意</b>:</p> <p>指定した階層にあるすべてのディレクトリに対して、 実行中のスクリプトからの実行権限が必要です。もし権限がなければ <b>realpath()</b> は <b><code>FALSE</code></b> を返します。</p>  <p><b>注意</b>:</p> <p>大文字小文字を区別しないファイルシステムの場合は、<b>realpath()</b> が大文字小文字をどちらかにそろえるかもしれないし、そろえないかもしれません。</p>  <p><b>注意</b>:</p> <p><b>realpath()</b> 関数は、Phar の内部にあるファイルに対しては機能しません。 そのようなパスは、実際のパスではなく仮想パスになるからです。</p> <p><b>注意</b>:  PHP の数値型は符号付整数であり、 多くのプラットフォームでは 32 ビットの整数を取るため、 ファイルシステム関数の中には 2GB より大きなファイルについては期待とは違う値を返すものがあります。 </p>
	 * @link https://php.net/manual/ja/function.realpath.php
	 ...
	 * @link https://php.net/manual/ja/function.realpath-cache-get.php
	 ...
	 * @link https://php.net/manual/ja/function.realpath-cache-size.php
	 ...
	 * @param resource $context <p><b>注意</b>: コンテキストのサポートは、 PHP 5.0.0 で追加されました。<i>contexts</i> の説明に関しては、 ストリーム を参照してください。</p>
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.rename.php
	 ...
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.rewind.php
	 ...
	 * @param resource $context <p><b>注意</b>: コンテキストのサポートは、 PHP 5.0.0 で追加されました。<i>contexts</i> の説明に関しては、 ストリーム を参照してください。</p>
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.rmdir.php
	 ...
	 * @return int
	 * @link https://php.net/manual/ja/function.set-file-buffer.php
	 * @since PHP 4, PHP 5, PHP 7
	 */
	 ...
	 * @link https://php.net/manual/ja/function.stat.php
	 ...
	 * @param string $link <p>リンクの名前。</p>
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.symlink.php
	 ...
	 * @link https://php.net/manual/ja/function.tempnam.php
	 ...
	 * @link https://php.net/manual/ja/function.tmpfile.php
	 ...
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.touch.php
	 * @since PHP 4, PHP 5, PHP 7
	 */
	 ...
	 * @link https://php.net/manual/ja/function.umask.php
	 * @since PHP 4, PHP 5, PHP 7
	 */
	 ...
	 * @param resource $context <p><b>注意</b>: コンテキストのサポートは、 PHP 5.0.0 で追加されました。<i>contexts</i> の説明に関しては、 ストリーム を参照してください。</p>
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.unlink.php
	 * @see rmdir()
	 * @since PHP 4, PHP 5, PHP 7
	 */
	...
	/**
	 * <code>filename</code> を include_path から探します。
	 */
