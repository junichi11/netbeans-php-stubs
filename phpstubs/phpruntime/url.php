 ...
 * @param bool $strict <p>If the <code>strict</code> parameter is set to <b><code>TRUE</code></b> then <b>base64_decode()</b> 関数は、 入力に base64 アルファベットの範囲外の文字が含まれる場合に <b><code>FALSE</code></b> を返します。 Otherwise invalid characters will be silently discarded.</p>
