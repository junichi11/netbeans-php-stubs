 ...
 * @link http://php.net/manual/ja/function.session-pgsql-add-error.php
 ...
 * @link http://php.net/manual/ja/function.session-pgsql-get-error.php
 ...
 * <p>この関数は、 現在のところ詳細な情報はありません。引数のリストのみが 記述されています。</p>
 * @return string
 * @link http://php.net/manual/ja/function.session-pgsql-get-field.php
 ...
 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
 * @link http://php.net/manual/ja/function.session-pgsql-reset.php
 * @since PECL session_pgsql SVN
 */
 ...
 * @param string $value
 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
 * @link http://php.net/manual/ja/function.session-pgsql-set-field.php
 ...
 * <p>この関数は、 現在のところ詳細な情報はありません。引数のリストのみが 記述されています。</p>
 * @return array
 * @link http://php.net/manual/ja/function.session-pgsql-status.php
 * @since PECL session_pgsql SVN
 */
