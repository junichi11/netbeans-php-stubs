...
namespace {
	 ...
	 * @link https://php.net/manual/ja/function.bcompiler-load.php
	 ...
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.bcompiler-load-exe.php
	 * @see bcompiler_load()
	 * @since PECL bcompiler >= 0.4
	 */
	 ...
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.bcompiler-parse-class.php
	 * @since PECL bcompiler >= 0.4
	 */
	 ...
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.bcompiler-read.php
	 * @since PECL bcompiler >= 0.4
	 */
	 ...
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.bcompiler-write-class.php
	 ...
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.bcompiler-write-constant.php
	 * @see bcompiler_write_header(), bcompiler_write_footer()
	 ...
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.bcompiler-write-exe-footer.php
	 ...
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.bcompiler-write-file.php
	 * @see bcompiler_write_header(), bcompiler_write_footer()
	 ...
	 * @param resource $filehandle <p><code>fopen()</code> が返すファイルハンドル。</p>
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.bcompiler-write-footer.php
	 ...
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.bcompiler-write-function.php
	 * @see bcompiler_write_header(), bcompiler_write_footer()
	 * @since PECL bcompiler >= 0.5
	 */
	 ...
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.bcompiler-write-functions-from-file.php
	 * @see bcompiler_write_header(), bcompiler_write_footer()
	 * @since PECL bcompiler >= 0.5
	 */
	 ...
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.bcompiler-write-header.php
	 ...
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.bcompiler-write-included-filename.php
	 * @since PECL bcompiler >= 0.5
	 */
