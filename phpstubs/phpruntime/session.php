...
/**
 * @link http://php.net/manual/ja/class.sessionidinterface.php
 * @since PHP 5 >= 5.5.1, PHP 7
 */
class SessionIdInterface {
	 ...
	 * @return string
	 * @link http://php.net/manual/ja/sessionidinterface.create-sid.php
	 * @since PHP 5 >= 5.5.1, PHP 7
	 */
...
/**
 * @link http://php.net/manual/ja/class.sessionupdatetimestamphandlerinterface.php
 * @since PHP 7
 */
class SessionUpdateTimestampHandlerInterface {
	 ...
	 * @link http://php.net/manual/ja/sessionupdatetimestamphandlerinterface.updatetimestamp.php
	 * @since PHP 7
	 */
	 ...
	 * @link http://php.net/manual/ja/sessionupdatetimestamphandlerinterface.validateid.php
	 * @since PHP 7
	 */
 ...
 * @link http://php.net/manual/ja/function.session-create-id.php
 ...
 * @link http://php.net/manual/ja/function.session-gc.php
