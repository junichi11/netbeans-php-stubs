...
/**
 * <p>OCI8 コレクション機能です。</p>
 * @link http://php.net/manual/ja/class.OCI-Collection.php
...
class OCI_Collection {
	 ...
	 * @link http://php.net/manual/ja/oci-collection.append.php
	 * @since PHP 5, PHP 7, PECL OCI8 >= 1.1.0
	 */
	 ...
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link http://php.net/manual/ja/oci-collection.assign.php
	 * @since PHP 5, PHP 7, PECL OCI8 >= 1.1.0
	 */
	 ...
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link http://php.net/manual/ja/oci-collection.assignelem.php
	 * @since PHP 5, PHP 7, PECL OCI8 >= 1.1.0
	 */
	 ...
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link http://php.net/manual/ja/oci-collection.free.php
	 * @since PHP 5, PHP 7, PECL OCI8 >= 1.1.0
	 */
	 ...
	 * @link http://php.net/manual/ja/oci-collection.getelem.php
	 * @since PHP 5, PHP 7, PECL OCI8 >= 1.1.0
	 */
	 ...
	 * @link http://php.net/manual/ja/oci-collection.max.php
	 * @since PHP 5, PHP 7, PECL OCI8 >= 1.1.0
	 */
	 ...
	 * @link http://php.net/manual/ja/oci-collection.size.php
	 * @since PHP 5, PHP 7, PECL OCI8 >= 1.1.0
	 */
	 ...
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link http://php.net/manual/ja/oci-collection.trim.php
	 * @since PHP 5, PHP 7, PECL OCI8 >= 1.1.0
	 */
