...
namespace parallel {
	...
	/**
	 * @link https://php.net/manual/ja/class.parallel-channel.php
	 * @since 0.9.0
	 */
	final class Channel {
		 ...
		 * @return self
		 * @link https://php.net/manual/ja/parallel-channel.construct.php
		 * @since 1.1.0
		 */
		 ...
		 * @return void
		 * @link https://php.net/manual/ja/parallel-channel.close.php
		 * @since 0.9.0
		 */
		 ...
		 * @return Channel
		 * @link https://php.net/manual/ja/parallel-channel.make.php
		 * @since 0.9.0
		 */
		 ...
		 * @param string $name
		 * @return Channel
		 * @link https://php.net/manual/ja/parallel-channel.open.php
		 * @since 0.9.0
		 */
		 ...
		 * @return mixed
		 * @link https://php.net/manual/ja/parallel-channel.recv.php
		 * @since 0.9.0
		 */
		 ...
		 * @param mixed $value
		 * @return void
		 * @link https://php.net/manual/ja/parallel-channel.send.php
		 * @since 0.9.0
		 */
	...
	/**
	 * @link https://php.net/manual/ja/class.parallel-events.php
	 * @since 0.9.0
	 */
	final class Events implements \Countable, \Traversable {
		 ...
		 * @return void
		 * @link https://php.net/manual/ja/parallel-events.addchannel.php
		 * @since 0.9.0
		 */
		 ...
		 * @return void
		 * @link https://php.net/manual/ja/parallel-events.addfuture.php
		 * @since 0.9.0
		 */
		 ...
		 * @return ?Event <p>Should there be no targets remaining, null shall be returned</p><p>Should this be a non-blocking loop, and blocking would occur, null shall be returned</p><p>Otherwise, the parallel\Events\Event returned describes the event.</p>
		 * @link https://php.net/manual/ja/parallel-events.poll.php
		 * @since 0.9.0
		 */
		 ...
		 * @param string $target
		 * @return void
		 * @link https://php.net/manual/ja/parallel-events.remove.php
		 * @since 0.9.0
		 */
		 ...
		 * @param bool $blocking
		 * @return void
		 * @link https://php.net/manual/ja/parallel-events.setblocking.php
		 * @since 0.9.0
		 */
		 ...
		 * @param \Input $input
		 * @return void
		 * @link https://php.net/manual/ja/parallel-events.setinput.php
		 * @since 0.9.0
		 */
		 ...
		 * @param int $timeout
		 * @return void
		 * @link https://php.net/manual/ja/parallel-events.settimeout.php
		 * @since 0.9.0
		 */
		 ...
		 * @return mixed
		 * @link https://php.net/manual/ja/parallel-future.value.php
		 * @since 0.8.0
		 */
...
namespace parallel\Events {
	...
	/**
	 * @link https://php.net/manual/ja/class.parallel-events-event.php
	 * @since 0.9.0
	 */
	final class Event {
...
namespace parallel\Events\Event {
	...
	/**
	 * @link https://php.net/manual/ja/class.parallel-events-event-type.php
	 * @since 0.9.0
	 */
	final class Type {
...
namespace parallel\Events {
	...
	/**
	 * @link https://php.net/manual/ja/class.parallel-events-input.php
	 * @since 0.9.0
	 */
	final class Input {
		 ...
		 * @param mixed $value
		 * @return void
		 * @link https://php.net/manual/ja/parallel-events-input.add.php
		 * @since 0.9.0
		 */
		 ...
		 * @return void
		 * @link https://php.net/manual/ja/parallel-events-input.clear.php
		 * @since 0.9.0
		 */
		 ...
		 * @param string $target
		 * @return void
		 * @link https://php.net/manual/ja/parallel-events-input.remove.php
		 * @since 0.9.0
		 */
		public function remove(string $target): void {}
	}
...
namespace parallel {
	...
	/**
	 * @link https://php.net/manual/ja/class.parallel-future.php
	 * @since 0.8.0
	 */
	final class Future {
		...
		/**
		 * Cancellation
		 * <p>Shall try to cancel the task</p><p><b>注意</b>:</p><p>If task is running, it will be interrupted.</p><p>Internal function calls in progress cannot be interrupted.</p>
		 * @return bool
		 * @link https://php.net/manual/ja/parallel-future.cancel.php
		 * @since 0.9.0
		 */
		 ...
		 * @return bool
		 * @link https://php.net/manual/ja/parallel-future.cancelled.php
		 * @since 0.9.0
		 */
		 ...
		 * @return bool
		 * @link https://php.net/manual/ja/parallel-future.done.php
		 * @since 0.8.0
		 */
	...
	/**
	 * @link https://php.net/manual/ja/class.parallel-runtime.php
	 * @since 0.8.0
	 */
	final class Runtime {
		 ...
		 * @return self
		 * @link https://php.net/manual/ja/parallel-runtime.construct.php
		 * @since 0.8.0
		 */
		public function __construct() {}
		 ...
		 * <p>Shall request that the runtime shutsdown.</p><p><b>注意</b>:</p><p>Tasks scheduled for execution will be executed before the shutdown occurs.</p>
		 * @return void
		 * @link https://php.net/manual/ja/parallel-runtime.close.php
		 * @since 0.8.0
		 */
		public function close(): void {}
		...
		/**
		 * Runtime Join
		 * <p>Shall attempt to force the runtime to shutdown.</p><p><b>注意</b>:</p><p>Tasks scheduled for execution will not be executed, the currently running task shall be interrupted.</p><p>Internal function calls in progress cannot be interrupted.</p>
		 * @return void
		 * @link https://php.net/manual/ja/parallel-runtime.kill.php
		 * @since 0.8.0
		 */
		 ...
		 * @return ?Future <b>警告</b> <p>The return \parallel\Future must not be ignored when the task contains a return or throw statement.</p>
		 * @link https://php.net/manual/ja/parallel-runtime.run.php
		 * @since 0.8.0
		 */
	...
	/**
	 * @link https://php.net/manual/ja/class.parallel-sync.php
	 * @since 1.1.0
	 */
	final class Sync {
		 ...
		 * @return self
		 * @link https://php.net/manual/ja/parallel-sync.construct.php
		 * @since 1.1.0
		 */
		public function __construct() {}
		 ...
		 * @return mixed
		 * @link https://php.net/manual/ja/parallel-sync.invoke.php
		 * @since 1.1.0
		 */
		 ...
		 * @return scalar
		 * @link https://php.net/manual/ja/parallel-sync.get.php
		 * @since 1.1.0
		 */
		 ...
		 * @param bool $all
		 * @return void
		 * @link https://php.net/manual/ja/parallel-sync.notify.php
		 * @since 1.1.0
		 */
		 ...
		 * @param \scalar $value
		 * @return void
		 * @link https://php.net/manual/ja/parallel-sync.set.php
		 * @since 1.1.0
		 */
		 ...
		 * @return void
		 * @link https://php.net/manual/ja/parallel-sync.wait.php
		 * @since 1.1.0
		 */
