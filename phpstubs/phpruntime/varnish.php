...
namespace {
	...
	/**
	 * @link https://php.net/manual/ja/class.varnishadmin.php
	...
	class VarnishAdmin {
		 ...
		 * @return self
		 * @link https://php.net/manual/ja/varnishadmin.construct.php
		 * @since PECL varnish >= 0.3
		 */
		 ...
		 * @link https://php.net/manual/ja/varnishadmin.auth.php
		 * @since PECL varnish >= 0.3
		 */
		 ...
		 * @link https://php.net/manual/ja/varnishadmin.ban.php
		 * @since PECL varnish >= 0.3
		 */
		 ...
		 * @return int <p>varnish のコマンドステータスを返します。</p>
		 * @link https://php.net/manual/ja/varnishadmin.banurl.php
		 * @since PECL varnish >= 0.3
		 */
		 ...
		 * @return int <p>varnish のコマンドステータスを返します。</p>
		 * @link https://php.net/manual/ja/varnishadmin.clearpanic.php
		 ...
		 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
		 * @link https://php.net/manual/ja/varnishadmin.connect.php
		 * @since PECL varnish >= 0.3
		 */
		 ...
		 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
		 * @link https://php.net/manual/ja/varnishadmin.disconnect.php
		 ...
		 * @link https://php.net/manual/ja/varnishadmin.getpanic.php
		 * @since PECL varnish >= 0.4
		 */
		 ...
		 * @link https://php.net/manual/ja/varnishadmin.getparams.php
		 * @since PECL varnish >= 0.4
		 */
		 ...
		 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
		 * @link https://php.net/manual/ja/varnishadmin.isrunning.php
		 * @since PECL varnish >= 0.3
		 */
		 ...
		 * @return void
		 * @link https://php.net/manual/ja/varnishadmin.setcompat.php
		 ...
		 * @return void
		 * @link https://php.net/manual/ja/varnishadmin.sethost.php
		 ...
		 * @return void
		 * @link https://php.net/manual/ja/varnishadmin.setident.php
		 * @since PECL varnish >= 0.8
		 */
		 ...
		 * @return int <p>varnish のコマンドステータスを返します。</p>
		 * @link https://php.net/manual/ja/varnishadmin.setparam.php
		 * @since PECL varnish >= 0.4
		 */
		 ...
		 * @return void
		 * @link https://php.net/manual/ja/varnishadmin.setport.php
		 * @since PECL varnish >= 0.8
		 */
		 ...
		 * @return void
		 * @link https://php.net/manual/ja/varnishadmin.setsecret.php
		 * @since PECL varnish >= 0.8
		 */
		 ...
		 * @return void
		 * @link https://php.net/manual/ja/varnishadmin.settimeout.php
		 * @since PECL varnish >= 0.8
		 */
		 ...
		 * @return int <p>varnish のコマンドステータスを返します。</p>
		 * @link https://php.net/manual/ja/varnishadmin.start.php
		 * @since PECL varnish >= 0.3
		 */
		 ...
		 * @return int <p>varnish のコマンドステータスを返します。</p>
		 * @link https://php.net/manual/ja/varnishadmin.stop.php
		 * @since PECL varnish >= 0.3
		 */
	...
	/**
	 * @link https://php.net/manual/ja/class.varnishlog.php
	...
	class VarnishLog {
		 ...
		 * @return self
		 * @link https://php.net/manual/ja/varnishlog.construct.php
		 * @since PECL varnish >= 0.6
		 */
		public function __construct(array $args = NULL) {}
		 ...
		 * @link https://php.net/manual/ja/varnishlog.getline.php
		 * @since PECL varnish >= 0.6
		 */
		 ...
		 * @link https://php.net/manual/ja/varnishlog.gettagname.php
		 * @since PECL varnish >= 0.6
		 */
	...
	/**
	 * @link https://php.net/manual/ja/class.varnishstat.php
	 * @since PECL varnish >= 0.3
	 */
	class VarnishStat {
		 ...
		 * @param array $args <p>設定用の引数。次のキーが使えます。</p> <pre>VARNISH_CONFIG_IDENT - ローカル varnish インスタンスの ident パス。</pre>
		 * @return self
		 * @link https://php.net/manual/ja/varnishstat.construct.php
		 * @since PECL varnish >= 0.3
		 */
		public function __construct(array $args = NULL) {}
		 ...
		 * @link https://php.net/manual/ja/varnishstat.getsnapshot.php
		 * @since PECL varnish >= 0.3
		 */
