...
namespace {
	 ...
	 * @link https://php.net/manual/ja/function.mailparse-determine-best-xfer-encoding.php
	 ...
	 * @link https://php.net/manual/ja/function.mailparse-msg-create.php
	 ...
	 * @link https://php.net/manual/ja/function.mailparse-msg-extract-part.php
	 ...
	 * @link https://php.net/manual/ja/function.mailparse-msg-extract-part-file.php
	 ...
	 * @param callable $callbackfunc
	 * @return string
	 * @link https://php.net/manual/ja/function.mailparse-msg-extract-whole-part-file.php
	 ...
	 * @link https://php.net/manual/ja/function.mailparse-msg-free.php
	 ...
	 * @return resource
	 * @link https://php.net/manual/ja/function.mailparse-msg-get-part.php
	 * @since PECL mailparse >= 0.9.0
	 */
	 ...
	 * @param resource $mimemail <p>有効な <i>MIME</i> リソース。</p>
	 * @return array
	 * @link https://php.net/manual/ja/function.mailparse-msg-get-part-data.php
	 * @since PECL mailparse >= 0.9.0
	 */
	 ...
	 * @param resource $mimemail <p>有効な <i>MIME</i> リソース。</p>
	 * @return array
	 * @link https://php.net/manual/ja/function.mailparse-msg-get-structure.php
	 * @since PECL mailparse >= 0.9.0
	 */
	 ...
	 * @param string $data
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.mailparse-msg-parse.php
	 * @since PECL mailparse >= 0.9.0
	 */
	 ...
	 * @link https://php.net/manual/ja/function.mailparse-msg-parse-file.php
	 ...
	 * @link https://php.net/manual/ja/function.mailparse-rfc822-parse-addresses.php
	 * @since PECL mailparse >= 0.9.0
	 */
	 ...
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.mailparse-stream-encode.php
	 * @since PECL mailparse >= 0.9.0
	 */
	 ...
	 * @link https://php.net/manual/ja/function.mailparse-uudecode-all.php
	 * @since PECL mailparse >= 0.9.0
	 */
