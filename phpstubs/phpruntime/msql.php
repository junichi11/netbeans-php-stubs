 ...
 * @return resource
 * @link http://php.net/manual/ja/function.msql.php
 ...
 * @link http://php.net/manual/ja/function.msql-affected-rows.php
 * @see msql_query()
 * @since PHP 4, PHP 5, PHP 7
 */
 ...
 * @link http://php.net/manual/ja/function.msql-close.php
 ...
 * @link http://php.net/manual/ja/function.msql-connect.php
 ...
 * @param resource $link_identifier <p>mSQL 接続。 指定されない場合、<code>msql_connect()</code> により直近にオープンされたリンクが 指定されたと仮定されます。そのようなリンクがない場合、この関数は、 <code>msql_connect()</code>をコールした時と同様にリンクを確立し、使用します。</p>
 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
 * @link http://php.net/manual/ja/function.msql-create-db.php
 * @see msql_drop_db()
 * @since PHP 4, PHP 5, PHP 7
 */
 ...
 * @param resource $link_identifier <p>mSQL 接続。 指定されない場合、<code>msql_connect()</code> により直近にオープンされたリンクが 指定されたと仮定されます。そのようなリンクがない場合、この関数は、 <code>msql_connect()</code>をコールした時と同様にリンクを確立し、使用します。</p>
 * @return bool
 * @link http://php.net/manual/ja/function.msql-createdb.php
 * @since PHP 4, PHP 5, PHP 7
 */
 ...
 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
 * @link http://php.net/manual/ja/function.msql-data-seek.php
 ...
 * @param resource $link_identifier <p>mSQL 接続。 指定されない場合、<code>msql_connect()</code> により直近にオープンされたリンクが 指定されたと仮定されます。そのようなリンクがない場合、この関数は、 <code>msql_connect()</code>をコールした時と同様にリンクを確立し、使用します。</p>
 * @return resource <p>成功した場合には正の mSQL リンク IDを、エラー時には <b><code>FALSE</code></b> を返します。</p>
 * @link http://php.net/manual/ja/function.msql-db-query.php
 * @see msql_query()
 * @since PHP 4, PHP 5, PHP 7
 */
 ...
 * @return string
 * @link http://php.net/manual/ja/function.msql-dbname.php
 * @since PHP 4, PHP 5, PHP 7
 */
 ...
 * @param resource $link_identifier <p>mSQL 接続。 指定されない場合、<code>msql_connect()</code> により直近にオープンされたリンクが 指定されたと仮定されます。そのようなリンクがない場合、この関数は、 <code>msql_connect()</code>をコールした時と同様にリンクを確立し、使用します。</p>
 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
 * @link http://php.net/manual/ja/function.msql-drop-db.php
 * @see msql_create_db()
 * @since PHP 4, PHP 5, PHP 7
 */
 ...
 * @link http://php.net/manual/ja/function.msql-error.php
 * @since PHP 4, PHP 5, PHP 7
 */
 ...
 * @link http://php.net/manual/ja/function.msql-fetch-array.php
 ...
 * @link http://php.net/manual/ja/function.msql-fetch-field.php
 * @see msql_field_seek()
 * @since PHP 4, PHP 5, PHP 7
 */
 ...
 * @link http://php.net/manual/ja/function.msql-fetch-object.php
 ...
 * @link http://php.net/manual/ja/function.msql-fetch-row.php
 ...
 * @link http://php.net/manual/ja/function.msql-field-flags.php
 * @since PHP 4, PHP 5, PHP 7
 */
 ...
 * @link http://php.net/manual/ja/function.msql-field-len.php
 * @since PHP 4, PHP 5, PHP 7
 */
 ...
 * @link http://php.net/manual/ja/function.msql-field-name.php
 * @see msql_field_len()
 * @since PHP 4, PHP 5, PHP 7
 */
 ...
 * @param int $field_offset <p>数値フィールドオフセット。 <code>field_offset</code> は、<i>1</i>から始まります。</p>
 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
 * @link http://php.net/manual/ja/function.msql-field-seek.php
 ...
 * @link http://php.net/manual/ja/function.msql-field-table.php
 * @since PHP 4, PHP 5, PHP 7
 */
 ...
 * @param resource $result <p>評価された結果 リソース。 この結果は、<code>msql_query()</code> のコールにより得られたものです。</p>
 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
 * @link http://php.net/manual/ja/function.msql-free-result.php
 * @since PHP 4, PHP 5, PHP 7
 */
 ...
 * @link http://php.net/manual/ja/function.msql-list-dbs.php
 ...
 * @param resource $link_identifier <p>mSQL 接続。 指定されない場合、<code>msql_connect()</code> により直近にオープンされたリンクが 指定されたと仮定されます。そのようなリンクがない場合、この関数は、 <code>msql_connect()</code>をコールした時と同様にリンクを確立し、使用します。</p>
 * @return resource <p>結果セットを返します。これは <code>msql_fetch_array()</code> のような結果セットを読み込む関数によって処理が可能です。失敗した場合は、 この関数は <b><code>FALSE</code></b> を返します。</p>
 * @link http://php.net/manual/ja/function.msql-list-fields.php
 ...
 * @param resource $link_identifier <p>mSQL 接続。 指定されない場合、<code>msql_connect()</code> により直近にオープンされたリンクが 指定されたと仮定されます。そのようなリンクがない場合、この関数は、 <code>msql_connect()</code>をコールした時と同様にリンクを確立し、使用します。</p>
 * @return resource <p>結果セットを返します。これは <code>msql_fetch_array()</code> のような結果セットを読み込む関数によって処理が可能です。失敗した場合は、 この関数は <b><code>FALSE</code></b> を返します。</p>
 * @link http://php.net/manual/ja/function.msql-list-tables.php
 ...
 * @link http://php.net/manual/ja/function.msql-num-fields.php
 ...
 * @link http://php.net/manual/ja/function.msql-num-rows.php
 * @see msql_num_fields()
 * @since PHP 4, PHP 5, PHP 7
 */
...
/**
 * msql_num_fields() のエイリアス
 * <p>この関数は次の関数のエイリアスです。 <code>msql_num_fields()</code></p>
 * @param resource $result <p>評価された結果 リソース。 この結果は、<code>msql_query()</code> のコールにより得られたものです。</p>
 * @return int
 * @link http://php.net/manual/ja/function.msql-numfields.php
 * @since PHP 4, PHP 5, PHP 7
 */
function msql_numfields($result): int {}

/**
 * msql_num_rows() のエイリアス
 * <p>この関数は次の関数のエイリアスです。 <code>msql_num_rows()</code></p>
 * @param resource $query_identifier
 * @return int
 * @link http://php.net/manual/ja/function.msql-numrows.php
 * @since PHP 4, PHP 5, PHP 7
 */
 ...
 * @return resource <p>成功した場合には正の mSQL リンク IDを、エラー時には <b><code>FALSE</code></b> を返します。</p>
 * @link http://php.net/manual/ja/function.msql-pconnect.php
 ...
 * @param resource $link_identifier <p>mSQL 接続。 指定されない場合、<code>msql_connect()</code> により直近にオープンされたリンクが 指定されたと仮定されます。そのようなリンクがない場合、この関数は、 <code>msql_connect()</code>をコールした時と同様にリンクを確立し、使用します。</p>
 * @return resource <p>成功した場合には正の mSQL リンク IDを、エラー時には <b><code>FALSE</code></b> を返します。</p>
 * @link http://php.net/manual/ja/function.msql-query.php
 ...
 * @return string
 * @link http://php.net/manual/ja/function.msql-regcase.php
 * @since PHP 4, PHP 5, PHP 7
 */
 ...
 * @link http://php.net/manual/ja/function.msql-result.php
 * @since PHP 4, PHP 5, PHP 7
 */
 ...
 * @param resource $link_identifier <p>mSQL 接続。 指定されない場合、<code>msql_connect()</code> により直近にオープンされたリンクが 指定されたと仮定されます。そのようなリンクがない場合、この関数は、 <code>msql_connect()</code>をコールした時と同様にリンクを確立し、使用します。</p>
 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
 * @link http://php.net/manual/ja/function.msql-select-db.php
 ...
 * @param mixed $field <p>フィールドのオフセット、あるいはフィールド名、またはテーブル名 .フィールド名 のいずれか。カラム名がエイリアス定義されている （'select foo as bar from ...'）場合、カラム名のかわりに エイリアスを使用します。</p>  <p><b>注意</b>:</p> <p>フィールド名やテーブル名.フィールド名を指定するよりも フィールドのオフセットを数値で指定するほうがはるかに高速です。</p>
 * @return string
 * @link http://php.net/manual/ja/function.msql-tablename.php
 * @since PHP 4, PHP 5, PHP 7
 */
