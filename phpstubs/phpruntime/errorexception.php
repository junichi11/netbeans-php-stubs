...
namespace {
	...
	/**
	 * <p>エラー例外です。</p>
	 * @link https://php.net/manual/ja/class.errorexception.php
	...
	class ErrorException extends \Exception {
		...
		/**
		 * @var int <p>例外の深刻度</p>
		 * @link https://php.net/manual/ja/class.errorexception.php#errorexception.props.severity
		 */
		protected $severity;
		 ...
		 * @return self
		 * @link https://php.net/manual/ja/errorexception.construct.php
		 * @since PHP 5 >= 5.1.0, PHP 7
		 */
		 ...
		 * @link https://php.net/manual/ja/errorexception.getseverity.php
		 * @since PHP 5 >= 5.1.0, PHP 7
		 */
