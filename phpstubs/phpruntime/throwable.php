...
namespace {
	 ...
	 * @link https://php.net/manual/ja/class.throwable.php
	 * @since PHP 7
	 */
	interface Throwable {
		 ...
		 * @link https://php.net/manual/ja/throwable.tostring.php
		 * @since PHP 7
		 */
		 ...
		 * @link https://php.net/manual/ja/throwable.getcode.php
		 * @since PHP 7
		 */
		 ...
		 * <p>スローされたオブジェクトが作られたファイル名を取得します。</p>
		 * @return string <p>スローされたオブジェクトが作られたファイル名を返します。</p>
		 * @link https://php.net/manual/ja/throwable.getfile.php
		 * @since PHP 7
		 */
		 ...
		 * @link https://php.net/manual/ja/throwable.getline.php
		 * @since PHP 7
		 */
		 ...
		 * @link https://php.net/manual/ja/throwable.getmessage.php
		 * @since PHP 7
		 */
		 ...
		 * @link https://php.net/manual/ja/throwable.getprevious.php
		 * @since PHP 7
		 */
		 ...
		 * @link https://php.net/manual/ja/throwable.gettrace.php
		 * @since PHP 7
		 */
		 ...
		 * @link https://php.net/manual/ja/throwable.gettraceasstring.php
		 * @since PHP 7
		 */
