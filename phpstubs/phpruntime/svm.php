...
namespace {
	...
	/**
	 * @link https://php.net/manual/ja/class.svm.php
	...
	class SVM {
		 ...
		 * @link https://php.net/manual/ja/svm.construct.php
		 * @since PECL svm >= 0.1.0
		 */
		 ...
		 * @link https://php.net/manual/ja/svm.crossvalidate.php
		 * @since PECL svm >= 0.1.0
		 */
		 ...
		 * @link https://php.net/manual/ja/svm.getoptions.php
		 * @since PECL svm >= 0.1.0
		 */
		 ...
		 * @link https://php.net/manual/ja/svm.setoptions.php
		 * @since PECL svm >= 0.1.0
		 */
		 ...
		 * @link https://php.net/manual/ja/svm.train.php
		 * @since PECL svm >= 0.1.0
		 */
	 ...
	 * @link https://php.net/manual/ja/class.svmmodel.php
	 * @since PECL svm >= 0.1.0
	 */
	class SVMModel {
		 ...
		 * @link https://php.net/manual/ja/svmmodel.construct.php
		 * @since PECL svm >= 0.1.0
		 */
		 ...
		 * @link https://php.net/manual/ja/svmmodel.checkprobabilitymodel.php
		 ...
		 * @link https://php.net/manual/ja/svmmodel.getlabels.php
		 * @since PECL svm >= 0.1.5
		 */
		 ...
		 * @link https://php.net/manual/ja/svmmodel.getnrclass.php
		 * @since PECL svm >= 0.1.5
		 */
		 ...
		 * @link https://php.net/manual/ja/svmmodel.getsvmtype.php
		 * @since PECL svm >= 0.1.5
		 */
		 ...
		 * @link https://php.net/manual/ja/svmmodel.getsvrprobability.php
		 * @since PECL svm >= 0.1.5
		 */
		 ...
		 * @link https://php.net/manual/ja/svmmodel.load.php
		 ...
		 * @link https://php.net/manual/ja/svmmodel.predict.php
		 * @since PECL svm >= 0.1.0
		 */
		 ...
		 * @param array $data <p>The array to be classified. This should be a series of key =&gt; value pairs in increasing key order, but not necessarily continuous.</p>
		 * @return float <p>Float the predicted value. This will be a class label in the case of classification, a real value in the case of regression. Throws SVMException on error</p>
		 * @link https://php.net/manual/ja/svmmodel.predict-probability.php
		 ...
		 * @return bool <p>エラー時に SVMException をスローします。 成功時に true を返します。</p>
		 * @link https://php.net/manual/ja/svmmodel.save.php
		 * @since PECL svm >= 0.1.0
		 */
