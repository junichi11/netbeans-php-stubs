...
namespace {
	 ...
	 * @link https://php.net/manual/ja/function.win32-continue-service.php
	 ...
	 * @link https://php.net/manual/ja/function.win32-create-service.php
	 ...
	 * @return mixed <p>成功した場合に <b><code>WIN32_NO_ERROR</code></b> を返します。パラメータに問題がある場合は <b><code>FALSE</code></b>、失敗した場合は Win32 エラーコード を返します。</p>
	 * @link https://php.net/manual/ja/function.win32-delete-service.php
	 ...
	 * @link https://php.net/manual/ja/function.win32-get-last-control-message.php
	 ...
	 * @param string $machine <p>マシン名。省略可能で、省略した場合はローカルマシンを使います。</p>
	 * @return int <p>成功した場合に <b><code>WIN32_NO_ERROR</code></b> を返します。パラメータに問題がある場合は <b><code>FALSE</code></b>、失敗した場合は Win32 エラーコード を返します。</p>
	 * @link https://php.net/manual/ja/function.win32-pause-service.php
	 * @see win32_start_service()
	 * @since PECL win32service >=0.1.0
	 */
	 ...
	 * @link https://php.net/manual/ja/function.win32-query-service-status.php
	 * @since PECL win32service >=0.1.0
	 */
	 ...
	 * @return int <p>成功した場合に <b><code>WIN32_NO_ERROR</code></b> を返します。パラメータに問題がある場合は <b><code>FALSE</code></b>、失敗した場合は Win32 エラーコード を返します。</p>
	 * @link https://php.net/manual/ja/function.win32-send-custom-control.php
	 ...
	 * @link https://php.net/manual/ja/function.win32-set-service-exit-code.php
	 ...
	 * @link https://php.net/manual/ja/function.win32-set-service-exit-mode.php
	 ...
	 * @link https://php.net/manual/ja/function.win32-set-service-status.php
	 * @see win32_start_service_ctrl_dispatcher()
	 * @since PECL win32service >=0.1.0
	 */
	 ...
	 * @param string $machine <p>オプションのマシン名。指定しなかった場合、ローカルマシンが使用されます。</p>
	 * @return int <p>成功した場合に <b><code>WIN32_NO_ERROR</code></b> を返します。パラメータに問題がある場合は <b><code>FALSE</code></b>、失敗した場合は Win32 エラーコード を返します。</p>
	 * @link https://php.net/manual/ja/function.win32-start-service.php
	 ...
	 * @link https://php.net/manual/ja/function.win32-start-service-ctrl-dispatcher.php
	 ...
	 * @param string $machine <p>オプションのマシン名。指定しなかった場合、ローカルマシンが使用されます。</p>
	 * @return int <p>成功した場合に <b><code>WIN32_NO_ERROR</code></b> を返します。パラメータに問題がある場合は <b><code>FALSE</code></b>、失敗した場合は Win32 エラーコード を返します。</p>
	 * @link https://php.net/manual/ja/function.win32-stop-service.php
	 * @see win32_start_service()
	 * @since PECL win32service >=0.1.0
	 */
