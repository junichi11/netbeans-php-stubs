...
namespace {
	 ...
	 * @link https://php.net/manual/ja/class.splbool.php
	...
	class SplBool extends \SplEnum {
		 ...
		 * @return array
		 * @link https://php.net/manual/ja/splenum.getconstlist.php
		 * @since PECL spl_types >= 0.1.0
		 */
	 ...
	 * @link https://php.net/manual/ja/class.splenum.php
	 * @since PECL spl_types >= 0.1.0
	 */
	class SplEnum extends \SplType {
		 ...
		 * @return self
		 * @link https://php.net/manual/ja/spltype.construct.php
		 * @since PECL spl_types >= 0.1.0
		 */
	 ...
	 * @link https://php.net/manual/ja/class.splfloat.php
	 * @since PECL spl_types >= 0.1.0
	 */
	 ...
	 * @link https://php.net/manual/ja/class.splint.php
	 * @since PECL spl_types >= 0.1.0
	 */
	 ...
	 * @link https://php.net/manual/ja/class.splstring.php
	 * @since PECL spl_types >= 0.1.0
	 */
	 ...
	 * @link https://php.net/manual/ja/class.spltype.php
	 * @since PECL spl_types >= 0.1.0
	 */
