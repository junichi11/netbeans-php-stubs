...
namespace wkhtmltox\Image {
	...
	/**
	 * <p>HTML入力をさまざまな画像形式に変換する</p>
	 * @link https://php.net/manual/ja/class.wkhtmltox-image-converter.php
	...
	class Converter {
		 ...
		 * @return self
		 * @link https://php.net/manual/ja/wkhtmltox-image-converter.construct.php
		 * @since wkhtmltox >= 0.1.0
		 */
		 ...
		 * @link https://php.net/manual/ja/wkhtmltox-image-converter.convert.php
		 * @since wkhtmltox >= 0.1.0
		 */
		 ...
		 * @return string <p>Returns a version string</p> <b>警告</b> <p>This is not yet implemented by libwkhtmltox</p>
		 * @link https://php.net/manual/ja/wkhtmltox-image-converter.getversion.php
...
namespace wkhtmltox\PDF {
	...
	/**
	 * <p>一件あるいは一組のHTML入力をPDF出力に変換する</p>
	 * @link https://php.net/manual/ja/class.wkhtmltox-pdf-converter.php
	 * @since wkhtmltox >= 0.1.0
	 */
	class Converter {
		 ...
		 * @return self
		 * @link https://php.net/manual/ja/wkhtmltox-pdf-converter.construct.php
		 * @since wkhtmltox >= 0.1.0
		 */
		 ...
		 * @return void
		 * @link https://php.net/manual/ja/wkhtmltox-pdf-converter.add.php
		 * @since wkhtmltox >= 0.1.0
		 */
		 ...
		 * @return ?string <p>Where the return value is used, it will be populated with the contents of the conversion buffer</p>
		 * @link https://php.net/manual/ja/wkhtmltox-pdf-converter.convert.php
		 * @since wkhtmltox >= 0.1.0
		 */
		public function convert(): ?string {}
		 ...
		 * @link https://php.net/manual/ja/wkhtmltox-pdf-converter.getversion.php
		 * @since wkhtmltox >= 0.3.2
		 */
		public function getVersion(): string {}
	}
	 ...
	 * @link https://php.net/manual/ja/class.wkhtmltox-pdf-object.php
	 * @since wkhtmltox >= 0.1.0
	 */
	class Object {
		 ...
		 * @return self
		 * @link https://php.net/manual/ja/wkhtmltox-pdf-object.construct.php
		 * @since wkhtmltox >= 0.1.0
		 */
