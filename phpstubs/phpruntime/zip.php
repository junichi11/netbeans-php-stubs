...
class ZipArchive implements \Countable {
	 ...
	 * @link http://php.net/manual/ja/class.ziparchive.php#ziparchive.props.status
	 */
	public $status;

	/**
	 * @var int <p>Zip アーカイブのシステム状態</p>
	 * @link http://php.net/manual/ja/class.ziparchive.php#ziparchive.props.statussys
	 */
	public $statusSys;

	/**
	 * @var int <p>アーカイブ内のファイル数</p>
	 * @link http://php.net/manual/ja/class.ziparchive.php#ziparchive.props.numfiles
	 */
	public $numFiles;

	/**
	 * @var string <p>ファイルシステム上のファイル名</p>
	 * @link http://php.net/manual/ja/class.ziparchive.php#ziparchive.props.filename
	 */
	public $filename;

	/**
	 * @var string <p>アーカイブのコメント</p>
	 * @link http://php.net/manual/ja/class.ziparchive.php#ziparchive.props.comment
	 */
	public $comment;
	 ...
	 * @link http://php.net/manual/ja/ziparchive.count.php
	 ...
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link http://php.net/manual/ja/ziparchive.setencryptionindex.php
	 ...
	 * @param string $password <p>Optional password, default used when missing.</p>
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link http://php.net/manual/ja/ziparchive.setencryptionname.php
	 * @since PHP >= 7.2.0, PECL zip >= 1.14.0
	 */
