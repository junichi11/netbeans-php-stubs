...
/**
 * @link http://php.net/manual/ja/class.mysqlnduhconnection.php
...
class MysqlndUhConnection {
	 ...
	 * @return self
	 * @link http://php.net/manual/ja/mysqlnduhconnection.construct.php
	 * @since PECL mysqlnd-uh >= 1.0.0-alpha
	 */
	 ...
	 * @link http://php.net/manual/ja/mysqlnduhconnection.changeuser.php
	 ...
	 * @link http://php.net/manual/ja/mysqlnduhconnection.charsetname.php
	 ...
	 * @return bool <p>Returns <b><code>TRUE</code></b> on success. Otherwise, returns <b><code>FALSE</code></b></p>
	 * @link http://php.net/manual/ja/mysqlnduhconnection.close.php
	 ...
	 * @return bool <p>Returns <b><code>TRUE</code></b> on success. Otherwise, returns <b><code>FALSE</code></b></p>
	 * @link http://php.net/manual/ja/mysqlnduhconnection.connect.php
	 ...
	 * @param \mysqlnd_connection $connection <p>Mysqlnd connection handle. Do not modify!</p>
	 * @return bool <p>Returns <b><code>TRUE</code></b> on success. Otherwise, returns <b><code>FALSE</code></b></p>
	 * @link http://php.net/manual/ja/mysqlnduhconnection.endpsession.php
	 ...
	 * @link http://php.net/manual/ja/mysqlnduhconnection.escapestring.php
	 ...
	 * @link http://php.net/manual/ja/mysqlnduhconnection.getaffectedrows.php
	 ...
	 * @link http://php.net/manual/ja/mysqlnduhconnection.geterrornumber.php
	 ...
	 * @link http://php.net/manual/ja/mysqlnduhconnection.geterrorstring.php
	 ...
	 * @link http://php.net/manual/ja/mysqlnduhconnection.getfieldcount.php
	 ...
	 * @link http://php.net/manual/ja/mysqlnduhconnection.gethostinformation.php
	 ...
	 * @link http://php.net/manual/ja/mysqlnduhconnection.getlastinsertid.php
	 ...
	 * @link http://php.net/manual/ja/mysqlnduhconnection.getlastmessage.php
	 ...
	 * @link http://php.net/manual/ja/mysqlnduhconnection.getprotocolinformation.php
	 ...
	 * @link http://php.net/manual/ja/mysqlnduhconnection.getserverinformation.php
	 ...
	 * @link http://php.net/manual/ja/mysqlnduhconnection.getserverstatistics.php
	 ...
	 * @link http://php.net/manual/ja/mysqlnduhconnection.getserverversion.php
	 ...
	 * @link http://php.net/manual/ja/mysqlnduhconnection.getsqlstate.php
	 * @see mysqlnd_uh_set_connection_proxy()
	 * @since PECL mysqlnd-uh >= 1.0.0-alpha
	 */
	 ...
	 * @link http://php.net/manual/ja/mysqlnduhconnection.getstatistics.php
	 ...
	 * @link http://php.net/manual/ja/mysqlnduhconnection.getthreadid.php
	 ...
	 * @link http://php.net/manual/ja/mysqlnduhconnection.getwarningcount.php
	 ...
	 * @param \mysqlnd_connection $connection <p>Mysqlnd connection handle. Do not modify!</p>
	 * @return bool <p>Returns <b><code>TRUE</code></b> on success. Otherwise, returns <b><code>FALSE</code></b></p>
	 * @link http://php.net/manual/ja/mysqlnduhconnection.init.php
	 * @see mysqlnd_uh_set_connection_proxy()
	 * @since PECL mysqlnd-uh >= 1.0.0-alpha
	 */
	 ...
	 * @return bool <p>Returns <b><code>TRUE</code></b> on success. Otherwise, returns <b><code>FALSE</code></b></p>
	 * @link http://php.net/manual/ja/mysqlnduhconnection.killconnection.php
	 ...
	 * @return array
	 * @link http://php.net/manual/ja/mysqlnduhconnection.listfields.php
	 ...
	 * @param string $par1
	 * @return void
	 * @link http://php.net/manual/ja/mysqlnduhconnection.listmethod.php
	 ...
	 * @param \mysqlnd_connection $connection <p>Mysqlnd connection handle. Do not modify!</p>
	 * @return bool <p>Returns <b><code>TRUE</code></b> on success. Otherwise, returns <b><code>FALSE</code></b></p>
	 * @link http://php.net/manual/ja/mysqlnduhconnection.moreresults.php
	 ...
	 * @param \mysqlnd_connection $connection <p>Mysqlnd connection handle. Do not modify!</p>
	 * @return bool <p>Returns <b><code>TRUE</code></b> on success. Otherwise, returns <b><code>FALSE</code></b></p>
	 * @link http://php.net/manual/ja/mysqlnduhconnection.nextresult.php
	 ...
	 * @param \mysqlnd_connection $connection <p>Mysqlnd connection handle. Do not modify!</p>
	 * @return bool <p>Returns <b><code>TRUE</code></b> on success. Otherwise, returns <b><code>FALSE</code></b></p>
	 * @link http://php.net/manual/ja/mysqlnduhconnection.ping.php
	 ...
	 * @return bool <p>Returns <b><code>TRUE</code></b> on success. Otherwise, returns <b><code>FALSE</code></b></p>
	 * @link http://php.net/manual/ja/mysqlnduhconnection.query.php
	 ...
	 * @return bool <p>Returns <b><code>TRUE</code></b> on success. Otherwise, returns <b><code>FALSE</code></b></p>
	 * @link http://php.net/manual/ja/mysqlnduhconnection.queryreadresultsetheader.php
	 * @see mysqlnd_uh_set_connection_proxy()
	 * @since PECL mysqlnd-uh >= 1.0.0-alpha
	 */
	 ...
	 * @param \mysqlnd_connection $connection <p>Mysqlnd connection handle. Do not modify!</p>
	 * @return bool <p>Returns <b><code>TRUE</code></b> on success. Otherwise, returns <b><code>FALSE</code></b></p>
	 * @link http://php.net/manual/ja/mysqlnduhconnection.reapquery.php
	 * @see mysqlnd_uh_set_connection_proxy()
	 * @since PECL mysqlnd-uh >= 1.0.0-alpha
	 */
	 ...
	 * @return bool <p>Returns <b><code>TRUE</code></b> on success. Otherwise, returns <b><code>FALSE</code></b></p>
	 * @link http://php.net/manual/ja/mysqlnduhconnection.refreshserver.php
	 * @see mysqlnd_uh_set_connection_proxy()
	 * @since PECL mysqlnd-uh >= 1.0.0-alpha
	 */
	 ...
	 * @param \mysqlnd_connection $connection <p>Mysqlnd connection handle. Do not modify!</p>
	 * @return bool <p>Returns <b><code>TRUE</code></b> on success. Otherwise, returns <b><code>FALSE</code></b></p>
	 * @link http://php.net/manual/ja/mysqlnduhconnection.restartpsession.php
	 * @see mysqlnd_uh_set_connection_proxy()
	 * @since PECL mysqlnd-uh >= 1.0.0-alpha
	 */
	 ...
	 * @return bool <p>Returns <b><code>TRUE</code></b> on success. Otherwise, returns <b><code>FALSE</code></b></p>
	 * @link http://php.net/manual/ja/mysqlnduhconnection.selectdb.php
	 ...
	 * @param \mysqlnd_connection $connection <p>Mysqlnd connection handle. Do not modify!</p>
	 * @return bool <p>Returns <b><code>TRUE</code></b> on success. Otherwise, returns <b><code>FALSE</code></b></p>
	 * @link http://php.net/manual/ja/mysqlnduhconnection.sendclose.php
	 * @see mysqlnd_uh_set_connection_proxy()
	 * @since PECL mysqlnd-uh >= 1.0.0-alpha
	 */
	 ...
	 * @param string $query <p>The query string.</p>
	 * @return bool <p>Returns <b><code>TRUE</code></b> on success. Otherwise, returns <b><code>FALSE</code></b></p>
	 * @link http://php.net/manual/ja/mysqlnduhconnection.sendquery.php
	 * @see mysqlnd_uh_set_connection_proxy()
	 * @since PECL mysqlnd-uh >= 1.0.0-alpha
	 */
	 ...
	 * @param \mysqlnd_connection $connection <p>Mysqlnd connection handle. Do not modify!</p>
	 * @return bool <p>Returns <b><code>TRUE</code></b> on success. Otherwise, returns <b><code>FALSE</code></b></p>
	 * @link http://php.net/manual/ja/mysqlnduhconnection.serverdumpdebuginformation.php
	 ...
	 * @return bool <p>Returns <b><code>TRUE</code></b> on success. Otherwise, returns <b><code>FALSE</code></b></p>
	 * @link http://php.net/manual/ja/mysqlnduhconnection.setautocommit.php
	 ...
	 * @return bool <p>Returns <b><code>TRUE</code></b> on success. Otherwise, returns <b><code>FALSE</code></b></p>
	 * @link http://php.net/manual/ja/mysqlnduhconnection.setcharset.php
	 ...
	 * @return bool <p>Returns <b><code>TRUE</code></b> on success. Otherwise, returns <b><code>FALSE</code></b></p>
	 * @link http://php.net/manual/ja/mysqlnduhconnection.setclientoption.php
	 ...
	 * @link http://php.net/manual/ja/mysqlnduhconnection.setserveroption.php
	 ...
	 * @param string $level
	 * @return void
	 * @link http://php.net/manual/ja/mysqlnduhconnection.shutdownserver.php
	 * @since PECL mysqlnd-uh >= 1.0.0-alpha
	 */
	 ...
	 * @return bool <p>Returns <b><code>TRUE</code></b> on success. Otherwise, returns <b><code>FALSE</code></b></p>
	 * @link http://php.net/manual/ja/mysqlnduhconnection.simplecommand.php
	 * @see mysqlnd_uh_set_connection_proxy()
	 * @since PECL mysqlnd-uh >= 1.0.0-alpha
	 */
	 ...
	 * @param bool $ignore_upsert_status <p>Whether to ignore <i>UPDATE</i>/<i>INSERT</i> status.</p>
	 * @return bool <p>Returns <b><code>TRUE</code></b> on success. Otherwise, returns <b><code>FALSE</code></b></p>
	 * @link http://php.net/manual/ja/mysqlnduhconnection.simplecommandhandleresponse.php
	 * @see mysqlnd_uh_set_connection_proxy()
	 * @since PECL mysqlnd-uh >= 1.0.0-alpha
	 */
	 ...
	 * @return bool <p>Returns <b><code>TRUE</code></b> on success. Otherwise, returns <b><code>FALSE</code></b></p>
	 * @link http://php.net/manual/ja/mysqlnduhconnection.sslset.php
	 ...
	 * @link http://php.net/manual/ja/mysqlnduhconnection.stmtinit.php
	 ...
	 * @link http://php.net/manual/ja/mysqlnduhconnection.storeresult.php
	 ...
	 * @param \mysqlnd_connection $connection <p>Mysqlnd connection handle. Do not modify!</p>
	 * @return bool <p>Returns <b><code>TRUE</code></b> on success. Otherwise, returns <b><code>FALSE</code></b></p>
	 * @link http://php.net/manual/ja/mysqlnduhconnection.txcommit.php
	 ...
	 * @param \mysqlnd_connection $connection <p>Mysqlnd connection handle. Do not modify!</p>
	 * @return bool <p>Returns <b><code>TRUE</code></b> on success. Otherwise, returns <b><code>FALSE</code></b></p>
	 * @link http://php.net/manual/ja/mysqlnduhconnection.txrollback.php
	 * @see mysqlnd_uh_set_connection_proxy(), mysqli_commit()
	 * @since PECL mysqlnd-uh >= 1.0.1-alpha
	 */
	 ...
	 * @param \mysqlnd_connection $connection <p>Mysqlnd connection handle. Do not modify!</p>
	 * @return resource <p>Resource of type <i>Mysqlnd Resultset (internal only - you must not modify it!)</i>. The documentation may also refer to such resources using the alias name <i>mysqlnd_resultset</i>.</p>
	 * @link http://php.net/manual/ja/mysqlnduhconnection.useresult.php
...
/**
 * @link http://php.net/manual/ja/class.mysqlnduhpreparedstatement.php
 * @since PECL mysqlnd-uh >= 1.0.0-alpha
 */
class MysqlndUhPreparedStatement {
	 ...
	 * <p></p><p>この関数は、 現在のところ詳細な情報はありません。引数のリストのみが 記述されています。</p>
	 * @return self
	 * @link http://php.net/manual/ja/mysqlnduhpreparedstatement.construct.php
	 * @since PECL mysqlnd-uh >= 1.0.0-alpha
	 */
	public function __construct() {}
	 ...
	 * @return bool <p>Returns <b><code>TRUE</code></b> on success. Otherwise, returns <b><code>FALSE</code></b></p>
	 * @link http://php.net/manual/ja/mysqlnduhpreparedstatement.execute.php
	 ...
	 * @return bool <p>Returns <b><code>TRUE</code></b> on success. Otherwise, returns <b><code>FALSE</code></b></p>
	 * @link http://php.net/manual/ja/mysqlnduhpreparedstatement.prepare.php
 ...
 * @link http://php.net/manual/ja/function.mysqlnd-uh-convert-to-mysqlnd.php
 * @since PECL mysqlnd-uh >= 1.0.0-alpha
 */
 ...
 * @return bool <p>Returns <b><code>TRUE</code></b> on success. Otherwise, returns <b><code>FALSE</code></b></p>
 * @link http://php.net/manual/ja/function.mysqlnd-uh-set-connection-proxy.php
 ...
 * @return bool <p>Returns <b><code>TRUE</code></b> on success. Otherwise, returns <b><code>FALSE</code></b></p>
 * @link http://php.net/manual/ja/function.mysqlnd-uh-set-statement-proxy.php
 * @see mysqlnd_uh_set_connection_proxy()
 * @since PECL mysqlnd-uh >= 1.0.0-alpha
 */
