...
class Imagick implements \Iterator {
	...
	/**
	 * @var int 黒
	 * @link http://php.net/manual/ja/imagick.constants.php
	 */
	 ...
	 * @link http://php.net/manual/ja/imagick.getimagemagicklicense.php
	 * @since PECL imagick 2.0.0
	 */
	 ...
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を返します。</p>
	 * @link http://php.net/manual/ja/imagick.render.php
	 * @since PECL imagick 2.0.0
	 */
...
class ImagickPixel {
	 ...
	 * @param bool $normalized <p>色を正規化する。</p>
