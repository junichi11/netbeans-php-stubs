...
class SoapClient {
	 ...
	 * @return array
	 * @link http://php.net/manual/ja/soapclient.getcookies.php
...
class SoapFault extends \Exception {
	 ...
	 * @link http://php.net/manual/ja/soapfault.construct.php
	 * @since PHP 5, PHP 7
	 */
...
class SoapHeader {
	 ...
	 * @link http://php.net/manual/ja/soapheader.construct.php
	 * @since PHP 5, PHP 7
	 */
	function __construct() {}
}
...
class SoapParam {
	 ...
	 * @link http://php.net/manual/ja/soapparam.construct.php
	 * @since PHP 5, PHP 7
	 */
	function __construct() {}
}
...
class SoapServer {
	 ...
	 * @link http://php.net/manual/ja/soapserver.construct.php
	 * @since PHP 5, PHP 7
	 */
	function __construct() {}
	 ...
	 * @param mixed $args <p>これらのオプションパラメータは、 オブジェクト作成時にデフォルトのクラスコンストラクタに渡されます。</p>
	 * @param mixed $_
	 * @return void <p>値を返しません。</p>
...
class SoapVar {
	 ...
	 * @link http://php.net/manual/ja/soapvar.construct.php
	 * @since PHP 5, PHP 7
	 */
	function __construct() {}
}
