...
namespace {
	 ...
	 * @link https://php.net/manual/ja/class.oauth.php
	...
	class OAuth {
		...
		/**
		 * @var mixed
		 * @link https://php.net/manual/ja/class.oauth.php#oauth.props.debug
		 */
		public $debug;

		/**
		 * @var mixed
		 * @link https://php.net/manual/ja/class.oauth.php#oauth.props.sslchecks
		 */
		public $sslChecks;

		/**
		 * @var mixed
		 * @link https://php.net/manual/ja/class.oauth.php#oauth.props.debuginfo
		 */
		public $debugInfo;
		 ...
		 * @return self
		 * @link https://php.net/manual/ja/oauth.construct.php
		 * @since PECL OAuth >= 0.99.1
		 */
		 ...
		 * @link https://php.net/manual/ja/oauth.destruct.php
		 ...
		 * @link https://php.net/manual/ja/oauth.disabledebug.php
		 ...
		 * @return bool <p><b><code>TRUE</code></b></p>
		 * @link https://php.net/manual/ja/oauth.disableredirects.php
		 * @since PECL OAuth >= 0.99.9
		 */
		 ...
		 * @return bool <p><b><code>TRUE</code></b></p>
		 * @link https://php.net/manual/ja/oauth.disablesslchecks.php
		 ...
		 * @return bool <p><b><code>TRUE</code></b></p>
		 * @link https://php.net/manual/ja/oauth.enabledebug.php
		 * @since PECL OAuth >= 0.99.3
		 */
		 ...
		 * @return bool <p><b><code>TRUE</code></b></p>
		 * @link https://php.net/manual/ja/oauth.enableredirects.php
		 * @since PECL OAuth >= 0.99.9
		 */
		 ...
		 * @return bool <p><b><code>TRUE</code></b></p>
		 * @link https://php.net/manual/ja/oauth.enablesslchecks.php
		 * @since PECL OAuth >= 0.99.5
		 */
		 ...
		 * @link https://php.net/manual/ja/oauth.fetch.php
		 * @since PECL OAuth >= 0.99.1
		 */
		 ...
		 * @link https://php.net/manual/ja/oauth.generatesignature.php
		 ...
		 * @link https://php.net/manual/ja/oauth.getaccesstoken.php
		 * @since PECL OAuth >= 0.99.1
		 */
		 ...
		 * @link https://php.net/manual/ja/oauth.getcapath.php
		 ...
		 * @link https://php.net/manual/ja/oauth.getlastresponse.php
		 * @since PECL OAuth >= 0.99.1
		 */
		 ...
		 * @link https://php.net/manual/ja/oauth.getlastresponseheaders.php
		 * @since No version information available, might only be in Git
		 */
		 ...
		 * @link https://php.net/manual/ja/oauth.getlastresponseinfo.php
		 * @since PECL OAuth >= 0.99.1
		 */
		 ...
		 * @link https://php.net/manual/ja/oauth.getrequestheader.php
		 * @since No version information available, might only be in Git
		 */
		 ...
		 * @param string $http_method <p>利用する HTTP メソッド。<i>GET</i> や <i>POST</i> など。</p>
		 * @return array <p>成功した場合は OAuth レスポンスをパースした配列、失敗した場合は <b><code>FALSE</code></b> を返します。</p>
		 * @link https://php.net/manual/ja/oauth.getrequesttoken.php
		 * @since PECL OAuth >= 0.99.1
		 */
		 ...
		 * @return bool <p>パラメータを正しく設定した場合に <b><code>TRUE</code></b> を返します。 それ以外の場合 (無効な <code>auth_type</code> を渡した場合など) は <b><code>FALSE</code></b> を返します。</p>
		 * @link https://php.net/manual/ja/oauth.setauthtype.php
		 * @since PECL OAuth >= 0.99.1
		 */
		 ...
		 * @link https://php.net/manual/ja/oauth.setcapath.php
		 * @since PECL OAuth >= 0.99.8
		 */
		 ...
		 * @link https://php.net/manual/ja/oauth.setnonce.php
		 * @since PECL OAuth >= 0.99.1
		 */
		 ...
		 * @link https://php.net/manual/ja/oauth.setrsacertificate.php
		 ...
		 * @return void <p>値を返しません。</p>
		 * @link https://php.net/manual/ja/oauth.setrequestengine.php
		 * @since PECL OAuth >= 1.0.0
		 */
		 ...
		 * @link https://php.net/manual/ja/oauth.setsslchecks.php
		 * @since No version information available, might only be in Git
		 */
		 ...
		 * @link https://php.net/manual/ja/oauth.settimestamp.php
		 * @since PECL OAuth >= 1.0.0
		 */
		 ...
		 * @return bool <p><b><code>TRUE</code></b></p>
		 * @link https://php.net/manual/ja/oauth.settoken.php
		 * @since PECL OAuth >= 0.99.1
		 */
		 ...
		 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
		 * @link https://php.net/manual/ja/oauth.setversion.php
		 * @since PECL OAuth >= 0.99.1
		 */
	 ...
	 * @link https://php.net/manual/ja/class.oauthexception.php
	 * @since PECL OAuth >= 0.99.1
	 */
	class OAuthException extends \Exception {
		 ...
		 * @link https://php.net/manual/ja/class.oauthexception.php#oauthexception.props.lastresponse
		 */
		public $lastResponse;

		/**
		 * @var mixed
		 * @link https://php.net/manual/ja/class.oauthexception.php#oauthexception.props.debuginfo
		 */
		public $debugInfo;
	 ...
	 * @link https://php.net/manual/ja/class.oauthprovider.php
	 * @since PECL OAuth >= 1.0.0
	 */
	class OAuthProvider {
		 ...
		 * @link https://php.net/manual/ja/oauthprovider.construct.php
		 * @since PECL OAuth >= 1.0.0
		 */
		 ...
		 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
		 * @link https://php.net/manual/ja/oauthprovider.addrequiredparameter.php
		 * @since PECL OAuth >= 1.0.0
		 */
		 ...
		 * @return void <p>値を返しません。</p>
		 * @link https://php.net/manual/ja/oauthprovider.calltimestampnoncehandler.php
		 * @since PECL OAuth >= 1.0.0
		 */
		 ...
		 * @return void <p>値を返しません。</p>
		 * @link https://php.net/manual/ja/oauthprovider.callconsumerhandler.php
		 * @since No version information available, might only be in Git
		 */
		 ...
		 * @return void <p>値を返しません。</p>
		 * @link https://php.net/manual/ja/oauthprovider.calltokenhandler.php
		 * @since PECL OAuth >= 1.0.0
		 */
		 ...
		 * @return void <p>値を返しません。</p>
		 * @link https://php.net/manual/ja/oauthprovider.checkoauthrequest.php
		 * @since PECL OAuth >= 1.0.0
		 */
		 ...
		 * @return void <p>値を返しません。</p>
		 * @link https://php.net/manual/ja/oauthprovider.consumerhandler.php
		 * @since PECL OAuth >= 1.0.0
		 */
		 ...
		 * @link https://php.net/manual/ja/oauthprovider.generatetoken.php
		 ...
		 * @link https://php.net/manual/ja/oauthprovider.is2leggedendpoint.php
		 * @since PECL OAuth >= 1.0.0
		 */
		 ...
		 * @return void <p>値を返しません。</p>
		 * @link https://php.net/manual/ja/oauthprovider.isrequesttokenendpoint.php
		 * @since PECL OAuth >= 1.0.0
		 */
		 ...
		 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
		 * @link https://php.net/manual/ja/oauthprovider.removerequiredparameter.php
		 * @since PECL OAuth >= 1.0.0
		 */
		 ...
		 * @link https://php.net/manual/ja/oauthprovider.reportproblem.php
		 * @since PECL OAuth >= 1.0.0
		 */
		 ...
		 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
		 * @link https://php.net/manual/ja/oauthprovider.setparam.php
		 * @since PECL OAuth >= 1.0.0
		 */
		 ...
		 * @return bool <p><b><code>TRUE</code></b></p>
		 * @link https://php.net/manual/ja/oauthprovider.setrequesttokenpath.php
		 * @since PECL OAuth >= 1.0.0
		 */
		 ...
		 * @param callable $callback_function <p><code>callable</code> 関数名。</p>
		 * @return void <p>値を返しません。</p>
		 * @link https://php.net/manual/ja/oauthprovider.timestampnoncehandler.php
		 * @since PECL OAuth >= 1.0.0
		 */
		 ...
		 * @param callable $callback_function <p><code>callable</code> 関数名。</p>
		 * @return void <p>値を返しません。</p>
		 * @link https://php.net/manual/ja/oauthprovider.tokenhandler.php
		 * @since PECL OAuth >= 1.0.0
		 */
	 ...
	 * @link https://php.net/manual/ja/function.oauth-get-sbs.php
	 ...
	 * @link https://php.net/manual/ja/function.oauth-urlencode.php
