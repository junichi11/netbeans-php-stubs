 ...
 * @link http://php.net/manual/ja/function.wincache-fcache-fileinfo.php
 ...
 * @link http://php.net/manual/ja/function.wincache-fcache-meminfo.php
 ...
 * @link http://php.net/manual/ja/function.wincache-lock.php
 ...
 * @link http://php.net/manual/ja/function.wincache-ocache-fileinfo.php
 ...
 * @link http://php.net/manual/ja/function.wincache-ocache-meminfo.php
 ...
 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
 * @link http://php.net/manual/ja/function.wincache-refresh-if-changed.php
 ...
 * @link http://php.net/manual/ja/function.wincache-rplist-fileinfo.php
 ...
 * @link http://php.net/manual/ja/function.wincache-rplist-meminfo.php
 ...
 * @link http://php.net/manual/ja/function.wincache-scache-info.php
 ...
 * @link http://php.net/manual/ja/function.wincache-scache-meminfo.php
 ...
 * @link http://php.net/manual/ja/function.wincache-ucache-add.php
 ...
 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
 * @link http://php.net/manual/ja/function.wincache-ucache-cas.php
 ...
 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
 * @link http://php.net/manual/ja/function.wincache-ucache-clear.php
 ...
 * @link http://php.net/manual/ja/function.wincache-ucache-dec.php
 ...
 * @link http://php.net/manual/ja/function.wincache-ucache-delete.php
 ...
 * @link http://php.net/manual/ja/function.wincache-ucache-exists.php
 ...
 * @link http://php.net/manual/ja/function.wincache-ucache-get.php
 ...
 * @link http://php.net/manual/ja/function.wincache-ucache-inc.php
 ...
 * @link http://php.net/manual/ja/function.wincache-ucache-info.php
 ...
 * @link http://php.net/manual/ja/function.wincache-ucache-meminfo.php
 ...
 * @param int $ttl <p>変数のキャッシュ内での生存時間を秒単位で指定します。 <code>ttl</code> で指定した秒数が経過すると、 格納されている変数はキャッシュから削除されます。 このパラメータのデフォルト値は <i>0</i> で、これは <code>wincache_ucache_delete()</code> あるいは <code>wincache_ucache_clear()</code> で明示的に削除するまでキャッシュに残り続けることを意味します。</p>
 * @return bool <p><code>key</code> が文字列のときは、成功した場合に <b><code>TRUE</code></b>、失敗した場合に <b><code>FALSE</code></b> を返します。</p><p><code>key</code> が配列のときの返り値は、次のようになります。</p><ul> <li>  配列内のすべての name =&gt; value ペアが設定できた場合は、空の配列を返します。  </li> <li>  配列内の name =&gt; value ペアがひとつも設定できなかった場合は、<b><code>FALSE</code></b> を返します。  </li> <li>  成功したペアと失敗したペアがある場合は、ユーザーキャッシュへの追加に失敗した name=&gt;value ペアを含む配列を返します。  </li> </ul>
 * @link http://php.net/manual/ja/function.wincache-ucache-set.php
 ...
 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
 * @link http://php.net/manual/ja/function.wincache-unlock.php
