 ...
 * @link http://php.net/manual/ja/function.sqlsrv-begin-transaction.php
 ...
 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
 * @link http://php.net/manual/ja/function.sqlsrv-cancel.php
 ...
 * @link http://php.net/manual/ja/function.sqlsrv-client-info.php
 ...
 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
 * @link http://php.net/manual/ja/function.sqlsrv-close.php
 * @see sqlsrv_connect()
 * @since バージョン情報なし。おそらく SVN 版にしか存在しないでしょう
 */
 ...
 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
 * @link http://php.net/manual/ja/function.sqlsrv-commit.php
 ...
 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
 * @link http://php.net/manual/ja/function.sqlsrv-configure.php
 * @since バージョン情報なし。おそらく SVN 版にしか存在しないでしょう
 */
 ...
 * @link http://php.net/manual/ja/function.sqlsrv-connect.php
 ...
 * @link http://php.net/manual/ja/function.sqlsrv-errors.php
 ...
 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
 * @link http://php.net/manual/ja/function.sqlsrv-execute.php
 ...
 * @link http://php.net/manual/ja/function.sqlsrv-fetch.php
 ...
 * @link http://php.net/manual/ja/function.sqlsrv-fetch-array.php
 ...
 * @link http://php.net/manual/ja/function.sqlsrv-fetch-object.php
 ...
 * @link http://php.net/manual/ja/function.sqlsrv-field-metadata.php
 ...
 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
 * @link http://php.net/manual/ja/function.sqlsrv-free-stmt.php
 * @see sqlsrv_cancel()
 * @since バージョン情報なし。おそらく SVN 版にしか存在しないでしょう
 */
 ...
 * @link http://php.net/manual/ja/function.sqlsrv-get-config.php
 * @see sqlsrv_configure()
 * @since バージョン情報なし。おそらく SVN 版にしか存在しないでしょう
 */
 ...
 * @link http://php.net/manual/ja/function.sqlsrv-get-field.php
 ...
 * @link http://php.net/manual/ja/function.sqlsrv-has-rows.php
 ...
 * @link http://php.net/manual/ja/function.sqlsrv-next-result.php
 ...
 * @link http://php.net/manual/ja/function.sqlsrv-num-fields.php
 ...
 * @link http://php.net/manual/ja/function.sqlsrv-num-rows.php
 ...
 * @link http://php.net/manual/ja/function.sqlsrv-prepare.php
 ...
 * @param array $options <p>An array specifing query property options. The supported keys are described in the following table:</p>  <b>Query Options</b>   Key Values Description     QueryTimeout A positive integer value. Sets the query timeout in seconds. By default, the driver will wait indefinitely for results.   SendStreamParamsAtExec  <b><code>TRUE</code></b> or <b><code>FALSE</code></b> (the default is <b><code>TRUE</code></b>) Configures the driver to send all stream data at execution (<b><code>TRUE</code></b>), or to send stream data in chunks (<b><code>FALSE</code></b>). By default, the value is set to <b><code>TRUE</code></b>. For more information, see <code>sqlsrv_send_stream_data()</code>.   Scrollable SQLSRV_CURSOR_FORWARD, SQLSRV_CURSOR_STATIC, SQLSRV_CURSOR_DYNAMIC, or SQLSRV_CURSOR_KEYSET See » Specifying a Cursor Type and Selecting Rows in the Microsoft SQLSRV documentation.
 * @return mixed <p>Returns a statement resource on success and <b><code>FALSE</code></b> if an error occurred.</p>
 * @link http://php.net/manual/ja/function.sqlsrv-query.php
 ...
 * @param resource $conn <p>The connection resource returned by a call to <code>sqlsrv_connect()</code>.</p>
 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
 * @link http://php.net/manual/ja/function.sqlsrv-rollback.php
 ...
 * @link http://php.net/manual/ja/function.sqlsrv-rows-affected.php
 * @see sqlsrv_num_rows()
 * @since バージョン情報なし。おそらく SVN 版にしか存在しないでしょう
 */
 ...
 * @link http://php.net/manual/ja/function.sqlsrv-send-stream-data.php
 * @see sqlsrv_prepare(), sqlsrv_query()
 * @since バージョン情報なし。おそらく SVN 版にしか存在しないでしょう
 */
 ...
 * @link http://php.net/manual/ja/function.sqlsrv-server-info.php
 * @see sqlsrv_client_info()
 * @since バージョン情報なし。おそらく SVN 版にしか存在しないでしょう
 */
