...
namespace {
	 ...
	 * @link https://php.net/manual/ja/function.sqlsrv-begin-transaction.php
	 ...
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.sqlsrv-cancel.php
	 ...
	 * @link https://php.net/manual/ja/function.sqlsrv-client-info.php
	 ...
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.sqlsrv-close.php
	 * @see sqlsrv_connect()
	 * @since No version information available, might only be in Git
	 */
	 ...
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.sqlsrv-commit.php
	 ...
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.sqlsrv-configure.php
	 * @since No version information available, might only be in Git
	 */
	 ...
	 * @link https://php.net/manual/ja/function.sqlsrv-connect.php
	 ...
	 * @link https://php.net/manual/ja/function.sqlsrv-errors.php
	 ...
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.sqlsrv-execute.php
	 ...
	 * @link https://php.net/manual/ja/function.sqlsrv-fetch.php
	...
	/**
	 * 行を配列として返す
	 * <p>クエリ結果から列データを順に返します。列データの型は連想配列、配列、またはその両方(デフォルト)を選択できます。</p>
	 * @param resource $stmt <p>sqlsrv_query あるいは sqlsrv_prepare が返すステートメントリソース。</p>
	 * @param int $fetchType <p>返り値の型を指定します。連想配列<b><code>SQLSRV_FETCH_ASSOC</code></b>, 配列<b><code>SQLSRV_FETCH_NUMERIC</code></b>, and 連想配列と配列の両方<b><code>SQLSRV_FETCH_BOTH</code></b> (デフォルト) のうち1つを指定します。</p> <p>SQLSRV_FETCH_ASSOC(連想配列)は同じ名前の列が複数存在する結果セットを扱う際に使ってはいけません(連想配列のキーが重複するため)。</p>
	 * @param int $row <p>スクロール可能なカーソルを用いた結果セットから、取得する列を指定します。 定義済み定数は、 <b><code>SQLSRV_SCROLL_NEXT</code></b>(次の列), <b><code>SQLSRV_SCROLL_PRIOR</code></b>(前の列), <b><code>SQLSRV_SCROLL_FIRST</code></b>(最初の列), <b><code>SQLSRV_SCROLL_LAST</code></b>(最後の列), <b><code>SQLSRV_SCROLL_ABSOLUTE</code></b>(列番号の絶対指定) and, <b><code>SQLSRV_SCROLL_RELATIVE</code></b>(列番号の相対指定) (デフォルト値). この引数を指定する場合は、<code>fetchType</code> を指定しなくてはなりません。</p>
	 * @param int $offset <p>引数rowに <b><code>SQLSRV_SCROLL_ABSOLUTE</code></b> または <b><code>SQLSRV_SCROLL_RELATIVE</code></b> を指定する際に、この引数で取得する列を指定します。 列番号は0から始まります。</p>
	 * @return array <p>成功時に配列を返します。 返す列がない場合は<b><code>NULL</code></b> を返します。エラーが起きた場合は <b><code>FALSE</code></b>を返します。</p>
	 * @link https://php.net/manual/ja/function.sqlsrv-fetch-array.php
	 ...
	 * @link https://php.net/manual/ja/function.sqlsrv-fetch-object.php
	 ...
	 * @link https://php.net/manual/ja/function.sqlsrv-field-metadata.php
	 ...
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.sqlsrv-free-stmt.php
	 * @see sqlsrv_cancel()
	 * @since No version information available, might only be in Git
	 */
	 ...
	 * @link https://php.net/manual/ja/function.sqlsrv-get-config.php
	 * @see sqlsrv_configure()
	 * @since No version information available, might only be in Git
	 */
	 ...
	 * @link https://php.net/manual/ja/function.sqlsrv-get-field.php
	 ...
	 * @link https://php.net/manual/ja/function.sqlsrv-has-rows.php
	 ...
	 * @link https://php.net/manual/ja/function.sqlsrv-next-result.php
	 ...
	 * @link https://php.net/manual/ja/function.sqlsrv-num-fields.php
	 ...
	 * @link https://php.net/manual/ja/function.sqlsrv-num-rows.php
	 ...
	 * @link https://php.net/manual/ja/function.sqlsrv-prepare.php
	 ...
	 * @param array $options <p>An array specifying query property options. The supported keys are described in the following table:</p>  <b>Query Options</b>   Key Values Description     QueryTimeout A positive integer value. Sets the query timeout in seconds. By default, the driver will wait indefinitely for results.   SendStreamParamsAtExec  <b><code>TRUE</code></b> or <b><code>FALSE</code></b> (the default is <b><code>TRUE</code></b>) Configures the driver to send all stream data at execution (<b><code>TRUE</code></b>), or to send stream data in chunks (<b><code>FALSE</code></b>). By default, the value is set to <b><code>TRUE</code></b>. For more information, see <code>sqlsrv_send_stream_data()</code>.   Scrollable SQLSRV_CURSOR_FORWARD, SQLSRV_CURSOR_STATIC, SQLSRV_CURSOR_DYNAMIC, or SQLSRV_CURSOR_KEYSET See » Specifying a Cursor Type and Selecting Rows in the Microsoft SQLSRV documentation.
	 * @return mixed <p>Returns a statement resource on success and <b><code>FALSE</code></b> if an error occurred.</p>
	 * @link https://php.net/manual/ja/function.sqlsrv-query.php
	 ...
	 * @param resource $conn <p>The connection resource returned by a call to <code>sqlsrv_connect()</code>.</p>
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.sqlsrv-rollback.php
	 ...
	 * @link https://php.net/manual/ja/function.sqlsrv-rows-affected.php
	 * @see sqlsrv_num_rows()
	 * @since No version information available, might only be in Git
	 */
	 ...
	 * @link https://php.net/manual/ja/function.sqlsrv-send-stream-data.php
	 * @see sqlsrv_prepare(), sqlsrv_query()
	 * @since No version information available, might only be in Git
	 */
	 ...
	 * @link https://php.net/manual/ja/function.sqlsrv-server-info.php
	 * @see sqlsrv_client_info()
	 * @since No version information available, might only be in Git
	 */
