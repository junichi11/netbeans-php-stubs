...
namespace pht {
	 ...
	 * @link https://php.net/manual/ja/class.pht-atomicinteger.php
	...
	class AtomicInteger implements \pht\Threaded {
		 ...
		 * @link https://php.net/manual/ja/pht-atomicinteger.construct.php
		 * @since PECL pht >= 0.0.1
		 */
		 ...
		 * @link https://php.net/manual/ja/pht-atomicinteger.dec.php
		 * @since PECL pht >= 0.0.1
		 */
		 ...
		 * @link https://php.net/manual/ja/pht-atomicinteger.get.php
		 * @since PECL pht >= 0.0.1
		 */
		 ...
		 * @return void <p>No return value.</p>
		 * @link https://php.net/manual/ja/pht-atomicinteger.inc.php
		 * @since PECL pht >= 0.0.1
		 */
		 ...
		 * @return void <p>No return value.</p>
		 * @link https://php.net/manual/ja/pht-atomicinteger.lock.php
		 * @since PECL pht >= 0.0.1
		 */
		 ...
		 * @return void <p>No return value.</p>
		 * @link https://php.net/manual/ja/pht-atomicinteger.set.php
		 * @since PECL pht >= 0.0.1
		 */
		 ...
		 * @return void <p>No return value.</p>
		 * @link https://php.net/manual/ja/pht-atomicinteger.unlock.php
		 * @since PECL pht >= 0.0.1
		 */
	 ...
	 * @link https://php.net/manual/ja/class.pht-hashtable.php
	 * @since PECL pht >= 0.0.1
	 */
	class HashTable implements \pht\Threaded {
		 ...
		 * @return void <p>No return value.</p>
		 * @link https://php.net/manual/ja/pht-hashtable.lock.php
		 * @since PECL pht >= 0.0.1
		 */
		public function lock(): void {}
		 ...
		 * @link https://php.net/manual/ja/pht-hashtable.size.php
		 * @since PECL pht >= 0.0.1
		 */
		 ...
		 * @return void <p>No return value.</p>
		 * @link https://php.net/manual/ja/pht-hashtable.unlock.php
		 * @since PECL pht >= 0.0.1
		 */
		public function unlock(): void {}
	}
	 ...
	 * @link https://php.net/manual/ja/class.pht-queue.php
	 * @since PECL pht >= 0.0.1
	 */
	class Queue implements \pht\Threaded {
		 ...
		 * @link https://php.net/manual/ja/pht-queue.front.php
		 * @since PECL pht >= 0.0.1
		 */
		 ...
		 * @return void <p>No return value.</p>
		 * @link https://php.net/manual/ja/pht-queue.lock.php
		 * @since PECL pht >= 0.0.1
		 */
		public function lock(): void {}
		 ...
		 * @link https://php.net/manual/ja/pht-queue.pop.php
		 * @since PECL pht >= 0.0.1
		 */
		public function pop() {}
		 ...
		 * @return void <p>No return value.</p>
		 * @link https://php.net/manual/ja/pht-queue.push.php
		 * @since PECL pht >= 0.0.1
		 */
		 ...
		 * @link https://php.net/manual/ja/pht-queue.size.php
		 * @since PECL pht >= 0.0.1
		 */
		public function size(): int {}
		 ...
		 * @return void <p>No return value.</p>
		 * @link https://php.net/manual/ja/pht-queue.unlock.php
		 * @since PECL pht >= 0.0.1
		 */
		public function unlock(): void {}
	}
	 ...
	 * @link https://php.net/manual/ja/class.pht-runnable.php
	 * @since PECL pht >= 0.0.1
	 */
	interface Runnable {
		 ...
		 * @return void <p>No return value.</p>
		 * @link https://php.net/manual/ja/pht-runnable.run.php
		 * @since PECL pht >= 0.0.1
		 */
	 ...
	 * @link https://php.net/manual/ja/class.pht-thread.php
	 * @since PECL pht >= 0.0.1
	 */
	class Thread {
		 ...
		 * @param mixed $_ctorArgs <p>An optional list of arguments for the threaded class' constructor. These arguments will be serialised (since they are being passed to another thread).</p>
		 * @return void <p>No return value.</p>
		 * @link https://php.net/manual/ja/pht-thread.addClassTask.php
		 * @since PECL pht >= 0.0.1
		 */
		 ...
		 * @param mixed $_globals <p>An optional list of arguments for the file. These arguments will be placed into a <i>$_THREAD</i> superglobal, which will be made available inside of the threaded file. All arguments will be serialised (since they are being passed to another thread).</p>
		 * @return void <p>No return value.</p>
		 * @link https://php.net/manual/ja/pht-thread.addFileTask.php
		 * @since PECL pht >= 0.0.1
		 */
		 ...
		 * @param callable $func <p>The function to be threaded. If it is bound to an instance, then <i>$this</i> will become <b><code>NULL</code></b>.</p>
		 * @param mixed $_funcArgs <p>An optional list of arguments for the function. These arguments will be serialised (since they are being passed to another thread).</p>
		 * @return void <p>No return value.</p>
		 * @link https://php.net/manual/ja/pht-thread.addFunctionTask.php
		 * @since PECL pht >= 0.0.1
		 */
		public function addFunctionTask(callable $func, $_funcArgs = NULL): void {}
		 ...
		 * @return void <p>No return value.</p>
		 * @link https://php.net/manual/ja/pht-thread.join.php
		 * @since PECL pht >= 0.0.1
		 */
		 ...
		 * @return void <p>No return value.</p>
		 * @link https://php.net/manual/ja/pht-thread.start.php
		 * @since PECL pht >= 0.0.1
		 */
		 ...
		 * @link https://php.net/manual/ja/pht-thread.taskCount.php
		 * @since PECL pht >= 0.0.1
		 */
	 ...
	 * @link https://php.net/manual/ja/class.pht-threaded.php
	 * @since PECL pht >= 0.0.1
	 */
	interface Threaded {
		 ...
		 * @return void <p>No return value.</p>
		 * @link https://php.net/manual/ja/pht-threaded.lock.php
		 * @since PECL pht >= 0.0.1
		 */
		public function lock(): void;
		 ...
		 * @return void <p>No return value.</p>
		 * @link https://php.net/manual/ja/pht-threaded.unlock.php
		 * @since PECL pht >= 0.0.1
		 */
		public function unlock(): void;
	}
	 ...
	 * @link https://php.net/manual/ja/class.pht-vector.php
	 * @since PECL pht >= 0.0.1
	 */
	class Vector implements \pht\Threaded {
		 ...
		 * @link https://php.net/manual/ja/pht-vector.construct.php
		 * @since PECL pht >= 0.0.1
		 */
		 ...
		 * <p>This method deletes a value at the specified offset in the vector (in linear time).</p><p>Since the pht\Vector class supports array access, deleting values can also be performed using the array subset notation (<i>[]</i>) in combination with the <code>unset()</code> function.</p>
		 ...
		 * @return void <p>No return value.</p>
		 * @link https://php.net/manual/ja/pht-vector.deleteAt.php
		 * @since PECL pht >= 0.0.1
		 */
		 ...
		 * @return void <p>No return value.</p>
		 * @link https://php.net/manual/ja/pht-vector.insertAt.php
		 * @since PECL pht >= 0.0.1
		 */
		 ...
		 * @return void <p>No return value.</p>
		 * @link https://php.net/manual/ja/pht-vector.lock.php
		 * @since PECL pht >= 0.0.1
		 */
		public function lock(): void {}
		 ...
		 * @link https://php.net/manual/ja/pht-vector.pop.php
		 * @since PECL pht >= 0.0.1
		 */
		public function pop() {}
		 ...
		 * <p>This method pushes a value onto the end of a vector (in constant time). The vector will automatically be resized if it is not large enough.</p><p>Since the pht\Vector class supports array access, new values can also be pushed onto the vector using the empty subset notation (<i>[]</i>).</p>
		 ...
		 * @return void <p>No return value.</p>
		 * @link https://php.net/manual/ja/pht-vector.push.php
		 * @since PECL pht >= 0.0.1
		 */
		public function push($value): void {}
		 ...
		 * @return void <p>No return value.</p>
		 * @link https://php.net/manual/ja/pht-vector.resize.php
		 * @since PECL pht >= 0.0.1
		 */
		 ...
		 * @link https://php.net/manual/ja/pht-vector.shift.php
		 * @since PECL pht >= 0.0.1
		 */
		 ...
		 * @link https://php.net/manual/ja/pht-vector.size.php
		 * @since PECL pht >= 0.0.1
		 */
		public function size(): int {}
		 ...
		 * @return void <p>No return value.</p>
		 * @link https://php.net/manual/ja/pht-vector.unlock.php
		 * @since PECL pht >= 0.0.1
		 */
		public function unlock(): void {}
		 ...
		 * @return void <p>No return value.</p>
		 * @link https://php.net/manual/ja/pht-vector.unshift.php
		 * @since PECL pht >= 0.0.1
		 */
		 ...
		 * <p>This method updates a value at the specified offset in the vector (in linear time). The vector will automatically be resized if it is not large enough.</p><p>Since the pht\Vector class supports array access, updating values can also be performed using the array subset notation (<i>[]</i>).</p>
		 * @param mixed $value <p>The value to be inserted into the vector. This value will be serialised (since it may be passed around between threads).</p>
		 ...
		 * @return void <p>No return value.</p>
		 * @link https://php.net/manual/ja/pht-vector.updateAt.php
		 * @since PECL pht >= 0.0.1
		 */
