...
/**
 * @link http://php.net/manual/ja/class.hashcontext.php
 * @since PHP 7 >= 7.2.0
 */
class HashContext {
	 ...
	 * @return self
	 * @link http://php.net/manual/ja/hashcontext.construct.php
	 * @since PHP 7 >= 7.2.0
	 */
 ...
 * @link http://php.net/manual/ja/function.hash-hkdf.php
 * @see hash_pbkdf2()
 * @since PHP 7 >= 7.1.2
 */
 ...
 * @link http://php.net/manual/ja/function.hash-hmac-algos.php
 ...
 * @see crypt(), password_hash(), hash(), hash_algos(), hash_init(), hash_hmac(), hash_hmac_file()
