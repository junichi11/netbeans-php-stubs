...
namespace {
	 ...
	 * @link https://php.net/manual/ja/class.yaf-action-abstract.php
	 * @since Yaf >=1.0.0
	 */
	class Yaf_Action_Abstract extends \Yaf_Controller_Abstract {
		...
		/**
		 * @var mixed
		 * @link https://php.net/manual/ja/class.yaf-action-abstract.php#yaf-action-abstract.props.controller
		 */
		 ...
		 * @return void
		 * @link https://php.net/manual/ja/yaf-controller-abstract.clone.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @return self
		 * @link https://php.net/manual/ja/yaf-controller-abstract.construct.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @return bool
		 * @link https://php.net/manual/ja/yaf-controller-abstract.display.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @param mixed $_
		 * @return mixed
		 * @link https://php.net/manual/ja/yaf-action-abstract.execute.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @link https://php.net/manual/ja/yaf-controller-abstract.forward.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @link https://php.net/manual/ja/yaf-action-abstract.getcontroller.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @param string $name
		 * @return void
		 * @link https://php.net/manual/ja/yaf-controller-abstract.getinvokearg.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @return void
		 * @link https://php.net/manual/ja/yaf-controller-abstract.getinvokeargs.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @return string
		 * @link https://php.net/manual/ja/yaf-controller-abstract.getmodulename.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @link https://php.net/manual/ja/yaf-controller-abstract.getrequest.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @link https://php.net/manual/ja/yaf-controller-abstract.getresponse.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @link https://php.net/manual/ja/yaf-controller-abstract.getview.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @return string
		 * @link https://php.net/manual/ja/yaf-controller-abstract.getviewpath.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @return void
		 * @link https://php.net/manual/ja/yaf-controller-abstract.init.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @param array $options
		 * @return void
		 * @link https://php.net/manual/ja/yaf-controller-abstract.initview.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @link https://php.net/manual/ja/yaf-controller-abstract.redirect.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @param array $parameters
		 * @return string
		 * @link https://php.net/manual/ja/yaf-controller-abstract.render.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @return void
		 * @link https://php.net/manual/ja/yaf-controller-abstract.setviewpath.php
		 * @since Yaf >=1.0.0
		 */
	 ...
	 * @link https://php.net/manual/ja/class.yaf-application.php
	...
	class Yaf_Application extends \Yaf_Application {
		...
		/**
		 * @var mixed
		 * @link https://php.net/manual/ja/class.yaf-application.php#yaf-application.props.config
		 */
		protected $config;

		/**
		 * @var mixed
		 * @link https://php.net/manual/ja/class.yaf-application.php#yaf-application.props.dispatcher
		 */
		protected $dispatcher;

		/**
		 * @var mixed
		 * @link https://php.net/manual/ja/class.yaf-application.php#yaf-application.props.app
		 */
		protected static $_app;

		/**
		 * @var mixed
		 * @link https://php.net/manual/ja/class.yaf-application.php#yaf-application.props.modules
		 */
		protected $_modules;

		/**
		 * @var mixed
		 * @link https://php.net/manual/ja/class.yaf-application.php#yaf-application.props.running
		 */
		protected $_running;

		/**
		 * @var mixed
		 * @link https://php.net/manual/ja/class.yaf-application.php#yaf-application.props.environ
		 */
		protected $_environ;
		 ...
		 * @return void
		 * @link https://php.net/manual/ja/yaf-application.clone.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @return self
		 * @link https://php.net/manual/ja/yaf-application.construct.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * デストラクタ
		 * @return void
		 * @link https://php.net/manual/ja/yaf-application.destruct.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @return void
		 * @link https://php.net/manual/ja/yaf-application.sleep.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @return void
		 * @link https://php.net/manual/ja/yaf-application.wakeup.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @return mixed <p>Yaf_Application のインスタンスを返します。まだ Yaf_Application を初期化していない場合は <b><code>NULL</code></b> を返します。</p>
		 * @link https://php.net/manual/ja/yaf-application.app.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @link https://php.net/manual/ja/yaf-application.bootstrap.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @link https://php.net/manual/ja/yaf-application.clearlasterror.php
		 * @since Yaf >=2.1.2
		 */
		 ...
		 * @return void
		 * @link https://php.net/manual/ja/yaf-application.environ.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @return void
		 * @link https://php.net/manual/ja/yaf-application.execute.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * アプリケーションディレクトリを取得する
		 * @return Yaf_Application
		 * @link https://php.net/manual/ja/yaf-application.getappdirectory.php
		 * @since Yaf >=2.1.4
		 */
		 ...
		 * @link https://php.net/manual/ja/yaf-application.getconfig.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @link https://php.net/manual/ja/yaf-application.getdispatcher.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @return string
		 * @link https://php.net/manual/ja/yaf-application.getlasterrormsg.php
		 * @since Yaf >=2.1.2
		 */
		 ...
		 * 直近で発生したエラーのコードを取得する
		 * @return int
		 * @link https://php.net/manual/ja/yaf-application.getlasterrorno.php
		 * @since Yaf >=2.1.2
		 */
		 ...
		 * @return array
		 * @link https://php.net/manual/ja/yaf-application.getmodules.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @return void
		 * @link https://php.net/manual/ja/yaf-application.run.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @return Yaf_Application
		 * @link https://php.net/manual/ja/yaf-application.setappdirectory.php
		 * @since Yaf >=2.1.4
		 */
	 ...
	 * @link https://php.net/manual/ja/class.yaf-bootstrap-abstract.php
	 * @since No version information available, might only be in Git
	 */
	...
	/**
	 * @link https://php.net/manual/ja/class.yaf-config-abstract.php
	 * @since Yaf >=1.0.0
	 */
	abstract class Yaf_Config_Abstract {
		...
		/**
		 * @var mixed
		 * @link https://php.net/manual/ja/class.yaf-config-abstract.php#yaf-config-abstract.props.config
		 */
		protected $_config;

		/**
		 * @var mixed
		 * @link https://php.net/manual/ja/class.yaf-config-abstract.php#yaf-config-abstract.props.readonly
		 */
		protected $_readonly;
		 ...
		 * @param mixed $value
		 * @return mixed
		 * @link https://php.net/manual/ja/yaf-config-abstract.get.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * <p></p><p>この関数は、 現在のところ詳細な情報はありません。引数のリストのみが 記述されています。</p>
		 * @return bool
		 * @link https://php.net/manual/ja/yaf-config-abstract.readonly.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @link https://php.net/manual/ja/yaf-config-abstract.set.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * <p></p><p>この関数は、 現在のところ詳細な情報はありません。引数のリストのみが 記述されています。</p>
		 * @return array
		 * @link https://php.net/manual/ja/yaf-config-abstract.toarray.php
		 * @since Yaf >=1.0.0
		 */
	 ...
	 * @link https://php.net/manual/ja/class.yaf-config-ini.php
	 * @since Yaf >=1.0.0
	 */
	class Yaf_Config_Ini extends \Yaf_Config_Abstract implements \Iterator, \ArrayAccess, \Countable {
		 ...
		 * @return self
		 * @link https://php.net/manual/ja/yaf-config-ini.construct.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @param string $name
		 * @return void
		 * @link https://php.net/manual/ja/yaf-config-ini.get.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @param string $name
		 * @return void
		 * @link https://php.net/manual/ja/yaf-config-ini.isset.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @param mixed $value
		 * @return void
		 * @link https://php.net/manual/ja/yaf-config-ini.set.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * <p></p><p>この関数は、 現在のところ詳細な情報はありません。引数のリストのみが 記述されています。</p>
		 * @return void
		 * @link https://php.net/manual/ja/yaf-config-ini.count.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * <p></p><p>この関数は、 現在のところ詳細な情報はありません。引数のリストのみが 記述されています。</p>
		 * @return void
		 * @link https://php.net/manual/ja/yaf-config-ini.current.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * <p></p><p>この関数は、 現在のところ詳細な情報はありません。引数のリストのみが 記述されています。</p>
		 * @return void
		 * @link https://php.net/manual/ja/yaf-config-ini.key.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * <p></p><p>この関数は、 現在のところ詳細な情報はありません。引数のリストのみが 記述されています。</p>
		 * @return void
		 * @link https://php.net/manual/ja/yaf-config-ini.next.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @param string $name
		 * @return void
		 * @link https://php.net/manual/ja/yaf-config-ini.offsetexists.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @param string $name
		 * @return void
		 * @link https://php.net/manual/ja/yaf-config-ini.offsetget.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @param string $value
		 * @return void
		 * @link https://php.net/manual/ja/yaf-config-ini.offsetset.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @param string $name
		 * @return void
		 * @link https://php.net/manual/ja/yaf-config-ini.offsetunset.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * <p></p><p>この関数は、 現在のところ詳細な情報はありません。引数のリストのみが 記述されています。</p>
		 * @return void
		 * @link https://php.net/manual/ja/yaf-config-ini.readonly.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * <p></p><p>この関数は、 現在のところ詳細な情報はありません。引数のリストのみが 記述されています。</p>
		 * @return void
		 * @link https://php.net/manual/ja/yaf-config-ini.rewind.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @return array
		 * @link https://php.net/manual/ja/yaf-config-ini.toarray.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * <p></p><p>この関数は、 現在のところ詳細な情報はありません。引数のリストのみが 記述されています。</p>
		 * @return void
		 * @link https://php.net/manual/ja/yaf-config-ini.valid.php
		 * @since Yaf >=1.0.0
		 */
	...
	/**
	 * @link https://php.net/manual/ja/class.yaf-config-simple.php
	 * @since Yaf >=1.0.0
	 */
	class Yaf_Config_Simple extends \Yaf_Config_Abstract implements \Iterator, \ArrayAccess, \Countable {
		...
		/**
		 * @var mixed
		 * @link https://php.net/manual/ja/class.yaf-config-simple.php#yaf-config-simple.props.readonly
		 */
		protected $_readonly;
		 ...
		 * @return self
		 * @link https://php.net/manual/ja/yaf-config-simple.construct.php
		 * @since Yaf >=1.0.0
		 */
		public function __construct(string $config_file, string $section = NULL) {}
		 ...
		 * @param string $name
		 * @return void
		 * @link https://php.net/manual/ja/yaf-config-simple.get.php
		 * @since Yaf >=1.0.0
		 */
		public function __get(string $name = NULL): void {}
		 ...
		 * @param string $name
		 * @return void
		 * @link https://php.net/manual/ja/yaf-config-simple.isset.php
		 * @since Yaf >=1.0.0
		 */
		public function __isset(string $name): void {}
		 ...
		 * @param string $value
		 * @return void
		 * @link https://php.net/manual/ja/yaf-config-simple.set.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * <p></p><p>この関数は、 現在のところ詳細な情報はありません。引数のリストのみが 記述されています。</p>
		 * @return void
		 * @link https://php.net/manual/ja/yaf-config-simple.count.php
		 * @since Yaf >=1.0.0
		 */
		public function count(): void {}
		 ...
		 * <p></p><p>この関数は、 現在のところ詳細な情報はありません。引数のリストのみが 記述されています。</p>
		 * @return void
		 * @link https://php.net/manual/ja/yaf-config-simple.current.php
		 * @since Yaf >=1.0.0
		 */
		public function current(): void {}
		 ...
		 * <p></p><p>この関数は、 現在のところ詳細な情報はありません。引数のリストのみが 記述されています。</p>
		 * @return void
		 * @link https://php.net/manual/ja/yaf-config-simple.key.php
		 * @since Yaf >=1.0.0
		 */
		public function key(): void {}
		 ...
		 * <p></p><p>この関数は、 現在のところ詳細な情報はありません。引数のリストのみが 記述されています。</p>
		 * @return void
		 * @link https://php.net/manual/ja/yaf-config-simple.next.php
		 * @since Yaf >=1.0.0
		 */
		public function next(): void {}
		 ...
		 * @param string $name
		 * @return void
		 * @link https://php.net/manual/ja/yaf-config-simple.offsetexists.php
		 * @since Yaf >=1.0.0
		 */
		public function offsetExists(string $name): void {}
		 ...
		 * @param string $name
		 * @return void
		 * @link https://php.net/manual/ja/yaf-config-simple.offsetget.php
		 * @since Yaf >=1.0.0
		 */
		public function offsetGet(string $name): void {}
		 ...
		 * @param string $value
		 * @return void
		 * @link https://php.net/manual/ja/yaf-config-simple.offsetset.php
		 * @since Yaf >=1.0.0
		 */
		public function offsetSet(string $name, string $value): void {}
		 ...
		 * @param string $name
		 * @return void
		 * @link https://php.net/manual/ja/yaf-config-simple.offsetunset.php
		 * @since Yaf >=1.0.0
		 */
		public function offsetUnset(string $name): void {}
		 ...
		 * <p></p><p>この関数は、 現在のところ詳細な情報はありません。引数のリストのみが 記述されています。</p>
		 * @return void
		 * @link https://php.net/manual/ja/yaf-config-simple.readonly.php
		 * @since Yaf >=1.0.0
		 */
		public function readonly(): void {}
		 ...
		 * <p></p><p>この関数は、 現在のところ詳細な情報はありません。引数のリストのみが 記述されています。</p>
		 * @return void
		 * @link https://php.net/manual/ja/yaf-config-simple.rewind.php
		 * @since Yaf >=1.0.0
		 */
		public function rewind(): void {}
		 ...
		 * @return array
		 * @link https://php.net/manual/ja/yaf-config-simple.toarray.php
		 * @since Yaf >=1.0.0
		 */
		public function toArray(): array {}
		 ...
		 * <p></p><p>この関数は、 現在のところ詳細な情報はありません。引数のリストのみが 記述されています。</p>
		 * @return void
		 * @link https://php.net/manual/ja/yaf-config-simple.valid.php
		 * @since Yaf >=1.0.0
		 */
		public function valid(): void {}
	}
	 ...
	 * @link https://php.net/manual/ja/class.yaf-controller-abstract.php
	 * @since Yaf >=1.0.0
	 */
	abstract class Yaf_Controller_Abstract {
		 ...
		 * @link https://php.net/manual/ja/class.yaf-controller-abstract.php#yaf-controller-abstract.props.actions
		 */
		public $actions;

		/**
		 * @var mixed <p>モジュール名</p>
		 * @link https://php.net/manual/ja/class.yaf-controller-abstract.php#yaf-controller-abstract.props.module
		 */
		protected $_module;

		/**
		 * @var mixed <p>コントローラ名</p>
		 * @link https://php.net/manual/ja/class.yaf-controller-abstract.php#yaf-controller-abstract.props.name
		 */
		protected $_name;

		/**
		 * @var mixed <p>現在のリクエストオブジェクト</p>
		 * @link https://php.net/manual/ja/class.yaf-controller-abstract.php#yaf-controller-abstract.props.request
		 */
		protected $_request;

		/**
		 * @var mixed <p>現在のレスポンスオブジェクト</p>
		 * @link https://php.net/manual/ja/class.yaf-controller-abstract.php#yaf-controller-abstract.props.response
		 */
		protected $_response;

		/**
		 * @var mixed
		 * @link https://php.net/manual/ja/class.yaf-controller-abstract.php#yaf-controller-abstract.props.invoke-args
		 */
		protected $_invoke_args;

		/**
		 * @var mixed <p>ビューエンジンオブジェクト</p>
		 * @link https://php.net/manual/ja/class.yaf-controller-abstract.php#yaf-controller-abstract.props.view
		 */
		protected $_view;
		 ...
		 * @return mixed
		 * @link https://php.net/manual/ja/yaf-request-abstract.getparam.php
		 * @since Yaf >=1.0.0
		 */
	 ...
	 * @link https://php.net/manual/ja/class.yaf-dispatcher.php
	 * @since Yaf >=1.0.0
	 */
	final class Yaf_Dispatcher {
		...
		/**
		 * @var mixed
		 * @link https://php.net/manual/ja/class.yaf-dispatcher.php#yaf-dispatcher.props.router
		 */
		protected $_router;

		/**
		 * @var mixed
		 * @link https://php.net/manual/ja/class.yaf-dispatcher.php#yaf-dispatcher.props.view
		 */
		protected $_view;

		/**
		 * @var mixed
		 * @link https://php.net/manual/ja/class.yaf-dispatcher.php#yaf-dispatcher.props.request
		 */
		protected $_request;

		/**
		 * @var mixed
		 * @link https://php.net/manual/ja/class.yaf-dispatcher.php#yaf-dispatcher.props.plugins
		 */
		protected $_plugins;

		/**
		 * @var mixed
		 * @link https://php.net/manual/ja/class.yaf-dispatcher.php#yaf-dispatcher.props.instance
		 */
		protected static $_instance;

		/**
		 * @var mixed
		 * @link https://php.net/manual/ja/class.yaf-dispatcher.php#yaf-dispatcher.props.auto-render
		 */
		protected $_auto_render;

		/**
		 * @var mixed
		 * @link https://php.net/manual/ja/class.yaf-dispatcher.php#yaf-dispatcher.props.return-response
		 */
		protected $_return_response;

		/**
		 * @var mixed
		 * @link https://php.net/manual/ja/class.yaf-dispatcher.php#yaf-dispatcher.props.instantly-flush
		 */
		protected $_instantly_flush;

		/**
		 * @var mixed
		 * @link https://php.net/manual/ja/class.yaf-dispatcher.php#yaf-dispatcher.props.default-module
		 */
		protected $_default_module;

		/**
		 * @var mixed
		 * @link https://php.net/manual/ja/class.yaf-dispatcher.php#yaf-dispatcher.props.default-controller
		 */
		protected $_default_controller;

		/**
		 * @var mixed
		 * @link https://php.net/manual/ja/class.yaf-dispatcher.php#yaf-dispatcher.props.default-action
		 */
		 ...
		 * @return void
		 * @link https://php.net/manual/ja/yaf-dispatcher.clone.php
		 * @since Yaf >=1.0.0
		 */
		private function __clone() {}
		 ...
		 * @return self
		 * @link https://php.net/manual/ja/yaf-dispatcher.construct.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @return void
		 * @link https://php.net/manual/ja/yaf-dispatcher.sleep.php
		 * @since Yaf >=1.0.0
		 */
		private function __sleep(): void {}
		 ...
		 * @return void
		 * @link https://php.net/manual/ja/yaf-dispatcher.wakeup.php
		 * @since Yaf >=1.0.0
		 */
		private function __wakeup(): void {}
		 ...
		 * @return Yaf_Dispatcher
		 * @link https://php.net/manual/ja/yaf-dispatcher.autorender.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @return Yaf_Dispatcher
		 * @link https://php.net/manual/ja/yaf-dispatcher.catchexception.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @return bool
		 * @link https://php.net/manual/ja/yaf-dispatcher.disableview.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @link https://php.net/manual/ja/yaf-dispatcher.dispatch.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * ビューのレンダリングを有効にする
		 * @return Yaf_Dispatcher
		 * @link https://php.net/manual/ja/yaf-dispatcher.enableview.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @param bool $flag <p>bool</p> <p><b>注意</b>:</p> <p>2.2.0 以降は、このパラメータを省略した場合に現在の状態を返すようになりました。</p>
		 * @return Yaf_Dispatcher
		 * @link https://php.net/manual/ja/yaf-dispatcher.flushinstantly.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @return Yaf_Application
		 * @link https://php.net/manual/ja/yaf-dispatcher.getapplication.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * ディスパッチャのインスタンスを取得する
		 * @return Yaf_Dispatcher
		 * @link https://php.net/manual/ja/yaf-dispatcher.getinstance.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @link https://php.net/manual/ja/yaf-dispatcher.getrequest.php
		 * @since Yaf >=1.0.0
		 */
		public function getRequest(): \Yaf_Request_Abstract {}
		 ...
		 * ルーターのインスタンスを取得する
		 * @return Yaf_Router
		 * @link https://php.net/manual/ja/yaf-dispatcher.getrouter.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @param array $options
		 * @return Yaf_View_Interface
		 * @link https://php.net/manual/ja/yaf-dispatcher.initview.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @return Yaf_Dispatcher
		 * @link https://php.net/manual/ja/yaf-dispatcher.registerplugin.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @param bool $flag
		 * @return Yaf_Dispatcher
		 * @link https://php.net/manual/ja/yaf-dispatcher.returnresponse.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @param string $action
		 * @return Yaf_Dispatcher
		 * @link https://php.net/manual/ja/yaf-dispatcher.setdefaultaction.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @return Yaf_Dispatcher
		 * @link https://php.net/manual/ja/yaf-dispatcher.setdefaultcontroller.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @param string $module
		 * @return Yaf_Dispatcher
		 * @link https://php.net/manual/ja/yaf-dispatcher.setdefaultmodule.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @return Yaf_Dispatcher
		 * @link https://php.net/manual/ja/yaf-dispatcher.seterrorhandler.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @param \Yaf_Request_Abstract $request
		 * @return Yaf_Dispatcher
		 * @link https://php.net/manual/ja/yaf-dispatcher.setrequest.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @return Yaf_Dispatcher
		 * @link https://php.net/manual/ja/yaf-dispatcher.setview.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @param bool $flag <p>bool</p>
		 * @return Yaf_Dispatcher
		 * @link https://php.net/manual/ja/yaf-dispatcher.throwexception.php
		 * @since Yaf >=1.0.0
		 */
	...
	/**
	 * @link https://php.net/manual/ja/class.yaf-exception.php
	 * @since Yaf >=1.0.0
	 */
	class Yaf_Exception extends \Exception {
		 ...
		 * <p></p><p>この関数は、 現在のところ詳細な情報はありません。引数のリストのみが 記述されています。</p>
		 * @return self
		 * @link https://php.net/manual/ja/yaf-exception.construct.php
		 * @since Yaf >=1.0.0
		 */
		public function __construct() {}
		 ...
		 * <p></p><p>この関数は、 現在のところ詳細な情報はありません。引数のリストのみが 記述されています。</p>
		 * @return void
		 * @link https://php.net/manual/ja/yaf-exception.getprevious.php
		 * @since Yaf >=1.0.0
		 */
	...
	/**
	 * @link https://php.net/manual/ja/class.yaf-exception-dispatchfailed.php
	 * @since Yaf >=1.0.0
	 */
	...
	/**
	 * @link https://php.net/manual/ja/class.yaf-exception-loadfailed.php
	 * @since Yaf >=1.0.0
	 */
	...
	/**
	 * @link https://php.net/manual/ja/class.yaf-exception-loadfailed-action.php
	 * @since Yaf >=1.0.0
	 */
	...
	/**
	 * @link https://php.net/manual/ja/class.yaf-exception-loadfailed-controller.php
	 * @since Yaf >=1.0.0
	 */
	...
	/**
	 * @link https://php.net/manual/ja/class.yaf-exception-loadfailed-module.php
	 * @since Yaf >=1.0.0
	 */
	...
	/**
	 * @link https://php.net/manual/ja/class.yaf-exception-loadfailed-view.php
	 * @since Yaf >=1.0.0
	 */
	...
	/**
	 * @link https://php.net/manual/ja/class.yaf-exception-routerfailed.php
	 * @since Yaf >=1.0.0
	 */
	...
	/**
	 * @link https://php.net/manual/ja/class.yaf-exception-startuperror.php
	 * @since Yaf >=1.0.0
	 */
	...
	/**
	 * @link https://php.net/manual/ja/class.yaf-exception-typeerror.php
	 * @since Yaf >=1.0.0
	 */
	 ...
	 * @link https://php.net/manual/ja/class.yaf-loader.php
	 * @since Yaf >=1.0.0
	 */
	class Yaf_Loader {
		...
		/**
		 * @var mixed
		 * @link https://php.net/manual/ja/class.yaf-loader.php#yaf-loader.props.local-ns
		 */
		protected $_local_ns;
		 ...
		 * @link https://php.net/manual/ja/class.yaf-loader.php#yaf-loader.props.library
		 */
		protected $_library;

		/**
		 * @var mixed
		 * @link https://php.net/manual/ja/class.yaf-loader.php#yaf-loader.props.global-library
		 */
		protected $_global_library;

		/**
		 * @var mixed
		 * @link https://php.net/manual/ja/class.yaf-loader.php#yaf-loader.props.instance
		 */
		static $_instance;
		 ...
		 * <p></p><p>この関数は、 現在のところ詳細な情報はありません。引数のリストのみが 記述されています。</p>
		 * @return void
		 * @link https://php.net/manual/ja/yaf-loader.clone.php
		 * @since Yaf >=1.0.0
		 */
		private function __clone() {}
		 ...
		 * <p></p><p>この関数は、 現在のところ詳細な情報はありません。引数のリストのみが 記述されています。</p>
		 * @return self
		 * @link https://php.net/manual/ja/yaf-loader.construct.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * <p></p><p>この関数は、 現在のところ詳細な情報はありません。引数のリストのみが 記述されています。</p>
		 * @return void
		 * @link https://php.net/manual/ja/yaf-loader.sleep.php
		 * @since Yaf >=1.0.0
		 */
		private function __sleep(): void {}
		 ...
		 * <p></p><p>この関数は、 現在のところ詳細な情報はありません。引数のリストのみが 記述されています。</p>
		 * @return void
		 * @link https://php.net/manual/ja/yaf-loader.wakeup.php
		 * @since Yaf >=1.0.0
		 */
		private function __wakeup(): void {}
		 ...
		 * <p></p><p>この関数は、 現在のところ詳細な情報はありません。引数のリストのみが 記述されています。</p>
		 * @return void
		 * @link https://php.net/manual/ja/yaf-loader.autoload.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * <p></p><p>この関数は、 現在のところ詳細な情報はありません。引数のリストのみが 記述されています。</p>
		 * @return void
		 * @link https://php.net/manual/ja/yaf-loader.clearlocalnamespace.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * <p></p><p>この関数は、 現在のところ詳細な情報はありません。引数のリストのみが 記述されています。</p>
		 * @return void
		 * @link https://php.net/manual/ja/yaf-loader.getinstance.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @return Yaf_Loader
		 * @link https://php.net/manual/ja/yaf-loader.getlibrarypath.php
		 * @since Yaf >=2.1.4
		 */
		 ...
		 * <p></p><p>この関数は、 現在のところ詳細な情報はありません。引数のリストのみが 記述されています。</p>
		 * @return void
		 * @link https://php.net/manual/ja/yaf-loader.getlocalnamespace.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * <p></p><p>この関数は、 現在のところ詳細な情報はありません。引数のリストのみが 記述されています。</p>
		 * @return void
		 * @link https://php.net/manual/ja/yaf-loader.import.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * <p></p><p>この関数は、 現在のところ詳細な情報はありません。引数のリストのみが 記述されています。</p>
		 * @return void
		 * @link https://php.net/manual/ja/yaf-loader.islocalname.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @link https://php.net/manual/ja/yaf-loader.registerlocalnamespace.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @param bool $is_global
		 * @return Yaf_Loader
		 * @link https://php.net/manual/ja/yaf-loader.setlibrarypath.php
		 * @since Yaf >=2.1.4
		 */
	 ...
	 * @link https://php.net/manual/ja/class.yaf-plugin-abstract.php
	 * @since Yaf >=1.0.0
	 */
	class Yaf_Plugin_Abstract {
		 ...
		 * @return void
		 * @link https://php.net/manual/ja/yaf-plugin-abstract.dispatchloopshutdown.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @param \Yaf_Response_Abstract $response
		 * @return void
		 * @link https://php.net/manual/ja/yaf-plugin-abstract.dispatchloopstartup.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @param \Yaf_Response_Abstract $response
		 * @return void
		 * @link https://php.net/manual/ja/yaf-plugin-abstract.postdispatch.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @param \Yaf_Response_Abstract $response
		 * @return void
		 * @link https://php.net/manual/ja/yaf-plugin-abstract.predispatch.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @param \Yaf_Response_Abstract $response
		 * @return void
		 * @link https://php.net/manual/ja/yaf-plugin-abstract.preresponse.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @param \Yaf_Response_Abstract $response
		 * @return void
		 * @link https://php.net/manual/ja/yaf-plugin-abstract.routershutdown.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @param \Yaf_Response_Abstract $response
		 * @return void
		 * @link https://php.net/manual/ja/yaf-plugin-abstract.routerstartup.php
		 * @since Yaf >=1.0.0
		 */
	 ...
	 * @link https://php.net/manual/ja/class.yaf-registry.php
	 * @since Yaf >=1.0.0
	 */
	class Yaf_Registry {
		...
		/**
		 * @var mixed
		 * @link https://php.net/manual/ja/class.yaf-registry.php#yaf-registry.props.instance
		 */
		static $_instance;

		/**
		 * @var mixed
		 * @link https://php.net/manual/ja/class.yaf-registry.php#yaf-registry.props.entries
		 */
		protected $_entries;
		 ...
		 * The __clone purpose
		 * @return void
		 * @link https://php.net/manual/ja/yaf-registry.clone.php
		 * @since Yaf >=1.0.0
		 */
		private function __clone() {}
		 ...
		 * @return self
		 * @link https://php.net/manual/ja/yaf-registry.construct.php
		 * @since Yaf >=1.0.0
		 */
		private function __construct() {}
		 ...
		 * @param string $name
		 * @return void
		 * @link https://php.net/manual/ja/yaf-registry.del.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @param string $name
		 * @return mixed
		 * @link https://php.net/manual/ja/yaf-registry.get.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @param string $name
		 * @return bool
		 * @link https://php.net/manual/ja/yaf-registry.has.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @param string $value
		 * @return bool
		 * @link https://php.net/manual/ja/yaf-registry.set.php
		 * @since Yaf >=1.0.0
		 */
	...
	/**
	 * @link https://php.net/manual/ja/class.yaf-request-abstract.php
	 * @since Yaf >=1.0.0
	 */
	class Yaf_Request_Abstract {
		...
		/**
		 * @var mixed
		 * @link https://php.net/manual/ja/class.yaf-request-abstract.php#yaf-request-abstract.props.module
		 */
		public $module;

		/**
		 * @var mixed
		 * @link https://php.net/manual/ja/class.yaf-request-abstract.php#yaf-request-abstract.props.controller
		 */
		public $controller;

		/**
		 * @var mixed
		 * @link https://php.net/manual/ja/class.yaf-request-abstract.php#yaf-request-abstract.props.action
		 */
		public $action;

		/**
		 * @var mixed
		 * @link https://php.net/manual/ja/class.yaf-request-abstract.php#yaf-request-abstract.props.method
		 */
		public $method;

		/**
		 * @var mixed
		 * @link https://php.net/manual/ja/class.yaf-request-abstract.php#yaf-request-abstract.props.params
		 */
		protected $params;

		/**
		 * @var mixed
		 * @link https://php.net/manual/ja/class.yaf-request-abstract.php#yaf-request-abstract.props.language
		 */
		protected $language;

		/**
		 * @var mixed
		 * @link https://php.net/manual/ja/class.yaf-request-abstract.php#yaf-request-abstract.props.exception
		 */
		protected $_exception;

		/**
		 * @var mixed
		 * @link https://php.net/manual/ja/class.yaf-request-abstract.php#yaf-request-abstract.props.base-uri
		 */
		protected $_base_uri;

		/**
		 * @var mixed
		 * @link https://php.net/manual/ja/class.yaf-request-abstract.php#yaf-request-abstract.props.uri
		 */
		protected $uri;

		/**
		 * @var mixed
		 * @link https://php.net/manual/ja/class.yaf-request-abstract.php#yaf-request-abstract.props.dispatched
		 */
		protected $dispatched;

		/**
		 * @var mixed
		 * @link https://php.net/manual/ja/class.yaf-request-abstract.php#yaf-request-abstract.props.routed
		 */
		protected $routed;
		 ...
		 * <p></p><p>この関数は、 現在のところ詳細な情報はありません。引数のリストのみが 記述されています。</p>
		 * @return void
		 * @link https://php.net/manual/ja/yaf-request-abstract.getactionname.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * <p></p><p>この関数は、 現在のところ詳細な情報はありません。引数のリストのみが 記述されています。</p>
		 * @return void
		 * @link https://php.net/manual/ja/yaf-request-abstract.getbaseuri.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * <p></p><p>この関数は、 現在のところ詳細な情報はありません。引数のリストのみが 記述されています。</p>
		 * @return void
		 * @link https://php.net/manual/ja/yaf-request-abstract.getcontrollername.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @return void <p>ストリングを返します</p>
		 * @link https://php.net/manual/ja/yaf-request-abstract.getenv.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * <p></p><p>この関数は、 現在のところ詳細な情報はありません。引数のリストのみが 記述されています。</p>
		 * @return void
		 * @link https://php.net/manual/ja/yaf-request-abstract.getexception.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @link https://php.net/manual/ja/yaf-request-abstract.getlanguage.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @link https://php.net/manual/ja/yaf-request-abstract.getmethod.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * <p></p><p>この関数は、 現在のところ詳細な情報はありません。引数のリストのみが 記述されています。</p>
		 * @return void
		 * @link https://php.net/manual/ja/yaf-request-abstract.getmodulename.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @return array
		 * @link https://php.net/manual/ja/yaf-request-abstract.getparams.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * <p></p><p>この関数は、 現在のところ詳細な情報はありません。引数のリストのみが 記述されています。</p>
		 * @return void
		 * @link https://php.net/manual/ja/yaf-request-abstract.getrequesturi.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @param string $default <p>このパラメータを指定すると、変数が見つからない場合にこの値を返すようになります。</p>
		 * @return void
		 * @link https://php.net/manual/ja/yaf-request-abstract.getserver.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @link https://php.net/manual/ja/yaf-request-abstract.iscli.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @link https://php.net/manual/ja/yaf-request-abstract.isdispatched.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @return bool <p>boolean</p>
		 * @link https://php.net/manual/ja/yaf-request-abstract.isget.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @return bool <p>boolean</p>
		 * @link https://php.net/manual/ja/yaf-request-abstract.ishead.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @return bool <p>boolean</p>
		 * @link https://php.net/manual/ja/yaf-request-abstract.isoptions.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @return bool <p>boolean</p>
		 * @link https://php.net/manual/ja/yaf-request-abstract.ispost.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @return bool <p>boolean</p>
		 * @link https://php.net/manual/ja/yaf-request-abstract.isput.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @return bool <p>boolean</p>
		 * @link https://php.net/manual/ja/yaf-request-abstract.isrouted.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @return bool <p>boolean</p>
		 * @link https://php.net/manual/ja/yaf-request-abstract.isxmlhttprequest.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @param string $action
		 * @return void
		 * @link https://php.net/manual/ja/yaf-request-abstract.setactionname.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @return bool <p>bool</p>
		 * @link https://php.net/manual/ja/yaf-request-abstract.setbaseuri.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @param string $controller
		 * @return void
		 * @link https://php.net/manual/ja/yaf-request-abstract.setcontrollername.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * <p></p><p>この関数は、 現在のところ詳細な情報はありません。引数のリストのみが 記述されています。</p>
		 * @return void
		 * @link https://php.net/manual/ja/yaf-request-abstract.setdispatched.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @param string $module
		 * @return void
		 * @link https://php.net/manual/ja/yaf-request-abstract.setmodulename.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @param string $value
		 * @return bool
		 * @link https://php.net/manual/ja/yaf-request-abstract.setparam.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @param string $uir
		 * @return void
		 * @link https://php.net/manual/ja/yaf-request-abstract.setrequesturi.php
		 * @since Yaf >=2.1.0
		 */
		 ...
		 * @param string $flag
		 * @return void
		 * @link https://php.net/manual/ja/yaf-request-abstract.setrouted.php
		 * @since Yaf >=1.0.0
		 */
	 ...
	 * <p><b>注意</b>:</p>
	 * <p>セキュリティの観点から、Yaf では $_GET/$_POST が読み込み専用となっています。つまり、 これらのグローバル変数の値を書き換えたとしても、 <code>Yaf_Request_Http::getQuery()</code> や <code>Yaf_Request_Http::getPost()</code> からはそれを取得できないということです。</p>
	 ...
	 * @link https://php.net/manual/ja/class.yaf-request-http.php
	 * @since Yaf >=1.0.0
	 */
	class Yaf_Request_Http extends \Yaf_Request_Abstract {
		 ...
		 * <p></p><p>この関数は、 現在のところ詳細な情報はありません。引数のリストのみが 記述されています。</p>
		 * @return void
		 * @link https://php.net/manual/ja/yaf-request-http.clone.php
		 * @since Yaf >=1.0.0
		 */
		private function __clone() {}
		 ...
		 * @return self
		 * @link https://php.net/manual/ja/yaf-request-http.construct.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @param string $default <p>このパラメータを指定すると、変数が見つからない場合にこの値を返すようになります。</p>
		 * @return mixed
		 * @link https://php.net/manual/ja/yaf-request-http.get.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @return mixed
		 * @link https://php.net/manual/ja/yaf-request-http.getcookie.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * <p></p><p>この関数は、 現在のところ詳細な情報はありません。引数のリストのみが 記述されています。</p>
		 * @return void
		 * @link https://php.net/manual/ja/yaf-request-http.getfiles.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @param string $default <p>このパラメータを指定すると、変数が見つからない場合にこの値を返すようになります。</p>
		 * @return mixed
		 * @link https://php.net/manual/ja/yaf-request-http.getpost.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @param string $default <p>このパラメータを指定すると、変数が見つからない場合にこの値を返すようになります。</p>
		 * @return mixed
		 * @link https://php.net/manual/ja/yaf-request-http.getquery.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @link https://php.net/manual/ja/yaf-request-http.getraw.php
		 * @since Yaf >=3.0.7
		 */
		 ...
		 * <p></p><p>この関数は、 現在のところ詳細な情報はありません。引数のリストのみが 記述されています。</p>
		 * @return void
		 * @link https://php.net/manual/ja/yaf-request-http.getrequest.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @return bool <p>boolean</p>
		 * @link https://php.net/manual/ja/yaf-request-http.isxmlhttprequest.php
		 * @since Yaf >=1.0.0
		 */
		public function isXmlHttpRequest(): bool {}
	 ...
	 * @link https://php.net/manual/ja/class.yaf-request-simple.php
	 * @since Yaf >=1.0.0
	 */
	class Yaf_Request_Simple extends \Yaf_Request_Abstract {
		 ...
		 * <p></p><p>この関数は、 現在のところ詳細な情報はありません。引数のリストのみが 記述されています。</p>
		 * @return void
		 * @link https://php.net/manual/ja/yaf-request-simple.clone.php
		 * @since Yaf >=1.0.0
		 */
		private function __clone() {}
		 ...
		 * @param array $params
		 * @return self
		 * @link https://php.net/manual/ja/yaf-request-simple.construct.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * <p></p><p>この関数は、 現在のところ詳細な情報はありません。引数のリストのみが 記述されています。</p>
		 * @return void
		 * @link https://php.net/manual/ja/yaf-request-simple.get.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * <p></p><p>この関数は、 現在のところ詳細な情報はありません。引数のリストのみが 記述されています。</p>
		 * @return void
		 * @link https://php.net/manual/ja/yaf-request-simple.getcookie.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * <p></p><p>この関数は、 現在のところ詳細な情報はありません。引数のリストのみが 記述されています。</p>
		 * @return void
		 * @link https://php.net/manual/ja/yaf-request-simple.getfiles.php
		 * @since Yaf >=1.0.0
		 */
		public function getFiles(): void {}
		 ...
		 * <p></p><p>この関数は、 現在のところ詳細な情報はありません。引数のリストのみが 記述されています。</p>
		 * @return void
		 * @link https://php.net/manual/ja/yaf-request-simple.getpost.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * <p></p><p>この関数は、 現在のところ詳細な情報はありません。引数のリストのみが 記述されています。</p>
		 * @return void
		 * @link https://php.net/manual/ja/yaf-request-simple.getquery.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * <p></p><p>この関数は、 現在のところ詳細な情報はありません。引数のリストのみが 記述されています。</p>
		 * @return void
		 * @link https://php.net/manual/ja/yaf-request-simple.getrequest.php
		 * @since Yaf >=1.0.0
		 */
		public function getRequest(): void {}
		 ...
		 * @link https://php.net/manual/ja/yaf-request-simple.isxmlhttprequest.php
		 * @since Yaf >=1.0.0
		 */
	...
	/**
	 * @link https://php.net/manual/ja/class.yaf-response-abstract.php
	 * @since Yaf >=1.0.0
	 */
	class Yaf_Response_Abstract {
		...
		/**
		 * @var mixed
		 * @link https://php.net/manual/ja/class.yaf-response-abstract.php#yaf-response-abstract.props.header
		 */
		protected $_header;

		/**
		 * @var mixed
		 * @link https://php.net/manual/ja/class.yaf-response-abstract.php#yaf-response-abstract.props.body
		 */
		protected $_body;

		/**
		 * @var mixed
		 * @link https://php.net/manual/ja/class.yaf-response-abstract.php#yaf-response-abstract.props.sendheader
		 */
		 ...
		 * <p></p><p>この関数は、 現在のところ詳細な情報はありません。引数のリストのみが 記述されています。</p>
		 * @return void
		 * @link https://php.net/manual/ja/yaf-response-abstract.clone.php
		 * @since Yaf >=1.0.0
		 */
		private function __clone() {}
		 ...
		 * <p></p><p>この関数は、 現在のところ詳細な情報はありません。引数のリストのみが 記述されています。</p>
		 * @return self
		 * @link https://php.net/manual/ja/yaf-response-abstract.construct.php
		 * @since Yaf >=1.0.0
		 */
		public function __construct() {}
		 ...
		 * <p></p><p>この関数は、 現在のところ詳細な情報はありません。引数のリストのみが 記述されています。</p>
		 * @return void
		 * @link https://php.net/manual/ja/yaf-response-abstract.destruct.php
		 * @since Yaf >=1.0.0
		 */
		public function __destruct() {}
		 ...
		 * @return string
		 * @link https://php.net/manual/ja/yaf-response-abstract.tostring.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @return bool <p>bool</p>
		 * @link https://php.net/manual/ja/yaf-response-abstract.appendbody.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @return bool
		 * @link https://php.net/manual/ja/yaf-response-abstract.clearbody.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @return void
		 * @link https://php.net/manual/ja/yaf-response-abstract.clearheaders.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @return mixed
		 * @link https://php.net/manual/ja/yaf-response-abstract.getbody.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * <p></p><p>この関数は、 現在のところ詳細な情報はありません。引数のリストのみが 記述されています。</p>
		 * @return void
		 * @link https://php.net/manual/ja/yaf-response-abstract.getheader.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @param string $key <p>コンテンツのキー。キーを指定しない場合は、 Yaf_Response_Abstract::DEFAULT_BODY を使います。</p> <p><b>注意</b>:</p> <p>このパラメータは 2.2.0 で導入されました。</p>
		 * @return bool <p>bool</p>
		 * @link https://php.net/manual/ja/yaf-response-abstract.prependbody.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * <p>レスポンスを送信します。</p>
		 * @return void
		 * @link https://php.net/manual/ja/yaf-response-abstract.response.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * <p></p><p>この関数は、 現在のところ詳細な情報はありません。引数のリストのみが 記述されています。</p>
		 * @return void
		 * @link https://php.net/manual/ja/yaf-response-abstract.setallheaders.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @param string $key <p>コンテンツのキー。キーを指定しない場合は、 Yaf_Response_Abstract::DEFAULT_BODY を使います。</p> <p><b>注意</b>:</p> <p>このパラメータは 2.2.0 で導入されました。</p>
		 * @return bool
		 * @link https://php.net/manual/ja/yaf-response-abstract.setbody.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @param bool $replace
		 * @return bool
		 * @link https://php.net/manual/ja/yaf-response-abstract.setheader.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * <p></p><p>この関数は、 現在のところ詳細な情報はありません。引数のリストのみが 記述されています。</p>
		 * @return void
		 * @link https://php.net/manual/ja/yaf-response-abstract.setredirect.php
		 * @since Yaf >=1.0.0
		 */
	 ...
	 * @link https://php.net/manual/ja/class.yaf-route-interface.php
	 * @since Yaf >=1.0.0
	 */
	class Yaf_Route_Interface {
		 ...
		 * @param array $query
		 * @return string
		 * @link https://php.net/manual/ja/yaf-route-interface.assemble.php
		 * @since Yaf >=2.3.0
		 */
		 ...
		 * @return bool
		 * @link https://php.net/manual/ja/yaf-route-interface.route.php
		 * @since Yaf >=1.0.0
		 */
	 ...
	 * @link https://php.net/manual/ja/class.yaf-route-map.php
	 * @since Yaf >=1.0.0
	 */
	class Yaf_Route_Map implements \Yaf_Route_Interface {
		...
		/**
		 * @var mixed
		 * @link https://php.net/manual/ja/class.yaf-route-map.php#yaf-route-map.props.ctl-router
		 */
		protected $_ctl_router;

		/**
		 * @var mixed
		 * @link https://php.net/manual/ja/class.yaf-route-map.php#yaf-route-map.props.delimeter
		 */
		 ...
		 * @return self
		 * @link https://php.net/manual/ja/yaf-route-map.construct.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @param array $query
		 * @return string
		 * @link https://php.net/manual/ja/yaf-route-map.assemble.php
		 * @since Yaf >=2.3.0
		 */
		 ...
		 * @param \Yaf_Request_Abstract $request
		 * @return bool
		 * @link https://php.net/manual/ja/yaf-route-map.route.php
		 * @since Yaf >=1.0.0
		 */
	 ...
	 * @link https://php.net/manual/ja/class.yaf-route-regex.php
	 * @since Yaf >=1.0.0
	 */
	class Yaf_Route_Regex extends \Yaf_Route_Interface implements \Yaf_Route_Interface {
		...
		/**
		 * @var mixed
		 * @link https://php.net/manual/ja/class.yaf-route-regex.php#yaf-route-regex.props.route
		 */
		protected $_route;

		/**
		 * @var mixed
		 * @link https://php.net/manual/ja/class.yaf-route-regex.php#yaf-route-regex.props.default
		 */
		protected $_default;

		/**
		 * @var mixed
		 * @link https://php.net/manual/ja/class.yaf-route-regex.php#yaf-route-regex.props.maps
		 */
		protected $_maps;

		/**
		 * @var mixed
		 * @link https://php.net/manual/ja/class.yaf-route-regex.php#yaf-route-regex.props.verify
		 */
		protected $_verify;
		 ...
		 * @return self
		 * @link https://php.net/manual/ja/yaf-route-regex.construct.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @param array $query
		 * @return string
		 * @link https://php.net/manual/ja/yaf-route-regex.assemble.php
		 * @since Yaf >=2.3.0
		 */
		public function assemble(array $info, array $query = NULL): string {}
		 ...
		 * @link https://php.net/manual/ja/yaf-route-regex.route.php
		 * @since Yaf >=1.0.0
		 */
		public function route(\Yaf_Request_Abstract $request): bool {}
	}
	 ...
	 * @link https://php.net/manual/ja/class.yaf-route-rewrite.php
	 * @since Yaf >=1.0.0
	 */
	class Yaf_Route_Rewrite extends \Yaf_Route_Interface implements \Yaf_Route_Interface {
		...
		/**
		 * @var mixed
		 * @link https://php.net/manual/ja/class.yaf-route-rewrite.php#yaf-route-rewrite.props.route
		 */
		protected $_route;

		/**
		 * @var mixed
		 * @link https://php.net/manual/ja/class.yaf-route-rewrite.php#yaf-route-rewrite.props.default
		 */
		protected $_default;

		/**
		 * @var mixed
		 * @link https://php.net/manual/ja/class.yaf-route-rewrite.php#yaf-route-rewrite.props.verify
		 */
		protected $_verify;
		 ...
		 * @param array $verify
		 * @return self
		 * @link https://php.net/manual/ja/yaf-route-rewrite.construct.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @param array $query
		 * @return string
		 * @link https://php.net/manual/ja/yaf-route-rewrite.assemble.php
		 * @since Yaf >=2.3.0
		 */
		public function assemble(array $info, array $query = NULL): string {}
		 ...
		 * @param \Yaf_Request_Abstract $request
		 * @return bool
		 * @link https://php.net/manual/ja/yaf-route-rewrite.route.php
		 * @since Yaf >=1.0.0
		 */
		public function route(\Yaf_Request_Abstract $request): bool {}
	}
	 ...
	 * @link https://php.net/manual/ja/class.yaf-route-simple.php
	 * @since Yaf >=1.0.0
	 */
	class Yaf_Route_Simple implements \Yaf_Route_Interface {
		...
		/**
		 * @var mixed
		 * @link https://php.net/manual/ja/class.yaf-route-simple.php#yaf-route-simple.props.controller
		 */
		protected $controller;

		/**
		 * @var mixed
		 * @link https://php.net/manual/ja/class.yaf-route-simple.php#yaf-route-simple.props.module
		 */
		protected $module;

		/**
		 * @var mixed
		 * @link https://php.net/manual/ja/class.yaf-route-simple.php#yaf-route-simple.props.action
		 */
		protected $action;

		/**
		 * Yaf_Route_Simple constructor
		 * <p>Yaf_Route_Simple will get route info from query string. and the parameters of this constructor will used as keys while searching for the route info in $_GET.</p><p>この関数は、 現在のところ詳細な情報はありません。引数のリストのみが 記述されています。</p>
		 ...
		 * @link https://php.net/manual/ja/yaf-route-simple.construct.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @param array $query
		 * @return string
		 * @link https://php.net/manual/ja/yaf-route-simple.assemble.php
		 * @since Yaf >=2.3.0
		 */
		public function assemble(array $info, array $query = NULL): string {}
		 ...
		 * @link https://php.net/manual/ja/yaf-route-simple.route.php
		 * @since Yaf >=1.0.0
		 */
		public function route(\Yaf_Request_Abstract $request): bool {}
	}
	 ...
	 * @link https://php.net/manual/ja/class.yaf-route-static.php
	 * @since Yaf >=1.0.0
	 */
	class Yaf_Route_Static implements \Yaf_Router {
		 ...
		 * @param array $query
		 * @return string
		 * @link https://php.net/manual/ja/yaf-route-static.assemble.php
		 * @since Yaf >=2.3.0
		 */
		public function assemble(array $info, array $query = NULL): string {}
		 ...
		 * @param string $uri
		 * @return void
		 * @link https://php.net/manual/ja/yaf-route-static.match.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @param \Yaf_Request_Abstract $request
		 * @return bool <p>常に <b><code>TRUE</code></b> を返します。</p>
		 * @link https://php.net/manual/ja/yaf-route-static.route.php
		 * @since Yaf >=1.0.0
		 */
		public function route(\Yaf_Request_Abstract $request): bool {}
	}
	...
	/**
	 * @link https://php.net/manual/ja/class.yaf-route-supervar.php
	 * @since Yaf >=1.0.0
	 */
	class Yaf_Route_Supervar implements \Yaf_Route_Interface {
		...
		/**
		 * @var mixed
		 * @link https://php.net/manual/ja/class.yaf-route-supervar.php#yaf-route-supervar.props.var-name
		 */
		protected $_var_name;
		 ...
		 * @return self
		 * @link https://php.net/manual/ja/yaf-route-supervar.construct.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @param array $query
		 * @return string
		 * @link https://php.net/manual/ja/yaf-route-supervar.assemble.php
		 * @since Yaf >=2.3.0
		 */
		public function assemble(array $info, array $query = NULL): string {}
		 ...
		 * @link https://php.net/manual/ja/yaf-route-supervar.route.php
		 * @since Yaf >=1.0.0
		 */
		public function route(\Yaf_Request_Abstract $request): bool {}
	}
	 ...
	 * @link https://php.net/manual/ja/class.yaf-router.php
	 * @since Yaf >=1.0.0
	 */
	class Yaf_Router {
		 ...
		 * @link https://php.net/manual/ja/class.yaf-router.php#yaf-router.props.routes
		 */
		protected $_routes;

		/**
		 * @var mixed <p>ルーティングを終えた後に、 今回のリクエストで使ったルートの名前がここに入ります。 この名前を取得するには <code>Yaf_Router::getCurrentRoute()</code> を使います。</p>
		 * @link https://php.net/manual/ja/class.yaf-router.php#yaf-router.props.current
		 */
		protected $_current;
		 ...
		 * Yaf_Router のコンストラクタ
		 * @return self
		 * @link https://php.net/manual/ja/yaf-router.construct.php
		 * @since Yaf >=1.0.0
		 */
		public function __construct() {}
		 ...
		 * @link https://php.net/manual/ja/yaf-router.addconfig.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @return bool
		 * @link https://php.net/manual/ja/yaf-router.addroute.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @link https://php.net/manual/ja/yaf-router.getcurrentroute.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @link https://php.net/manual/ja/yaf-router.getroute.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * <p>登録済みのルートを取得します。</p>
		 * @return mixed
		 * @link https://php.net/manual/ja/yaf-router.getroutes.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @param \Yaf_Request_Abstract $request
		 * @return bool
		 * @link https://php.net/manual/ja/yaf-router.route.php
		 * @since Yaf >=1.0.0
		 */
		public function route(\Yaf_Request_Abstract $request): bool {}
	...
	/**
	 * @link https://php.net/manual/ja/class.yaf-session.php
	 * @since Yaf >=1.0.0
	 */
	class Yaf_Session implements \Iterator, \ArrayAccess, \Countable {
		...
		/**
		 * @var mixed
		 * @link https://php.net/manual/ja/class.yaf-session.php#yaf-session.props.instance
		 */
		protected static $_instance;

		/**
		 * @var mixed
		 * @link https://php.net/manual/ja/class.yaf-session.php#yaf-session.props.session
		 */
		protected $_session;

		/**
		 * @var mixed
		 * @link https://php.net/manual/ja/class.yaf-session.php#yaf-session.props.started
		 */
		protected $_started;
		 ...
		 * <p></p><p>この関数は、 現在のところ詳細な情報はありません。引数のリストのみが 記述されています。</p>
		 * @return void
		 * @link https://php.net/manual/ja/yaf-session.clone.php
		 * @since Yaf >=1.0.0
		 */
		private function __clone() {}
		 ...
		 * <p></p><p>この関数は、 現在のところ詳細な情報はありません。引数のリストのみが 記述されています。</p>
		 * @return self
		 * @link https://php.net/manual/ja/yaf-session.construct.php
		 * @since Yaf >=1.0.0
		 */
		private function __construct() {}
		 ...
		 * @param string $name
		 * @return void
		 * @link https://php.net/manual/ja/yaf-session.get.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @param string $name
		 * @return void
		 * @link https://php.net/manual/ja/yaf-session.isset.php
		 * @since Yaf >=1.0.0
		 */
		public function __isset(string $name): void {}
		 ...
		 * @param string $value
		 * @return void
		 * @link https://php.net/manual/ja/yaf-session.set.php
		 * @since Yaf >=1.0.0
		 */
		public function __set(string $name, string $value): void {}
		 ...
		 * <p></p><p>この関数は、 現在のところ詳細な情報はありません。引数のリストのみが 記述されています。</p>
		 * @return void
		 * @link https://php.net/manual/ja/yaf-session.sleep.php
		 * @since Yaf >=1.0.0
		 */
		private function __sleep(): void {}
		 ...
		 * @param string $name
		 * @return void
		 * @link https://php.net/manual/ja/yaf-session.unset.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * <p></p><p>この関数は、 現在のところ詳細な情報はありません。引数のリストのみが 記述されています。</p>
		 * @return void
		 * @link https://php.net/manual/ja/yaf-session.wakeup.php
		 * @since Yaf >=1.0.0
		 */
		private function __wakeup(): void {}
		 ...
		 * <p></p><p>この関数は、 現在のところ詳細な情報はありません。引数のリストのみが 記述されています。</p>
		 * @return void
		 * @link https://php.net/manual/ja/yaf-session.count.php
		 * @since Yaf >=1.0.0
		 */
		public function count(): void {}
		 ...
		 * <p></p><p>この関数は、 現在のところ詳細な情報はありません。引数のリストのみが 記述されています。</p>
		 * @return void
		 * @link https://php.net/manual/ja/yaf-session.current.php
		 * @since Yaf >=1.0.0
		 */
		public function current(): void {}
		 ...
		 * @param string $name
		 * @return void
		 * @link https://php.net/manual/ja/yaf-session.del.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * <p></p><p>この関数は、 現在のところ詳細な情報はありません。引数のリストのみが 記述されています。</p>
		 * @return void
		 * @link https://php.net/manual/ja/yaf-session.getinstance.php
		 * @since Yaf >=1.0.0
		 */
		public static function getInstance(): void {}
		 ...
		 * @param string $name
		 * @return void
		 * @link https://php.net/manual/ja/yaf-session.has.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * <p></p><p>この関数は、 現在のところ詳細な情報はありません。引数のリストのみが 記述されています。</p>
		 * @return void
		 * @link https://php.net/manual/ja/yaf-session.key.php
		 * @since Yaf >=1.0.0
		 */
		public function key(): void {}
		 ...
		 * <p></p><p>この関数は、 現在のところ詳細な情報はありません。引数のリストのみが 記述されています。</p>
		 * @return void
		 * @link https://php.net/manual/ja/yaf-session.next.php
		 * @since Yaf >=1.0.0
		 */
		public function next(): void {}
		 ...
		 * @param string $name
		 * @return void
		 * @link https://php.net/manual/ja/yaf-session.offsetexists.php
		 * @since Yaf >=1.0.0
		 */
		public function offsetExists(string $name): void {}
		 ...
		 * @param string $name
		 * @return void
		 * @link https://php.net/manual/ja/yaf-session.offsetget.php
		 * @since Yaf >=1.0.0
		 */
		public function offsetGet(string $name): void {}
		 ...
		 * @param string $value
		 * @return void
		 * @link https://php.net/manual/ja/yaf-session.offsetset.php
		 * @since Yaf >=1.0.0
		 */
		public function offsetSet(string $name, string $value): void {}
		 ...
		 * @param string $name
		 * @return void
		 * @link https://php.net/manual/ja/yaf-session.offsetunset.php
		 * @since Yaf >=1.0.0
		 */
		public function offsetUnset(string $name): void {}
		 ...
		 * <p></p><p>この関数は、 現在のところ詳細な情報はありません。引数のリストのみが 記述されています。</p>
		 * @return void
		 * @link https://php.net/manual/ja/yaf-session.rewind.php
		 * @since Yaf >=1.0.0
		 */
		public function rewind(): void {}
		 ...
		 * <p></p><p>この関数は、 現在のところ詳細な情報はありません。引数のリストのみが 記述されています。</p>
		 * @return void
		 * @link https://php.net/manual/ja/yaf-session.start.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * <p></p><p>この関数は、 現在のところ詳細な情報はありません。引数のリストのみが 記述されています。</p>
		 * @return void
		 * @link https://php.net/manual/ja/yaf-session.valid.php
		 * @since Yaf >=1.0.0
		 */
		public function valid(): void {}
	}
	 ...
	 * @link https://php.net/manual/ja/class.yaf-view-interface.php
	 * @since Yaf >=1.0.0
	 */
	class Yaf_View_Interface {
		 ...
		 * @param string $value
		 * @return bool
		 * @link https://php.net/manual/ja/yaf-view-interface.assign.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @return bool
		 * @link https://php.net/manual/ja/yaf-view-interface.display.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * <p></p><p>この関数は、 現在のところ詳細な情報はありません。引数のリストのみが 記述されています。</p>
		 * @return void
		 * @link https://php.net/manual/ja/yaf-view-interface.getscriptpath.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @param array $tpl_vars
		 * @return string
		 * @link https://php.net/manual/ja/yaf-view-interface.render.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @return void
		 * @link https://php.net/manual/ja/yaf-view-interface.setscriptpath.php
		 * @since Yaf >=1.0.0
		 */
	 ...
	 * @link https://php.net/manual/ja/class.yaf-view-simple.php
	 * @since Yaf >=1.0.0
	 */
	class Yaf_View_Simple implements \Yaf_View_Interface {
		...
		/**
		 * @var mixed
		 * @link https://php.net/manual/ja/class.yaf-view-simple.php#yaf-view-simple.props.tpl-vars
		 */
		protected $_tpl_vars;

		/**
		 * @var mixed
		 * @link https://php.net/manual/ja/class.yaf-view-simple.php#yaf-view-simple.props.tpl-dir
		 */
		protected $_tpl_dir;
		 ...
		 * @return self
		 * @link https://php.net/manual/ja/yaf-view-simple.construct.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @return void
		 * @link https://php.net/manual/ja/yaf-view-simple.get.php
		 * @since Yaf >=1.0.0
		 */
		public function __get(string $name = NULL): void {}
		 ...
		 * @param string $name
		 * @return void
		 * @link https://php.net/manual/ja/yaf-view-simple.isset.php
		 * @since Yaf >=1.0.0
		 */
		public function __isset(string $name): void {}
		 ...
		 * @return void
		 * @link https://php.net/manual/ja/yaf-view-simple.set.php
		 * @since Yaf >=1.0.0
		 */
		public function __set(string $name, $value): void {}
		 ...
		 * @return bool
		 * @link https://php.net/manual/ja/yaf-view-simple.assign.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @param mixed $value <p>代入する値。</p>
		 * @return bool
		 * @link https://php.net/manual/ja/yaf-view-simple.assignref.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @return bool
		 * @link https://php.net/manual/ja/yaf-view-simple.clear.php
		 * @since Yaf >=2.2.0
		 */
		 ...
		 * @param array $tpl_vars
		 * @return bool
		 * @link https://php.net/manual/ja/yaf-view-simple.display.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @param array $tpl_vars
		 * @return string
		 * @link https://php.net/manual/ja/yaf-view-simple.eval.php
		 * @since Yaf >=2.2.0
		 */
		 ...
		 * テンプレートのディレクトリを取得する
		 * @return string
		 * @link https://php.net/manual/ja/yaf-view-simple.getscriptpath.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @param array $tpl_vars
		 * @return string
		 * @link https://php.net/manual/ja/yaf-view-simple.render.php
		 * @since Yaf >=1.0.0
		 */
		 ...
		 * @return bool
		 * @link https://php.net/manual/ja/yaf-view-simple.setscriptpath.php
		 * @since Yaf >=1.0.0
		 */
