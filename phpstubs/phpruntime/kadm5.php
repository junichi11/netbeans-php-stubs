 ...
 * @link http://php.net/manual/ja/function.kadm5-chpass-principal.php
 ...
 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
 * @link http://php.net/manual/ja/function.kadm5-create-principal.php
 ...
 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
 * @link http://php.net/manual/ja/function.kadm5-delete-principal.php
 ...
 * @param resource $handle <p>KADM5 ハンドル。</p>
 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
 * @link http://php.net/manual/ja/function.kadm5-destroy.php
 ...
 * @param resource $handle <p>KADM5 ハンドル。</p>
 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
 * @link http://php.net/manual/ja/function.kadm5-flush.php
 * @since PECL kadm5 >= 0.2.3
 */
 ...
 * @link http://php.net/manual/ja/function.kadm5-get-policies.php
 * @since PECL kadm5 >= 0.2.3
 */
 ...
 * @link http://php.net/manual/ja/function.kadm5-get-principal.php
 ...
 * @link http://php.net/manual/ja/function.kadm5-get-principals.php
 ...
 * @link http://php.net/manual/ja/function.kadm5-init-with-password.php
 * @see kadm5_destroy()
 * @since PECL kadm5 >= 0.2.3
 */
 ...
 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
 * @link http://php.net/manual/ja/function.kadm5-modify-principal.php
