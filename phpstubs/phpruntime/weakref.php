...
/**
 * @link http://php.net/manual/ja/class.weakmap.php
...
class WeakMap implements \Countable, \ArrayAccess, \Iterator {
	 ...
	 * @link http://php.net/manual/ja/weakmap.construct.php
	 * @since PECL weakref >= 0.2.0
	 */
	 ...
	 * @link http://php.net/manual/ja/weakmap.count.php
	 * @since PECL weakref >= 0.2.0
	 */
	 ...
	 * @link http://php.net/manual/ja/weakmap.current.php
	 * @since PECL weakref >= 0.2.0
	 */
	 ...
	 * @link http://php.net/manual/ja/weakmap.key.php
	 * @since PECL weakref >= 0.2.0
	 */
	 ...
	 * @link http://php.net/manual/ja/weakmap.next.php
	 * @since PECL weakref >= 0.2.0
	 */
	 ...
	 * @link http://php.net/manual/ja/weakmap.offsetexists.php
	 * @since PECL weakref >= 0.2.0
	 */
	 ...
	 * @link http://php.net/manual/ja/weakmap.offsetget.php
	 * @since PECL weakref >= 0.2.0
	 */
	 ...
	 * @return void <p>値を返しません。</p>
	 * @link http://php.net/manual/ja/weakmap.offsetset.php
	 * @since PECL weakref >= 0.2.0
	 */
	 ...
	 * @return void <p>値を返しません。</p>
	 * @link http://php.net/manual/ja/weakmap.offsetunset.php
	 * @since PECL weakref >= 0.2.0
	 */
	 ...
	 * @return void <p>値を返しません。</p>
	 * @link http://php.net/manual/ja/weakmap.rewind.php
	 * @since PECL weakref >= 0.2.0
	 */
	 ...
	 * @link http://php.net/manual/ja/weakmap.valid.php
	 * @since PECL weakref >= 0.2.0
	 */
 ...
 * @link http://php.net/manual/ja/class.weakref.php
...
class WeakRef {
	 ...
	 * @return self <p>値を返しません。</p>
	 * @link http://php.net/manual/ja/weakref.construct.php
	 * @since PECL weakref >= 0.1.0
	 */
	 ...
	 * @link http://php.net/manual/ja/weakref.acquire.php
	 * @since PECL weakref >= 0.1.0
	 */
	 ...
	 * @link http://php.net/manual/ja/weakref.get.php
	 * @since PECL weakref >= 0.1.0
	 */
	 ...
	 * @link http://php.net/manual/ja/weakref.release.php
	 * @since PECL weakref >= 0.1.0
	 */
	 ...
	 * @link http://php.net/manual/ja/weakref.valid.php
	 * @since PECL weakref >= 0.1.0
	 */
	public function valid(): bool {}
}
