...
namespace {
	 ...
	 * @link https://php.net/manual/ja/class.finfo.php
	...
	class finfo {
		 ...
		 * @return resource
		 * @link https://php.net/manual/ja/finfo.construct.php
		 ...
		 * @link https://php.net/manual/ja/finfo.buffer.php
		 * @since PHP 5 >= 5.3.0, PHP 7, PECL fileinfo >= 0.1.0
		 */
		function buffer() {}
		 ...
		 * @link https://php.net/manual/ja/finfo.file.php
		 * @since PHP >= 5.3.0, PECL fileinfo >= 0.1.0
		 */
		function file() {}
		 ...
		 * @link https://php.net/manual/ja/finfo.set-flags.php
		 * @since PHP >= 5.3.0, PECL fileinfo >= 0.1.0
		 */
		function set_flags() {}
	}
	 ...
	 * @link https://php.net/manual/ja/function.finfo-buffer.php
	 * @see finfo_file()
	 * @since PHP 5 >= 5.3.0, PHP 7, PECL fileinfo >= 0.1.0
	 */
	 ...
	 * @link https://php.net/manual/ja/function.finfo-close.php
	 * @since PHP >= 5.3.0, PECL fileinfo >= 0.1.0
	 */
	 ...
	 * @link https://php.net/manual/ja/function.finfo-file.php
	 * @see finfo_buffer()
	 * @since PHP >= 5.3.0, PECL fileinfo >= 0.1.0
	 */
	 ...
	 * @link https://php.net/manual/ja/function.finfo-open.php
	 * @see finfo_close()
	 * @since PHP >= 5.3.0, PECL fileinfo >= 0.1.0
	 */
	 ...
	 * @param int $options <p>ひとつあるいは複数のFileinfo 定数の組み合わせ。</p>
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.finfo-set-flags.php
	 * @since PHP >= 5.3.0, PECL fileinfo >= 0.1.0
	 */
	 ...
	 * @return string <p>Content type を MIME 形式で返します。 たとえば <i>text/plain</i> あるいは <i>application/octet-stream</i> のような形式です。 失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.mime-content-type.php
