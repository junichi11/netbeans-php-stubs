 ...
 * @link http://php.net/manual/ja/function.dbase-add-record.php
 ...
 * @param resource $dbase_identifier <p>The database link identifier, returned by <code>dbase_open()</code> or <code>dbase_create()</code>.</p>
 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
 * @link http://php.net/manual/ja/function.dbase-close.php
 ...
 * @link http://php.net/manual/ja/function.dbase-create.php
 ...
 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
 * @link http://php.net/manual/ja/function.dbase-delete-record.php
 ...
 * @link http://php.net/manual/ja/function.dbase-get-header-info.php
 * @since PHP 5 < 5.3.0, dbase 5, dbase 7
 */
 ...
 * @link http://php.net/manual/ja/function.dbase-get-record.php
 ...
 * @link http://php.net/manual/ja/function.dbase-get-record-with-names.php
 ...
 * @link http://php.net/manual/ja/function.dbase-numfields.php
 ...
 * <p>Gets the number of records (rows) in the specified database.</p><p><b>注意</b>:</p><p>Record numbers are between 1 and <i>dbase_numrecords($db)</i>, while field numbers are between 0 and <i>dbase_numfields($db)-1</i>.</p>
 * @param resource $dbase_identifier <p>The database link identifier, returned by <code>dbase_open()</code> or <code>dbase_create()</code>.</p>
 * @return int <p>The number of records in the database, or <b><code>FALSE</code></b> if an error occurs.</p>
 * @link http://php.net/manual/ja/function.dbase-numrecords.php
 * @see dbase_numfields()
 * @since PHP 5 < 5.3.0, dbase 5, dbase 7
 */
 ...
 * @link http://php.net/manual/ja/function.dbase-open.php
 ...
 * @param resource $dbase_identifier <p>The database link identifier, returned by <code>dbase_open()</code> or <code>dbase_create()</code>.</p>
 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
 * @link http://php.net/manual/ja/function.dbase-pack.php
 ...
 * @param int $record_number <p>An integer which spans from 1 to the number of records in the database (as returned by <code>dbase_numrecords()</code>).</p>
 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
 * @link http://php.net/manual/ja/function.dbase-replace-record.php
