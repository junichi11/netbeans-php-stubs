 ...
 * @param string $iv
 * @return string
 * @link http://php.net/manual/ja/function.mcrypt-cbc.php
 * @since PHP 4, PHP 5
 */
 ...
 * @param string $iv
 * @return string
 * @link http://php.net/manual/ja/function.mcrypt-cfb.php
 * @since PHP 4, PHP 5
 */
 ...
 * @param int $mode
 * @return string
 * @link http://php.net/manual/ja/function.mcrypt-ecb.php
 * @since PHP 4, PHP 5
 */
 ...
 * @param resource $td
 * @return bool
 * @link http://php.net/manual/ja/function.mcrypt-generic-end.php
 ...
 * @param string $algorithm <p><b><code>MCRYPT_暗号名</code></b> 定数のいずれか、 あるいはアルゴリズム名をあらわす文字列。</p>
 * @param string $lib_dir <p>オプションのパラメータ <code>lib_dir</code> により、 システム上での algorithm モジュールの位置を指定することが可能です。</p>
 * @return bool <p>この関数は、セルフテストが成功した場合 <b><code>TRUE</code></b>、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
 ...
 * @param string $iv
 * @return string
 * @link http://php.net/manual/ja/function.mcrypt-ofb.php
 * @since PHP 4, PHP 5
 */
