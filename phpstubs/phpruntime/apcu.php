...
namespace {
	 ...
	 * @link https://php.net/manual/ja/class.apcuiterator.php
	...
	class APCUIterator implements \Iterator {
		 ...
		 * @link https://php.net/manual/ja/apcuiterator.construct.php
		 ...
		 * @link https://php.net/manual/ja/apcuiterator.current.php
		 * @since PECL apcu >= 5.0.0
		 */
		 ...
		 * @link https://php.net/manual/ja/apcuiterator.gettotalcount.php
		 * @see apcu_cache_info()
		 * @since PECL apcu >= 5.0.0
		 */
		 ...
		 * @link https://php.net/manual/ja/apcuiterator.gettotalhits.php
		 * @see apcu_cache_info()
		 * @since PECL apcu >= 5.0.0
		 */
		 ...
		 * @link https://php.net/manual/ja/apcuiterator.gettotalsize.php
		 * @see apcu_cache_info()
		 * @since PECL apcu >= 5.0.0
		 */
		 ...
		 * @link https://php.net/manual/ja/apcuiterator.key.php
		 * @since PECL apcu >= 5.0.0
		 */
		 ...
		 * @link https://php.net/manual/ja/apcuiterator.next.php
		 * @since PECL apcu >= 5.0.0
		 */
		 ...
		 * @link https://php.net/manual/ja/apcuiterator.rewind.php
		 * @since PECL apcu >= 5.0.0
		 */
		 ...
		 * @link https://php.net/manual/ja/apcuiterator.valid.php
		 * @since PECL apcu >= 5.0.0
		 */
	 ...
	 * @link https://php.net/manual/ja/function.apcu-add.php
	 ...
	 * @link https://php.net/manual/ja/function.apcu-cache-info.php
	 * @since PECL apcu >= 4.0.0
	 */
	 ...
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.apcu-cas.php
	 ...
	 * @link https://php.net/manual/ja/function.apcu-clear-cache.php
	 * @see apcu_cache_info()
	 * @since PECL apcu >= 4.0.0
	 */
	 ...
	 * @link https://php.net/manual/ja/function.apcu-dec.php
	 * @see apcu_inc()
	 * @since PECL apcu >= 4.0.0
	 */
	 ...
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.apcu-delete.php
	 ...
	 * @link https://php.net/manual/ja/function.apcu-entry.php
	 * @see apcu_store(), apcu_fetch(), apcu_delete()
	 ...
	 * @link https://php.net/manual/ja/function.apcu-exists.php
	 ...
	 * @link https://php.net/manual/ja/function.apcu-fetch.php
	 ...
	 * @param bool $success <p>この参照渡しの変数に、成功したか失敗したかの結果が格納されます。</p>
	 * @return int <p>成功した場合に <code>key</code> の現在値を返します。 失敗した場合に <b><code>FALSE</code></b> を返します</p>
	 * @link https://php.net/manual/ja/function.apcu-inc.php
	 * @see apcu_dec()
	 * @since PECL apcu >= 4.0.0
	 */
	 ...
	 * @link https://php.net/manual/ja/function.apcu-sma-info.php
	 * @since PECL apcu >= 4.0.0
	 */
	 ...
	 * @link https://php.net/manual/ja/function.apcu-store.php
