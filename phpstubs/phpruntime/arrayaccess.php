...
namespace {
	 ...
	 * @link https://php.net/manual/ja/class.arrayaccess.php
	 * @since PHP 5, PHP 7
	 */
	interface ArrayAccess {
		 ...
		 * @link https://php.net/manual/ja/arrayaccess.offsetexists.php
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * @link https://php.net/manual/ja/arrayaccess.offsetget.php
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * @link https://php.net/manual/ja/arrayaccess.offsetset.php
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * @return void <p>値を返しません。</p>
		 * @link https://php.net/manual/ja/arrayaccess.offsetunset.php
		 * @since PHP 5, PHP 7
		 */
