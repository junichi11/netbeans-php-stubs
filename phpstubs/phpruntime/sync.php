 ...
 * @link http://php.net/manual/ja/class.syncevent.php
...
class SyncEvent {
	 ...
	 * @link http://php.net/manual/ja/syncevent.construct.php
	 * @since PECL sync >= 1.0.0
	 */
	 ...
	 * @link http://php.net/manual/ja/syncevent.fire.php
	 * @since PECL sync >= 1.0.0
	 */
	 ...
	 * @link http://php.net/manual/ja/syncevent.reset.php
	 * @since PECL sync >= 1.0.0
	 */
	 ...
	 * @return bool <p>A boolean of TRUE if the event was fired, FALSE otherwise.</p>
	 * @link http://php.net/manual/ja/syncevent.wait.php
	 * @since PECL sync >= 1.0.0
	 */
 ...
 * @link http://php.net/manual/ja/class.syncmutex.php
 * @since PECL sync >= 1.0.0
 */
class SyncMutex {
	 ...
	 * @link http://php.net/manual/ja/syncmutex.construct.php
	 * @since PECL sync >= 1.0.0
	 */
	 ...
	 * @link http://php.net/manual/ja/syncmutex.lock.php
	 * @since PECL sync >= 1.0.0
	 */
	 ...
	 * @link http://php.net/manual/ja/syncmutex.unlock.php
	 * @since PECL sync >= 1.0.0
	 */
 ...
 * @link http://php.net/manual/ja/class.syncreaderwriter.php
 * @since PECL sync >= 1.0.0
 */
class SyncReaderWriter {
	 ...
	 * @link http://php.net/manual/ja/syncreaderwriter.construct.php
	 * @since PECL sync >= 1.0.0
	 */
	 ...
	 * @return bool <p>A boolean of TRUE if the lock was obtained, FALSE otherwise.</p>
	 * @link http://php.net/manual/ja/syncreaderwriter.readlock.php
	 * @since PECL sync >= 1.0.0
	 */
	 ...
	 * @return bool <p>A boolean of TRUE if the unlock operation was successful, FALSE otherwise.</p>
	 * @link http://php.net/manual/ja/syncreaderwriter.readunlock.php
	 * @since PECL sync >= 1.0.0
	 */
	 ...
	 * @param int $wait <p>The number of milliseconds to wait for a lock. A value of -1 is infinite.</p>
	 * @return bool <p>A boolean of TRUE if the lock was obtained, FALSE otherwise.</p>
	 * @link http://php.net/manual/ja/syncreaderwriter.writelock.php
	 * @since PECL sync >= 1.0.0
	 */
	 ...
	 * @return bool <p>A boolean of TRUE if the unlock operation was successful, FALSE otherwise.</p>
	 * @link http://php.net/manual/ja/syncreaderwriter.writeunlock.php
	 * @since PECL sync >= 1.0.0
	 */
 ...
 * @link http://php.net/manual/ja/class.syncsemaphore.php
 * @since PECL sync >= 1.0.0
 */
class SyncSemaphore {
	 ...
	 * @link http://php.net/manual/ja/syncsemaphore.construct.php
	 * @since PECL sync >= 1.0.0
	 */
	 ...
	 * @link http://php.net/manual/ja/syncsemaphore.lock.php
	 * @since PECL sync >= 1.0.0
	 */
	public function lock(int $wait = -1): bool {}
	 ...
	 * @return bool <p>A boolean of TRUE if the unlock operation was successful, FALSE otherwise.</p>
	 * @link http://php.net/manual/ja/syncsemaphore.unlock.php
	 * @since PECL sync >= 1.0.0
	 */
 ...
 * @link http://php.net/manual/ja/class.syncsharedmemory.php
...
class SyncSharedMemory {
	 ...
	 * @link http://php.net/manual/ja/syncsharedmemory.construct.php
	 * @since PECL sync >= 1.1.0
	 */
	 ...
	 * @link http://php.net/manual/ja/syncsharedmemory.first.php
	 * @since PECL sync >= 1.1.0
	 */
	 ...
	 * @link http://php.net/manual/ja/syncsharedmemory.read.php
	 * @since PECL sync >= 1.1.0
	 */
	 ...
	 * @link http://php.net/manual/ja/syncsharedmemory.size.php
	 * @since PECL sync >= 1.1.0
	 */
	 ...
	 * @link http://php.net/manual/ja/syncsharedmemory.write.php
	 * @since PECL sync >= 1.1.0
	 */
