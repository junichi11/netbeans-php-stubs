...
namespace {
	 ...
	 * @link https://php.net/manual/ja/function.shmop-close.php
	 * @see shmop_open()
	 ...
	 * @link https://php.net/manual/ja/function.shmop-delete.php
	 * @since PHP 4 >= 4.0.4, PHP 5, PHP 7
	 */
	 ...
	 * @link https://php.net/manual/ja/function.shmop-open.php
	 ...
	 * @link https://php.net/manual/ja/function.shmop-read.php
	 * @see shmop_write()
	 * @since PHP 4 >= 4.0.4, PHP 5, PHP 7
	 */
	 ...
	 * @link https://php.net/manual/ja/function.shmop-size.php
	 * @since PHP 4 >= 4.0.4, PHP 5, PHP 7
	 */
	 ...
	 * @link https://php.net/manual/ja/function.shmop-write.php
	 * @see shmop_read()
	 * @since PHP 4 >= 4.0.4, PHP 5, PHP 7
	 */
