...
namespace XMLDiff {
	 ...
	 * @link https://php.net/manual/ja/class.xmldiff-base.php
	...
	class Base {
		 ...
		 * @return self
		 * @link https://php.net/manual/ja/xmldiff-base.construct.php
		 * @since PECL xmldiff >= 0.8.0
		 */
		 ...
		 * @link https://php.net/manual/ja/xmldiff-base.diff.php
		 * @since PECL xmldiff >= 0.8.0
		 */
		 ...
		 * @return mixed <p>Implementation dependent.</p>
		 * @link https://php.net/manual/ja/xmldiff-base.merge.php
		 * @since PECL xmldiff >= 0.8.0
		 */
	...
	/**
	 * @link https://php.net/manual/ja/class.xmldiff-dom.php
	 * @since PECL xmldiff >= 0.8.0
	 */
	class DOM extends \XMLDiff\Base {
		 ...
		 * @link https://php.net/manual/ja/xmldiff-dom.diff.php
		 * @since PECL xmldiff >= 0.8.0
		 */
		 ...
		 * @link https://php.net/manual/ja/xmldiff-dom.merge.php
		 * @since PECL xmldiff >= 0.8.0
		 */
	...
	/**
	 * @link https://php.net/manual/ja/class.xmldiff-file.php
	 * @since PECL xmldiff >= 0.8.0
	 */
	class File extends \XMLDiff\Base {
		 ...
		 * @link https://php.net/manual/ja/xmldiff-file.diff.php
		 * @since PECL xmldiff >= 0.8.0
		 */
		 ...
		 * @link https://php.net/manual/ja/xmldiff-file.merge.php
		 * @since PECL xmldiff >= 0.8.0
		 */
	...
	/**
	 * @link https://php.net/manual/ja/class.xmldiff-memory.php
	 * @since PECL xmldiff >= 0.8.0
	 */
	class Memory extends \XMLDiff\Base {
		 ...
		 * @return string <p>String with the XML document containing the diff information or NULL.</p>
		 * @link https://php.net/manual/ja/xmldiff-memory.diff.php
		 * @since PECL xmldiff >= 0.8.0
		 */
		public function diff(string $from, string $to): string {}
		 ...
		 * @return string <p>String with the new XML document or NULL.</p>
		 * @link https://php.net/manual/ja/xmldiff-memory.merge.php
		 * @since PECL xmldiff >= 0.8.0
		 */
		public function merge(string $src, string $diff): string {}
	}
