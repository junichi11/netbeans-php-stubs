...
namespace {
	 ...
	 * @link https://php.net/manual/ja/function.ifx-affected-rows.php
	 * @see ifx_num_rows()
	 ...
	 * @link https://php.net/manual/ja/function.ifx-blobinfile-mode.php
	 * @since PHP 4, PHP 5 < 5.2.1
	 */
	 ...
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.ifx-byteasvarchar.php
	 ...
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.ifx-close.php
	 ...
	 * @link https://php.net/manual/ja/function.ifx-connect.php
	 ...
	 * @link https://php.net/manual/ja/function.ifx-copy-blob.php
	 ...
	 * @return int <p>新規の BLOB オブジェクト ID を返します。 エラーの場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.ifx-create-blob.php
	 ...
	 * @link https://php.net/manual/ja/function.ifx-create-char.php
	 * @see ifx_free_char()
	 * @since PHP 4, PHP 5 < 5.2.1
	 */
	 ...
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.ifx-do.php
	 * @see ifx_prepare()
	 * @since PHP 4, PHP 5 < 5.2.1
	 */
	 ...
	 * @link https://php.net/manual/ja/function.ifx-error.php
	 * @see ifx_errormsg()
	 * @since PHP 4, PHP 5 < 5.2.1
	 */
	 ...
	 * @link https://php.net/manual/ja/function.ifx-errormsg.php
	 * @see ifx_error()
	 * @since PHP 4, PHP 5 < 5.2.1
	 */
	 ...
	 * @link https://php.net/manual/ja/function.ifx-fetch-row.php
	 * @since PHP 4, PHP 5 < 5.2.1
	 */
	 ...
	 * @link https://php.net/manual/ja/function.ifx-fieldproperties.php
	 * @see ifx_fieldtypes()
	 * @since PHP 4, PHP 5 < 5.2.1
	 */
	 ...
	 * @link https://php.net/manual/ja/function.ifx-fieldtypes.php
	 ...
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.ifx-free-blob.php
	 * @see ifx_create_blob()
	 * @since PHP 4, PHP 5 < 5.2.1
	 */
	 ...
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.ifx-free-char.php
	 * @see ifx_create_char()
	 * @since PHP 4, PHP 5 < 5.2.1
	 */
	 ...
	 * @param resource $result_id <p><code>result_id</code> は、 <code>ifx_query()</code> または <code>ifx_prepare()</code> (select 型のクエリのみ!) により返された有効な結果 ID です。</p>
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.ifx-free-result.php
	 * @see ifx_do()
	 * @since PHP 4, PHP 5 < 5.2.1
	 */
	 ...
	 * @link https://php.net/manual/ja/function.ifx-get-blob.php
	 * @see ifx_get_char()
	 * @since PHP 4, PHP 5 < 5.2.1
	 */
	 ...
	 * @link https://php.net/manual/ja/function.ifx-get-char.php
	 * @see ifx_get_blob()
	 * @since PHP 4, PHP 5 < 5.2.1
	 */
	 ...
	 * @link https://php.net/manual/ja/function.ifx-getsqlca.php
	 * @since PHP 4, PHP 5 < 5.2.1
	 */
	 ...
	 * @link https://php.net/manual/ja/function.ifx-htmltbl-result.php
	 * @since PHP 4, PHP 5 < 5.2.1
	 */
	 ...
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.ifx-nullformat.php
	 * @since PHP 4, PHP 5 < 5.2.1
	 */
	 ...
	 * @link https://php.net/manual/ja/function.ifx-num-fields.php
	 * @see ifx_num_rows()
	 * @since PHP 4, PHP 5 < 5.2.1
	 */
	 ...
	 * @link https://php.net/manual/ja/function.ifx-num-rows.php
	 * @see ifx_num_fields()
	 * @since PHP 4, PHP 5 < 5.2.1
	 */
	 ...
	 * @link https://php.net/manual/ja/function.ifx-pconnect.php
	 * @see ifx_connect()
	 * @since PHP 4, PHP 5 < 5.2.1
	 */
	 ...
	 * @link https://php.net/manual/ja/function.ifx-prepare.php
	 * @see ifx_do()
	 * @since PHP 4, PHP 5 < 5.2.1
	 */
	 ...
	 * @link https://php.net/manual/ja/function.ifx-query.php
	 * @see ifx_connect()
	 * @since PHP 4, PHP 5 < 5.2.1
	 */
	 ...
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.ifx-textasvarchar.php
	 ...
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.ifx-update-blob.php
	 * @see ifx_update_char()
	 * @since PHP 4, PHP 5 < 5.2.1
	 */
	 ...
	 * @param string $content <p>新規データの文字列。</p>
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.ifx-update-char.php
	 * @see ifx_update_blob()
	 * @since PHP 4, PHP 5 < 5.2.1
	 */
	 ...
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.ifxus-close-slob.php
	 * @see ifxus_open_slob()
	 * @since PHP 4, PHP 5 < 5.2.1
	 */
	 ...
	 * @link https://php.net/manual/ja/function.ifxus-create-slob.php
	 ...
	 * @param int $bid <p>既存の SLOB の ID。</p>
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.ifxus-free-slob.php
	 ...
	 * @param int $mode <p><b><code>IFX_LO_RDONLY</code></b>、 <b><code>IFX_LO_WRONLY</code></b>、<b><code>IFX_LO_APPEND</code></b>、 <b><code>IFX_LO_RDWR</code></b>、<b><code>IFX_LO_BUFFER</code></b>、 <b><code>IFX_LO_NOBUFFER</code></b> の組み合わせ。</p>
	 * @return int <p>新しい SLOB オブジェクトの ID、あるいはエラー時に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.ifxus-open-slob.php
	 * @see ifxus_close_slob(), ifxus_free_slob()
	 * @since PHP 4, PHP 5 < 5.2.1
	 */
	 ...
	 * @link https://php.net/manual/ja/function.ifxus-read-slob.php
	 ...
	 * @link https://php.net/manual/ja/function.ifxus-seek-slob.php
	 * @see ifxus_tell_slob()
	 * @since PHP 4, PHP 5 < 5.2.1
	 */
	 ...
	 * @param int $bid <p>既存の SLOB の ID。</p>
	 * @return int <p>シーク位置を表す整数値、あるいはエラー時に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.ifxus-tell-slob.php
	 * @see ifxus_seek_slob()
	 * @since PHP 4, PHP 5 < 5.2.1
	 */
	 ...
	 * @link https://php.net/manual/ja/function.ifxus-write-slob.php
	 * @see ifxus_read_slob()
	 * @since PHP 4, PHP 5 < 5.2.1
	 */
