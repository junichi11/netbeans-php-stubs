...
class XMLReader {
	 ...
	 * @link http://php.net/manual/ja/class.xmlreader.php#xmlreader.props.attributecount
	 */
	public $attributeCount;

	/**
	 * @var string <p>ノードのベース URI</p>
	 * @link http://php.net/manual/ja/class.xmlreader.php#xmlreader.props.baseuri
	 */
	public $baseURI;

	/**
	 * @var int <p>ツリー内でのノードの階層 (0 から数える)</p>
	 * @link http://php.net/manual/ja/class.xmlreader.php#xmlreader.props.depth
	 */
	public $depth;

	/**
	 * @var bool <p>ノードが属性を保持しているかどうか</p>
	 * @link http://php.net/manual/ja/class.xmlreader.php#xmlreader.props.hasattributes
	 */
	public $hasAttributes;

	/**
	 * @var bool <p>ノードがテキストの値を保持しているかどうか</p>
	 * @link http://php.net/manual/ja/class.xmlreader.php#xmlreader.props.hasvalue
	 */
	public $hasValue;

	/**
	 * @var bool <p>属性が DTD のデフォルトかどうか</p>
	 * @link http://php.net/manual/ja/class.xmlreader.php#xmlreader.props.isdefault
	 */
	public $isDefault;

	/**
	 * @var bool <p>ノードが空要素のタグかどうか</p>
	 * @link http://php.net/manual/ja/class.xmlreader.php#xmlreader.props.isemptyelement
	 */
	public $isEmptyElement;

	/**
	 * @var string <p>ノードのローカル名</p>
	 * @link http://php.net/manual/ja/class.xmlreader.php#xmlreader.props.localname
	 */
	public $localName;

	/**
	 * @var string <p>ノードの限定名</p>
	 * @link http://php.net/manual/ja/class.xmlreader.php#xmlreader.props.name
	 */
	public $name;

	/**
	 * @var string <p>ノードに関連付けられた名前空間の URI</p>
	 * @link http://php.net/manual/ja/class.xmlreader.php#xmlreader.props.namespaceuri
	 */
	public $namespaceURI;

	/**
	 * @var int <p>ノードの型</p>
	 * @link http://php.net/manual/ja/class.xmlreader.php#xmlreader.props.nodetype
	 */
	public $nodeType;

	/**
	 * @var string <p>ノードに関連付けられた名前空間のプレフィックス</p>
	 * @link http://php.net/manual/ja/class.xmlreader.php#xmlreader.props.prefix
	 */
	public $prefix;

	/**
	 * @var string <p>ノードのテキスト値</p>
	 * @link http://php.net/manual/ja/class.xmlreader.php#xmlreader.props.value
	 */
	public $value;

	/**
	 * @var string <p>ノードが存在する xml:lang スコープ</p>
	 * @link http://php.net/manual/ja/class.xmlreader.php#xmlreader.props.xmllang
	 */
	public $xmlLang;
