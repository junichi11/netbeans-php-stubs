 ...
 * @link http://php.net/manual/ja/function.rpm-close.php
 * @see rpm_open()
 ...
 * @link http://php.net/manual/ja/function.rpm-get-tag.php
 ...
 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
 * @link http://php.net/manual/ja/function.rpm-is-valid.php
 * @since PECL rpmreader >= 0.1.0
 */
 ...
 * @link http://php.net/manual/ja/function.rpm-open.php
 * @see rpm_close()
 * @since PECL rpmreader >= 0.1.0
 */
 ...
 * @link http://php.net/manual/ja/function.rpm-version.php
