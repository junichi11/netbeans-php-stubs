...
namespace {
	 ...
	 * @link https://php.net/manual/ja/class.directory.php
	...
	class Directory {
		 ...
		 * @link https://php.net/manual/ja/class.directory.php#directory.props.path
		 */
		public $path;

		/**
		 * @var resource <p><code>readdir()</code> や <code>rewinddir()</code>、 <code>closedir()</code> などのディレクトリ関数で使います。</p>
		 * @link https://php.net/manual/ja/class.directory.php#directory.props.handle
		 */
		public $handle;

		/**
		 * ディレクトリハンドルをクローズする
		 * <p><code>closedir()</code> と同じですが、<code> dir_handle</code> のデフォルトが $this-&gt;handle になります。</p>
		 * @param resource $dir_handle
		 * @return void
		 * @link https://php.net/manual/ja/directory.close.php
		 * @since PHP 4, PHP 5, PHP 7
		 */
		 ...
		 * <p><code>readdir()</code> と同じですが、<code> dir_handle</code> のデフォルトが $this-&gt;handle になります。</p>
		 * @param resource $dir_handle
		 * @return string
		 * @link https://php.net/manual/ja/directory.read.php
		 * @since PHP 4, PHP 5, PHP 7
		 */
		...
		/**
		 * ディレクトリハンドルを元に戻す
		 * <p><code>rewinddir()</code> と同じですが、<code> dir_handle</code> のデフォルトが $this-&gt;handle になります。</p>
		 * @param resource $dir_handle
		 * @return void
		 * @link https://php.net/manual/ja/directory.rewind.php
		 * @since PHP 4, PHP 5, PHP 7
		 */
	 ...
	 * @link https://php.net/manual/ja/function.chdir.php
	 * @see getcwd()
	 * @since PHP 4, PHP 5, PHP 7
	 */
	 ...
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.chroot.php
	 ...
	 * @return void
	 * @link https://php.net/manual/ja/function.closedir.php
	 * @since PHP 4, PHP 5, PHP 7
	 */
	 ...
	 * @link https://php.net/manual/ja/function.dir.php
	 * @since PHP 4, PHP 5, PHP 7
	 */
	 ...
	 * @link https://php.net/manual/ja/function.getcwd.php
	 * @see chdir(), chmod()
	 * @since PHP 4, PHP 5, PHP 7
	 */
	 ...
	 * @return resource <p>成功した場合にディレクトリハンドルの <code>resource</code> 、 失敗した場合に <b><code>FALSE</code></b> を返します</p>
	 * @link https://php.net/manual/ja/function.opendir.php
	 ...
	 * @link https://php.net/manual/ja/function.readdir.php
	 ...
	 * @link https://php.net/manual/ja/function.rewinddir.php
	 * @since PHP 4, PHP 5, PHP 7
	 */
	 ...
	 * @link https://php.net/manual/ja/function.scandir.php
