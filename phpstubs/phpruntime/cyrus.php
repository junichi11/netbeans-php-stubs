...
namespace {
	 ...
	 * @link https://php.net/manual/ja/function.cyrus-authenticate.php
	 ...
	 * @link https://php.net/manual/ja/function.cyrus-bind.php
	 * @since PHP 4 >= 4.1.0, PECL cyrus 1.0
	 */
	 ...
	 * @param resource $connection <p>接続ハンドル。</p>
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.cyrus-close.php
	 * @since PHP 4 >= 4.1.0, PECL cyrus 1.0
	 */
	 ...
	 * @link https://php.net/manual/ja/function.cyrus-connect.php
	 * @since PHP 4 >= 4.1.0, PECL cyrus 1.0
	 */
	 ...
	 * @link https://php.net/manual/ja/function.cyrus-query.php
	 * @since PHP 4 >= 4.1.0, PECL cyrus 1.0
	 */
	 ...
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p>
	 * @link https://php.net/manual/ja/function.cyrus-unbind.php
	 * @since PHP 4 >= 4.1.0, PECL cyrus 1.0
	 */
