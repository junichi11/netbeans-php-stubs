...
namespace {
	 ...
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p><p>A return value of <b><code>FALSE</code></b> indicates that flushing all cache contents has failed or the operation is not supported by the active storage handler. Applications must not expect that calling the function will always flush the cache.</p>
	 * @link https://php.net/manual/ja/function.mysqlnd-qc-clear-cache.php
	 ...
	 * @link https://php.net/manual/ja/function.mysqlnd-qc-get-available-handlers.php
	 ...
	 * @link https://php.net/manual/ja/function.mysqlnd-qc-get-cache-info.php
	 ...
	 * @link https://php.net/manual/ja/function.mysqlnd-qc-get-core-stats.php
	 ...
	 * @link https://php.net/manual/ja/function.mysqlnd-qc-get-normalized-query-trace-log.php
	 ...
	 * @link https://php.net/manual/ja/function.mysqlnd-qc-get-query-trace-log.php
	 ...
	 * @link https://php.net/manual/ja/function.mysqlnd-qc-set-cache-condition.php
	 ...
	 * @link https://php.net/manual/ja/function.mysqlnd-qc-set-is-select.php
	 ...
	 * @return bool <p>成功した場合に <b><code>TRUE</code></b> を、失敗した場合に <b><code>FALSE</code></b> を返します。</p><p>If changing the storage handler fails a catchable fatal error will be thrown. The query cache cannot operate if the previous storage handler has been shutdown but no new storage handler has been installed.</p>
	 * @link https://php.net/manual/ja/function.mysqlnd-qc-set-storage-handler.php
	 ...
	 * @return bool <p>Returns TRUE on success or FALSE on FAILURE.</p>
	 * @link https://php.net/manual/ja/function.mysqlnd-qc-set-user-handlers.php
	 * @since PECL mysqlnd_qc >= 1.0.0
	 */
	...
	/**
	 * <code>mysqlnd_qc_set_cache_condition()</code> のパラメータとして使い、 スキーマベースの自動キャッシュの条件を設定します。
	 */
	define('MYSQLND_QC_CONDITION_META_SCHEMA_PATTERN', null);

	/**
	 * <i>mysqlnd_qc.cache_by_default = 1</i> の場合に クエリをキャッシュに格納できないようにするために使用する SQL ヒント。
	 */
	...
	/**
	 * プラグインのバージョンを表す文字列。1.0.0-prototype など。
	 */
