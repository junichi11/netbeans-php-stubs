...
namespace {
	 ...
	 * @link https://php.net/manual/ja/class.simplexmlelement.php
	 * @since PHP 5, PHP 7
	 */
	class SimpleXMLElement implements \Traversable {
		 ...
		 * @link https://php.net/manual/ja/simplexmlelement.construct.php
		 ...
		 * @link https://php.net/manual/ja/simplexmlelement.tostring.php
		 ...
		 * @link https://php.net/manual/ja/simplexmlelement.addattribute.php
		 ...
		 * @link https://php.net/manual/ja/simplexmlelement.addchild.php
		 * @since PHP 5 >= 5.1.3, PHP 7
		 */
		 ...
		 * @link https://php.net/manual/ja/simplexmlelement.asxml.php
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * @link https://php.net/manual/ja/simplexmlelement.attributes.php
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * @link https://php.net/manual/ja/simplexmlelement.children.php
		 * @see count()
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * @link https://php.net/manual/ja/simplexmlelement.count.php
		 * @since PHP 5 >= 5.3.0, PHP 7
		 */
		 ...
		 * @link https://php.net/manual/ja/simplexmlelement.getdocnamespaces.php
		 ...
		 * @link https://php.net/manual/ja/simplexmlelement.getname.php
		 * @since PHP 5 >= 5.1.3, PHP 7
		 */
		 ...
		 * @link https://php.net/manual/ja/simplexmlelement.getnamespaces.php
		 * @since PHP 5 >= 5.1.2, PHP 7
		 */
		 ...
		 * @link https://php.net/manual/ja/simplexmlelement.registerxpathnamespace.php
		 ...
		 * @link https://php.net/manual/ja/simplexmlelement.xpath.php
		 * @since PHP 5, PHP 7
		 */
	 ...
	 * @link https://php.net/manual/ja/class.simplexmliterator.php
	 * @since PHP 5 >= 5.1.3, PHP 7
	 */
	class SimpleXMLIterator extends \SimpleXMLElement implements \RecursiveIterator, \Countable {
		 ...
		 * @link https://php.net/manual/ja/simplexmliterator.current.php
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * @link https://php.net/manual/ja/simplexmliterator.getchildren.php
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * @link https://php.net/manual/ja/simplexmliterator.haschildren.php
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * @link https://php.net/manual/ja/simplexmliterator.key.php
		 * @since PHP 5, PHP 7
		 */
		public function key() {}
		 ...
		 * @return void <p>値を返しません。</p>
		 * @link https://php.net/manual/ja/simplexmliterator.next.php
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * @return void <p>値を返しません。</p>
		 * @link https://php.net/manual/ja/simplexmliterator.rewind.php
		 * @since PHP 5, PHP 7
		 */
		 ...
		 * @link https://php.net/manual/ja/simplexmliterator.valid.php
		 * @since PHP 5, PHP 7
		 */
	 ...
	 * @link https://php.net/manual/ja/function.simplexml-import-dom.php
	 ...
	 * @link https://php.net/manual/ja/function.simplexml-load-file.php
	 ...
	 * @param bool $is_prefix <p><code>ns</code> がプレフィックスである場合に <b><code>TRUE</code></b>、 URI である場合に <b><code>FALSE</code></b>。デフォルトは <b><code>FALSE</code></b> です。</p>
	 * @return SimpleXMLElement <p><code>SimpleXMLElement</code> クラスのオブジェクトを返します。 XML ドキュメント内のデータをプロパティに含みます。 失敗した場合に <b><code>FALSE</code></b> を返します。</p> <b>警告</b><p>この関数は論理値 <b><code>FALSE</code></b> を返す可能性がありますが、<b><code>FALSE</code></b> として評価される値を返す可能性もあります。 詳細については 論理値の セクションを参照してください。この関数の返り値を調べるには ===演算子 を 使用してください。</p>
	 * @link https://php.net/manual/ja/function.simplexml-load-string.php
