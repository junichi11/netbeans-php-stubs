...
class tidy {
	 ...
	 * @return tidyNode <p>tidyNode オブジェクトを返します。</p>
	 * @link http://php.net/manual/ja/tidy.php.php
...
class tidyNode {
	 ...
	 * @link http://php.net/manual/ja/class.tidynode.php#tidynode.props.value
	 */
	public $value;

	/**
	 * @var string <p>HTML ノードの名前</p>
	 * @link http://php.net/manual/ja/class.tidynode.php#tidynode.props.name
	 */
	public $name;

	/**
	 * @var int <p>タグの型 (上の定数のひとつで、たとえば <b><code>TIDY_NODETYPE_PHP</code></b>)</p>
	 * @link http://php.net/manual/ja/class.tidynode.php#tidynode.props.type
	 */
	public $type;

	/**
	 * @var int <p>ファイル内でそのタグが存在する行番号</p>
	 * @link http://php.net/manual/ja/class.tidynode.php#tidynode.props.line
	 */
	public $line;

	/**
	 * @var int <p>ファイル内でそのタグが存在するカラム番号</p>
	 * @link http://php.net/manual/ja/class.tidynode.php#tidynode.props.column
	 */
	public $column;

	/**
	 * @var bool <p>そのノードが独自タグであるかどうかを表す</p>
	 * @link http://php.net/manual/ja/class.tidynode.php#tidynode.props.proprietary
	 */
	public $proprietary;

	/**
	 * @var int <p>タグの ID (上の定数のひとつで、たとえば <b><code>TIDY_TAG_FRAME</code></b>)</p>
	 * @link http://php.net/manual/ja/class.tidynode.php#tidynode.props.id
	 */
	public $id;

	/**
	 * @var array <p>現在のノードの属性名 (キー) を表す文字列の配列</p>
	 * @link http://php.net/manual/ja/class.tidynode.php#tidynode.props.attribute
	 */
	public $attribute;

	/**
	 * @var array <p>現在のノードの子を表す <b>tidyNode</b> の配列</p>
	 * @link http://php.net/manual/ja/class.tidynode.php#tidynode.props.child
	 */
	public $child;
