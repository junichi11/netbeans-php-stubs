 ...
 * @link http://php.net/manual/ja/function.mysqlnd-ms-dump-servers.php
 ...
 * @link http://php.net/manual/ja/function.mysqlnd-ms-fabric-select-global.php
 * @since バージョン情報なし。おそらく SVN 版にしか存在しないでしょう
 */
 ...
 * @return array <p><b><code>FALSE</code></b> on error. Otherwise, <b><code>TRUE</code></b></p>
 * @link http://php.net/manual/ja/function.mysqlnd-ms-fabric-select-shard.php
 * @since バージョン情報なし。おそらく SVN 版にしか存在しないでしょう
 */
 ...
 * @link http://php.net/manual/ja/function.mysqlnd-ms-get-last-gtid.php
 ...
 * @link http://php.net/manual/ja/function.mysqlnd-ms-get-last-used-connection.php
 ...
 * @link http://php.net/manual/ja/function.mysqlnd-ms-get-stats.php
 ...
 * @link http://php.net/manual/ja/function.mysqlnd-ms-match-wild.php
 * @since PECL mysqlnd_ms >= 1.1.0
 */
 ...
 * @link http://php.net/manual/ja/function.mysqlnd-ms-query-is-select.php
 * @since PECL mysqlnd_ms >= 1.0.0
 */
 ...
 * @link http://php.net/manual/ja/function.mysqlnd-ms-set-qos.php
 ...
 * @link http://php.net/manual/ja/function.mysqlnd-ms-set-user-pick-server.php
 ...
 * @link http://php.net/manual/ja/function.mysqlnd-ms-xa-begin.php
 ...
 * @link http://php.net/manual/ja/function.mysqlnd-ms-xa-commit.php
 * @see mysqlnd_ms_get_stats()
 * @since PECL mysqlnd_ms < 1.6.0
 */
 ...
 * @link http://php.net/manual/ja/function.mysqlnd-ms-xa-gc.php
 * @see mysqlnd_ms_get_stats()
 * @since PECL mysqlnd_ms < 1.6.0
 */
 ...
 * @link http://php.net/manual/ja/function.mysqlnd-ms-xa-rollback.php
 * @see mysqlnd_ms_get_stats()
 * @since PECL mysqlnd_ms < 1.6.0
 */
