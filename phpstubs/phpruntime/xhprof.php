 ...
 * @link http://php.net/manual/ja/function.xhprof-disable.php
 ...
 * @param array $options <p>オプション項目の配列。つまり、 'ignored_functions' オプションで関数を渡すと、 その関数のプロ愛リングを無視したりできます。</p>
 * @return void <p><b><code>NULL</code></b></p>
 * @link http://php.net/manual/ja/function.xhprof-enable.php
 ...
 * @link http://php.net/manual/ja/function.xhprof-sample-disable.php
 * @since PECL xhprof >= 0.9.0
 */
 ...
 * @return void <p><b><code>NULL</code></b></p>
 * @link http://php.net/manual/ja/function.xhprof-sample-enable.php
