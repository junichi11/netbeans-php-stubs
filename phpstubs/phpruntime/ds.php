...
namespace Ds {
	 ...
	 * @link http://php.net/manual/ja/class.ds-collection.php
	...
	interface Collection {
		 ...
		 * @link http://php.net/manual/ja/ds-collection.clear.php
		 * @since PECL ds >= 1.0.0
		 */
		 ...
		 * @link http://php.net/manual/ja/ds-collection.copy.php
		 * @since PECL ds >= 1.0.0
		 */
		 ...
		 * @link http://php.net/manual/ja/ds-collection.isempty.php
		 * @since PECL ds >= 1.0.0
		 */
		 ...
		 * @link http://php.net/manual/ja/ds-collection.toarray.php
		 * @since PECL ds >= 1.0.0
		 */
	 ...
	 * @link http://php.net/manual/ja/class.ds-deque.php
	 * @since バージョン情報なし。おそらく SVN 版にしか存在しないでしょう
	 */
	class Deque {
		 ...
		 * @return void <p>値を返しません。</p>
		 * @link http://php.net/manual/ja/ds-deque.allocate.php
		 * @since PECL ds >= 1.0.0
		 */
		 ...
		 * @param callable $callback <p></p> <code>mixed</code> callback ( <code>mixed</code> <code>$value</code> ) <p>A <code>callable</code> to apply to each value in the deque.</p> <p>The callback should return what the value should be replaced by.</p>
		 * @return void <p>値を返しません。</p>
		 * @link http://php.net/manual/ja/ds-deque.apply.php
		 * @since PECL ds >= 1.0.0
		 */
		 ...
		 * @link http://php.net/manual/ja/ds-deque.capacity.php
		 * @since PECL ds >= 1.0.0
		 */
		 ...
		 * @return void <p>値を返しません。</p>
		 * @link http://php.net/manual/ja/ds-deque.clear.php
		 * @since PECL ds >= 1.0.0
		 */
		public function clear(): void {}
		 ...
		 * @link http://php.net/manual/ja/ds-deque.contains.php
		 * @since PECL ds >= 1.0.0
		 */
		 ...
		 * @link http://php.net/manual/ja/ds-deque.copy.php
		 * @since PECL ds >= 1.0.0
		 */
		 ...
		 * @param callable $callback <p></p> bool callback ( <code>mixed</code> <code>$value</code> ) <p>Optional <code>callable</code> which returns <b><code>TRUE</code></b> if the value should be included, <b><code>FALSE</code></b> otherwise.</p> <p>If a callback is not provided, only values which are <b><code>TRUE</code></b> (see converting to boolean) will be included.</p>
		 ...
		 * @link http://php.net/manual/ja/ds-deque.filter.php
		 * @since PECL ds >= 1.0.0
		 */
		 ...
		 * @link http://php.net/manual/ja/ds-deque.find.php
		 * @since PECL ds >= 1.0.0
		 */
		 ...
		 * @link http://php.net/manual/ja/ds-deque.first.php
		 * @since PECL ds >= 1.0.0
		 */
		 ...
		 * @link http://php.net/manual/ja/ds-deque.get.php
		 * @since PECL ds >= 1.0.0
		 */
		 ...
		 * @param mixed $_values
		 * @return void <p>値を返しません。</p>
		 * @link http://php.net/manual/ja/ds-deque.insert.php
		 * @since PECL ds >= 1.0.0
		 */
		 ...
		 * @link http://php.net/manual/ja/ds-deque.isempty.php
		 * @since PECL ds >= 1.0.0
		 */
		public function isEmpty(): bool {}
		 ...
		 * @link http://php.net/manual/ja/ds-deque.join.php
		 * @since PECL ds >= 1.0.0
		 */
		 ...
		 * @link http://php.net/manual/ja/ds-deque.last.php
		 * @since PECL ds >= 1.0.0
		 */
		 ...
		 * @param callable $callback <p></p> <code>mixed</code> callback ( <code>mixed</code> <code>$value</code> ) <p>A <code>callable</code> to apply to each value in the deque.</p> <p>The callable should return what the new value will be in the new deque.</p>
		 ...
		 * @link http://php.net/manual/ja/ds-deque.map.php
		 * @since PECL ds >= 1.0.0
		 */
		 ...
		 * @link http://php.net/manual/ja/ds-deque.merge.php
		 * @since PECL ds >= 1.0.0
		 */
		 ...
		 * @link http://php.net/manual/ja/ds-deque.pop.php
		 * @since PECL ds >= 1.0.0
		 */
		public function pop() {}
		 ...
		 * @param mixed $_values
		 * @return void <p>値を返しません。</p>
		 * @link http://php.net/manual/ja/ds-deque.push.php
		 * @since PECL ds >= 1.0.0
		 */
		 ...
		 * @param callable $callback <code>mixed</code> callback ( <code>mixed</code> <code>$carry</code> , <code>mixed</code> <code>$value</code> )   <code>carry</code>   <p>The return value of the previous callback, or <code>initial</code> if it's the first iteration.</p>   <code>value</code>   <p>The value of the current iteration.</p>
		 ...
		 * @link http://php.net/manual/ja/ds-deque.reduce.php
		 * @since PECL ds >= 1.0.0
		 */
		 ...
		 * @link http://php.net/manual/ja/ds-deque.remove.php
		 * @since PECL ds >= 1.0.0
		 */
		 ...
		 * @return void <p>値を返しません。</p>
		 * @link http://php.net/manual/ja/ds-deque.reverse.php
		 * @since PECL ds >= 1.0.0
		 */
		 ...
		 * @link http://php.net/manual/ja/ds-deque.reversed.php
		 * @since PECL ds >= 1.0.0
		 */
		 ...
		 * @link http://php.net/manual/ja/ds-deque.rotate.php
		 * @since PECL ds >= 1.0.0
		 */
		 ...
		 * @return void <p>値を返しません。</p>
		 * @link http://php.net/manual/ja/ds-deque.set.php
		 * @since PECL ds >= 1.0.0
		 */
		 ...
		 * @link http://php.net/manual/ja/ds-deque.shift.php
		 * @since PECL ds >= 1.0.0
		 */
		 ...
		 * @link http://php.net/manual/ja/ds-deque.slice.php
		 * @since PECL ds >= 1.0.0
		 */
		 ...
		 * @link http://php.net/manual/ja/ds-deque.sorted.php
		 * @since PECL ds >= 1.0.0
		 */
		 ...
		 * @link http://php.net/manual/ja/ds-deque.sum.php
		 * @since PECL ds >= 1.0.0
		 */
		public function sum() {}
		 ...
		 * @link http://php.net/manual/ja/ds-deque.toarray.php
		 * @since PECL ds >= 1.0.0
		 */
		public function toArray(): array {}
		 ...
		 * @return void <p>値を返しません。</p>
		 * @link http://php.net/manual/ja/ds-deque.unshift.php
		 * @since PECL ds >= 1.0.0
		 */
	 ...
	 * @link http://php.net/manual/ja/class.ds-hashable.php
	 * @since バージョン情報なし。おそらく SVN 版にしか存在しないでしょう
	 */
	interface Hashable {
		 ...
		 * @link http://php.net/manual/ja/ds-hashable.equals.php
		 * @since PECL ds >= 1.0.0
		 */
		 ...
		 * @link http://php.net/manual/ja/ds-hashable.hash.php
		 * @since PECL ds >= 1.0.0
		 */
	 ...
	 * @link http://php.net/manual/ja/class.ds-map.php
	 * @since バージョン情報なし。おそらく SVN 版にしか存在しないでしょう
	 */
	class Map {
		 ...
		 * @param int $capacity <p>The number of values for which capacity should be allocated.</p>  <p><b>注意</b>:</p> <p>Capacity will stay the same if this value is less than or equal to the current capacity.</p>   <p><b>注意</b>:</p> <p>Capacity will always be rounded up to the nearest power of 2.</p>
		 * @return void <p>値を返しません。</p>
		 * @link http://php.net/manual/ja/ds-map.allocate.php
		 * @since PECL ds >= 1.0.0
		 */
		public function allocate(int $capacity): void {}
		 ...
		 * @param callable $callback <p></p> <code>mixed</code> callback ( <code>mixed</code> <code>$key</code> , <code>mixed</code> <code>$value</code> ) <p>A <code>callable</code> to apply to each value in the map.</p> <p>The callback should return what the value should be replaced by.</p>
		 * @return void <p>値を返しません。</p>
		 * @link http://php.net/manual/ja/ds-map.apply.php
		 * @since PECL ds >= 1.0.0
		 */
		public function apply(callable $callback): void {}
		 ...
		 * <p>Returns the current capacity.</p>
		 * @return int <p>The current capacity.</p>
		 * @link http://php.net/manual/ja/ds-map.capacity.php
		 * @since PECL ds >= 1.0.0
		 */
		public function capacity(): int {}
		 ...
		 * @return void <p>値を返しません。</p>
		 * @link http://php.net/manual/ja/ds-map.clear.php
		 * @since PECL ds >= 1.0.0
		 */
		public function clear(): void {}
		 ...
		 * @link http://php.net/manual/ja/ds-map.copy.php
		 * @since PECL ds >= 1.0.0
		 */
		 ...
		 * @link http://php.net/manual/ja/ds-map.diff.php
		 * @since PECL ds >= 1.0.0
		 */
		 ...
		 * @param callable $callback <p></p> bool callback ( <code>mixed</code> <code>$key</code> , <code>mixed</code> <code>$value</code> ) <p>Optional <code>callable</code> which returns <b><code>TRUE</code></b> if the pair should be included, <b><code>FALSE</code></b> otherwise.</p> <p>If a callback is not provided, only values which are <b><code>TRUE</code></b> (see converting to boolean) will be included.</p>
		 ...
		 * @link http://php.net/manual/ja/ds-map.filter.php
		 * @since PECL ds >= 1.0.0
		 */
		 ...
		 * @link http://php.net/manual/ja/ds-map.first.php
		 * @since PECL ds >= 1.0.0
		 */
		 ...
		 * @link http://php.net/manual/ja/ds-map.get.php
		 * @since PECL ds >= 1.0.0
		 */
		 ...
		 * @link http://php.net/manual/ja/ds-map.haskey.php
		 * @since PECL ds >= 1.0.0
		 */
		 ...
		 * @link http://php.net/manual/ja/ds-map.hasvalue.php
		 * @since PECL ds >= 1.0.0
		 */
		 ...
		 * @link http://php.net/manual/ja/ds-map.intersect.php
		 * @since PECL ds >= 1.0.0
		 */
		 ...
		 * @link http://php.net/manual/ja/ds-map.isempty.php
		 * @since PECL ds >= 1.0.0
		 */
		public function isEmpty(): bool {}
		 ...
		 * @link http://php.net/manual/ja/ds-map.keys.php
		 * @since PECL ds >= 1.0.0
		 */
		 ...
		 * @param callable $comparator <p>比較関数は、最初の引数と二番目の引数の比較結果を返します。最初の引数のほうが二番目の引数より大きい場合は正の数を、二番目の引数と等しい場合はゼロを、そして二番目の引数より小さい場合は負の数を返す必要があります。PHP 7.0.0 より前のバージョンでは、この整数が -2147483648 から 2147483647 までの範囲におさまる必要がありました。</p>  int callback ( <code>mixed</code> <code>$a</code>, <code>mixed</code> <code>$b</code> )  <b>警告</b> <p>Returning <i>non-integer</i> values from the comparison function, such as <code>float</code>, will result in an internal cast to <code>integer</code> of the callback's return value. So values such as 0.99 and 0.1 will both be cast to an integer value of 0, which will compare such values as equal.</p>
		 * @return void <p>値を返しません。</p>
		 * @link http://php.net/manual/ja/ds-map.ksort.php
		 * @since PECL ds >= 1.0.0
		 */
		 ...
		 * @link http://php.net/manual/ja/ds-map.ksorted.php
		 * @since バージョン情報なし。おそらく SVN 版にしか存在しないでしょう
		 */
		 ...
		 * @link http://php.net/manual/ja/ds-map.last.php
		 * @since PECL ds >= 1.0.0
		 */
		 ...
		 * @param callable $callback <p></p> <code>mixed</code> callback ( <code>mixed</code> <code>$key</code> , <code>mixed</code> <code>$value</code> ) <p>A <code>callable</code> to apply to each value in the map.</p> <p>The callable should return what the key will be mapped to in the resulting map.</p>
		 ...
		 * @link http://php.net/manual/ja/ds-map.map.php
		 * @since PECL ds >= 1.0.0
		 */
		 ...
		 * @link http://php.net/manual/ja/ds-map.merge.php
		 * @since PECL ds >= 1.0.0
		 */
		 ...
		 * @link http://php.net/manual/ja/ds-map.pairs.php
		 * @since PECL ds >= 1.0.0
		 */
		 ...
		 * @return void <p>値を返しません。</p>
		 * @link http://php.net/manual/ja/ds-map.put.php
		 * @since PECL ds >= 1.0.0
		 */
		 ...
		 * @return void <p>値を返しません。</p>
		 * @link http://php.net/manual/ja/ds-map.putall.php
		 * @since PECL ds >= 1.0.2
		 */
		 ...
		 * @link http://php.net/manual/ja/ds-map.remove.php
		 * @since PECL ds >= 1.0.0
		 */
		 ...
		 * @return void <p>値を返しません。</p>
		 * @link http://php.net/manual/ja/ds-map.reverse.php
		 * @since PECL ds >= 1.0.0
		 */
		public function reverse(): void {}
		 ...
		 * @link http://php.net/manual/ja/ds-map.reversed.php
		 * @since PECL ds >= 1.0.0
		 */
		 ...
		 * @link http://php.net/manual/ja/ds-map.skip.php
		 * @since PECL ds >= 1.0.0
		 */
		 ...
		 * @link http://php.net/manual/ja/ds-map.slice.php
		 * @since PECL ds >= 1.0.0
		 */
		 ...
		 * @param callable $comparator <p>比較関数は、最初の引数と二番目の引数の比較結果を返します。最初の引数のほうが二番目の引数より大きい場合は正の数を、二番目の引数と等しい場合はゼロを、そして二番目の引数より小さい場合は負の数を返す必要があります。PHP 7.0.0 より前のバージョンでは、この整数が -2147483648 から 2147483647 までの範囲におさまる必要がありました。</p>  int callback ( <code>mixed</code> <code>$a</code>, <code>mixed</code> <code>$b</code> )  <b>警告</b> <p>Returning <i>non-integer</i> values from the comparison function, such as <code>float</code>, will result in an internal cast to <code>integer</code> of the callback's return value. So values such as 0.99 and 0.1 will both be cast to an integer value of 0, which will compare such values as equal.</p>
		 * @return void <p>値を返しません。</p>
		 * @link http://php.net/manual/ja/ds-map.sort.php
		 * @since PECL ds >= 1.0.0
		 */
		public function sort(callable $comparator = NULL): void {}
		 ...
		 * @link http://php.net/manual/ja/ds-map.sorted.php
		 * @since PECL ds >= 1.0.0
		 */
		 ...
		 * @link http://php.net/manual/ja/ds-map.sum.php
		 * @since バージョン情報なし。おそらく SVN 版にしか存在しないでしょう
		 */
		public function sum() {}
		 ...
		 * @link http://php.net/manual/ja/ds-map.toarray.php
		 * @since PECL ds >= 1.0.0
		 */
		public function toArray(): array {}
		 ...
		 * @link http://php.net/manual/ja/ds-map.union.php
		 * @since PECL ds >= 1.0.0
		 */
		 ...
		 * @link http://php.net/manual/ja/ds-map.values.php
		 * @since PECL ds >= 1.0.0
		 */
		 ...
		 * @link http://php.net/manual/ja/ds-map.xor.php
		 * @since PECL ds >= 1.0.0
		 */
	 ...
	 * @link http://php.net/manual/ja/class.ds-pair.php
	 * @since バージョン情報なし。おそらく SVN 版にしか存在しないでしょう
	 */
	class Pair implements \JsonSerializable {
		 ...
		 * @return self
		 * @link http://php.net/manual/ja/ds-pair.construct.php
		 * @since PECL ds >= 1.0.0
		 */
	 ...
	 * @link http://php.net/manual/ja/class.ds-priorityqueue.php
	 * @since バージョン情報なし。おそらく SVN 版にしか存在しないでしょう
	 */
	class PriorityQueue {
		 ...
		 * @param int $capacity <p>The number of values for which capacity should be allocated.</p>  <p><b>注意</b>:</p> <p>Capacity will stay the same if this value is less than or equal to the current capacity.</p>   <p><b>注意</b>:</p> <p>Capacity will always be rounded up to the nearest power of 2.</p>
		 * @return void <p>値を返しません。</p>
		 * @link http://php.net/manual/ja/ds-priorityqueue.allocate.php
		 * @since PECL ds >= 1.0.0
		 */
		public function allocate(int $capacity): void {}
		 ...
		 * <p>Returns the current capacity.</p>
		 * @return int <p>The current capacity.</p>
		 * @link http://php.net/manual/ja/ds-priorityqueue.capacity.php
		 * @since PECL ds >= 1.0.0
		 */
		public function capacity(): int {}
		 ...
		 * @return void <p>値を返しません。</p>
		 * @link http://php.net/manual/ja/ds-priorityqueue.clear.php
		 * @since PECL ds >= 1.0.0
		 */
		public function clear(): void {}
		 ...
		 * @link http://php.net/manual/ja/ds-priorityqueue.copy.php
		 * @since PECL ds >= 1.0.0
		 */
		 ...
		 * @link http://php.net/manual/ja/ds-priorityqueue.isempty.php
		 * @since PECL ds >= 1.0.0
		 */
		public function isEmpty(): bool {}
		 ...
		 * @link http://php.net/manual/ja/ds-priorityqueue.peek.php
		 * @since PECL ds >= 1.0.0
		 */
		 ...
		 * @link http://php.net/manual/ja/ds-priorityqueue.pop.php
		 * @since PECL ds >= 1.0.0
		 */
		public function pop() {}
		 ...
		 * @return void <p>値を返しません。</p>
		 * @link http://php.net/manual/ja/ds-priorityqueue.push.php
		 * @since PECL ds >= 1.0.0
		 */
		 ...
		 * @link http://php.net/manual/ja/ds-priorityqueue.toarray.php
		 * @since PECL ds >= 1.0.0
		 */
		public function toArray(): array {}
	}
	 ...
	 * @link http://php.net/manual/ja/class.ds-queue.php
	 * @since バージョン情報なし。おそらく SVN 版にしか存在しないでしょう
	 */
	class Queue {
		 ...
		 * @param int $capacity <p>The number of values for which capacity should be allocated.</p>  <p><b>注意</b>:</p> <p>Capacity will stay the same if this value is less than or equal to the current capacity.</p>   <p><b>注意</b>:</p> <p>Capacity will always be rounded up to the nearest power of 2.</p>
		 * @return void <p>値を返しません。</p>
		 * @link http://php.net/manual/ja/ds-queue.allocate.php
		 * @since PECL ds >= 1.0.0
		 */
		public function allocate(int $capacity): void {}
		 ...
		 * <p>Returns the current capacity.</p>
		 * @return int <p>The current capacity.</p>
		 * @link http://php.net/manual/ja/ds-queue.capacity.php
		 * @since PECL ds >= 1.0.0
		 */
		public function capacity(): int {}
		 ...
		 * <p>Removes all values from the queue.</p>
		 * @return void <p>値を返しません。</p>
		 * @link http://php.net/manual/ja/ds-queue.clear.php
		 * @since PECL ds >= 1.0.0
		 */
		public function clear(): void {}
		 ...
		 * @link http://php.net/manual/ja/ds-queue.copy.php
		 * @since PECL ds >= 1.0.0
		 */
		 ...
		 * <p>Returns whether the queue is empty.</p>
		 * @return bool <p>Returns <b><code>TRUE</code></b> if the queue is empty, <b><code>FALSE</code></b> otherwise.</p>
		 * @link http://php.net/manual/ja/ds-queue.isempty.php
		 * @since PECL ds >= 1.0.0
		 */
		public function isEmpty(): bool {}
		 ...
		 * <p>Returns the value at the front of the queue, but does not remove it.</p>
		 * @return mixed <p>The value at the front of the queue.</p>
		 * @link http://php.net/manual/ja/ds-queue.peek.php
		 * @since PECL ds >= 1.0.0
		 */
		public function peek() {}
		 ...
		 * @return mixed <p>The removed value which was at the front of the queue.</p>
		 * @link http://php.net/manual/ja/ds-queue.pop.php
		 * @since PECL ds >= 1.0.0
		 */
		public function pop() {}
		 ...
		 * @param mixed $_values
		 * @return void <p>値を返しません。</p>
		 * @link http://php.net/manual/ja/ds-queue.push.php
		 * @since PECL ds >= 1.0.0
		 */
		public function push($_values = NULL): void {}
		 ...
		 * @return array <p>An <code>array</code> containing all the values in the same order as the queue.</p>
		 * @link http://php.net/manual/ja/ds-queue.toarray.php
		 * @since PECL ds >= 1.0.0
		 */
		public function toArray(): array {}
	}
	 ...
	 * <p>Use cases:</p>
	 * @link http://php.net/manual/ja/class.ds-sequence.php
	 * @since バージョン情報なし。おそらく SVN 版にしか存在しないでしょう
	 */
	interface Sequence {
		 ...
		 * @return void <p>値を返しません。</p>
		 * @link http://php.net/manual/ja/ds-sequence.allocate.php
		 * @since PECL ds >= 1.0.0
		 */
		public function allocate(int $capacity): void;
		 ...
		 * @param callable $callback <p></p> <code>mixed</code> callback ( <code>mixed</code> <code>$value</code> ) <p>A <code>callable</code> to apply to each value in the sequence.</p> <p>The callback should return what the value should be replaced by.</p>
		 * @return void <p>値を返しません。</p>
		 * @link http://php.net/manual/ja/ds-sequence.apply.php
		 * @since PECL ds >= 1.0.0
		 */
		public function apply(callable $callback): void;
		 ...
		 * <p>Returns the current capacity.</p>
		 * @return int <p>The current capacity.</p>
		 * @link http://php.net/manual/ja/ds-sequence.capacity.php
		 * @since PECL ds >= 1.0.0
		 */
		public function capacity(): int;
		 ...
		 * @link http://php.net/manual/ja/ds-sequence.contains.php
		 * @since PECL ds >= 1.0.0
		 */
		public function contains($_values = NULL): bool;
		 ...
		 * @link http://php.net/manual/ja/ds-sequence.filter.php
		 * @since PECL ds >= 1.0.0
		 */
		 ...
		 * @param mixed $value <p>The value to find.</p>
		 * @return mixed <p>The index of the value, or <b><code>FALSE</code></b> if not found.</p> <p><b>注意</b>:</p> <p>Values will be compared by value and by type.</p>
		 * @link http://php.net/manual/ja/ds-sequence.find.php
		 * @since PECL ds >= 1.0.0
		 */
		public function find($value);
		 ...
		 * @link http://php.net/manual/ja/ds-sequence.first.php
		 * @since PECL ds >= 1.0.0
		 */
		public function first();
		 ...
		 * @param int $index <p>The index to access, starting at 0.</p>
		 * @return mixed <p>The value at the requested index.</p>
		 * @link http://php.net/manual/ja/ds-sequence.get.php
		 * @since PECL ds >= 1.0.0
		 */
		public function get(int $index);
		 ...
		 * @param mixed $_values
		 * @return void <p>値を返しません。</p>
		 * @link http://php.net/manual/ja/ds-sequence.insert.php
		 * @since PECL ds >= 1.0.0
		 */
		public function insert(int $index, $_values = NULL): void;
		 ...
		 * @link http://php.net/manual/ja/ds-sequence.join.php
		 * @since PECL ds >= 1.0.0
		 */
		public function join(string $glue = NULL): string;
		 ...
		 * @link http://php.net/manual/ja/ds-sequence.last.php
		 * @since PECL ds >= 1.0.0
		 */
		public function last();
		 ...
		 * @param callable $callback <p></p> <code>mixed</code> callback ( <code>mixed</code> <code>$value</code> ) <p>A <code>callable</code> to apply to each value in the sequence.</p> <p>The callable should return what the new value will be in the new sequence.</p>
		 ...
		 * @link http://php.net/manual/ja/ds-sequence.map.php
		 * @since PECL ds >= 1.0.0
		 */
		 ...
		 * @link http://php.net/manual/ja/ds-sequence.merge.php
		 * @since PECL ds >= 1.0.0
		 */
		 ...
		 * <p>Removes and returns the last value.</p>
		 * @return mixed <p>The removed last value.</p>
		 * @link http://php.net/manual/ja/ds-sequence.pop.php
		 * @since PECL ds >= 1.0.0
		 */
		public function pop();
		 ...
		 * @param mixed $_values
		 * @return void <p>値を返しません。</p>
		 * @link http://php.net/manual/ja/ds-sequence.push.php
		 * @since PECL ds >= 1.0.0
		 */
		public function push($_values = NULL): void;
		 ...
		 * @param mixed $initial <p>The initial value of the carry value. Can be <b><code>NULL</code></b>.</p>
		 * @return mixed <p>The return value of the final callback.</p>
		 * @link http://php.net/manual/ja/ds-sequence.reduce.php
		 * @since PECL ds >= 1.0.0
		 */
		public function reduce(callable $callback, $initial = NULL);
		 ...
		 * @param int $index <p>The index of the value to remove.</p>
		 * @return mixed <p>The value that was removed.</p>
		 * @link http://php.net/manual/ja/ds-sequence.remove.php
		 * @since PECL ds >= 1.0.0
		 */
		public function remove(int $index);
		 ...
		 * @return void <p>値を返しません。</p>
		 * @link http://php.net/manual/ja/ds-sequence.reverse.php
		 * @since PECL ds >= 1.0.0
		 */
		public function reverse(): void;
		 ...
		 * @link http://php.net/manual/ja/ds-sequence.reversed.php
		 * @since PECL ds >= 1.0.0
		 */
		 ...
		 * @link http://php.net/manual/ja/ds-sequence.rotate.php
		 * @since PECL ds >= 1.0.0
		 */
		public function rotate(int $rotations): void;
		 ...
		 * @param mixed $value <p>The new value.</p>
		 * @return void <p>値を返しません。</p>
		 * @link http://php.net/manual/ja/ds-sequence.set.php
		 * @since PECL ds >= 1.0.0
		 */
		public function set(int $index, $value): void;
		 ...
		 * <p>Removes and returns the first value.</p>
		 * @return mixed <p>The first value, which was removed.</p>
		 * @link http://php.net/manual/ja/ds-sequence.shift.php
		 * @since PECL ds >= 1.0.0
		 */
		public function shift();
		 ...
		 * @link http://php.net/manual/ja/ds-sequence.slice.php
		 * @since PECL ds >= 1.0.0
		 */
		 ...
		 * @param callable $comparator <p>比較関数は、最初の引数と二番目の引数の比較結果を返します。最初の引数のほうが二番目の引数より大きい場合は正の数を、二番目の引数と等しい場合はゼロを、そして二番目の引数より小さい場合は負の数を返す必要があります。PHP 7.0.0 より前のバージョンでは、この整数が -2147483648 から 2147483647 までの範囲におさまる必要がありました。</p>  int callback ( <code>mixed</code> <code>$a</code>, <code>mixed</code> <code>$b</code> )  <b>警告</b> <p>Returning <i>non-integer</i> values from the comparison function, such as <code>float</code>, will result in an internal cast to <code>integer</code> of the callback's return value. So values such as 0.99 and 0.1 will both be cast to an integer value of 0, which will compare such values as equal.</p>
		 * @return void <p>値を返しません。</p>
		 * @link http://php.net/manual/ja/ds-sequence.sort.php
		 * @since PECL ds >= 1.0.0
		 */
		public function sort(callable $comparator = NULL): void;
		 ...
		 * @link http://php.net/manual/ja/ds-sequence.sorted.php
		 * @since PECL ds >= 1.0.0
		 */
		 ...
		 * @link http://php.net/manual/ja/ds-sequence.sum.php
		 * @since PECL ds >= 1.0.0
		 */
		public function sum();
		 ...
		 * @return void <p>値を返しません。</p>
		 * @link http://php.net/manual/ja/ds-sequence.unshift.php
		 * @since PECL ds >= 1.0.0
		 */
		public function unshift($values = NULL): void;
	}
	 ...
	 * @link http://php.net/manual/ja/class.ds-set.php
	 * @since バージョン情報なし。おそらく SVN 版にしか存在しないでしょう
	 */
	class Set {
		 ...
		 * @param mixed $_values
		 * @return void <p>値を返しません。</p>
		 * @link http://php.net/manual/ja/ds-set.add.php
		 * @since PECL ds >= 1.0.0
		 */
		 ...
		 * @param int $capacity <p>The number of values for which capacity should be allocated.</p>  <p><b>注意</b>:</p> <p>Capacity will stay the same if this value is less than or equal to the current capacity.</p>   <p><b>注意</b>:</p> <p>Capacity will always be rounded up to the nearest power of 2.</p>
		 * @return void <p>値を返しません。</p>
		 * @link http://php.net/manual/ja/ds-set.allocate.php
		 * @since PECL ds >= 1.0.0
		 */
		public function allocate(int $capacity): void {}
		 ...
		 * <p>Returns the current capacity.</p>
		 * @return int <p>The current capacity.</p>
		 * @link http://php.net/manual/ja/ds-set.capacity.php
		 * @since PECL ds >= 1.0.0
		 */
		public function capacity(): int {}
		 ...
		 * @return void <p>値を返しません。</p>
		 * @link http://php.net/manual/ja/ds-set.clear.php
		 * @since PECL ds >= 1.0.0
		 */
		public function clear(): void {}
		 ...
		 * @link http://php.net/manual/ja/ds-set.contains.php
		 * @since PECL ds >= 1.0.0
		 */
		public function contains($_values = NULL): bool {}
		 ...
		 * @link http://php.net/manual/ja/ds-set.copy.php
		 * @since PECL ds >= 1.0.0
		 */
		 ...
		 * @link http://php.net/manual/ja/ds-set.diff.php
		 * @since PECL ds >= 1.0.0
		 */
		 ...
		 * @link http://php.net/manual/ja/ds-set.filter.php
		 * @since PECL ds >= 1.0.0
		 */
		 ...
		 * @return void <p>The first value in the set.</p>
		 * @link http://php.net/manual/ja/ds-set.first.php
		 * @since PECL ds >= 1.0.0
		 */
		 ...
		 * @param int $index <p>The index to access, starting at 0.</p>
		 * @return mixed <p>The value at the requested index.</p>
		 * @link http://php.net/manual/ja/ds-set.get.php
		 * @since PECL ds >= 1.0.0
		 */
		public function get(int $index) {}
		 ...
		 * @link http://php.net/manual/ja/ds-set.intersect.php
		 * @since PECL ds >= 1.0.0
		 */
		 ...
		 * @link http://php.net/manual/ja/ds-set.isempty.php
		 * @since PECL ds >= 1.0.0
		 */
		public function isEmpty(): bool {}
		 ...
		 * @link http://php.net/manual/ja/ds-set.join.php
		 * @since PECL ds >= 1.0.0
		 */
		public function join(string $glue = NULL): string {}
		 ...
		 * @link http://php.net/manual/ja/ds-set.last.php
		 * @since PECL ds >= 1.0.0
		 */
		 ...
		 * @link http://php.net/manual/ja/ds-set.merge.php
		 * @since PECL ds >= 1.0.3
		 */
		 ...
		 * @param mixed $initial <p>The initial value of the carry value. Can be <b><code>NULL</code></b>.</p>
		 * @return mixed <p>The return value of the final callback.</p>
		 * @link http://php.net/manual/ja/ds-set.reduce.php
		 * @since PECL ds >= 1.0.0
		 */
		public function reduce(callable $callback, $initial = NULL) {}
		 ...
		 * @param mixed $_values
		 * @return void <p>値を返しません。</p>
		 * @link http://php.net/manual/ja/ds-set.remove.php
		 * @since PECL ds >= 1.0.0
		 */
		 ...
		 * @return void <p>値を返しません。</p>
		 * @link http://php.net/manual/ja/ds-set.reverse.php
		 * @since PECL ds >= 1.0.0
		 */
		public function reverse(): void {}
		 ...
		 * @link http://php.net/manual/ja/ds-set.reversed.php
		 * @since PECL ds >= 1.0.0
		 */
		 ...
		 * @link http://php.net/manual/ja/ds-set.slice.php
		 * @since PECL ds >= 1.0.0
		 */
		 ...
		 * @param callable $comparator <p>比較関数は、最初の引数と二番目の引数の比較結果を返します。最初の引数のほうが二番目の引数より大きい場合は正の数を、二番目の引数と等しい場合はゼロを、そして二番目の引数より小さい場合は負の数を返す必要があります。PHP 7.0.0 より前のバージョンでは、この整数が -2147483648 から 2147483647 までの範囲におさまる必要がありました。</p>  int callback ( <code>mixed</code> <code>$a</code>, <code>mixed</code> <code>$b</code> )  <b>警告</b> <p>Returning <i>non-integer</i> values from the comparison function, such as <code>float</code>, will result in an internal cast to <code>integer</code> of the callback's return value. So values such as 0.99 and 0.1 will both be cast to an integer value of 0, which will compare such values as equal.</p>
		 * @return void <p>値を返しません。</p>
		 * @link http://php.net/manual/ja/ds-set.sort.php
		 * @since PECL ds >= 1.0.0
		 */
		public function sort(callable $comparator = NULL): void {}
		 ...
		 * @link http://php.net/manual/ja/ds-set.sorted.php
		 * @since PECL ds >= 1.0.0
		 */
		 ...
		 * @link http://php.net/manual/ja/ds-set.sum.php
		 * @since PECL ds >= 1.0.0
		 */
		public function sum() {}
		 ...
		 * @link http://php.net/manual/ja/ds-set.toarray.php
		 * @since PECL ds >= 1.0.0
		 */
		public function toArray(): array {}
		 ...
		 * @link http://php.net/manual/ja/ds-set.union.php
		 * @since PECL ds >= 1.0.0
		 */
		 ...
		 * @link http://php.net/manual/ja/ds-set.xor.php
		 * @since PECL ds >= 1.0.0
		 */
	 ...
	 * @link http://php.net/manual/ja/class.ds-stack.php
	 * @since バージョン情報なし。おそらく SVN 版にしか存在しないでしょう
	 */
	class Stack {
		 ...
		 * @param int $capacity <p>The number of values for which capacity should be allocated.</p>  <p><b>注意</b>:</p> <p>Capacity will stay the same if this value is less than or equal to the current capacity.</p>
		 * @return void <p>値を返しません。</p>
		 * @link http://php.net/manual/ja/ds-stack.allocate.php
		 * @since PECL ds >= 1.0.0
		 */
		public function allocate(int $capacity): void {}
		 ...
		 * <p>Returns the current capacity.</p>
		 * @return int <p>The current capacity.</p>
		 * @link http://php.net/manual/ja/ds-stack.capacity.php
		 * @since PECL ds >= 1.0.0
		 */
		public function capacity(): int {}
		 ...
		 * @return void <p>値を返しません。</p>
		 * @link http://php.net/manual/ja/ds-stack.clear.php
		 * @since PECL ds >= 1.0.0
		 */
		public function clear(): void {}
		 ...
		 * @link http://php.net/manual/ja/ds-stack.copy.php
		 * @since PECL ds >= 1.0.0
		 */
		 ...
		 * @link http://php.net/manual/ja/ds-stack.isempty.php
		 * @since PECL ds >= 1.0.0
		 */
		public function isEmpty(): bool {}
		 ...
		 * @link http://php.net/manual/ja/ds-stack.peek.php
		 * @since PECL ds >= 1.0.0
		 */
		public function peek() {}
		 ...
		 * @link http://php.net/manual/ja/ds-stack.pop.php
		 * @since PECL ds >= 1.0.0
		 */
		public function pop() {}
		 ...
		 * @param mixed $_values
		 * @return void <p>値を返しません。</p>
		 * @link http://php.net/manual/ja/ds-stack.push.php
		 * @since PECL ds >= 1.0.0
		 */
		public function push($_values = NULL): void {}
		 ...
		 * @link http://php.net/manual/ja/ds-stack.toarray.php
		 * @since PECL ds >= 1.0.0
		 */
		public function toArray(): array {}
	}
	 ...
	 * @link http://php.net/manual/ja/class.ds-vector.php
	 * @since バージョン情報なし。おそらく SVN 版にしか存在しないでしょう
	 */
	class Vector {
		 ...
		 * @param int $capacity <p>The number of values for which capacity should be allocated.</p>  <p><b>注意</b>:</p> <p>Capacity will stay the same if this value is less than or equal to the current capacity.</p>
		 * @return void <p>値を返しません。</p>
		 * @link http://php.net/manual/ja/ds-vector.allocate.php
		 * @since PECL ds >= 1.0.0
		 */
		public function allocate(int $capacity): void {}
		 ...
		 * @param callable $callback <p></p> <code>mixed</code> callback ( <code>mixed</code> <code>$value</code> ) <p>A <code>callable</code> to apply to each value in the vector.</p> <p>The callback should return what the value should be replaced by.</p>
		 * @return void <p>値を返しません。</p>
		 * @link http://php.net/manual/ja/ds-vector.apply.php
		 * @since PECL ds >= 1.0.0
		 */
		public function apply(callable $callback): void {}
		 ...
		 * <p>Returns the current capacity.</p>
		 * @return int <p>The current capacity.</p>
		 * @link http://php.net/manual/ja/ds-vector.capacity.php
		 * @since PECL ds >= 1.0.0
		 */
		public function capacity(): int {}
		 ...
		 * @return void <p>値を返しません。</p>
		 * @link http://php.net/manual/ja/ds-vector.clear.php
		 * @since PECL ds >= 1.0.0
		 */
		public function clear(): void {}
		 ...
		 * @link http://php.net/manual/ja/ds-vector.contains.php
		 * @since PECL ds >= 1.0.0
		 */
		public function contains($_values = NULL): bool {}
		 ...
		 * @link http://php.net/manual/ja/ds-vector.copy.php
		 * @since PECL ds >= 1.0.0
		 */
		 ...
		 * @link http://php.net/manual/ja/ds-vector.filter.php
		 * @since PECL ds >= 1.0.0
		 */
		 ...
		 * @param mixed $value <p>The value to find.</p>
		 * @return mixed <p>The index of the value, or <b><code>FALSE</code></b> if not found.</p> <p><b>注意</b>:</p> <p>Values will be compared by value and by type.</p>
		 * @link http://php.net/manual/ja/ds-vector.find.php
		 * @since PECL ds >= 1.0.0
		 */
		public function find($value) {}
		 ...
		 * @link http://php.net/manual/ja/ds-vector.first.php
		 * @since PECL ds >= 1.0.0
		 */
		public function first() {}
		 ...
		 * @param int $index <p>The index to access, starting at 0.</p>
		 * @return mixed <p>The value at the requested index.</p>
		 * @link http://php.net/manual/ja/ds-vector.get.php
		 * @since PECL ds >= 1.0.0
		 */
		public function get(int $index) {}
		 ...
		 * @param mixed $_values
		 * @return void <p>値を返しません。</p>
		 * @link http://php.net/manual/ja/ds-vector.insert.php
		 * @since PECL ds >= 1.0.0
		 */
		public function insert(int $index, $_values = NULL): void {}
		 ...
		 * @link http://php.net/manual/ja/ds-vector.isempty.php
		 * @since PECL ds >= 1.0.0
		 */
		public function isEmpty(): bool {}
		 ...
		 * @link http://php.net/manual/ja/ds-vector.join.php
		 * @since PECL ds >= 1.0.0
		 */
		public function join(string $glue = NULL): string {}
		 ...
		 * @link http://php.net/manual/ja/ds-vector.last.php
		 * @since PECL ds >= 1.0.0
		 */
		public function last() {}
		 ...
		 * @param callable $callback <p></p> <code>mixed</code> callback ( <code>mixed</code> <code>$value</code> ) <p>A <code>callable</code> to apply to each value in the vector.</p> <p>The callable should return what the new value will be in the new vector.</p>
		 ...
		 * @link http://php.net/manual/ja/ds-vector.map.php
		 * @since PECL ds >= 1.0.0
		 */
		 ...
		 * @link http://php.net/manual/ja/ds-vector.merge.php
		 * @since PECL ds >= 1.0.0
		 */
		 ...
		 * <p>Removes and returns the last value.</p>
		 * @return mixed <p>The removed last value.</p>
		 * @link http://php.net/manual/ja/ds-vector.pop.php
		 * @since PECL ds >= 1.0.0
		 */
		public function pop() {}
		 ...
		 * @param mixed $_values
		 * @return void <p>値を返しません。</p>
		 * @link http://php.net/manual/ja/ds-vector.push.php
		 * @since PECL ds >= 1.0.0
		 */
		public function push($_values = NULL): void {}
		 ...
		 * @param mixed $initial <p>The initial value of the carry value. Can be <b><code>NULL</code></b>.</p>
		 * @return mixed <p>The return value of the final callback.</p>
		 * @link http://php.net/manual/ja/ds-vector.reduce.php
		 * @since PECL ds >= 1.0.0
		 */
		public function reduce(callable $callback, $initial = NULL) {}
		 ...
		 * @param int $index <p>The index of the value to remove.</p>
		 * @return mixed <p>The value that was removed.</p>
		 * @link http://php.net/manual/ja/ds-vector.remove.php
		 * @since PECL ds >= 1.0.0
		 */
		public function remove(int $index) {}
		 ...
		 * @return void <p>値を返しません。</p>
		 * @link http://php.net/manual/ja/ds-vector.reverse.php
		 * @since PECL ds >= 1.0.0
		 */
		public function reverse(): void {}
		 ...
		 * @link http://php.net/manual/ja/ds-vector.reversed.php
		 * @since PECL ds >= 1.0.0
		 */
		 ...
		 * @link http://php.net/manual/ja/ds-vector.rotate.php
		 * @since PECL ds >= 1.0.0
		 */
		public function rotate(int $rotations): void {}
		 ...
		 * @param mixed $value <p>The new value.</p>
		 * @return void <p>値を返しません。</p>
		 * @link http://php.net/manual/ja/ds-vector.set.php
		 * @since PECL ds >= 1.0.0
		 */
		public function set(int $index, $value): void {}
		 ...
		 * <p>Removes and returns the first value.</p>
		 * @return mixed <p>The first value, which was removed.</p>
		 * @link http://php.net/manual/ja/ds-vector.shift.php
		 * @since PECL ds >= 1.0.0
		 */
		public function shift() {}
		 ...
		 * @link http://php.net/manual/ja/ds-vector.slice.php
		 * @since PECL ds >= 1.0.0
		 */
		 ...
		 * @param callable $comparator <p>比較関数は、最初の引数と二番目の引数の比較結果を返します。最初の引数のほうが二番目の引数より大きい場合は正の数を、二番目の引数と等しい場合はゼロを、そして二番目の引数より小さい場合は負の数を返す必要があります。PHP 7.0.0 より前のバージョンでは、この整数が -2147483648 から 2147483647 までの範囲におさまる必要がありました。</p>  int callback ( <code>mixed</code> <code>$a</code>, <code>mixed</code> <code>$b</code> )  <b>警告</b> <p>Returning <i>non-integer</i> values from the comparison function, such as <code>float</code>, will result in an internal cast to <code>integer</code> of the callback's return value. So values such as 0.99 and 0.1 will both be cast to an integer value of 0, which will compare such values as equal.</p>
		 * @return void <p>値を返しません。</p>
		 * @link http://php.net/manual/ja/ds-vector.sort.php
		 * @since PECL ds >= 1.0.0
		 */
		public function sort(callable $comparator = NULL): void {}
		 ...
		 * @link http://php.net/manual/ja/ds-vector.sorted.php
		 * @since PECL ds >= 1.0.0
		 */
		 ...
		 * @link http://php.net/manual/ja/ds-vector.sum.php
		 * @since PECL ds >= 1.0.0
		 */
		public function sum() {}
		 ...
		 * @link http://php.net/manual/ja/ds-vector.toarray.php
		 * @since PECL ds >= 1.0.0
		 */
		public function toArray(): array {}
		 ...
		 * @return void <p>値を返しません。</p>
		 * @link http://php.net/manual/ja/ds-vector.unshift.php
		 * @since PECL ds >= 1.0.0
		 */
		public function unshift($values = NULL): void {}
	}
